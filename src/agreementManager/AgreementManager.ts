...
class AgreementManager {
    ...
    public getBlock(
        ...
        const block = this.forkService.getAgreement(forkCnt, transactionCnt)
            ?.blockConfirmation.signedBlock.encodedBlock;
        if (!block) return undefined;
        return EvmUtils.decodeBlock(block);
    }
    ...
    public addDispute(dispute: DisputeStruct, timestamp: number): void {
        this.forkService.addDispute(dispute, timestamp);
    }
    ...
    public confirmDispute(
        ...
        this.forkService.addDisputeSignature(dispute, confirmationSignature);
    }

    public isDisputeKnown(dispute: DisputeStruct): boolean {
        return this.forkService.isDisputeKnown(dispute);
    }

    public getDisputeSignatures(dispute: DisputeStruct): SignatureLike[] {
        return this.forkService.getDisputeSignatures(dispute);
    }
    ...
    public hasParticipantSignedDispute(
        ...
        return this.forkService.hasParticipantSignedDispute(
            dispute,
            participant
        );
    }
