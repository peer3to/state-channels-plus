...
import ForkReductionService from "./ForkReductionService";
import SnapshotPostingService from "./SnapshotPostingService";
...
> {
    ...
    forkReductionService: ForkReductionService;
    snapshotPostingService: SnapshotPostingService;
    ...
    constructor(
        ...
        this.forkReductionService = new ForkReductionService(
            this.self,
            this.logger
        );
        this.snapshotPostingService = new SnapshotPostingService(
            this.self,
            this.logger
        );
    ...
    public async dispose() {
        ...
        this.forkReductionService.dispose();
    ...
    public setReductionTimeout(
        ...
        return this.forkReductionService.setReductionTimeout(
            forkId,
            localTriggerTimestamp,
            isRescheduled
        );
    }

    public reduceLocally(forkId: ForkId) {
        return this.forkReductionService.reduceLocally(forkId);
    }
    ...
    public set forkId(forkId: ForkId) {
        if (this.latestForkId !== forkId) {
            ...
            this.forkReductionService.onForkTransition();
    ...
    public isKillPeriodExpiredCached(forkId: ForkId) {
        return this.forkReductionService.isKillPeriodExpiredCached(forkId);
    }
    ...
    public postStateSnapshot(forkId: ForkId) {
        return this.snapshotPostingService.postStateSnapshot(forkId);
    }

    public prepareUpdateSnapshotSameFork(forkId: ForkId) {
        return this.snapshotPostingService.prepareUpdateSnapshotSameFork(
            forkId
        );
    }

    public prepareUpdateStateSnapshotFork() {
        return this.snapshotPostingService.prepareUpdateStateSnapshotFork();
    }
