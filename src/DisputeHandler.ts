...
class DisputeHandler {
    ...
    public createDisputeAuditingData(
        ...
        // TODO: Implement proper dispute auditing data creation
        ...
        return {
            genesisStateSnapshot: outputStateSnapshot,
            latestStateSnapshot: this.agreementManager.getSnapShot(
                forkCnt,
                transactionCnt
            )!,
            ...
            joinChannelBlocks: this.agreementManager.getJoinChannelChain(),
            timestamp: 0,
    ...
    private async createDisputeStruct(
        ...
        const genesisStateSnapshotHash =
            this.agreementManager.getForkGenesisSnapshot(
                forkCnt
