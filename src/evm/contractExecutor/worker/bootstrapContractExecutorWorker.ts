import type { ContractExecutorServiceOptions } from "../rpc/contractExecutor/ContractExecutorService";
...
export function bootstrapContractExecutorWorker(
    ...
    /** the scripted test workers speak on a port of their own making */
    port: RuntimePort = adaptWorkerScope()
): void {
    ...
    >(
        (self) => new ContractExecutorRoot(self, options),
