    ...
    return (
        <div className="modal-overlay">
            <div className="modal-content">
                ...
                <p>
                    There is no money at stake. The balances shown are only for
                    accounting purposes and don't represent any value.
                </p>
                <p>
                    The game runs entirely peer-to-peer between the users
                    devices. A blockchain is used as the final settlement layer
                    and supreme court.
                </p>
                <p>
                    <a
                    ...
                    provides the decentralized (web3) hosting of the user
                    interface making it always available and unstoppable, also
                    powered by Polkadot.
                </p>
                <p>
