...
Contribution in this file: [`REQ-TIME-5-S9NQXK`](../../../specification/protocol-model/time.md#req-time-5-s9nqxk), [`REQ-RUNTIME-6-6F4SSM`](../../../specification/runtime/execution.md#req-runtime-6-6f4ssm). The conformance rows below name this owner and the other required owners.
