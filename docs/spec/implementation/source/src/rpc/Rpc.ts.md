...
One parse classifies a valid response before a valid request; independent deserializers retain their original acceptance rules and undefined-on-invalid behavior. See [Rpc.ts](../../../../../../src/rpc/Rpc.ts#L73).
