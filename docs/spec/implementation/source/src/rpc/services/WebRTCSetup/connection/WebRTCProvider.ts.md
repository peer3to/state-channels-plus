...
The loader propagates import failures directly. The unused local-constructor predicate is removed; isWorkerRuntime remains the shared worker-scope test. See [WebRTCProvider.ts](../../../../../../../../../src/rpc/services/WebRTCSetup/connection/WebRTCProvider.ts#L34).
