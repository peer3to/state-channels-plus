# src/rpc/services/lobbyMatching — Subsystem

> **Status:** Authored — engineer verification pending.

This subsystem owns caller-topic lobby admission and exclusive two-peer matching. It does not own channel IDs or channel opening.
