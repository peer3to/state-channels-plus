...
| -------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [RpcHandler.ts](../../../../../../src/rpc/RpcHandler.ts) | [`REQ-RPC-1-FF89Z0`](../../../../specification/peer-communication/rpc.md#req-rpc-1-ff89z0), [`REQ-RPC-2-SZDTTM`](../../../../specification/peer-communication/rpc.md#req-rpc-2-szdttm) |
...
| --------------------------------------------------------------------------- | -------------- | ------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="unit-test-rpc-handler-1-8bp2k8"></a>`UNIT-TEST-RPC-HANDLER-1-8BP2K8` | Delivery verbs | Send via each verb with transport/address/none targets, including empty target lists | Correct transports receive exactly once; loopback dispatches locally; empty lists no-op; requests register correlation | <a id="unit-test-rpc-handler-1-8bp2k8.p1"></a>`UNIT-TEST-RPC-HANDLER-1-8BP2K8.P1` — broadcast fan-out; <a id="unit-test-rpc-handler-1-8bp2k8.p2"></a>`UNIT-TEST-RPC-HANDLER-1-8BP2K8.P2` — sendOne by transport; <a id="unit-test-rpc-handler-1-8bp2k8.p3"></a>`UNIT-TEST-RPC-HANDLER-1-8BP2K8.P3` — sendMultiple transports overload; <a id="unit-test-rpc-handler-1-8bp2k8.p4"></a>`UNIT-TEST-RPC-HANDLER-1-8BP2K8.P4` — request registers and resolves; <a id="unit-test-rpc-handler-1-8bp2k8.p5"></a>`UNIT-TEST-RPC-HANDLER-1-8BP2K8.P5` — sendOne by address; <a id="unit-test-rpc-handler-1-8bp2k8.p6"></a>`UNIT-TEST-RPC-HANDLER-1-8BP2K8.P6` — sendOne loopback; <a id="unit-test-rpc-handler-1-8bp2k8.p7"></a>`UNIT-TEST-RPC-HANDLER-1-8BP2K8.P7` — sendMultiple addresses overload; <a id="unit-test-rpc-handler-1-8bp2k8.p8"></a>`UNIT-TEST-RPC-HANDLER-1-8BP2K8.P8` — sendMultiple empty list |
