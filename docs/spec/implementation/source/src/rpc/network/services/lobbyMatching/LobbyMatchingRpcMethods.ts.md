...
> **Source:** [src/rpc/network/services/lobbyMatching/LobbyMatchingRpcMethods.ts](../../../../../../../../../src/rpc/network/services/lobbyMatching/LobbyMatchingRpcMethods.ts) > **Status:** Authored — engineer verification pending.
...
Endpoint senders are NetworkTransport values. Lobby session ownership, authentication and matching stay on the peer service; internal runtime transports cannot enter these endpoint constructor types. See [NetworkTransport.ts](../../../../transport/NetworkTransport.ts.md).

The otherwise unused topic parameter stays in pick and commit because LobbyRpcAdmissionGuard reads rpc.params[0]. Endpoint names and positional arguments stay unchanged. See [LobbyMatchingRpcMethods.ts](../../../../../../../../../src/rpc/network/services/lobbyMatching/LobbyMatchingRpcMethods.ts#L33).
...
| -------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| [LobbyMatchingRpcMethods.ts](../../../../../../../../../src/rpc/network/services/lobbyMatching/LobbyMatchingRpcMethods.ts) | [`REQ-LOBBY-4-E0TARV`](../../../../../../../specification/peer-communication/lobby-matching.md#req-lobby-4-e0tarv) |
