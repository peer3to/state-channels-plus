...
3. **Only the peer's own record is a penalty source.** The duplicate check in
   [`peerAcknowledgesDisputedFork`](../../../../../../../../../src/rpc/network/services/isForkDisputedService/IsForkDisputedService.ts#L136) reads what the peer did and keeps the exclusion.
   The check in [`IAcknowledgeDisputedFork`](../../../../../../../../../src/rpc/network/services/isForkDisputedService/IsForkDisputedService.ts#L150) reads this node's own bookkeeping and
   is reached only when two requests from the same peer race past the outer guard, so it closes with
   reconnect allowed instead. It closes only when a transport is still known; an address-only hit has
   nothing to close ([`REQ-DACK-1-ESEGGG` (One round per fork per peer pair)](../../../../../../../specification/peer-communication/dispute-acknowledgment.md#req-dack-1-eseggg)).
   The silence and refusal rules are untouched: they remain terminate-and-exclude, with the honest-versus-unavailable
   split still open under [`DEF-5-E8TP9N`](../../../../../../../audit/open-findings.md#def-5-e8tp9n).
...
| Outputs      | Requests to peers; recorded acknowledgments; exclusions for the peer's own duplicate, refusal, or silence.                                                                                 |
| Owned state  | Per-fork round dedup; per-peer acknowledgment records.                                                                                                                                     |
| Side effects | Disconnect/blacklist on the peer's duplicate, refusal, or timeout; a reconnect-allowed close on a repeated write of this node's own record; consequence gate consumed by block validation. |
...
| ------------------------------------------------------------------------------------------------------------------------ | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| [`REQ-DACK-1-ESEGGG`](../../../../../../../specification/peer-communication/dispute-acknowledgment.md#req-dack-1-eseggg) | Covered               | **Here:** round dedup; the [peer-record duplicate](../../../../../../../../../src/rpc/network/services/isForkDisputedService/IsForkDisputedService.ts#L136) is a violation and excludes, while a [repeated write of our own record](../../../../../../../../../src/rpc/network/services/isForkDisputedService/IsForkDisputedService.ts#L150) closes with reconnect allowed and excludes nobody. | None.            |
