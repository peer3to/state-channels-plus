...
1. **Validate before signing, structurally.** A non-32-byte challenge or a non-finite time is rejected
   [before any signature exists](../../../../../../../../../src/rpc/network/services/initHandshake/InitHandshakeRpcMethods.ts#L44). An already authenticated sender is excluded for a
   malformed challenge; a sender without proven identity is only disconnected. The NaN check is
   load-bearing because NaN defeats window comparisons ([`REQ-AUTH-1-RF901K` (Validate before signing)](../../../../../../../specification/peer-communication/handshake.md#req-auth-1-rf901k)).
2. **A time outside the window is refused, not punished.** The
   [window check](../../../../../../../../../src/rpc/network/services/initHandshake/InitHandshakeRpcMethods.ts#L60) closes with reconnect allowed and throws the declared refusal. A
   clock the two nodes disagree about is an environment fault, and it is the one request-side failure
   an honest peer can hit; treating it as misbehaviour excluded honest peers whose clock drifted
...
| Side effects | Signing; a reconnect-allowed close for a clock difference, exclusion for a malformed challenge or a duplicate ack; timeout arming. |
...
| -------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [InitHandshakeRpcMethods.ts](../../../../../../../../../src/rpc/network/services/initHandshake/InitHandshakeRpcMethods.ts) | [`INV-AUTH-2-VQ6D54`](../../../../../../../specification/peer-communication/handshake.md#inv-auth-2-vq6d54), [`REQ-AUTH-1-RF901K`](../../../../../../../specification/peer-communication/handshake.md#req-auth-1-rf901k), [`REQ-RPC-4-9VX0B9`](../../../../../../../specification/peer-communication/rpc.md#req-rpc-4-9vx0b9), [`REQ-AUTH-4-JWCF71`](../../../../../../../specification/peer-communication/handshake.md#req-auth-4-jwcf71) |
...
| ----------------------------------------------------------------------------------------------------------- | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| [`REQ-AUTH-4-JWCF71`](../../../../../../../specification/peer-communication/handshake.md#req-auth-4-jwcf71) | Partial               | **Here:** the request-side [window check](../../../../../../../../../src/rpc/network/services/initHandshake/InitHandshakeRpcMethods.ts#L60) closes with reconnect allowed and never excludes, while a malformed challenge and a duplicate ack keep the punitive close. **Other files:** [InitHandshakeService](InitHandshakeService.ts.md) applies the same split on the response side and owns the ack timeout. | None.                                                                                                                              |
