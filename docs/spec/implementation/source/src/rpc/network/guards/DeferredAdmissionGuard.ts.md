...
> **Source:** [src/rpc/network/guards/DeferredAdmissionGuard.ts](../../../../../../../../src/rpc/network/guards/DeferredAdmissionGuard.ts) > **Status:** Authored — engineer verification pending.
...
- The queue has no item cap in this pass. [`OQ-SPEC-LOBBY-1-D65YTT` (Deferred-admission queue bound)](../../../../../../specification/open-questions.md#oq-spec-lobby-1-d65ytt) owns that hardening decision.

## Linked requirements

| Source file                                                                                           | Specification IDs                                                                                                                                                                                                 |
| ----------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [DeferredAdmissionGuard.ts](../../../../../../../../src/rpc/network/guards/DeferredAdmissionGuard.ts) | [`REQ-LOBBY-7-BXQ1QA`](../../../../../../specification/peer-communication/lobby-matching.md#req-lobby-7-bxq1qa), [`REQ-RPC-7-9CBSHK`](../../../../../../specification/peer-communication/rpc.md#req-rpc-7-9cbshk) |
