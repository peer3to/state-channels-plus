...
> **Source:** [src/rpc/network/guards/AGuard.ts](../../../../../../../../src/rpc/network/guards/AGuard.ts) > **Status:** Authored — engineer verification pending.
...
1. **Predicate/consequence split is structural.** `check` cannot express a consequence and `onFailure` cannot pass — the shape enforces the pure-check rule of [`REQ-RPC-7-9CBSHK` (Guard semantics)](../../../../../../specification/peer-communication/rpc.md#req-rpc-7-9cbshk).
...
| --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| [AGuard.ts](../../../../../../../../src/rpc/network/guards/AGuard.ts) | [`REQ-RPC-7-9CBSHK`](../../../../../../specification/peer-communication/rpc.md#req-rpc-7-9cbshk) |
...
- Pure-check/consequence separation ([`REQ-RPC-7-9CBSHK` (Guard semantics)](../../../../../../specification/peer-communication/rpc.md#req-rpc-7-9cbshk)).
...
| ------------------------------------------------------------------------------------------------ | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| [`REQ-RPC-7-9CBSHK`](../../../../../../specification/peer-communication/rpc.md#req-rpc-7-9cbshk) | Covered               | **Here:** the enforced shape. **Other files:** ordering in [runGuards](runGuards.ts.md); bypass in [ANetworkRpcService](../ANetworkRpcService.ts.md). | None.            |
