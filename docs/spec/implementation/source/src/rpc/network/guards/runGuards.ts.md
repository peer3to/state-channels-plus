...
> **Source:** [src/rpc/network/guards/runGuards.ts](../../../../../../../../src/rpc/network/guards/runGuards.ts) > **Status:** Authored — engineer verification pending.
...
1. **Order is contract.** Cheap/structural guards precede expensive ones by declaration position; the runner adds no reordering or parallelism ([#L10](../../../../../../../../src/rpc/network/guards/runGuards.ts#L10)).
...
| --------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| [runGuards.ts](../../../../../../../../src/rpc/network/guards/runGuards.ts) | [`REQ-RPC-7-9CBSHK`](../../../../../../specification/peer-communication/rpc.md#req-rpc-7-9cbshk) |
...
- Declaration-order short-circuit ([`REQ-RPC-7-9CBSHK` (Guard semantics)](../../../../../../specification/peer-communication/rpc.md#req-rpc-7-9cbshk)).
...
| ------------------------------------------------------------------------------------------------ | --------------------- | ------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| [`REQ-RPC-7-9CBSHK`](../../../../../../specification/peer-communication/rpc.md#req-rpc-7-9cbshk) | Covered               | **Here:** the ordering/short-circuit semantics ([#L10](../../../../../../../../src/rpc/network/guards/runGuards.ts#L10)). | None.            |
...
- [AGuard](AGuard.ts.md), [ANetworkRpcService](../ANetworkRpcService.ts.md).
