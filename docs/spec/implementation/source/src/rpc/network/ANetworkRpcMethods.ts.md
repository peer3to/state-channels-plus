# ANetworkRpcMethods.ts — Source Report

> **Source:** [src/rpc/network/ANetworkRpcMethods.ts](../../../../../../../src/rpc/network/ANetworkRpcMethods.ts) > **Status:** Authored — engineer verification pending.
...
- Each receiver holds its concrete `ANetworkRpcService` and sender transport. Manager and remote-RPC access derive from the service; no separate manager reference is stored. Concrete service types preserve custom-root endpoint inference.
...
| ----------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| [ANetworkRpcMethods.ts](../../../../../../../src/rpc/network/ANetworkRpcMethods.ts) | [`INV-RPC-1-SJS2T6`](../../../../../specification/peer-communication/rpc.md#inv-rpc-1-sjs2t6) |

## Assumptions, dependencies, trust boundaries, and limits

- Endpoints must treat `senderTransport.peerAddress` as the caller identity source ([`INV-RPC-1-SJS2T6` (Identity-bound dispatch)](../../../../../specification/peer-communication/rpc.md#inv-rpc-1-sjs2t6)).

## Specification adherence

- Sender binding underpinning identity-bound dispatch ([`INV-RPC-1-SJS2T6` (Identity-bound dispatch)](../../../../../specification/peer-communication/rpc.md#inv-rpc-1-sjs2t6)).
...
- [ANetworkRpcService](ANetworkRpcService.ts.md) (factory caller).
