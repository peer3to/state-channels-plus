...
> **Source:** [src/rpc/network/RemoteRpcProxy.ts](../../../../../../../src/rpc/network/RemoteRpcProxy.ts) > **Status:** Authored — engineer verification pending.
...
| --------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| [RemoteRpcProxy.ts](../../../../../../../src/rpc/network/RemoteRpcProxy.ts) | [`REQ-RPC-1-FF89Z0`](../../../../../specification/peer-communication/rpc.md#req-rpc-1-ff89z0) |
...
- Public-surface confinement at the type and runtime levels ([`REQ-RPC-1-FF89Z0` (Typed wire contract)](../../../../../specification/peer-communication/rpc.md#req-rpc-1-ff89z0)).
