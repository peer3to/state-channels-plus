...
> **Source:** [src/rpc/internal/errorWire.ts](../../../../../../../src/rpc/internal/errorWire.ts) > **Status:** Authored — engineer verification pending.
...
The codec is shared by detached and request failures. It preserves nested revert bytes, error names, ethers metadata and peer stamps; the original extraction comment is retained. See [errorWire.ts](../../../../../../../src/rpc/internal/errorWire.ts#L45).
...
| ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------ |
| [errorWire.ts](../../../../../../../src/rpc/internal/errorWire.ts) | [`REQ-RUNTIME-3-VQXW59`](../../../../../specification/runtime/execution.md#req-runtime-3-vqxw59) |
...
## Migrated bridge codec ownership

The WebRTC bridge uses this shared error codec for [`REQ-RUNTIME-1-RSM6MZ` (Transfer-safe boundary)](../../../../../specification/runtime/execution.md#req-runtime-1-rsm6mz) and [`REQ-RUNTIME-4-B0N70Y` (Platform equivalence)](../../../../../specification/runtime/execution.md#req-runtime-4-b0n70y). The removed `src/rpc/internal/services/webRTCBridge/bridgeError.ts` had no separate encoding contract: its message, name and stack projection is covered here, together with the richer shared error fields.
