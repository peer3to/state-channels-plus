...
The gas usage endpoint returns the host signer's snapshot in a named field, so the client sees rows of plain strings and numbers that cross the port unchanged.
...
| [`REQ-SDK-ARCH-5-NSJYQT`](../../../../../../../specification/runtime/sdk.md#req-sdk-arch-5-nsjyqt) | Partial | **Here:** the named-field snapshot endpoint [`ChainSignerRpcMethods.ts`](../../../../../../../../../src/rpc/internal/services/chainSigner/ChainSignerRpcMethods.ts#L33). **Other files:** [ChainSignerService.ts](ChainSignerService.ts.md) holds the host signer, [ClientChainSigner.ts](../../../../evm/signer/ClientChainSigner.ts.md) is the client side of the same call. | Counting and aggregation are the signer's and the table's. |
