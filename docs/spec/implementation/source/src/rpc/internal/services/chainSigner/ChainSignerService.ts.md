...
- Per-invocation endpoint receivers retain their own sender ([`ChainSignerService.ts`](../../../../../../../../../src/rpc/internal/services/chainSigner/ChainSignerService.ts#L27)).
- The gas usage read is composed here, not in the routable methods class: the service asks the host signer's recorder for its settled rows and names the field ([`ChainSignerService.ts`](../../../../../../../../../src/rpc/internal/services/chainSigner/ChainSignerService.ts#L19)).
- The read's settle is bounded by `GAS_USAGE_SETTLE_MS`, the same bound as the disposal report, so it answers well inside the port request timeout the client read rides on. A receipt still pending when the bound expires is not in that read; it shows up on a later read once it mines ([`ChainSignerService.ts`](../../../../../../../../../src/rpc/internal/services/chainSigner/ChainSignerService.ts#L21)).
...
- [`REQ-SDK-ARCH-6-8DE4ER` (Chain spending is observable)](../../../../../../../specification/runtime/sdk.md#req-sdk-arch-6-8de4er): The service composes the bounded, settled gas usage read and its named field
...
- [`REQ-SDK-ARCH-6-8DE4ER` (Chain spending is observable)](../../../../../../../specification/runtime/sdk.md#req-sdk-arch-6-8de4er): The bounded, settled gas usage read and its named field live on this non-routable service See [`ChainSignerService.ts`](../../../../../../../../../src/rpc/internal/services/chainSigner/ChainSignerService.ts#L19).
...
| [`REQ-SDK-ARCH-6-8DE4ER`](../../../../../../../specification/runtime/sdk.md#req-sdk-arch-6-8de4er)     | Partial               | **Here:** the bounded settled read and its named field in [`gasUsageTable`](../../../../../../../../../src/rpc/internal/services/chainSigner/ChainSignerService.ts#L19). **Other files:** [ChainSignerRpcMethods.ts](ChainSignerRpcMethods.ts.md) exposes it as one endpoint call, [HostNonceManager.ts](../../../../evm/signer/HostNonceManager.ts.md) owns the recorder, [GasUsageRecorder.ts](../../../../evm/gasUsage/GasUsageRecorder.ts.md) settles and snapshots.                                                                                                                                                                                                                                                                                                                                 | Counting, aggregation and the disposal report are elsewhere. |
