# AContractExecutor.ts — Source Report

> **Source:** [src/evm/contractExecutor/AContractExecutor.ts](../../../../../../../src/evm/contractExecutor/AContractExecutor.ts) > **Status:** Authored — engineer verification pending.
...
The executor abstraction: the typed operation surface both inline and worker executors implement.
