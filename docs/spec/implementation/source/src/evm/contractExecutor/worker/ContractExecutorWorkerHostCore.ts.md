...
The [internal host options](../../../../../../../../src/evm/contractExecutor/worker/ContractExecutorWorkerHostCore.ts#L32) accept an optional logger. Initialization uses that instance when supplied, otherwise the platform logger factory. This keeps logger ownership explicit and lets monitor tests observe the real logger without replacing module exports.

Request catches use serializeError. Configured monitoring and injected monitoring retain distinct setup paths, and disposal stops the active monitor. See [ContractExecutorWorkerHostCore.ts](../../../../../../../../src/evm/contractExecutor/worker/ContractExecutorWorkerHostCore.ts#L8).
...
| ------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [ContractExecutorWorkerHostCore.ts](../../../../../../../../src/evm/contractExecutor/worker/ContractExecutorWorkerHostCore.ts) | [`INV-RUNTIME-1-AKRHAK`](../../../../../../specification/runtime/execution.md#inv-runtime-1-akrhak), [`REQ-RUNTIME-2-KBXKTG`](../../../../../../specification/runtime/execution.md#req-runtime-2-kbxktg), [`REQ-RUNTIME-3-VQXW59`](../../../../../../specification/runtime/execution.md#req-runtime-3-vqxw59), [`REQ-RUNTIME-6-6F4SSM`](../../../../../../specification/runtime/execution.md#req-runtime-6-6f4ssm) |
