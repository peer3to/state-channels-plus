...
`getGasUsageTable` is the caller-facing read of the peer's chain spending; it delegates to the client chain signer, which reaches the host's recorder over the port and answers rows the host has already settled. It covers only what the SDK runtime sent: a transaction the consuming application signs with its own wallet, an `open` among them, never reaches this signer and is not in the table. See [P2pInstance.ts](../../../../../../src/evm/P2pInstance.ts#L94).
...
| ---------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [P2pInstance.ts](../../../../../../src/evm/P2pInstance.ts) | [`REQ-SDK-ARCH-2-QBZAT8`](../../../../specification/runtime/sdk.md#req-sdk-arch-2-qbzat8), [`REQ-LOG-1-H2VQ8X`](../../../../specification/runtime/log-collection.md#req-log-1-h2vq8x), [`REQ-SDK-ARCH-6-8DE4ER`](../../../../specification/runtime/sdk.md#req-sdk-arch-6-8de4er) |
...
| [`REQ-SDK-ARCH-6-8DE4ER`](../../../../specification/runtime/sdk.md#req-sdk-arch-6-8de4er)     | Partial               | **Here:** the public read in [getGasUsageTable](../../../../../../src/evm/P2pInstance.ts#L94). **Other files:** [ClientChainSigner.ts](signer/ClientChainSigner.ts.md) crosses the port, [HostNonceManager.ts](signer/HostNonceManager.ts.md) produces the records.                                                            | None demonstrated for this contribution.                                                                                                                                                                                                                                     |
