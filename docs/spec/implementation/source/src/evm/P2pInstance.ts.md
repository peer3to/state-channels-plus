...
`getGasUsageTable` is the caller-facing read of the peer's chain spending; it delegates to the client chain signer, which reaches the host's recorder over the port. See [P2pInstance.ts](../../../../../../src/evm/P2pInstance.ts#L93).
