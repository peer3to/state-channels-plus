...
The codec is shared by detached and request failures. It preserves nested revert bytes, error names, ethers metadata and peer stamps; the original extraction comment is retained. See [errorWire.ts](../../../../../../../src/evm/p2pRuntime/errorWire.ts#L23).
