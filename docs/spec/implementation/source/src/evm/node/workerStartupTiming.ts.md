# workerStartupTiming.ts — Source Report

> **Source:** [src/evm/node/workerStartupTiming.ts](../../../../../../../src/evm/node/workerStartupTiming.ts) > **Status:** Authored — engineer verification pending.
...
Node worker startup timing measurement (performance evidence for the worker-boundary decisions).
