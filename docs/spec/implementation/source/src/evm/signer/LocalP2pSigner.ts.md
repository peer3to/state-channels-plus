...
3. **`disconnectFromPeers` leaves discovery first, and is therefore async** ([#L260](../../../../../../../src/evm/signer/LocalP2pSigner.ts#L260)).
   ...
   ([#L261](../../../../../../../src/evm/signer/LocalP2pSigner.ts#L261), [#L262](../../../../../../../src/evm/signer/LocalP2pSigner.ts#L262)). Returning a promise is the observable
   ...
   `connectToChannel` ([#L153](../../../../../../../src/evm/signer/LocalP2pSigner.ts#L153)) re-observes its key and peers reconnect normally
...
| [`REQ-UPG-7-KQPXRE`](../../../../../specification/peer-communication/transport-upgrade.md#req-upg-7-kqpxre)         | Partial               | **Here:** `disconnectFromPeers` awaits the leave of every observed discovery key before `disconnectAll` ([#L387](../../../../../../../src/evm/signer/LocalP2pSigner.ts#L387)), and `connectToChannel` ([#L159](../../../../../../../src/evm/signer/LocalP2pSigner.ts#L159)) re-observes the channel key afterwards. **Other files:** [P2PManager](../../P2PManager.ts.md) owns the observed-key set; [EventHandler](../../eventHandlers/EventHandler.ts.md) applies the same ordering at channel close. | Neither the set nor the leave primitive is implemented here. |
