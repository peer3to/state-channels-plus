# ClientChainSigner.ts — Source Report

> **Source:** [src/evm/signer/ClientChainSigner.ts](../../../../../../../src/evm/signer/ClientChainSigner.ts) > **Status:** Authored — engineer verification pending.
...
| -------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [ClientChainSigner.ts](../../../../../../../src/evm/signer/ClientChainSigner.ts) | [`REQ-ID-3-KR0BE3`](../../../../../specification/protocol-model/identity.md#req-id-3-kr0be3), [`REQ-SDK-ARCH-5-AAM7YK`](../../../../../specification/runtime/sdk.md#req-sdk-arch-5-aam7yk), [`REQ-SDK-ARCH-5-NSJYQT`](../../../../../specification/runtime/sdk.md#req-sdk-arch-5-nsjyqt) |
...
| -------------------------------------------------------------------------------------------- | --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------- |
| [`REQ-SDK-ARCH-5-NSJYQT`](../../../../../specification/runtime/sdk.md#req-sdk-arch-5-nsjyqt) | Partial               | **Here:** the client read in [getGasUsageTable](../../../../../../../src/evm/signer/ClientChainSigner.ts#L79). **Other files:** [ChainSignerRpcMethods.ts](../../rpc/internal/services/chainSigner/ChainSignerRpcMethods.ts.md) serves it, [P2pInstance.ts](../P2pInstance.ts.md) exposes it to callers. | None demonstrated for this contribution. |
