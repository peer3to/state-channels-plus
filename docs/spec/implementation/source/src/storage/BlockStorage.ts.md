...
| [`REQ-BLKSTORE-1-KYHTWT`](../../../../specification/storage/blocks.md#req-blkstore-1-kyhtwt) | Covered               | **Here:** refuse-if-unequal, merge-if-equal ([#L310](../../../../../../src/storage/BlockStorage.ts#L310)). **Other files:** conflict _resolution_ is [ValidationService](../stateManager/ingest/ValidationService.ts.md) evidence rules.                                        | None.                                                                                                 |
