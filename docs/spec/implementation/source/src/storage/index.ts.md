...
> **Source:** [src/storage/index.ts](../../../../../../src/storage/index.ts) > **Status:** Authored — engineer verification pending.
...
Storage module re-export (`Storage` default).
