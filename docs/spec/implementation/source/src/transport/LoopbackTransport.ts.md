# LoopbackTransport.ts — Source Report

> **Source:** [src/transport/LoopbackTransport.ts](../../../../../../src/transport/LoopbackTransport.ts) > **Status:** Authored — engineer verification pending.
...
Self-delivery: the only `isTrusted` transport — local typed calls dispatch through the same
pipeline with guards bypassed.
