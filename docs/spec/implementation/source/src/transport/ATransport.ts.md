...
The base owns the Node data.toString() then onRpc delivery. Browser String(data), loopback no-op and WebRTC-specific behavior remain in their own implementations. See [ATransport.ts](../../../../../../src/transport/ATransport.ts#L45).
...
3. **`isTransport` checks the stable delivery surface.** Compatible transports are identified by `transportType`, `send`, and `sendRpcResponse`, not by one module graph's constructor ([#L92](../../../../../../src/transport/ATransport.ts#L92)).
4. **Close is first-call-wins.** The first close marks the transport closed, emits an unexpected-disconnection hook when applicable, removes the connection, and invokes concrete cleanup; later closes do nothing ([#L54](../../../../../../src/transport/ATransport.ts#L54)).
...
| <a id="unit-test-atransport-32-qf87jk"></a>`UNIT-TEST-ATRANSPORT-32-QF87JK` | Transport frame conversion                       | Invoke the real base onMessage with string, Buffer and a throwing conversion; a record-only onRpc capture observes payload/receiver and the same conversion error escapes.                                           | Each variation below states its observable result; preserve all unrelated stored state and lifecycle policy.                                                                                                  | <a id="unit-test-atransport-32-qf87jk.p1"></a>`UNIT-TEST-ATRANSPORT-32-QF87JK.P1` — converts string and Buffer frames and preserves conversion errors                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
