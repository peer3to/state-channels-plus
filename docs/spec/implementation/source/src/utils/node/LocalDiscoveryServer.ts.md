...
9. **A reconnect suspension does not touch the dial loop.** The dial gate skips a blacklisted peer
   ([#L1114](../../../../../../../src/utils/node/LocalDiscoveryServer.ts#L1121)) and nothing else
...
10. **The accepting side never dials a closed route back.** An earlier revision armed a delayed
    ...
    is not carried on the wire — [`ATransport.close`](../../../../../../../src/transport/ATransport.ts#L15)
    ...
    dial at all ([#L691](../../../../../../../src/utils/node/LocalDiscoveryServer.ts#L701) starts the
