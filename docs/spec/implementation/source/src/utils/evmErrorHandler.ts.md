...
3. **The unhandled-error log delegates its metadata to `LoggerUtils`.** When no handler matches
   ...
   ([#L131](../../../../../../src/utils/evmErrorHandler.ts#L131)) rather than a hand-built
