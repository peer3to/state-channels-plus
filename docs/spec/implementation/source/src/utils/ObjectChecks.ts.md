...
- Service recognition requires callable runRPC and createRPCMethods plus the non-null router owner. Prototype-aware checks support separate module graphs; they do not authorize endpoint names.
...
3. **Authorization is separate.** Attacker-controlled endpoint names are resolved by [ANetworkRpcService](../rpc/network/ANetworkRpcService.ts.md), not by these reusable shape predicates.
...
| <a id="unit-test-object-checks-3-3jxmp5"></a>`UNIT-TEST-OBJECT-CHECKS-3-3JXMP5` | RPC-service rejection branches   | Remove or corrupt each operation in an otherwise complete public service shape | Missing service operations and invalid service/manager value kinds reject          | <a id="unit-test-object-checks-3-3jxmp5.p1"></a>`UNIT-TEST-OBJECT-CHECKS-3-3JXMP5.P1` — missing/null/primitive/function service; <a id="unit-test-object-checks-3-3jxmp5.p2"></a>`UNIT-TEST-OBJECT-CHECKS-3-3JXMP5.P2` — non-callable `createRPCMethods`; <a id="unit-test-object-checks-3-3jxmp5.p3"></a>`UNIT-TEST-OBJECT-CHECKS-3-3JXMP5.P3` — missing/null/primitive/function `router`; <a id="unit-test-object-checks-3-3jxmp5.p4"></a>`UNIT-TEST-OBJECT-CHECKS-3-3JXMP5.P4` — missing/non-callable `runRPC`<br><a id="unit-test-object-checks-3-3jxmp5.p5"></a>`UNIT-TEST-OBJECT-CHECKS-3-3JXMP5.P5`: An actual runtime service passes structural service recognition through callable construction/dispatch and its router, without a peer manager dependency.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
- [ANetworkRpcService](../rpc/network/ANetworkRpcService.ts.md).
