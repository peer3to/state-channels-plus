...
| --- | --- | --- |
| [EventSyncService.ts](eventSync/EventSyncService.ts.md) | One authoritative read owner fetches a chain head and batches the threshold and slash sets at that head. | [`REQ-GOSSIP-4-J5Z4DF`](../../../../specification/peer-communication/block-gossip.md#req-gossip-4-j5z4df) |
| [StateManager.ts](StateManager.ts.md) | Channel reset, fork transition and stop coordinate eligibility and candidate lifetimes. | [`REQ-GOSSIP-4-J5Z4DF`](../../../../specification/peer-communication/block-gossip.md#req-gossip-4-j5z4df) |
