...
2. **A disputed-fork refusal resolves the wait `false`.** `RaceConditionSnapshotUpdateDisputedFork`, raised by a same-fork advance on a disputed fork, is logged once as a warning and resolves the submission `false` instead of rejecting ([#L167](../../../../../../../src/stateManager/snapshotUpdate/SnapshotUpdateService.ts#L167)). `RaceConditionSnapshotUpdateNotLatestFork`, raised when a later reduction became the latest fork between preparation and send, is a handled race logged as a warning ([#L161](../../../../../../../src/stateManager/snapshotUpdate/SnapshotUpdateService.ts#L161)); the next post adopts the latest fork. `postStateSnapshotWait` returns that value; it resolves `true` when the post landed, lost a handled race, or had nothing to post, and every other failure still rejects. The leave exit falls back to its self-removal dispute on `false` ([`REQ-ENFSNAP-4-ESP98F` (Disputed-fork advance rule)](../../../../../specification/enforcement/snapshot-adoption.md#req-enfsnap-4-esp98f)). The refusal is not retried: preparation already skips posting onto a disputed fork, so it only meets a post that raced a new dispute, and the next post targets the reduced fork.
...
| --------------------------------------------------------------------------------------------------- | --------------------------- | -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="unit-test-snapshot-update-service-1-a4b38n"></a>`UNIT-TEST-SNAPSHOT-UPDATE-SERVICE-1-A4B38N` | Walk, gates, and submission | Advance across zero/one/multiple generations, unresolved disputes, and consumed/unconsumed inbound heads | Correct link chains and ranges; inadmissible preparation produces no transaction; admissible submission lands | <a id="unit-test-snapshot-update-service-1-a4b38n.p1"></a>`UNIT-TEST-SNAPSHOT-UPDATE-SERVICE-1-A4B38N.P1` — multi-generation walk; <a id="unit-test-snapshot-update-service-1-a4b38n.p2"></a>`UNIT-TEST-SNAPSHOT-UPDATE-SERVICE-1-A4B38N.P2` — range boundary at processed tip; <a id="unit-test-snapshot-update-service-1-a4b38n.p3"></a>`UNIT-TEST-SNAPSHOT-UPDATE-SERVICE-1-A4B38N.P3` — same-fork chain; <a id="unit-test-snapshot-update-service-1-a4b38n.p4"></a>`UNIT-TEST-SNAPSHOT-UPDATE-SERVICE-1-A4B38N.P4` — already-current no-op; <a id="unit-test-snapshot-update-service-1-a4b38n.p5"></a>`UNIT-TEST-SNAPSHOT-UPDATE-SERVICE-1-A4B38N.P5` — admissible prepared snapshot is submitted; <a id="unit-test-snapshot-update-service-1-a4b38n.p6"></a>`UNIT-TEST-SNAPSHOT-UPDATE-SERVICE-1-A4B38N.P6` — unresolved current dispute blocks fork calldata and submission; <a id="unit-test-snapshot-update-service-1-a4b38n.p7"></a>`UNIT-TEST-SNAPSHOT-UPDATE-SERVICE-1-A4B38N.P7` — unconsumed inbound head blocks same-fork calldata preparation; <a id="unit-test-snapshot-update-service-1-a4b38n.p8"></a>`UNIT-TEST-SNAPSHOT-UPDATE-SERVICE-1-A4B38N.P8` — high-level posting stands down without changing the on-chain snapshot while inbound remains unconsumed; <a id="unit-test-snapshot-update-service-1-a4b38n.p9"></a>`UNIT-TEST-SNAPSHOT-UPDATE-SERVICE-1-A4B38N.P9` — a dispute committed between preparation and send makes the chain refuse the post on the disputed fork and `postStateSnapshotWait` resolve `false` |
