...
`postStateSnapshotWait` is an explicit internal awaitable boundary used by the channel leave so transaction failure can fall back to dispute. This contributes to [`REQ-LIF-10-QR8NQ9` (Runtime departure and channel reuse)](../../../../../specification/settlement/lifecycle.md#req-lif-10-qr8nq9).
