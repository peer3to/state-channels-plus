...
7. **Losing the race to re-seed an emptied window is not a reduction failure.** The empty-window escalation ([#L197](../../../../../../../src/stateManager/reduction/ReductionExecutor.ts#L197)) is attempted by every reducer of that window, so all but one are refused as past the evidence deadline. It goes through [`DisputeManager.disputeToleratingLostRace`](../../disputeManager/DisputeManager.ts.md) ([#L204](../../../../../../../src/stateManager/reduction/ReductionExecutor.ts#L204)), which absorbs that refusal; the attempt returns and the winner's `DisputeCommitted` event re-drives the reduction. A bare `dispute` call let the refusal reach [`ReductionManager.failCompletion`](./ReductionManager.ts.md) ([ReductionManager.ts#L382](../../../../../../../src/stateManager/reduction/ReductionManager.ts#L382)), which rejects the shared completion and calls `StateManager.abort()` — an honest reducer tore its runtime down over the expected outcome of a race ([`REQ-DISPUTE-PIPE-6-6FZB9M` (Minimal intervention and convergence)](../../../../../specification/disputes/dispute-processing.md#req-dispute-pipe-6-6fzb9m)).
...
| -------------------------------------------------------------------------------------------------------------------- | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| [`REQ-DISPUTE-PIPE-6-6FZB9M`](../../../../../specification/disputes/dispute-processing.md#req-dispute-pipe-6-6fzb9m) | Covered               | **Here:** race classification + install-then-submit; the empty-window escalation tolerates the lost re-seed race ([#L204](../../../../../../../src/stateManager/reduction/ReductionExecutor.ts#L204)) instead of failing the attempt. **Other files:** [DisputeManager](../../disputeManager/DisputeManager.ts.md) owns `disputeToleratingLostRace` and the refusal it absorbs. | None.            |
