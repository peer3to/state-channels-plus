...
After the node adds its own signature, the committed block keeps one confirmation signature per signer ([retainOneSignaturePerSigner](../../../../../../../src/stateManager/block/BlockCommitService.ts#L83)) before it is stored and relayed. Storage deep-copies its arguments, so this is what bounds the post-commit relay ([`REQ-BLKSTORE-4-RQTR2Y` (One confirmation signature per signer)](../../../../../specification/storage/blocks.md#req-blkstore-4-rqtr2y)).
...
After canonical block storage, a live or spectate commit publishes the normalized previous/resulting union. Dispute replay and a cancelled commit do not replace current membership knowledge. A committed callback marks the point after which later side-effect failure must not roll the VM behind stored state. Spectators persist and notify without signing or relaying; insertion promotes a listed signer before the normal signing/gossip path. Fresh gossip requires PARTICIPATING. See [publishOffChainEligibility](../../../../../../../src/stateManager/block/BlockCommitService.ts#L93).
...
| [`REQ-GOSSIP-4-J5Z4DF`](../../../../../specification/peer-communication/block-gossip.md#req-gossip-4-j5z4df)         | Covered               | **Here:** [publishOffChainEligibility](../../../../../../../src/stateManager/block/BlockCommitService.ts#L93) implements the contribution described above. **Other files:** [Storage.ts](../../storage/Storage.ts.md), [MembershipService.ts](../membership/MembershipService.ts.md)                                                                                                                                                                                                                                                                                                                                                                                           | Limited to this file's contribution; cache freshness and aggregate queue limits remain as specified. |
