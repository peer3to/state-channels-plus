...
| [`REQ-DSTORE-1-5AQYJX`](../../../../specification/storage/dispute-evidence.md#req-dstore-1-5aqyjx)                | Covered               | **Here:** the final-dispute path ([#L430](../../../../../../src/eventHandlers/EventHandler.ts#L430)) and `persistDisputeAndNotify` ([#L675](../../../../../../src/eventHandlers/EventHandler.ts#L675)) store each committed-dispute copy tagged `CHAIN_EVENT`; the tag states the copy's origin. **Other files:** [DisputeStorage](../storage/DisputeStorage.ts.md) applies first-copy retention and chain-event precedence.                                             | None.                                                                                                |
