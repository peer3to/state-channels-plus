...
- Committed-dispute copies stored as chain-event copies; retention is DisputeStorage's ([`REQ-DSTORE-1-5AQYJX` (Dispute confirmation retention)](../../../../specification/storage/dispute-evidence.md#req-dstore-1-5aqyjx)).
...
| [`REQ-GOSSIP-4-J5Z4DF`](../../../../specification/peer-communication/block-gossip.md#req-gossip-4-j5z4df)         | Covered               | **Here:** [observeOnChainSlash](../../../../../../src/eventHandlers/EventHandler.ts#L741) implements the contribution described above. **Other files:** [MembershipService.ts](../stateManager/membership/MembershipService.ts.md), [StateApplicationService.ts](../stateManager/snapshotUpdate/StateApplicationService.ts.md), [BlockQueueManager.ts](../stateManager/ingest/BlockQueueManager.ts.md)                                                                   | Limited to this file's contribution; cache freshness and aggregate queue limits remain as specified. |
| [`REQ-DSTORE-1-5AQYJX`](../../../../specification/storage/dispute-evidence.md#req-dstore-1-5aqyjx)                | Covered               | **Here:** the final-dispute path ([#L416](../../../../../../src/eventHandlers/EventHandler.ts#L416)) and `persistDisputeAndNotify` ([#L661](../../../../../../src/eventHandlers/EventHandler.ts#L661)) store each committed-dispute copy tagged `CHAIN_EVENT`; the tag states the copy's origin. **Other files:** [DisputeStorage](../storage/DisputeStorage.ts.md) applies first-copy retention and chain-event precedence.                                             | None.                                                                                                |
