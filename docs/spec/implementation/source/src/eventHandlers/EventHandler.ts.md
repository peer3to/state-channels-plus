...
5. **Channel close leaves discovery before it disconnects.** `handleChannelClose`
   ([#L245](../../../../../../src/eventHandlers/EventHandler.ts#L245)) calls `leaveAllDiscoveryKeys` ([#L253](../../../../../../src/eventHandlers/EventHandler.ts#L253)) and only then
   `disconnectAll` ([#L254](../../../../../../src/eventHandlers/EventHandler.ts#L254)). The order is the whole point: peers that still share the
   channel's discovery key are re-dialed, so closing first makes the disconnect a pause that discovery
   silently undoes. Leaving every observed key — not just the closing channel's — is what a caller
   that is ending participation actually means, and it excludes and penalizes nobody
   ([`REQ-UPG-7-KQPXRE`](../../../../specification/peer-communication/transport-upgrade.md#req-upg-7-kqpxre)).
6. **One ethers-backed intake, typed internal fan-out.** `StateChannelEventListener` and
...
- Channel-close teardown leaves discovery before closing transports, so the disconnect is observable
  rather than immediately undone by a redial.
...
| [`REQ-UPG-7-KQPXRE`](../../../../specification/peer-communication/transport-upgrade.md#req-upg-7-kqpxre)          | Partial               | **Here:** channel close stops observing every discovery key before closing the channel's transports ([#L253](../../../../../../src/eventHandlers/EventHandler.ts#L253), [#L254](../../../../../../src/eventHandlers/EventHandler.ts#L254)), and records no exclusion or penalty. **Other files:** [P2PManager](../P2PManager.ts.md) owns the observed-key set and the leave-all primitive; [LocalP2pSigner](../evm/signer/LocalP2pSigner.ts.md) applies the same ordering to the public disconnect operation. | Re-observing on a later channel connect is not this file's path. |
...
| ------------------------------------------------------------------------------- | -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="unit-test-event-handler-1-rz2c7w"></a>`UNIT-TEST-EVENT-HANDLER-1-RZ2C7W` | Chain-event branches | Deliver committed/killed/slashed/reduced events across final/expired/auditable, relevant/irrelevant, duplicate, and race cases, plus a 0-participant state-snapshot update for the selected channel | Branches per the pipeline algorithm; replication precedes action; improvement rule uploads only outcome-changers; challenges fire on mismatched reductions; the close leaves every observed discovery key before any transport closes and excludes nobody | <a id="unit-test-event-handler-1-rz2c7w.p1"></a>`UNIT-TEST-EVENT-HANDLER-1-RZ2C7W.P1` — final branch; <a id="unit-test-event-handler-1-rz2c7w.p2"></a>`UNIT-TEST-EVENT-HANDLER-1-RZ2C7W.P2` — dedup; <a id="unit-test-event-handler-1-rz2c7w.p3"></a>`UNIT-TEST-EVENT-HANDLER-1-RZ2C7W.P3` — relevance gate; <a id="unit-test-event-handler-1-rz2c7w.p4"></a>`UNIT-TEST-EVENT-HANDLER-1-RZ2C7W.P4` — improvement uploads; <a id="unit-test-event-handler-1-rz2c7w.p5"></a>`UNIT-TEST-EVENT-HANDLER-1-RZ2C7W.P5` — kill→replacement first-wins; <a id="unit-test-event-handler-1-rz2c7w.p6"></a>`UNIT-TEST-EVENT-HANDLER-1-RZ2C7W.P6` — adopt matching reduction; <a id="unit-test-event-handler-1-rz2c7w.p7"></a>`UNIT-TEST-EVENT-HANDLER-1-RZ2C7W.P7` — expired branch; <a id="unit-test-event-handler-1-rz2c7w.p8"></a>`UNIT-TEST-EVENT-HANDLER-1-RZ2C7W.P8` — auditable branch; <a id="unit-test-event-handler-1-rz2c7w.p9"></a>`UNIT-TEST-EVENT-HANDLER-1-RZ2C7W.P9` — non-improvement skips upload; <a id="unit-test-event-handler-1-rz2c7w.p10"></a>`UNIT-TEST-EVENT-HANDLER-1-RZ2C7W.P10` — challenge mismatched reduction; <a id="unit-test-event-handler-1-rz2c7w.p11"></a>`UNIT-TEST-EVENT-HANDLER-1-RZ2C7W.P11` — improvement upload skipped as already initiated: reduction still scheduled; <a id="unit-test-event-handler-1-rz2c7w.p12"></a>`UNIT-TEST-EVENT-HANDLER-1-RZ2C7W.P12` — a channel-close event for the selected channel leaves every observed discovery key before any transport is closed and marks no peer excluded |
