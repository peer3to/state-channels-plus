...
| [`REQ-GOSSIP-4-J5Z4DF`](../../../../specification/peer-communication/block-gossip.md#req-gossip-4-j5z4df)         | Covered               | **Here:** [observeOnChainSlash](../../../../../../src/eventHandlers/EventHandler.ts#L729) implements the contribution described above. **Other files:** [MembershipService.ts](../stateManager/membership/MembershipService.ts.md), [StateApplicationService.ts](../stateManager/snapshotUpdate/StateApplicationService.ts.md), [BlockQueueManager.ts](../stateManager/ingest/BlockQueueManager.ts.md)                                                                   | Limited to this file's contribution; cache freshness and aggregate queue limits remain as specified. |
