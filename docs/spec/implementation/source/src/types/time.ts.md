# time.ts — Source Report

> **Source:** [src/types/time.ts](../../../../../../src/types/time.ts) > **Status:** Authored — engineer verification pending.
...
Timing-configuration type (p2p/agreement/chainFallback/evidence windows).
