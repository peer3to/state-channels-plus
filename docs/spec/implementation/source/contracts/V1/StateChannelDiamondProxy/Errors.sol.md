...
The two membership-freeze refusals carry their comparison: `RaceConditionSnapshotDuringKillPeriod(killPeriodEnd, currentTimestamp)` ([#L123](../../../../../../../contracts/V1/StateChannelDiamondProxy/Errors.sol#L123)) and `RaceConditionDisputeAnchorBehindSnapshot(consumedInboundHeight, disputeInboundHeight)` ([#L130](../../../../../../../contracts/V1/StateChannelDiamondProxy/Errors.sol#L130)), under decision 2 below.
