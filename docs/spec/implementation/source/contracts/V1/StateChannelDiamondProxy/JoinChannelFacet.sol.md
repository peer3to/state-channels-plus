...
2. **The undisputed-fork gate is an internal call, not an external self-call.** Both join and top-up
   ...
   ([#L59](../../../../../../../contracts/V1/StateChannelDiamondProxy/JoinChannelFacet.sol#L59)) before the membership split and revert
...
3. **The composable deposit self-call is typed by the interface.** `depositAssetsComposable` is
   ...
   ([#L85](../../../../../../../contracts/V1/StateChannelDiamondProxy/JoinChannelFacet.sol#L85)).
