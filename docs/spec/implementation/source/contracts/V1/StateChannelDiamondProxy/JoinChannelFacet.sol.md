...
2. **The undisputed-fork gate is an internal call, not an external self-call.** The join branch
   evaluates [`_isForkDisputed`](../../../../../../../contracts/V1/StateChannelDiamondProxy/StateChannelCommon.sol#L224)
   on [StateChannelCommon](./StateChannelCommon.sol.md)
   ([#L73](../../../../../../../contracts/V1/StateChannelDiamondProxy/JoinChannelFacet.sol#L73)); it
...
3. **The composable deposit self-call is typed by the interface.** `depositAssetsComposable` is
   ...
   ([#L101](../../../../../../../contracts/V1/StateChannelDiamondProxy/JoinChannelFacet.sol#L101)).
...
5. **A sub-threshold confirmation is rejected with both address sets, from a revert branch.**
   [#L94](../../../../../../../contracts/V1/StateChannelDiamondProxy/JoinChannelFacet.sol#L94)
