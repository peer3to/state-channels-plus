...
[`validateTimeLogic`](../../../../../../src/stateManager/ingest/ValidationService.ts#L221); the
...
| [`INV-BCP-3-GTHAHV`](block-confirmation-pipeline.md#inv-bcp-3-gthahv) | In-order execution; future blocks parked.                                                                                                                                                                                                                                                                      | Covered               | [src/stateManager/ingest/BlockQueueManager.ts](../../../../../../src/stateManager/ingest/BlockQueueManager.ts#L48) (`tryDequeuePriority`), [src/stateManager/ingest/ValidationService.ts](../../../../../../src/stateManager/ingest/ValidationService.ts#L16) gate #6                 | None.            |
...
| [`INV-BCP-7-ZDZ5WB`](block-confirmation-pipeline.md#inv-bcp-7-zdz5wb) | Subjective lateness never produces a proof or slash.                                                                                                                                                                                                                                                           | Covered               | [src/stateManager/ingest/ValidationService.ts](../../../../../../src/stateManager/ingest/ValidationService.ts#L16) (`NOT_ENOUGH_TIME` path)                                                                                                                                           | None.            |
...
| [`REQ-BCP-2-1K3HN9`](block-confirmation-pipeline.md#req-bcp-2-1k3hn9) | Objective timestamp rule is evaluated by the canonical Solidity predicate over the exact proof struct.                                                                                                                                                                                                         | Covered               | [src/stateManager/ingest/ValidationService.ts](../../../../../../src/stateManager/ingest/ValidationService.ts#L16) (`hasInvalidTimestamp.staticCall`)                                                                                                                                 | None.            |
