...
([../../protocol/cross-layer-messages.md](../../../../../specification/settlement/cross-layer-messages.md) §4, [`REQ-MSG-10-7JS45Q`](../../../../../specification/settlement/cross-layer-messages.md#req-msg-10-7js45q)).
...
live in [`StateManager`](../../../../../../../src/stateManager/StateManager.ts#L97) and the contracts, not
here.
...
([`StateManager`](../../../../../../../src/stateManager/StateManager.ts#L97), lines ~512-528; SDK TODO:
...
| ID                                              | Invariant                                                                                                                                                                                                           |
| ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="inv-jcs-1-srjkvk"></a>`INV-JCS-1-SRJKVK` | A responder signs a join only if the ECDSA signer, the declared `participant`, and the authenticated transport peer are the same address (`signJoinRequest` stage 3).                                               |
| <a id="inv-jcs-2-95qm5s"></a>`INV-JCS-2-95QM5S` | A responder signs only a join pinned to its own current on-chain snapshot and fork (`expectedForkId`/`expectedSnapshotHash` equality, stages 6–7) and only when the local signer is in the threshold set (stage 8). |
| <a id="inv-jcs-3-xj8kgx"></a>`INV-JCS-3-XJ8KGX` | The collector accepts a returned signature only if it recovers to the addressed threshold participant; one mismatched or missing signature fails the entire collection (unanimity).                                 |
| <a id="inv-jcs-4-1fj7ch"></a>`INV-JCS-4-1FJ7CH` | The collector only ever collects for the local node's own participant identity (stage 1).                                                                                                                           |
| <a id="inv-jcs-5-16v4vg"></a>`INV-JCS-5-16V4VG` | `joinChannelService` holds no state between calls; every decision is derived from arguments plus live chain/state-manager reads at call time.                                                                       |
...
| ----------------------------------------------------- | ------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="inv-jcs-1-srjkvk.t1"></a>`INV-JCS-1-SRJKVK.T1` | [`INV-JCS-1-SRJKVK`](join-channel.md#inv-jcs-1-srjkvk) | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Responder signs only when signer == participant == authenticated peer.                                                                                                                                                                       | <a id="inv-jcs-1-srjkvk.t1.p1"></a>`INV-JCS-1-SRJKVK.T1.P1` — valid case<br><a id="inv-jcs-1-srjkvk.t1.p2"></a>`INV-JCS-1-SRJKVK.T1.P2` — correct identity/signature<br><a id="inv-jcs-1-srjkvk.t1.p3"></a>`INV-JCS-1-SRJKVK.T1.P3` — direct invalid/opposite<br><a id="inv-jcs-1-srjkvk.t1.p4"></a>`INV-JCS-1-SRJKVK.T1.P4` — wrong identity/signature<br><a id="inv-jcs-1-srjkvk.t1.p5"></a>`INV-JCS-1-SRJKVK.T1.P5` — missing identity/signature<br><a id="inv-jcs-1-srjkvk.t1.p6"></a>`INV-JCS-1-SRJKVK.T1.P6` — duplicate identity/signature<br><a id="inv-jcs-1-srjkvk.t1.p7"></a>`INV-JCS-1-SRJKVK.T1.P7` — forged identity/signature<br><a id="inv-jcs-1-srjkvk.t1.p8"></a>`INV-JCS-1-SRJKVK.T1.P8` — membership boundary                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| <a id="inv-jcs-2-95qm5s.t1"></a>`INV-JCS-2-95QM5S.T1` | [`INV-JCS-2-95QM5S`](join-channel.md#inv-jcs-2-95qm5s) | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Responder signs only a join pinned to its current snapshot/fork with local signer in threshold.                                                                                                                                              | <a id="inv-jcs-2-95qm5s.t1.p1"></a>`INV-JCS-2-95QM5S.T1.P1` — valid case<br><a id="inv-jcs-2-95qm5s.t1.p2"></a>`INV-JCS-2-95QM5S.T1.P2` — matching commitment<br><a id="inv-jcs-2-95qm5s.t1.p3"></a>`INV-JCS-2-95QM5S.T1.P3` — correct identity/signature<br><a id="inv-jcs-2-95qm5s.t1.p4"></a>`INV-JCS-2-95QM5S.T1.P4` — new participant<br><a id="inv-jcs-2-95qm5s.t1.p5"></a>`INV-JCS-2-95QM5S.T1.P5` — direct invalid/opposite<br><a id="inv-jcs-2-95qm5s.t1.p6"></a>`INV-JCS-2-95QM5S.T1.P6` — mismatched commitment<br><a id="inv-jcs-2-95qm5s.t1.p7"></a>`INV-JCS-2-95QM5S.T1.P7` — predecessor case<br><a id="inv-jcs-2-95qm5s.t1.p8"></a>`INV-JCS-2-95QM5S.T1.P8` — genesis case<br><a id="inv-jcs-2-95qm5s.t1.p9"></a>`INV-JCS-2-95QM5S.T1.P9` — stale fork<br><a id="inv-jcs-2-95qm5s.t1.p10"></a>`INV-JCS-2-95QM5S.T1.P10` — foreign fork<br><a id="inv-jcs-2-95qm5s.t1.p11"></a>`INV-JCS-2-95QM5S.T1.P11` — wrong identity/signature<br><a id="inv-jcs-2-95qm5s.t1.p12"></a>`INV-JCS-2-95QM5S.T1.P12` — missing identity/signature<br><a id="inv-jcs-2-95qm5s.t1.p13"></a>`INV-JCS-2-95QM5S.T1.P13` — duplicate identity/signature<br><a id="inv-jcs-2-95qm5s.t1.p14"></a>`INV-JCS-2-95QM5S.T1.P14` — forged identity/signature<br><a id="inv-jcs-2-95qm5s.t1.p15"></a>`INV-JCS-2-95QM5S.T1.P15` — membership boundary<br><a id="inv-jcs-2-95qm5s.t1.p16"></a>`INV-JCS-2-95QM5S.T1.P16` — existing participant<br><a id="inv-jcs-2-95qm5s.t1.p17"></a>`INV-JCS-2-95QM5S.T1.P17` — removed participant<br><a id="inv-jcs-2-95qm5s.t1.p18"></a>`INV-JCS-2-95QM5S.T1.P18` — slashed participant<br><a id="inv-jcs-2-95qm5s.t1.p19"></a>`INV-JCS-2-95QM5S.T1.P19` — concurrent membership change                                                                                                                                                                                                                                                                                                                                            |
| <a id="inv-jcs-3-xj8kgx.t1"></a>`INV-JCS-3-XJ8KGX.T1` | [`INV-JCS-3-XJ8KGX`](join-channel.md#inv-jcs-3-xj8kgx) | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Collector requires each signature to recover to its addressed participant; one failure fails unanimity.                                                                                                                                      | <a id="inv-jcs-3-xj8kgx.t1.p1"></a>`INV-JCS-3-XJ8KGX.T1.P1` — valid case<br><a id="inv-jcs-3-xj8kgx.t1.p2"></a>`INV-JCS-3-XJ8KGX.T1.P2` — correct identity/signature<br><a id="inv-jcs-3-xj8kgx.t1.p3"></a>`INV-JCS-3-XJ8KGX.T1.P3` — malformed input<br><a id="inv-jcs-3-xj8kgx.t1.p4"></a>`INV-JCS-3-XJ8KGX.T1.P4` — direct invalid/opposite<br><a id="inv-jcs-3-xj8kgx.t1.p5"></a>`INV-JCS-3-XJ8KGX.T1.P5` — wrong identity/signature<br><a id="inv-jcs-3-xj8kgx.t1.p6"></a>`INV-JCS-3-XJ8KGX.T1.P6` — missing identity/signature<br><a id="inv-jcs-3-xj8kgx.t1.p7"></a>`INV-JCS-3-XJ8KGX.T1.P7` — duplicate identity/signature<br><a id="inv-jcs-3-xj8kgx.t1.p8"></a>`INV-JCS-3-XJ8KGX.T1.P8` — forged identity/signature<br><a id="inv-jcs-3-xj8kgx.t1.p9"></a>`INV-JCS-3-XJ8KGX.T1.P9` — membership boundary<br><a id="inv-jcs-3-xj8kgx.t1.p10"></a>`INV-JCS-3-XJ8KGX.T1.P10` — adversarial input<br><a id="inv-jcs-3-xj8kgx.t1.p11"></a>`INV-JCS-3-XJ8KGX.T1.P11` — partial failure<br><a id="inv-jcs-3-xj8kgx.t1.p12"></a>`INV-JCS-3-XJ8KGX.T1.P12` — retry and recovery                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| <a id="inv-jcs-4-1fj7ch.t1"></a>`INV-JCS-4-1FJ7CH.T1` | [`INV-JCS-4-1FJ7CH`](join-channel.md#inv-jcs-4-1fj7ch) | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Collector runs only for the local node's own participant identity.                                                                                                                                                                           | <a id="inv-jcs-4-1fj7ch.t1.p1"></a>`INV-JCS-4-1FJ7CH.T1.P1` — valid case<br><a id="inv-jcs-4-1fj7ch.t1.p2"></a>`INV-JCS-4-1FJ7CH.T1.P2` — correct identity/signature<br><a id="inv-jcs-4-1fj7ch.t1.p3"></a>`INV-JCS-4-1FJ7CH.T1.P3` — direct invalid/opposite<br><a id="inv-jcs-4-1fj7ch.t1.p4"></a>`INV-JCS-4-1FJ7CH.T1.P4` — wrong identity/signature<br><a id="inv-jcs-4-1fj7ch.t1.p5"></a>`INV-JCS-4-1FJ7CH.T1.P5` — missing identity/signature<br><a id="inv-jcs-4-1fj7ch.t1.p6"></a>`INV-JCS-4-1FJ7CH.T1.P6` — duplicate identity/signature<br><a id="inv-jcs-4-1fj7ch.t1.p7"></a>`INV-JCS-4-1FJ7CH.T1.P7` — forged identity/signature<br><a id="inv-jcs-4-1fj7ch.t1.p8"></a>`INV-JCS-4-1FJ7CH.T1.P8` — membership boundary                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| <a id="inv-jcs-5-16v4vg.t1"></a>`INV-JCS-5-16V4VG.T1` | [`INV-JCS-5-16V4VG`](join-channel.md#inv-jcs-5-16v4vg) | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Service is stateless across calls; decisions from args + live reads.                                                                                                                                                                         | <a id="inv-jcs-5-16v4vg.t1.p1"></a>`INV-JCS-5-16V4VG.T1.P1` — valid case<br><a id="inv-jcs-5-16v4vg.t1.p2"></a>`INV-JCS-5-16V4VG.T1.P2` — zero/empty/no-op where meaningful<br><a id="inv-jcs-5-16v4vg.t1.p3"></a>`INV-JCS-5-16V4VG.T1.P3` — direct invalid/opposite<br><a id="inv-jcs-5-16v4vg.t1.p4"></a>`INV-JCS-5-16V4VG.T1.P4` — exact boundary<br><a id="inv-jcs-5-16v4vg.t1.p5"></a>`INV-JCS-5-16V4VG.T1.P5` — failure/recovery<br><a id="inv-jcs-5-16v4vg.t1.p6"></a>`INV-JCS-5-16V4VG.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| <a id="req-jcs-1-ddrpa8.t1"></a>`REQ-JCS-1-DDRPA8.T1` | <a id="req-jcs-1-ddrpa8"></a>`REQ-JCS-1-DDRPA8`        | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | `requestJoinSignature` MUST run the full decode + identity + channel + deadline + fork + snapshot + threshold chain before signing ([`REQ-RPC-2-SZDTTM`](../../../../../specification/peer-communication/rpc.md#req-rpc-2-szdttm) instance). | <a id="req-jcs-1-ddrpa8.t1.p1"></a>`REQ-JCS-1-DDRPA8.T1.P1` — valid case<br><a id="req-jcs-1-ddrpa8.t1.p2"></a>`REQ-JCS-1-DDRPA8.T1.P2` — matching commitment<br><a id="req-jcs-1-ddrpa8.t1.p3"></a>`REQ-JCS-1-DDRPA8.T1.P3` — correct identity/signature<br><a id="req-jcs-1-ddrpa8.t1.p4"></a>`REQ-JCS-1-DDRPA8.T1.P4` — before deadline<br><a id="req-jcs-1-ddrpa8.t1.p5"></a>`REQ-JCS-1-DDRPA8.T1.P5` — new participant<br><a id="req-jcs-1-ddrpa8.t1.p6"></a>`REQ-JCS-1-DDRPA8.T1.P6` — direct invalid/opposite<br><a id="req-jcs-1-ddrpa8.t1.p7"></a>`REQ-JCS-1-DDRPA8.T1.P7` — mismatched commitment<br><a id="req-jcs-1-ddrpa8.t1.p8"></a>`REQ-JCS-1-DDRPA8.T1.P8` — predecessor case<br><a id="req-jcs-1-ddrpa8.t1.p9"></a>`REQ-JCS-1-DDRPA8.T1.P9` — genesis case<br><a id="req-jcs-1-ddrpa8.t1.p10"></a>`REQ-JCS-1-DDRPA8.T1.P10` — stale fork<br><a id="req-jcs-1-ddrpa8.t1.p11"></a>`REQ-JCS-1-DDRPA8.T1.P11` — foreign fork<br><a id="req-jcs-1-ddrpa8.t1.p12"></a>`REQ-JCS-1-DDRPA8.T1.P12` — wrong identity/signature<br><a id="req-jcs-1-ddrpa8.t1.p13"></a>`REQ-JCS-1-DDRPA8.T1.P13` — missing identity/signature<br><a id="req-jcs-1-ddrpa8.t1.p14"></a>`REQ-JCS-1-DDRPA8.T1.P14` — duplicate identity/signature<br><a id="req-jcs-1-ddrpa8.t1.p15"></a>`REQ-JCS-1-DDRPA8.T1.P15` — forged identity/signature<br><a id="req-jcs-1-ddrpa8.t1.p16"></a>`REQ-JCS-1-DDRPA8.T1.P16` — membership boundary<br><a id="req-jcs-1-ddrpa8.t1.p17"></a>`REQ-JCS-1-DDRPA8.T1.P17` — at deadline<br><a id="req-jcs-1-ddrpa8.t1.p18"></a>`REQ-JCS-1-DDRPA8.T1.P18` — after deadline<br><a id="req-jcs-1-ddrpa8.t1.p19"></a>`REQ-JCS-1-DDRPA8.T1.P19` — maximum honest skew<br><a id="req-jcs-1-ddrpa8.t1.p20"></a>`REQ-JCS-1-DDRPA8.T1.P20` — existing participant<br><a id="req-jcs-1-ddrpa8.t1.p21"></a>`REQ-JCS-1-DDRPA8.T1.P21` — removed participant<br><a id="req-jcs-1-ddrpa8.t1.p22"></a>`REQ-JCS-1-DDRPA8.T1.P22` — slashed participant<br><a id="req-jcs-1-ddrpa8.t1.p23"></a>`REQ-JCS-1-DDRPA8.T1.P23` — concurrent membership change |
| <a id="req-jcs-2-wmqgwc.t1"></a>`REQ-JCS-2-WMQGWC.T1` | <a id="req-jcs-2-wmqgwc"></a>`REQ-JCS-2-WMQGWC`        | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Admission MUST be gated by an explicit consent/authorization decision, not auto-sign.                                                                                                                                                        | <a id="req-jcs-2-wmqgwc.t1.p1"></a>`REQ-JCS-2-WMQGWC.T1.P1` — valid case<br><a id="req-jcs-2-wmqgwc.t1.p2"></a>`REQ-JCS-2-WMQGWC.T1.P2` — correct identity/signature<br><a id="req-jcs-2-wmqgwc.t1.p3"></a>`REQ-JCS-2-WMQGWC.T1.P3` — direct invalid/opposite<br><a id="req-jcs-2-wmqgwc.t1.p4"></a>`REQ-JCS-2-WMQGWC.T1.P4` — wrong identity/signature<br><a id="req-jcs-2-wmqgwc.t1.p5"></a>`REQ-JCS-2-WMQGWC.T1.P5` — missing identity/signature<br><a id="req-jcs-2-wmqgwc.t1.p6"></a>`REQ-JCS-2-WMQGWC.T1.P6` — duplicate identity/signature<br><a id="req-jcs-2-wmqgwc.t1.p7"></a>`REQ-JCS-2-WMQGWC.T1.P7` — forged identity/signature<br><a id="req-jcs-2-wmqgwc.t1.p8"></a>`REQ-JCS-2-WMQGWC.T1.P8` — membership boundary                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| <a id="req-jcs-3-c371c5.t1"></a>`REQ-JCS-3-C371C5.T1` | <a id="req-jcs-3-c371c5"></a>`REQ-JCS-3-C371C5`        | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | `requestJoinSignature` failure outcomes MUST conform to a decided failure-outcome policy and be resource-bounded per peer.                                                                                                                   | <a id="req-jcs-3-c371c5.t1.p1"></a>`REQ-JCS-3-C371C5.T1.P1` — valid case<br><a id="req-jcs-3-c371c5.t1.p2"></a>`REQ-JCS-3-C371C5.T1.P2` — correct identity/signature<br><a id="req-jcs-3-c371c5.t1.p3"></a>`REQ-JCS-3-C371C5.T1.P3` — new participant<br><a id="req-jcs-3-c371c5.t1.p4"></a>`REQ-JCS-3-C371C5.T1.P4` — malformed input<br><a id="req-jcs-3-c371c5.t1.p5"></a>`REQ-JCS-3-C371C5.T1.P5` — direct invalid/opposite<br><a id="req-jcs-3-c371c5.t1.p6"></a>`REQ-JCS-3-C371C5.T1.P6` — wrong identity/signature<br><a id="req-jcs-3-c371c5.t1.p7"></a>`REQ-JCS-3-C371C5.T1.P7` — missing identity/signature<br><a id="req-jcs-3-c371c5.t1.p8"></a>`REQ-JCS-3-C371C5.T1.P8` — duplicate identity/signature<br><a id="req-jcs-3-c371c5.t1.p9"></a>`REQ-JCS-3-C371C5.T1.P9` — forged identity/signature<br><a id="req-jcs-3-c371c5.t1.p10"></a>`REQ-JCS-3-C371C5.T1.P10` — membership boundary<br><a id="req-jcs-3-c371c5.t1.p11"></a>`REQ-JCS-3-C371C5.T1.P11` — existing participant<br><a id="req-jcs-3-c371c5.t1.p12"></a>`REQ-JCS-3-C371C5.T1.P12` — removed participant<br><a id="req-jcs-3-c371c5.t1.p13"></a>`REQ-JCS-3-C371C5.T1.P13` — slashed participant<br><a id="req-jcs-3-c371c5.t1.p14"></a>`REQ-JCS-3-C371C5.T1.P14` — concurrent membership change<br><a id="req-jcs-3-c371c5.t1.p15"></a>`REQ-JCS-3-C371C5.T1.P15` — adversarial input<br><a id="req-jcs-3-c371c5.t1.p16"></a>`REQ-JCS-3-C371C5.T1.P16` — partial failure<br><a id="req-jcs-3-c371c5.t1.p17"></a>`REQ-JCS-3-C371C5.T1.P17` — retry and recovery                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
