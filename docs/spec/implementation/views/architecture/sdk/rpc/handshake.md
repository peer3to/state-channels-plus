...
Node local and Holepunch transports inherit the same data.toString delivery from ATransport. Browser, loopback and WebRTC conversion remain explicit in those transports. Peer frame classification parses once and retains response-first precedence.

[ATransport.ts.md](../../../../source/src/transport/ATransport.ts.md), [Rpc.ts.md](../../../../source/src/rpc/Rpc.ts.md), [P2PManager.ts.md](../../../../source/src/P2PManager.ts.md).
