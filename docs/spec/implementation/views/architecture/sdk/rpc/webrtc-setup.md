...
| ID                                                       | Invariant                                                                                                                                                                                                                                                                                                         |
| -------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`INV-WRTC-1-FZ9RBH`](webrtc-setup.md#inv-wrtc-1-fz9rbh) | The peer address keying every WebRTC connection is read from the authenticated `senderTransport.peerAddress`, never from the signaling payload; a peer can only affect its own connection slot.                                                                                                                   |
| [`INV-WRTC-2-691KC5`](webrtc-setup.md#inv-wrtc-2-691kc5) | All three remote signaling methods are one-way and reachable only behind `HandshakeCompletedGuard`; they never run for an unauthenticated transport.                                                                                                                                                              |
| [`INV-WRTC-3-9GBJGJ`](webrtc-setup.md#inv-wrtc-3-9gbjgj) | Every signaling handler catches its own failures and neither throws to the dispatcher nor disconnects/blacklists the peer (silent-ignore), so a failed upgrade degrades to the existing transport.                                                                                                                |
| [`INV-WRTC-4-Z0MAZF`](webrtc-setup.md#inv-wrtc-4-z0mazf) | Only one peer offers per upgrade (`localAddress < completedPeerAddress` tiebreak), avoiding offer glare.                                                                                                                                                                                                          |
