...
[`SpectateService.generateSyncPayload`](../../../../../../../src/rpc/network/services/spectate/SpectateService.ts#L569)):
...
[`SpectateService.rejectSync`](../../../../../../../src/rpc/network/services/spectate/SpectateService.ts#L1180)
...
| `applySyncResponse`            | runtime left the channel the request was for (channel generation changed)                                              | Return false before persistence and replay; no abort, no peer cut                                                              |
...
| [`INV-SPC-4-WVXS19`](spectate.md#inv-spc-4-wvxs19) | Fail-closed: any failure aborts with no partial commitment ([`REQ-MSG-9-BFN9P5`](../../../../../specification/settlement/cross-layer-messages.md#req-msg-9-bfn9p5)).                  | Covered               | [SpectateService.rejectSync](../../../../../../../src/rpc/network/services/spectate/SpectateService.ts#L1180); [SpectatingValidationStrategy](../../../../../../../src/stateManager/validationStrategy/SpectatingValidationStrategy.ts#L21)                                                 | None.                                                                      |
...
| [`REQ-SPC-1-H10R5K`](spectate.md#req-spc-1-h10r5k) | The responder MUST prove at least the requested height on that fork or a verified successor whose lineage contains it; an unrelated fork or above-latest same-fork height is refused. | Covered               | [SpectateService.generateSyncPayload](../../../../../../../src/rpc/network/services/spectate/SpectateService.ts#L569)                                                                                                                                                                       | None.                                                                      |
