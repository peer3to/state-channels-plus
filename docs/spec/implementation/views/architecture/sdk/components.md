...
| [`OpenChannelNegotiationService`](../../../../../../src/rpc/network/services/openChannelNegotiation/OpenChannelNegotiationService.ts#L47) | Open-terms negotiation      | Exported for integrator wiring; **not** instantiated by `MainRpcService`.                                                                                                                                                                                                                                                                                                              |
