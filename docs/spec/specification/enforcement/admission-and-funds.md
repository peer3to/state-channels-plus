...
double-entry (membership split), and unbacked balances ([`INV-ENFADM-1-H53AQY`](admission-and-funds.md#inv-enfadm-1-h53aqy) ties every claimed deposit
