...
observes a half-released runtime. It MUST leave the runtime able to accept work for another channel, and it
MUST be refused on a runtime that has already shut down.
