...
**<a id="req-sdk-arch-5-nsjyqt"></a>`REQ-SDK-ARCH-5-NSJYQT` — Chain spending is observable.** A participant MUST aggregate what its own
...
| <a id="req-sdk-arch-5-nsjyqt.t1"></a>`REQ-SDK-ARCH-5-NSJYQT.T1` | [`REQ-SDK-ARCH-5-NSJYQT`](sdk.md#req-sdk-arch-5-nsjyqt) | Send chain transactions of each outcome from one participant, then read its cost aggregate and its disposal report.          | Every mined transaction is counted once under its contract and function, reverted ones are counted and totalled apart from the successful ones and never move a bound, unmined or never-sent functions are absent, and disposal reports the aggregate once. | <a id="req-sdk-arch-5-nsjyqt.t1.p1"></a>`REQ-SDK-ARCH-5-NSJYQT.T1.P1` — no transaction sent; <a id="req-sdk-arch-5-nsjyqt.t1.p2"></a>`REQ-SDK-ARCH-5-NSJYQT.T1.P2` — one mined transaction; <a id="req-sdk-arch-5-nsjyqt.t1.p3"></a>`REQ-SDK-ARCH-5-NSJYQT.T1.P3` — repeated calls of one function; <a id="req-sdk-arch-5-nsjyqt.t1.p4"></a>`REQ-SDK-ARCH-5-NSJYQT.T1.P4` — mined but reverted; <a id="req-sdk-arch-5-nsjyqt.t1.p5"></a>`REQ-SDK-ARCH-5-NSJYQT.T1.P5` — one selector on two contracts; <a id="req-sdk-arch-5-nsjyqt.t1.p6"></a>`REQ-SDK-ARCH-5-NSJYQT.T1.P6` — unnamed selector; <a id="req-sdk-arch-5-nsjyqt.t1.p7"></a>`REQ-SDK-ARCH-5-NSJYQT.T1.P7` — never-called function absent; <a id="req-sdk-arch-5-nsjyqt.t1.p8"></a>`REQ-SDK-ARCH-5-NSJYQT.T1.P8` — disposal emits the aggregate exactly once, carrying the rows the participant's own read answers, with the receipt outstanding at disposal included. |
