...
- **Atomicity.** A snapshot advance is atomic: any failure in range verification or message
  ...
  Partial progress across transactions exists only at snapshot granularity ([`REQ-MSG-5-5XB7DB`](cross-layer-messages.md#req-msg-5-5xb7db)).
...
signs the `JoinChannel`, and every currently eligible participant — snapshot participants ∪
pending participants, minus on-chain-slashed — must countersign
(`JoinChannelFacet._processJoinChannel`
via `verifyThresholdSigned`). Join admission is a current-state chain decision, not a proof about
history, so its set is the chain's live eligibility view — the same slash-excluding rule that
governs disputes — rather than a block's previous∪resulting transition union
([finality.md §6](../protocol-model/finality.md)). An on-chain-slashed participant MUST NOT be
able to block later admissions. The flow:
...
balance, while slashing applies the protocol-defined penalty ([`REQ-SM-8-8CHSQ8`](../protocol-model/state-machines.md#req-sm-8-8chsq8)).
...
| ------------------------------------------------------- | ---------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="inv-msg-1-36y41q.t1"></a>`INV-MSG-1-36Y41Q.T1`   | [`INV-MSG-1-36Y41Q`](cross-layer-messages.md#inv-msg-1-36y41q)   | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Each stream is one hash-linked chain per channel; heights +1; identity = `keccak256(abi.encode(block))`                                   | <a id="inv-msg-1-36y41q.t1.p1"></a>`INV-MSG-1-36Y41Q.T1.P1` — valid case<br><a id="inv-msg-1-36y41q.t1.p4"></a>`INV-MSG-1-36Y41Q.T1.P4` — direct invalid/opposite case<br><a id="inv-msg-1-36y41q.t1.p2"></a>`INV-MSG-1-36Y41Q.T1.P2` — matching commitment<br><a id="inv-msg-1-36y41q.t1.p5"></a>`INV-MSG-1-36Y41Q.T1.P5` — mismatched commitment<br><a id="inv-msg-1-36y41q.t1.p6"></a>`INV-MSG-1-36Y41Q.T1.P6` — predecessor snapshot<br><a id="inv-msg-1-36y41q.t1.p7"></a>`INV-MSG-1-36Y41Q.T1.P7` — genesis snapshot<br><a id="inv-msg-1-36y41q.t1.p8"></a>`INV-MSG-1-36Y41Q.T1.P8` — stale fork<br><a id="inv-msg-1-36y41q.t1.p9"></a>`INV-MSG-1-36Y41Q.T1.P9` — foreign fork<br><a id="inv-msg-1-36y41q.t1.p3"></a>`INV-MSG-1-36Y41Q.T1.P3` — correct identity/signature<br><a id="inv-msg-1-36y41q.t1.p10"></a>`INV-MSG-1-36Y41Q.T1.P10` — wrong identity/signature<br><a id="inv-msg-1-36y41q.t1.p11"></a>`INV-MSG-1-36Y41Q.T1.P11` — missing identity/signature<br><a id="inv-msg-1-36y41q.t1.p12"></a>`INV-MSG-1-36Y41Q.T1.P12` — duplicate identity/signature<br><a id="inv-msg-1-36y41q.t1.p13"></a>`INV-MSG-1-36Y41Q.T1.P13` — forged identity/signature<br><a id="inv-msg-1-36y41q.t1.p14"></a>`INV-MSG-1-36Y41Q.T1.P14` — membership boundary                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| <a id="inv-msg-2-pq0t1k.t1"></a>`INV-MSG-2-PQ0T1K.T1`   | [`INV-MSG-2-PQ0T1K`](cross-layer-messages.md#inv-msg-2-pq0t1k)   | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | No replay, no omission: each block processed exactly once, in order                                                                       | <a id="inv-msg-2-pq0t1k.t1.p1"></a>`INV-MSG-2-PQ0T1K.T1.P1` — valid case<br><a id="inv-msg-2-pq0t1k.t1.p3"></a>`INV-MSG-2-PQ0T1K.T1.P3` — direct invalid/opposite case<br><a id="inv-msg-2-pq0t1k.t1.p2"></a>`INV-MSG-2-PQ0T1K.T1.P2` — duplicate delivery<br><a id="inv-msg-2-pq0t1k.t1.p4"></a>`INV-MSG-2-PQ0T1K.T1.P4` — replay of processed block<br><a id="inv-msg-2-pq0t1k.t1.p5"></a>`INV-MSG-2-PQ0T1K.T1.P5` — omitted block<br><a id="inv-msg-2-pq0t1k.t1.p6"></a>`INV-MSG-2-PQ0T1K.T1.P6` — reordered blocks<br><a id="inv-msg-2-pq0t1k.t1.p7"></a>`INV-MSG-2-PQ0T1K.T1.P7` — concurrent delivery                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| <a id="inv-msg-3-pcr3kt.t1"></a>`INV-MSG-3-PCR3KT.T1`   | [`INV-MSG-3-PCR3KT`](cross-layer-messages.md#inv-msg-3-pcr3kt)   | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Tip `totalBalance` = cumulative sum of message balances; chain totals match processed prefixes                                            | <a id="inv-msg-3-pcr3kt.t1.p1"></a>`INV-MSG-3-PCR3KT.T1.P1` — valid case<br><a id="inv-msg-3-pcr3kt.t1.p3"></a>`INV-MSG-3-PCR3KT.T1.P3` — direct invalid/opposite case<br><a id="inv-msg-3-pcr3kt.t1.p2"></a>`INV-MSG-3-PCR3KT.T1.P2` — zero balance<br><a id="inv-msg-3-pcr3kt.t1.p4"></a>`INV-MSG-3-PCR3KT.T1.P4` — exact balance boundary<br><a id="inv-msg-3-pcr3kt.t1.p5"></a>`INV-MSG-3-PCR3KT.T1.P5` — one beyond boundary<br><a id="inv-msg-3-pcr3kt.t1.p6"></a>`INV-MSG-3-PCR3KT.T1.P6` — maximum value<br><a id="inv-msg-3-pcr3kt.t1.p7"></a>`INV-MSG-3-PCR3KT.T1.P7` — conservation check                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| <a id="inv-msg-4-6e5g7v.t1"></a>`INV-MSG-4-6E5G7V.T1`   | [`INV-MSG-4-6E5G7V`](cross-layer-messages.md#inv-msg-4-6e5g7v)   | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | `totalWithdrawals ≤ totalDeposits` at every outbound processing step                                                                      | <a id="inv-msg-4-6e5g7v.t1.p1"></a>`INV-MSG-4-6E5G7V.T1.P1` — valid case<br><a id="inv-msg-4-6e5g7v.t1.p3"></a>`INV-MSG-4-6E5G7V.T1.P3` — direct invalid/opposite case<br><a id="inv-msg-4-6e5g7v.t1.p2"></a>`INV-MSG-4-6E5G7V.T1.P2` — zero balance<br><a id="inv-msg-4-6e5g7v.t1.p4"></a>`INV-MSG-4-6E5G7V.T1.P4` — exact balance boundary<br><a id="inv-msg-4-6e5g7v.t1.p5"></a>`INV-MSG-4-6E5G7V.T1.P5` — one beyond boundary<br><a id="inv-msg-4-6e5g7v.t1.p6"></a>`INV-MSG-4-6E5G7V.T1.P6` — maximum value<br><a id="inv-msg-4-6e5g7v.t1.p7"></a>`INV-MSG-4-6E5G7V.T1.P7` — conservation check                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| <a id="inv-msg-5-yc48r5.t1"></a>`INV-MSG-5-YC48R5.T1`   | [`INV-MSG-5-YC48R5`](cross-layer-messages.md#inv-msg-5-yc48r5)   | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Processed tips advance only to strictly newer descendants                                                                                 | <a id="inv-msg-5-yc48r5.t1.p1"></a>`INV-MSG-5-YC48R5.T1.P1` — valid case<br><a id="inv-msg-5-yc48r5.t1.p3"></a>`INV-MSG-5-YC48R5.T1.P3` — direct invalid/opposite case<br><a id="inv-msg-5-yc48r5.t1.p2"></a>`INV-MSG-5-YC48R5.T1.P2` — matching commitment<br><a id="inv-msg-5-yc48r5.t1.p4"></a>`INV-MSG-5-YC48R5.T1.P4` — mismatched commitment<br><a id="inv-msg-5-yc48r5.t1.p5"></a>`INV-MSG-5-YC48R5.T1.P5` — predecessor snapshot<br><a id="inv-msg-5-yc48r5.t1.p6"></a>`INV-MSG-5-YC48R5.T1.P6` — genesis snapshot<br><a id="inv-msg-5-yc48r5.t1.p7"></a>`INV-MSG-5-YC48R5.T1.P7` — stale fork<br><a id="inv-msg-5-yc48r5.t1.p8"></a>`INV-MSG-5-YC48R5.T1.P8` — foreign fork                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| <a id="inv-msg-6-1c22rd.t1"></a>`INV-MSG-6-1C22RD.T1`   | [`INV-MSG-6-1C22RD`](cross-layer-messages.md#inv-msg-6-1c22rd)   | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Balance invariant: `totalDeposits == totalWithdrawals + getTotalStateBalance(state)` with chain-anchored deposits/withdrawals             | <a id="inv-msg-6-1c22rd.t1.p1"></a>`INV-MSG-6-1C22RD.T1.P1` — valid case<br><a id="inv-msg-6-1c22rd.t1.p3"></a>`INV-MSG-6-1C22RD.T1.P3` — direct invalid/opposite case<br><a id="inv-msg-6-1c22rd.t1.p2"></a>`INV-MSG-6-1C22RD.T1.P2` — zero balance<br><a id="inv-msg-6-1c22rd.t1.p4"></a>`INV-MSG-6-1C22RD.T1.P4` — exact balance boundary<br><a id="inv-msg-6-1c22rd.t1.p5"></a>`INV-MSG-6-1C22RD.T1.P5` — one beyond boundary<br><a id="inv-msg-6-1c22rd.t1.p6"></a>`INV-MSG-6-1C22RD.T1.P6` — maximum value<br><a id="inv-msg-6-1c22rd.t1.p7"></a>`INV-MSG-6-1C22RD.T1.P7` — conservation check                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| <a id="req-msg-1-ay3a77.t1"></a>`REQ-MSG-1-AY3A77.T1`   | [`REQ-MSG-1-AY3A77`](cross-layer-messages.md#req-msg-1-ay3a77)   | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Snapshots MUST commit both stream tips + totals; dispute outputs likewise                                                                 | <a id="req-msg-1-ay3a77.t1.p1"></a>`REQ-MSG-1-AY3A77.T1.P1` — valid case<br><a id="req-msg-1-ay3a77.t1.p4"></a>`REQ-MSG-1-AY3A77.T1.P4` — direct invalid/opposite case<br><a id="req-msg-1-ay3a77.t1.p2"></a>`REQ-MSG-1-AY3A77.T1.P2` — matching commitment<br><a id="req-msg-1-ay3a77.t1.p5"></a>`REQ-MSG-1-AY3A77.T1.P5` — mismatched commitment<br><a id="req-msg-1-ay3a77.t1.p6"></a>`REQ-MSG-1-AY3A77.T1.P6` — predecessor snapshot<br><a id="req-msg-1-ay3a77.t1.p7"></a>`REQ-MSG-1-AY3A77.T1.P7` — genesis snapshot<br><a id="req-msg-1-ay3a77.t1.p8"></a>`REQ-MSG-1-AY3A77.T1.P8` — stale fork<br><a id="req-msg-1-ay3a77.t1.p9"></a>`REQ-MSG-1-AY3A77.T1.P9` — foreign fork<br><a id="req-msg-1-ay3a77.t1.p3"></a>`REQ-MSG-1-AY3A77.T1.P3` — malformed input<br><a id="req-msg-1-ay3a77.t1.p10"></a>`REQ-MSG-1-AY3A77.T1.P10` — adversarial input<br><a id="req-msg-1-ay3a77.t1.p11"></a>`REQ-MSG-1-AY3A77.T1.P11` — partial failure<br><a id="req-msg-1-ay3a77.t1.p12"></a>`REQ-MSG-1-AY3A77.T1.P12` — retry and recovery                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| <a id="req-msg-2-7yad1a.t1"></a>`REQ-MSG-2-7YAD1A.T1`   | [`REQ-MSG-2-7YAD1A`](cross-layer-messages.md#req-msg-2-7yad1a)   | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | A dispute's claimed inbound tip MUST be an ancestor of the chain tip with matching height                                                 | <a id="req-msg-2-7yad1a.t1.p1"></a>`REQ-MSG-2-7YAD1A.T1.P1` — valid case<br><a id="req-msg-2-7yad1a.t1.p4"></a>`REQ-MSG-2-7YAD1A.T1.P4` — direct invalid/opposite case<br><a id="req-msg-2-7yad1a.t1.p2"></a>`REQ-MSG-2-7YAD1A.T1.P2` — matching commitment<br><a id="req-msg-2-7yad1a.t1.p5"></a>`REQ-MSG-2-7YAD1A.T1.P5` — mismatched commitment<br><a id="req-msg-2-7yad1a.t1.p6"></a>`REQ-MSG-2-7YAD1A.T1.P6` — predecessor snapshot<br><a id="req-msg-2-7yad1a.t1.p7"></a>`REQ-MSG-2-7YAD1A.T1.P7` — genesis snapshot<br><a id="req-msg-2-7yad1a.t1.p8"></a>`REQ-MSG-2-7YAD1A.T1.P8` — stale fork<br><a id="req-msg-2-7yad1a.t1.p9"></a>`REQ-MSG-2-7YAD1A.T1.P9` — foreign fork<br><a id="req-msg-2-7yad1a.t1.p3"></a>`REQ-MSG-2-7YAD1A.T1.P3` — malformed input<br><a id="req-msg-2-7yad1a.t1.p10"></a>`REQ-MSG-2-7YAD1A.T1.P10` — adversarial input<br><a id="req-msg-2-7yad1a.t1.p11"></a>`REQ-MSG-2-7YAD1A.T1.P11` — partial failure<br><a id="req-msg-2-7yad1a.t1.p12"></a>`REQ-MSG-2-7YAD1A.T1.P12` — retry and recovery                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| <a id="req-msg-3-yy569f.t1"></a>`REQ-MSG-3-YY569F.T1`   | [`REQ-MSG-3-YY569F`](cross-layer-messages.md#req-msg-3-yy569f)   | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Packaged inbound blocks MUST chain from the previous snapshot tip and exist on-chain; fabrication is provable fraud                       | <a id="req-msg-3-yy569f.t1.p1"></a>`REQ-MSG-3-YY569F.T1.P1` — valid case<br><a id="req-msg-3-yy569f.t1.p4"></a>`REQ-MSG-3-YY569F.T1.P4` — direct invalid/opposite case<br><a id="req-msg-3-yy569f.t1.p2"></a>`REQ-MSG-3-YY569F.T1.P2` — matching commitment<br><a id="req-msg-3-yy569f.t1.p5"></a>`REQ-MSG-3-YY569F.T1.P5` — mismatched commitment<br><a id="req-msg-3-yy569f.t1.p6"></a>`REQ-MSG-3-YY569F.T1.P6` — predecessor snapshot<br><a id="req-msg-3-yy569f.t1.p7"></a>`REQ-MSG-3-YY569F.T1.P7` — genesis snapshot<br><a id="req-msg-3-yy569f.t1.p8"></a>`REQ-MSG-3-YY569F.T1.P8` — stale fork<br><a id="req-msg-3-yy569f.t1.p9"></a>`REQ-MSG-3-YY569F.T1.P9` — foreign fork<br><a id="req-msg-3-yy569f.t1.p3"></a>`REQ-MSG-3-YY569F.T1.P3` — malformed input<br><a id="req-msg-3-yy569f.t1.p10"></a>`REQ-MSG-3-YY569F.T1.P10` — adversarial input<br><a id="req-msg-3-yy569f.t1.p11"></a>`REQ-MSG-3-YY569F.T1.P11` — partial failure<br><a id="req-msg-3-yy569f.t1.p12"></a>`REQ-MSG-3-YY569F.T1.P12` — retry and recovery                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| <a id="req-msg-4-sc1fex.t1"></a>`REQ-MSG-4-SC1FEX.T1`   | [`REQ-MSG-4-SC1FEX`](cross-layer-messages.md#req-msg-4-sc1fex)   | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Outbound processing MUST verify the linked range and skip the processed prefix before consuming                                           | <a id="req-msg-4-sc1fex.t1.p1"></a>`REQ-MSG-4-SC1FEX.T1.P1` — valid case<br><a id="req-msg-4-sc1fex.t1.p3"></a>`REQ-MSG-4-SC1FEX.T1.P3` — direct invalid/opposite case<br><a id="req-msg-4-sc1fex.t1.p2"></a>`REQ-MSG-4-SC1FEX.T1.P2` — matching commitment<br><a id="req-msg-4-sc1fex.t1.p4"></a>`REQ-MSG-4-SC1FEX.T1.P4` — mismatched commitment<br><a id="req-msg-4-sc1fex.t1.p5"></a>`REQ-MSG-4-SC1FEX.T1.P5` — predecessor snapshot<br><a id="req-msg-4-sc1fex.t1.p6"></a>`REQ-MSG-4-SC1FEX.T1.P6` — genesis snapshot<br><a id="req-msg-4-sc1fex.t1.p7"></a>`REQ-MSG-4-SC1FEX.T1.P7` — stale fork<br><a id="req-msg-4-sc1fex.t1.p8"></a>`REQ-MSG-4-SC1FEX.T1.P8` — foreign fork                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| <a id="req-msg-5-5xb7db.t1"></a>`REQ-MSG-5-5XB7DB.T1`   | [`REQ-MSG-5-5XB7DB`](cross-layer-messages.md#req-msg-5-5xb7db)   | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Catch-up MUST be batchable into smaller ranges with identical results                                                                     | <a id="req-msg-5-5xb7db.t1.p1"></a>`REQ-MSG-5-5XB7DB.T1.P1` — valid case<br><a id="req-msg-5-5xb7db.t1.p3"></a>`REQ-MSG-5-5XB7DB.T1.P3` — direct invalid/opposite case<br><a id="req-msg-5-5xb7db.t1.p2"></a>`REQ-MSG-5-5XB7DB.T1.P2` — zero/empty/no-op case<br><a id="req-msg-5-5xb7db.t1.p4"></a>`REQ-MSG-5-5XB7DB.T1.P4` — exact boundary<br><a id="req-msg-5-5xb7db.t1.p5"></a>`REQ-MSG-5-5XB7DB.T1.P5` — failure and recovery<br><a id="req-msg-5-5xb7db.t1.p6"></a>`REQ-MSG-5-5XB7DB.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| <a id="req-msg-6-mznqam.t1"></a>`REQ-MSG-6-MZNQAM.T1`   | [`REQ-MSG-6-MZNQAM`](cross-layer-messages.md#req-msg-6-mznqam)   | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Snapshot advance MUST require finality (same-fork) or finalized reduction + expired challenge period (successor fork)                     | <a id="req-msg-6-mznqam.t1.p1"></a>`REQ-MSG-6-MZNQAM.T1.P1` — valid case<br><a id="req-msg-6-mznqam.t1.p4"></a>`REQ-MSG-6-MZNQAM.T1.P4` — direct invalid/opposite case<br><a id="req-msg-6-mznqam.t1.p2"></a>`REQ-MSG-6-MZNQAM.T1.P2` — matching commitment<br><a id="req-msg-6-mznqam.t1.p5"></a>`REQ-MSG-6-MZNQAM.T1.P5` — mismatched commitment<br><a id="req-msg-6-mznqam.t1.p6"></a>`REQ-MSG-6-MZNQAM.T1.P6` — predecessor snapshot<br><a id="req-msg-6-mznqam.t1.p7"></a>`REQ-MSG-6-MZNQAM.T1.P7` — genesis snapshot<br><a id="req-msg-6-mznqam.t1.p8"></a>`REQ-MSG-6-MZNQAM.T1.P8` — stale fork<br><a id="req-msg-6-mznqam.t1.p9"></a>`REQ-MSG-6-MZNQAM.T1.P9` — foreign fork<br><a id="req-msg-6-mznqam.t1.p3"></a>`REQ-MSG-6-MZNQAM.T1.P3` — before deadline<br><a id="req-msg-6-mznqam.t1.p10"></a>`REQ-MSG-6-MZNQAM.T1.P10` — at deadline<br><a id="req-msg-6-mznqam.t1.p11"></a>`REQ-MSG-6-MZNQAM.T1.P11` — after deadline<br><a id="req-msg-6-mznqam.t1.p12"></a>`REQ-MSG-6-MZNQAM.T1.P12` — maximum honest skew                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| <a id="req-msg-7-q40q3r.t1"></a>`REQ-MSG-7-Q40Q3R.T1`   | [`REQ-MSG-7-Q40Q3R`](cross-layer-messages.md#req-msg-7-q40q3r)   | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Same-fork advance MUST consume all pending inbound messages                                                                               | <a id="req-msg-7-q40q3r.t1.p1"></a>`REQ-MSG-7-Q40Q3R.T1.P1` — valid case<br><a id="req-msg-7-q40q3r.t1.p3"></a>`REQ-MSG-7-Q40Q3R.T1.P3` — direct invalid/opposite case<br><a id="req-msg-7-q40q3r.t1.p2"></a>`REQ-MSG-7-Q40Q3R.T1.P2` — matching commitment<br><a id="req-msg-7-q40q3r.t1.p4"></a>`REQ-MSG-7-Q40Q3R.T1.P4` — mismatched commitment<br><a id="req-msg-7-q40q3r.t1.p5"></a>`REQ-MSG-7-Q40Q3R.T1.P5` — predecessor snapshot<br><a id="req-msg-7-q40q3r.t1.p6"></a>`REQ-MSG-7-Q40Q3R.T1.P6` — genesis snapshot<br><a id="req-msg-7-q40q3r.t1.p7"></a>`REQ-MSG-7-Q40Q3R.T1.P7` — stale fork<br><a id="req-msg-7-q40q3r.t1.p8"></a>`REQ-MSG-7-Q40Q3R.T1.P8` — foreign fork                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| <a id="req-msg-8-n1ecj5.t1"></a>`REQ-MSG-8-N1ECJ5.T1`   | [`REQ-MSG-8-N1ECJ5`](cross-layer-messages.md#req-msg-8-n1ecj5)   | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Exits MUST be withdrawable only through snapshot advance (no standalone submission)                                                       | <a id="req-msg-8-n1ecj5.t1.p1"></a>`REQ-MSG-8-N1ECJ5.T1.P1` — valid case<br><a id="req-msg-8-n1ecj5.t1.p4"></a>`REQ-MSG-8-N1ECJ5.T1.P4` — direct invalid/opposite case<br><a id="req-msg-8-n1ecj5.t1.p2"></a>`REQ-MSG-8-N1ECJ5.T1.P2` — matching commitment<br><a id="req-msg-8-n1ecj5.t1.p5"></a>`REQ-MSG-8-N1ECJ5.T1.P5` — mismatched commitment<br><a id="req-msg-8-n1ecj5.t1.p6"></a>`REQ-MSG-8-N1ECJ5.T1.P6` — predecessor snapshot<br><a id="req-msg-8-n1ecj5.t1.p7"></a>`REQ-MSG-8-N1ECJ5.T1.P7` — genesis snapshot<br><a id="req-msg-8-n1ecj5.t1.p8"></a>`REQ-MSG-8-N1ECJ5.T1.P8` — stale fork<br><a id="req-msg-8-n1ecj5.t1.p9"></a>`REQ-MSG-8-N1ECJ5.T1.P9` — foreign fork<br><a id="req-msg-8-n1ecj5.t1.p3"></a>`REQ-MSG-8-N1ECJ5.T1.P3` — zero balance<br><a id="req-msg-8-n1ecj5.t1.p10"></a>`REQ-MSG-8-N1ECJ5.T1.P10` — exact balance boundary<br><a id="req-msg-8-n1ecj5.t1.p11"></a>`REQ-MSG-8-N1ECJ5.T1.P11` — one beyond boundary<br><a id="req-msg-8-n1ecj5.t1.p12"></a>`REQ-MSG-8-N1ECJ5.T1.P12` — maximum value<br><a id="req-msg-8-n1ecj5.t1.p13"></a>`REQ-MSG-8-N1ECJ5.T1.P13` — conservation check                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| <a id="req-msg-9-bfn9p5.t1"></a>`REQ-MSG-9-BFN9P5.T1`   | [`REQ-MSG-9-BFN9P5`](cross-layer-messages.md#req-msg-9-bfn9p5)   | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Spectating MUST be fail-closed: any failure aborts with no funds or obligations at risk                                                   | <a id="req-msg-9-bfn9p5.t1.p1"></a>`REQ-MSG-9-BFN9P5.T1.P1` — valid case<br><a id="req-msg-9-bfn9p5.t1.p3"></a>`REQ-MSG-9-BFN9P5.T1.P3` — direct invalid/opposite case<br><a id="req-msg-9-bfn9p5.t1.p2"></a>`REQ-MSG-9-BFN9P5.T1.P2` — malformed input<br><a id="req-msg-9-bfn9p5.t1.p4"></a>`REQ-MSG-9-BFN9P5.T1.P4` — adversarial input<br><a id="req-msg-9-bfn9p5.t1.p5"></a>`REQ-MSG-9-BFN9P5.T1.P5` — partial failure<br><a id="req-msg-9-bfn9p5.t1.p6"></a>`REQ-MSG-9-BFN9P5.T1.P6` — retry and recovery                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| <a id="req-msg-10-7js45q.t1"></a>`REQ-MSG-10-7JS45Q.T1` | [`REQ-MSG-10-7JS45Q`](cross-layer-messages.md#req-msg-10-7js45q) | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Joining MUST carry the joiner's signature plus the full threshold set's signatures, pinned to an expected snapshot/fork                   | <a id="req-msg-10-7js45q.t1.p1"></a>`REQ-MSG-10-7JS45Q.T1.P1` — valid case<br><a id="req-msg-10-7js45q.t1.p5"></a>`REQ-MSG-10-7JS45Q.T1.P5` — direct invalid/opposite case<br><a id="req-msg-10-7js45q.t1.p2"></a>`REQ-MSG-10-7JS45Q.T1.P2` — matching commitment<br><a id="req-msg-10-7js45q.t1.p6"></a>`REQ-MSG-10-7JS45Q.T1.P6` — mismatched commitment<br><a id="req-msg-10-7js45q.t1.p7"></a>`REQ-MSG-10-7JS45Q.T1.P7` — predecessor snapshot<br><a id="req-msg-10-7js45q.t1.p8"></a>`REQ-MSG-10-7JS45Q.T1.P8` — genesis snapshot<br><a id="req-msg-10-7js45q.t1.p9"></a>`REQ-MSG-10-7JS45Q.T1.P9` — stale fork<br><a id="req-msg-10-7js45q.t1.p10"></a>`REQ-MSG-10-7JS45Q.T1.P10` — foreign fork<br><a id="req-msg-10-7js45q.t1.p3"></a>`REQ-MSG-10-7JS45Q.T1.P3` — correct identity/signature<br><a id="req-msg-10-7js45q.t1.p11"></a>`REQ-MSG-10-7JS45Q.T1.P11` — wrong identity/signature<br><a id="req-msg-10-7js45q.t1.p12"></a>`REQ-MSG-10-7JS45Q.T1.P12` — missing identity/signature<br><a id="req-msg-10-7js45q.t1.p13"></a>`REQ-MSG-10-7JS45Q.T1.P13` — duplicate identity/signature<br><a id="req-msg-10-7js45q.t1.p14"></a>`REQ-MSG-10-7JS45Q.T1.P14` — forged identity/signature<br><a id="req-msg-10-7js45q.t1.p15"></a>`REQ-MSG-10-7JS45Q.T1.P15` — membership boundary<br><a id="req-msg-10-7js45q.t1.p4"></a>`REQ-MSG-10-7JS45Q.T1.P4` — new participant<br><a id="req-msg-10-7js45q.t1.p16"></a>`REQ-MSG-10-7JS45Q.T1.P16` — existing participant<br><a id="req-msg-10-7js45q.t1.p17"></a>`REQ-MSG-10-7JS45Q.T1.P17` — removed participant<br><a id="req-msg-10-7js45q.t1.p18"></a>`REQ-MSG-10-7JS45Q.T1.P18` — slashed participant<br><a id="req-msg-10-7js45q.t1.p19"></a>`REQ-MSG-10-7JS45Q.T1.P19` — concurrent membership change |
| <a id="req-msg-11-vs3zgc.t1"></a>`REQ-MSG-11-VS3ZGC.T1` | [`REQ-MSG-11-VS3ZGC`](cross-layer-messages.md#req-msg-11-vs3zgc) | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | A deposited-but-unincluded joiner MUST be able to force inclusion via the dispute game and then be covered by leader election             | <a id="req-msg-11-vs3zgc.t1.p1"></a>`REQ-MSG-11-VS3ZGC.T1.P1` — valid case<br><a id="req-msg-11-vs3zgc.t1.p5"></a>`REQ-MSG-11-VS3ZGC.T1.P5` — direct invalid/opposite case<br><a id="req-msg-11-vs3zgc.t1.p2"></a>`REQ-MSG-11-VS3ZGC.T1.P2` — zero balance<br><a id="req-msg-11-vs3zgc.t1.p6"></a>`REQ-MSG-11-VS3ZGC.T1.P6` — exact balance boundary<br><a id="req-msg-11-vs3zgc.t1.p7"></a>`REQ-MSG-11-VS3ZGC.T1.P7` — one beyond boundary<br><a id="req-msg-11-vs3zgc.t1.p8"></a>`REQ-MSG-11-VS3ZGC.T1.P8` — maximum value<br><a id="req-msg-11-vs3zgc.t1.p9"></a>`REQ-MSG-11-VS3ZGC.T1.P9` — conservation check<br><a id="req-msg-11-vs3zgc.t1.p3"></a>`REQ-MSG-11-VS3ZGC.T1.P3` — new participant<br><a id="req-msg-11-vs3zgc.t1.p10"></a>`REQ-MSG-11-VS3ZGC.T1.P10` — existing participant<br><a id="req-msg-11-vs3zgc.t1.p11"></a>`REQ-MSG-11-VS3ZGC.T1.P11` — removed participant<br><a id="req-msg-11-vs3zgc.t1.p12"></a>`REQ-MSG-11-VS3ZGC.T1.P12` — slashed participant<br><a id="req-msg-11-vs3zgc.t1.p13"></a>`REQ-MSG-11-VS3ZGC.T1.P13` — concurrent membership change<br><a id="req-msg-11-vs3zgc.t1.p4"></a>`REQ-MSG-11-VS3ZGC.T1.P4` — malformed input<br><a id="req-msg-11-vs3zgc.t1.p14"></a>`REQ-MSG-11-VS3ZGC.T1.P14` — adversarial input<br><a id="req-msg-11-vs3zgc.t1.p15"></a>`REQ-MSG-11-VS3ZGC.T1.P15` — partial failure<br><a id="req-msg-11-vs3zgc.t1.p16"></a>`REQ-MSG-11-VS3ZGC.T1.P16` — retry and recovery                                                                                                                                                                                                                                                                                                                    |
| <a id="req-msg-11-vs3zgc.t2"></a>`REQ-MSG-11-VS3ZGC.T2` | [`REQ-MSG-11-VS3ZGC`](cross-layer-messages.md#req-msg-11-vs3zgc) | Deposit a join, keep it pending through a dispute, then exercise forced inclusion and successor-fork authoring through public protocol inputs.        | Reduction applies the pending JOIN, forced inclusion makes the joiner a successor participant, and leader election schedules it normally. | <a id="req-msg-11-vs3zgc.t2.p1"></a>`REQ-MSG-11-VS3ZGC.T2.P1` — a pending JOIN present when another valid dispute begins is applied to the successor participant set; <a id="req-msg-11-vs3zgc.t2.p2"></a>`REQ-MSG-11-VS3ZGC.T2.P2` — omission through the force-inclusion threshold creates a dispute whose reduction includes the joiner; <a id="req-msg-11-vs3zgc.t2.p3"></a>`REQ-MSG-11-VS3ZGC.T2.P3` — the included joiner receives an assigned successor-fork authoring turn and its block is accepted. ; <a id="req-msg-11-vs3zgc.t2.p4"></a>`REQ-MSG-11-VS3ZGC.T2.P4` — the pending set holds only joins the current snapshot has not consumed: empty after open, the joiner after its deposit, and never the original participants                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| <a id="req-msg-12-1rrb0w.t1"></a>`REQ-MSG-12-1RRB0W.T1` | [`REQ-MSG-12-1RRB0W`](cross-layer-messages.md#req-msg-12-1rrb0w) | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Anyone MUST be able to verify the balance invariant trustlessly for a claimed snapshot                                                    | <a id="req-msg-12-1rrb0w.t1.p1"></a>`REQ-MSG-12-1RRB0W.T1.P1` — valid case<br><a id="req-msg-12-1rrb0w.t1.p4"></a>`REQ-MSG-12-1RRB0W.T1.P4` — direct invalid/opposite case<br><a id="req-msg-12-1rrb0w.t1.p2"></a>`REQ-MSG-12-1RRB0W.T1.P2` — matching commitment<br><a id="req-msg-12-1rrb0w.t1.p5"></a>`REQ-MSG-12-1RRB0W.T1.P5` — mismatched commitment<br><a id="req-msg-12-1rrb0w.t1.p6"></a>`REQ-MSG-12-1RRB0W.T1.P6` — predecessor snapshot<br><a id="req-msg-12-1rrb0w.t1.p7"></a>`REQ-MSG-12-1RRB0W.T1.P7` — genesis snapshot<br><a id="req-msg-12-1rrb0w.t1.p8"></a>`REQ-MSG-12-1RRB0W.T1.P8` — stale fork<br><a id="req-msg-12-1rrb0w.t1.p9"></a>`REQ-MSG-12-1RRB0W.T1.P9` — foreign fork<br><a id="req-msg-12-1rrb0w.t1.p3"></a>`REQ-MSG-12-1RRB0W.T1.P3` — zero balance<br><a id="req-msg-12-1rrb0w.t1.p10"></a>`REQ-MSG-12-1RRB0W.T1.P10` — exact balance boundary<br><a id="req-msg-12-1rrb0w.t1.p11"></a>`REQ-MSG-12-1RRB0W.T1.P11` — one beyond boundary<br><a id="req-msg-12-1rrb0w.t1.p12"></a>`REQ-MSG-12-1RRB0W.T1.P12` — maximum value<br><a id="req-msg-12-1rrb0w.t1.p13"></a>`REQ-MSG-12-1RRB0W.T1.P13` — conservation check                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
