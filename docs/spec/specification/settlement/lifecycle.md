...
1. **Same-fork finality.** Every required participant supplied its finality vote (directly or via
   ...
   run; the treatment of already committed claims and finalized reduction references as the
   checkpoint advances is the bounded open question
   [`OQ-50-YSDG8S`](../open-questions.md#oq-50-ysdg8s) — until decided, checkpoint preservation
   is required, unsafe adoption is rejected, and no update freeze or new waiting period exists.
