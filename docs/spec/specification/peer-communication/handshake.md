...
transport, including silence before proof, never penalizes an identity. Two refusals at verification carry no new
...
reconnect loop without manufacturing an exclusion it cannot prove. Completion grants no channel
