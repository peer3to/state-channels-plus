...
have its defined consequence. Authenticated wire-contract violations MUST disconnect and exclude the
sender; unknown identities and failures that do not prove peer misconduct MUST only lose the affected
transport. A probe against a gated service MUST NOT reveal whether a method exists.
