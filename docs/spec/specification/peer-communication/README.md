...
| [channel-negotiation.md](./channel-negotiation.md) | Two-party open-terms negotiation: deterministic proposer, negotiated-terms-only signing, chain-observed completion. |
