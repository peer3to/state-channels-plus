...
independent **below the retention bound**; above it, which signatures an entry kept depends on which
arrived first ([`REQ-QSTORE-2-VYWJAQ`](queue.md#req-qstore-2-vywjaq)).
