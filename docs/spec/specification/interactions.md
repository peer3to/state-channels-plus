...
| Proof material                            | Block progression → Disputes                         | [`REQ-IX-4-BB35GC`](interactions.md#req-ix-4-bb35gc) |
...
**<a id="req-ix-4-bb35gc"></a>`REQ-IX-4-BB35GC` — Proof material.** Block progression produces the material disputes consume: milestones,
