...
> **Scope:** The on-chain dispute game: valid dispute inputs, the dispute-window lifecycle,
> deterministic reduction to a canonical successor fork, timeout precedence and ordering, and
> snapshot advancement. Fraud-proof enforcement is a separate mechanism specified in
> [fraud-proofs.md](./fraud-proofs.md); this document consumes its output (the on-chain slash set)
> but does not restate it.

Implementation entry points:
[`DisputeManagerFacet`](../../../../contracts/V1/StateChannelDiamondProxy/DisputeManagerFacet.sol)
(upload), [`DisputeVerificationFacet`](../../../../contracts/V1/StateChannelDiamondProxy/DisputeVerificationFacet.sol)
(reduction, output computation, kill),
[`DisputeFraudProofFacet`](../../../../contracts/V1/StateChannelDiamondProxy/DisputeFraudProofFacet.sol)
(dispute policing), [`StateSnapshotFacet`](../../../../contracts/V1/StateChannelDiamondProxy/StateSnapshotFacet.sol)
(snapshot advancement), shared helpers in
[`utils/DisputeUtils.sol`](../../../../contracts/V1/StateChannelDiamondProxy/utils/DisputeUtils.sol)
and [`StateChannelCommon`](../../../../contracts/V1/StateChannelDiamondProxy/StateChannelCommon.sol).
On-chain types: [`DisputeTypes.sol`](../../../../contracts/V1/types/DisputeTypes.sol),
[`ProofTypes.sol`](../../../../contracts/V1/types/ProofTypes.sol). Off-chain drivers:
[`src/disputeManager/DisputeManager.ts`](../../../../src/disputeManager/DisputeManager.ts),
[`src/stateManager/DisputeValidationService.ts`](../../../../src/stateManager/DisputeValidationService.ts),
[`src/stateManager/reduction/`](../../../../src/stateManager/reduction). The full off-chain
pipeline is specified in [../sdk/dispute-pipeline.md](../sdk/dispute-pipeline.md).
...
A dispute stating none of the four inputs is itself objectively invalid: `_hasDisputeReason`
([`DisputeUtils.sol`](../../../../contracts/V1/StateChannelDiamondProxy/utils/DisputeUtils.sol))
implements the exact predicate, and the `InvalidDisputeReason` dispute fraud proof kills such a
...
Defined in [`DisputeTypes.sol`](../../../../contracts/V1/types/DisputeTypes.sol); field-level
detail in [../reference/data-types.md](../reference/data-types.md).
...
Reconstructed from the facet code. The old specification's
"no commitments before kill → spammer slashed" transition does not describe the implementation:
...
- If the dispute's last milestone is not provably final on its own, the full
  ...
  allowed. The off-chain constructor decides this via `isLastMilestoneFinalByEveryone`
  ([`DisputeManager.constructDispute`](../../../../src/disputeManager/DisputeManager.ts)).
...
(`getEvidenceTime`, [reference/configuration.md](../reference/configuration.md)):
...
on [`DisputeVerificationFacet`](../../../../contracts/V1/StateChannelDiamondProxy/DisputeVerificationFacet.sol):
...
`Current:` every commit path passes `reductionTimestamp = now − evidenceTime`, so the
...
- Off-chain execution resumes from the successor fork's genesis
  ([`ReductionManager`](../../../../src/stateManager/reduction/ReductionManager.ts) schedules the
...
([`_killDispute`](../../../../contracts/V1/StateChannelDiamondProxy/DisputeVerificationFacet.sol)),
and [`DisputeUtils.areDisputesCommitted`](../../../../contracts/V1/StateChannelDiamondProxy/utils/DisputeUtils.sol)
...
Neither a proof nor permutation tests exist. Verification: `none — gap` (permutation,
...
- **At most one timeout per fork, at the lowest timed-out height (`INV-DIS-8`).** The protocol is
  ...
  apparent missed slots reduce to the earliest one. `Current:` implemented as the min-`blockHeight`
...
[`DisputeValidationService`](../../../../src/stateManager/DisputeValidationService.ts)) so an
...
black boxes at their external entry points, the SDK auditor against a live chain, and the whole
game end-to-end including adversarial cases.

- **Facet unit/property tests:**
  [`test/V1/StateChannelDiamondProxy/DisputeVerificationFacet.t.sol`](../../../../test/V1/StateChannelDiamondProxy/DisputeVerificationFacet.t.sol)
...
- **Dispute validation e2e:**
  [`test/e2e/disputeValidation/`](../../../../test/e2e/disputeValidation) — per-input-field
...
- **System e2e:** [`test/e2e/`](../../../../test/e2e) — `E2E-DisputeManager`, `E2E-FinalDispute`,
  ...
  [`test/e2e/fuzz/`](../../../../test/e2e/fuzz).
- **Unit (SDK):** [`test/unit/DisputeManager.test.ts`](../../../../test/unit/DisputeManager.test.ts),
...
| ---------- | -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| REQ-DIS-1  | Design pending | A dispute MUST state at least one of the four valid inputs (timeout, valid on-chain slashes, self-removal, forced inbound inclusion); fraud proofs are not a dispute input.                                                                        | [`DisputeUtils._hasDisputeReason`](../../../../contracts/V1/StateChannelDiamondProxy/utils/DisputeUtils.sol), `InvalidDisputeReason` handler in [`DisputeFraudProofFacet`](../../../../contracts/V1/StateChannelDiamondProxy/DisputeFraudProofFacet.sol)                                                                                                                       | [`test/e2e/disputeValidation/disputeInputFields/`](../../../../test/e2e/disputeValidation/disputeInputFields)                                                                                                                                                                                                                                                                                                                                                     |
| REQ-DIS-2  | Design pending | Upload is limited to eligible disputers: `disputer == msg.sender`, dispute-eligible, ≤1 dispute per window per participant, throttled to one upload per `evidenceTime` per sender.                                                                 | [`DisputeManagerFacet._uploadDispute`](../../../../contracts/V1/StateChannelDiamondProxy/DisputeManagerFacet.sol)                                                                                                                                                                                                                                                              | [`test/e2e/disputeValidation/uploadRevert/`](../../../../test/e2e/disputeValidation/uploadRevert) (incl. `disputerThrottle.test.ts`, `disputer.test.ts`)                                                                                                                                                                                                                                                                                                          |
| REQ-DIS-3  | Design pending | An uploaded dispute records its commitment immediately; while the kill period runs, an invalid committed dispute can be killed via dispute fraud proof, slashing its disputer. (Intended rule: open question §4.2.)                                | [`DisputeManagerFacet._uploadDispute`](../../../../contracts/V1/StateChannelDiamondProxy/DisputeManagerFacet.sol), [`DisputeFraudProofFacet.applyDisputeFraudProofs`](../../../../contracts/V1/StateChannelDiamondProxy/DisputeFraudProofFacet.sol), [`DisputeVerificationFacet._killDispute`](../../../../contracts/V1/StateChannelDiamondProxy/DisputeVerificationFacet.sol) | [`DisputeVerificationFacet.t.sol`](../../../../test/V1/StateChannelDiamondProxy/DisputeVerificationFacet.t.sol) (kill-period tests), [`test/e2e/disputeValidation/`](../../../../test/e2e/disputeValidation)                                                                                                                                                                                                                                                      |
| REQ-DIS-4  | Design pending | Reduction runs only after the kill period expires and consumes exactly the committed dispute set.                                                                                                                                                  | [`_commitToDisputeReducedResult`](../../../../contracts/V1/StateChannelDiamondProxy/StateChannelCommon.sol), [`DisputeUtils.areDisputesCommitted`](../../../../contracts/V1/StateChannelDiamondProxy/utils/DisputeUtils.sol), [`DisputeVerificationFacet.reduceAndFinalize`](../../../../contracts/V1/StateChannelDiamondProxy/DisputeVerificationFacet.sol)                   | [`E2E-ReductionManager.test.ts`](../../../../test/e2e/E2E-ReductionManager.test.ts), [`test/unit/ReductionExecutor.test.ts`](../../../../test/unit/ReductionExecutor.test.ts)                                                                                                                                                                                                                                                                                     |
| INV-DIS-5  | Design pending | The reduced result is independent of the order in which valid dispute inputs are applied (intended; currently violated in principle: kill's swap-with-last reorders the committed set and slash application is order-sensitive — see §5 and OQ-4). | [`DisputeVerificationFacet.reduce`](../../../../contracts/V1/StateChannelDiamondProxy/DisputeVerificationFacet.sol) (fold operators §5), [`_killDispute`](../../../../contracts/V1/StateChannelDiamondProxy/DisputeVerificationFacet.sol), [`DisputeUtils.areDisputesCommitted`](../../../../contracts/V1/StateChannelDiamondProxy/utils/DisputeUtils.sol)                     | none — gap (permutation/adversarial-interleaving tests incl. kills, and convergence proof required)                                                                                                                                                                                                                                                                                                                                                               |
| REQ-DIS-6  | Design pending | Every initiated dispute window MUST end in a canonical successor fork (`forkId = keccak256(output SnapshotData)`, genesis timestamp = kill-period end), whether individual claims are accepted or rejected; valid state is carried forward.        | [`reduceOutputToSnapshotData`](../../../../contracts/V1/StateChannelDiamondProxy/DisputeVerificationFacet.sol), [`getGenesisTimestamp`](../../../../contracts/V1/StateChannelDiamondProxy/StateChannelCommon.sol)                                                                                                                                                              | [`E2E-FinalDispute.test.ts`](../../../../test/e2e/E2E-FinalDispute.test.ts), [`E2E-DisputeManager.test.ts`](../../../../test/e2e/E2E-DisputeManager.test.ts); all-killed-window path: none — gap                                                                                                                                                                                                                                                                  |
| INV-DIS-7  | Design pending | In a fork whose reduction contains any on-chain slashes, timeout removal is not applied — slashes take precedence.                                                                                                                                 | [`reduceOutputToSnapshotData`](../../../../contracts/V1/StateChannelDiamondProxy/DisputeVerificationFacet.sol), `_calculateRemovals`                                                                                                                                                                                                                                           | [`DisputeVerificationFacet.t.sol`](../../../../test/V1/StateChannelDiamondProxy/DisputeVerificationFacet.t.sol) (`slashAndTimeout_ignoresTimeout`, `slashSuppressesTimeout`)                                                                                                                                                                                                                                                                                      |
| INV-DIS-8  | Design pending | A fork applies at most one timeout, targeting the participant at the lowest timed-out block height; no skipping ahead past an earlier missed slot.                                                                                                 | timeout fold in [`DisputeVerificationFacet.reduce`](../../../../contracts/V1/StateChannelDiamondProxy/DisputeVerificationFacet.sol)                                                                                                                                                                                                                                            | [`E2E-Timeouts.test.ts`](../../../../test/e2e/E2E-Timeouts.test.ts); multi-missed-author ordering and empty-timeout divergence (§5): none — gap                                                                                                                                                                                                                                                                                                                   |
| REQ-DIS-9  | Design pending | The on-chain snapshot advances to a successor fork only along committed `reducedResult` links whose challenge periods have expired, verifying genesis identity/timestamp and processing the proven outbound range incrementally.                   | [`StateSnapshotFacet.updateStateSnapshotFork`](../../../../contracts/V1/StateChannelDiamondProxy/StateSnapshotFacet.sol)                                                                                                                                                                                                                                                       | [`E2E-StateSnapshots.test.ts`](../../../../test/e2e/E2E-StateSnapshots.test.ts), [`E2E-MaliciousUpdateSnapshot.test.ts`](../../../../test/e2e/E2E-MaliciousUpdateSnapshot.test.ts); multi-generation adversarial walks: none — gap                                                                                                                                                                                                                                |
| REQ-DIS-10 | Design pending | Timeout claims MUST satisfy the deadline, linkage, schedule, and existence conditions of §6.3; violations are falsifiable via the `Timeout*` dispute fraud proofs and upload race checks.                                                          | [`DisputeManagerFacet._disputeRaceConditionCheck`](../../../../contracts/V1/StateChannelDiamondProxy/DisputeManagerFacet.sol), `Timeout*` handlers in [`DisputeFraudProofFacet`](../../../../contracts/V1/StateChannelDiamondProxy/DisputeFraudProofFacet.sol)                                                                                                                 | [`test/e2e/disputeValidation/disputeInputFields/timeout.test.ts`](../../../../test/e2e/disputeValidation/disputeInputFields/timeout.test.ts), [`E2E-Timeouts.test.ts`](../../../../test/e2e/E2E-Timeouts.test.ts), [`E2E-FirstBlockTimestampGrace.test.ts`](../../../../test/e2e/E2E-FirstBlockTimestampGrace.test.ts), timeout-calldata tests in [`DisputeVerificationFacet.t.sol`](../../../../test/V1/StateChannelDiamondProxy/DisputeVerificationFacet.t.sol) |

Open questions in this document are mirrored in [../open-questions.md](../open-questions.md).
