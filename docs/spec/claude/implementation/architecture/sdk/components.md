...
> **Specification subject:** [specification/architecture/sdk.md](../../../specification/architecture/sdk.md)
...
| [`JoinChannelService`](../../../../../../src/rpc/services/joinChannel/JoinChannelService.ts#L28)                                  | Join-signature collection   | Collects the unanimous `JoinChannelConfirmation` ([../protocol/cross-layer-messages.md](../../../specification/protocol/cross-layer-messages.md)).                                                                                                                                                                                                                             |
...
structs (field-level reference: [../reference/data-types.md](../../../specification/reference/data-types.md)):
...
| ----------------------- | ----------------------------------------------------------------------------------------------------------------- | ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| `REQ-SDK-3`             | Handshake signatures are domain-tagged and cannot collide with block signatures.                                  | Claimed; audit pending | [src/rpc/services/initHandshake/InitHandshakeService.ts](../../../../../../src/rpc/services/initHandshake/InitHandshakeService.ts#L2) (`HANDSHAKE_DOMAIN`) | Engineer audit pending; any divergence named in the evidence remains open. |
| `REQ-SDK-4`             | Only the addressed peer may settle an RPC request; oversized/undecodable frames disconnect.                       | Claimed; audit pending | [src/P2PManager.ts](../../../../../../src/P2PManager.ts#L1) (`handleRpcResponse`, `onRpc`)                                                                 | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-SDK-4`             | `BlockStorage` never overwrites a stored block with a conflicting body; `justPersist` never advances live height. | Claimed; audit pending | [src/storage/BlockStorage.ts](../../../../../../src/storage/BlockStorage.ts#L1)                                                                            | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-SDK-5`             | The event pipeline's processed-block watermark never advances past an incomplete or failed log.                   | Claimed; audit pending | [src/stateManager/EventSyncService.ts](../../../../../../src/stateManager/EventSyncService.ts#L1) (`publishCompletedBlocks`)                               | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-SDK-6`             | Blacklisting is peer-identity-keyed and survives transport replacement.                                           | Claimed; audit pending | [src/ProfileManager.ts](../../../../../../src/ProfileManager.ts#L1), [src/P2PManager.ts](../../../../../../src/P2PManager.ts#L1)                           | Engineer audit pending; any divergence named in the evidence remains open. |
