...
> **Specification subject:** [specification/protocol/block-processing.md](../../../specification/protocol/block-processing.md)
...
> Protocol-level rationale: [../protocol/finality.md](../../../specification/protocol/finality.md),
> [../protocol/time.md](../../../specification/protocol/time.md),
> [../protocol/fraud-proofs.md](../../../specification/protocol/fraud-proofs.md).
...
protocol time model is specified in [../protocol/time.md](../../../specification/protocol/time.md).
...
3. **Forged inbound blocks.** Each carried inbound block must exist locally or
   ...
   [../protocol/cross-layer-messages.md](../../../specification/protocol/cross-layer-messages.md).
...
6. **Snapshot construction.** [`createStateSnapshot`](../../../../../../src/stateManager/StateManager.ts#L1118)
   ...
   hierarchy: [../concepts/history-and-commitments.md](../../../specification/concepts/history-and-commitments.md)).
...
3. **Sign if appropriate** (never under `DisputeValidationStrategy`):
   ...
   time the post granted us ([../protocol/time.md](../../../specification/protocol/time.md)).
   Signing is the non-equivocating vote of
   [../protocol/finality.md](../../../specification/protocol/finality.md).
...
([../protocol/state-proofs.md](../../../specification/protocol/state-proofs.md)). When no milestone
...
| -------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `INV-BCP-1.T1` | `INV-BCP-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Validation/execution serialized under the StateManager mutex.                                                                                                                                                                                                                                                  | `INV-BCP-1.T1.P1` — valid case and direct invalid/opposite<br>`INV-BCP-1.T1.P2` — zero/empty/no-op where meaningful, exact boundary, failure/recovery and relevant race                                                                                                                                                                               |
| `INV-BCP-2.T1` | `INV-BCP-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Failed validation restores the VM to its pre-transition state.                                                                                                                                                                                                                                                 | `INV-BCP-2.T1.P1` — valid case and direct invalid/opposite<br>`INV-BCP-2.T1.P2` — malformed and adversarial input, partial failure, retry and recovery                                                                                                                                                                                                |
| `INV-BCP-3.T1` | `INV-BCP-3`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | In-order execution; future blocks parked.                                                                                                                                                                                                                                                                      | `INV-BCP-3.T1.P1` — valid case and direct invalid/opposite<br>`INV-BCP-3.T1.P2` — duplicate/replay, every relevant permutation and concurrent delivery                                                                                                                                                                                                |
| `INV-BCP-4.T1` | `INV-BCP-4`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Monotone, attributed, capped signature/source merging; fixed entry lifetime.                                                                                                                                                                                                                                   | `INV-BCP-4.T1.P1` — valid case and direct invalid/opposite<br>`INV-BCP-4.T1.P2` — correct/wrong/missing/duplicate/forged identity or signature and membership boundary<br>`INV-BCP-4.T1.P3` — before/at/after deadline and maximum honest skew<br>`INV-BCP-4.T1.P4` — duplicate/replay, every relevant permutation and concurrent delivery            |
| `INV-BCP-5.T1` | `INV-BCP-5`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Persist before gossip.                                                                                                                                                                                                                                                                                         | `INV-BCP-5.T1.P1` — valid case and direct invalid/opposite<br>`INV-BCP-5.T1.P2` — zero/empty/no-op where meaningful, exact boundary, failure/recovery and relevant race                                                                                                                                                                               |
| `INV-BCP-6.T1` | `INV-BCP-6`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Every live `DISPUTE` outcome stores a fraud proof before disputing.                                                                                                                                                                                                                                            | `INV-BCP-6.T1.P1` — valid case and direct invalid/opposite<br>`INV-BCP-6.T1.P2` — malformed and adversarial input, partial failure, retry and recovery                                                                                                                                                                                                |
| `INV-BCP-7.T1` | `INV-BCP-7`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Subjective lateness never produces a proof or slash.                                                                                                                                                                                                                                                           | `INV-BCP-7.T1.P1` — valid case and direct invalid/opposite<br>`INV-BCP-7.T1.P2` — new/existing/removed/slashed participant and concurrent membership change                                                                                                                                                                                           |
| `REQ-BCP-1.T1` | `REQ-BCP-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Both input paths (peer RPC and chain calldata) converge on one ingest with source attribution / on-chain timestamp respectively.                                                                                                                                                                               | `REQ-BCP-1.T1.P1` — valid case and direct invalid/opposite<br>`REQ-BCP-1.T1.P2` — correct/wrong/missing/duplicate/forged identity or signature and membership boundary<br>`REQ-BCP-1.T1.P3` — before/at/after deadline and maximum honest skew                                                                                                        |
| `REQ-BCP-2.T1` | `REQ-BCP-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Objective timestamp rule is evaluated by the canonical Solidity predicate over the exact proof struct.                                                                                                                                                                                                         | `REQ-BCP-2.T1.P1` — valid case and direct invalid/opposite<br>`REQ-BCP-2.T1.P2` — before/at/after deadline and maximum honest skew<br>`REQ-BCP-2.T1.P3` — static review of every named alternative, omitted category and changed assumption                                                                                                           |
| `REQ-BCP-3.T1` | `REQ-BCP-3`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Non-state-mutating intake and merge (older/future/duplicate blocks, late signatures) never require the state-transition mutex; merge rules are deterministic, idempotent, and resource-capped per entry.                                                                                                       | `REQ-BCP-3.T1.P1` — valid case and direct invalid/opposite<br>`REQ-BCP-3.T1.P2` — correct/wrong/missing/duplicate/forged identity or signature and membership boundary<br>`REQ-BCP-3.T1.P3` — duplicate/replay, every relevant permutation and concurrent delivery                                                                                    |
| `REQ-BCP-4.T1` | `REQ-BCP-4`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | State application is total-order by `(forkId, height)` — at most one block in execution; same-coordinate competing bodies coexist in the queue, the first validated body wins locally (decided 2026-08-10), and the conflict is surfaced via validation/fraud-proof/drop paths, never hidden by arrival order. | `REQ-BCP-4.T1.P1` — valid case and direct invalid/opposite<br>`REQ-BCP-4.T1.P2` — matching/mismatched commitment, predecessor/genesis, stale and foreign fork<br>`REQ-BCP-4.T1.P3` — duplicate/replay, every relevant permutation and concurrent delivery<br>`REQ-BCP-4.T1.P4` — malformed and adversarial input, partial failure, retry and recovery |
...
| ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------- |
| `INV-BCP-1`             | Validation/execution serialized under the StateManager mutex.                                                                                                                                                                                                                                                  | Claimed; audit pending | [src/stateManager/StateManager.ts](../../../../../../src/stateManager/StateManager.ts#L1) (`onBlockConfirmation`, `playTransaction`, `withMutex`)                                                                                                                              | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-BCP-2`             | Failed validation restores the VM to its pre-transition state.                                                                                                                                                                                                                                                 | Claimed; audit pending | `onBlockConfirmation` finally-block + `restoreStateAfterFailedValidation`                                                                                                                                                                                                      | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-BCP-3`             | In-order execution; future blocks parked.                                                                                                                                                                                                                                                                      | Claimed; audit pending | [src/stateManager/BlockQueueManager.ts](../../../../../../src/stateManager/BlockQueueManager.ts#L48) (`tryDequeuePriority`), [src/stateManager/ValidationService.ts](../../../../../../src/stateManager/ValidationService.ts#L15) gate #6                                      | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-BCP-4`             | Monotone, attributed, capped signature/source merging; fixed entry lifetime.                                                                                                                                                                                                                                   | Claimed; audit pending | [src/storage/QueueStorage.ts](../../../../../../src/storage/QueueStorage.ts#L1), [BlockQueueManager.scheduleQueueTimeout](../../../../../../src/stateManager/BlockQueueManager.ts#L153)                                                                                        | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-BCP-5`             | Persist before gossip.                                                                                                                                                                                                                                                                                         | Claimed; audit pending | `success()` step order, `tryMergeStoredBlockConfirmation`                                                                                                                                                                                                                      | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-BCP-6`             | Every live `DISPUTE` outcome stores a fraud proof before disputing.                                                                                                                                                                                                                                            | Claimed; audit pending | [src/stateManager/validationStrategy/BlockValidationStrategy.ts](../../../../../../src/stateManager/validationStrategy/BlockValidationStrategy.ts#L1), [src/stateManager/utils/FraudProofService.ts](../../../../../../src/stateManager/utils/FraudProofService.ts#L16)        | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-BCP-7`             | Subjective lateness never produces a proof or slash.                                                                                                                                                                                                                                                           | Claimed; audit pending | [src/stateManager/ValidationService.ts](../../../../../../src/stateManager/ValidationService.ts#L15) (`NOT_ENOUGH_TIME` path)                                                                                                                                                  | Engineer audit pending; any divergence named in the evidence remains open. |
| `REQ-BCP-1`             | Both input paths (peer RPC and chain calldata) converge on one ingest with source attribution / on-chain timestamp respectively.                                                                                                                                                                               | Claimed; audit pending | [src/rpc/services/stateTransition](../../../../../../src/rpc/services/stateTransition), [src/eventHandlers/EventHandler.ts](../../../../../../src/eventHandlers/EventHandler.ts#L1) (`onBlockCalldataPosted`)                                                                  | Engineer audit pending; any divergence named in the evidence remains open. |
| `REQ-BCP-2`             | Objective timestamp rule is evaluated by the canonical Solidity predicate over the exact proof struct.                                                                                                                                                                                                         | Claimed; audit pending | [src/stateManager/ValidationService.ts](../../../../../../src/stateManager/ValidationService.ts#L15) (`hasInvalidTimestamp.staticCall`)                                                                                                                                        | Engineer audit pending; any divergence named in the evidence remains open. |
| `REQ-BCP-3`             | Non-state-mutating intake and merge (older/future/duplicate blocks, late signatures) never require the state-transition mutex; merge rules are deterministic, idempotent, and resource-capped per entry.                                                                                                       | Claimed; audit pending | [BlockQueueManager](../../../../../../src/stateManager/BlockQueueManager.ts#L31) (scheduled tasks), [QueueStorage](../../../../../../src/storage/QueueStorage.ts#L26), [StateManager.tryMergeStoredBlockConfirmation](../../../../../../src/stateManager/StateManager.ts#L769) | Engineer audit pending; any divergence named in the evidence remains open. |
| `REQ-BCP-4`             | State application is total-order by `(forkId, height)` — at most one block in execution; same-coordinate competing bodies coexist in the queue, the first validated body wins locally (decided 2026-08-10), and the conflict is surfaced via validation/fraud-proof/drop paths, never hidden by arrival order. | Claimed; audit pending | mutex sites in [StateManager](../../../../../../src/stateManager/StateManager.ts#L107) (`onBlockConfirmation`, `playTransaction`, `setLatestState`); ordering in [BlockQueueManager.tryExecuteFromQueue](../../../../../../src/stateManager/BlockQueueManager.ts#L244)         | Engineer audit pending; any divergence named in the evidence remains open. |
