...
protocol-level property ([../../protocol/finality.md](../../../../specification/protocol/finality.md)), not fixable
at this ingress.
...
| -------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `REQ-STS-1.T1` | `REQ-STS-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | `onBlockConfirmation` delegates all payload judgment to `ingestBlockConfirmation`, passing the handshake-verified sender address for attribution; the RPC layer performs no payload validation of its own. | `REQ-STS-1.T1.P1` — valid case and direct invalid/opposite<br>`REQ-STS-1.T1.P2` — zero/empty/no-op where meaningful, exact boundary, failure/recovery and relevant race |
| `REQ-STS-2.T1` | `REQ-STS-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | A `false` keep-connection verdict disconnects and blacklists the sender by EVM address; `true` has no RPC-layer side effect.                                                                               | `REQ-STS-2.T1.P1` — valid case and direct invalid/opposite<br>`REQ-STS-2.T1.P2` — zero/empty/no-op where meaningful, exact boundary, failure/recovery and relevant race |
| `INV-STS-1.T1` | `INV-STS-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Handler holds no mutex and mutates no live state inline.                                                                                                                                                   | `INV-STS-1.T1.P1` — valid case and direct invalid/opposite<br>`INV-STS-1.T1.P2` — zero/empty/no-op where meaningful, exact boundary, failure/recovery and relevant race |
| `INV-STS-2.T1` | `INV-STS-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Peer-RPC ingest is always source-attributed.                                                                                                                                                               | `INV-STS-2.T1.P1` — valid case and direct invalid/opposite<br>`INV-STS-2.T1.P2` — correct/wrong/missing/duplicate/forged identity or signature and membership boundary  |
| `INV-STS-3.T1` | `INV-STS-3`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Verdict-to-penalty mapping as stated.                                                                                                                                                                      | `INV-STS-3.T1.P1` — valid case and direct invalid/opposite<br>`INV-STS-3.T1.P2` — static review of every named alternative, omitted category and changed assumption     |
...
| ----------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| `REQ-STS-1`             | `onBlockConfirmation` delegates all payload judgment to `ingestBlockConfirmation`, passing the handshake-verified sender address for attribution; the RPC layer performs no payload validation of its own. | Claimed; audit pending | [src/rpc/services/stateTransition/StateTransitionRpcMethods.ts](../../../../../../../src/rpc/services/stateTransition/StateTransitionRpcMethods.ts#L1), [src/stateManager/BlockQueueManager.ts](../../../../../../../src/stateManager/BlockQueueManager.ts#L48) | Engineer audit pending; any divergence named in the evidence remains open. |
| `REQ-STS-2`             | A `false` keep-connection verdict disconnects and blacklists the sender by EVM address; `true` has no RPC-layer side effect.                                                                               | Claimed; audit pending | [src/rpc/services/stateTransition/StateTransitionRpcMethods.ts](../../../../../../../src/rpc/services/stateTransition/StateTransitionRpcMethods.ts#L1)                                                                                                          | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-STS-1`             | Handler holds no mutex and mutates no live state inline.                                                                                                                                                   | Claimed; audit pending | [src/rpc/services/stateTransition](../../../../../../../src/rpc/services/stateTransition), pipeline mutex sites in [src/stateManager/StateManager.ts](../../../../../../../src/stateManager/StateManager.ts#L1)                                                 | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-STS-2`             | Peer-RPC ingest is always source-attributed.                                                                                                                                                               | Claimed; audit pending | [src/rpc/services/stateTransition/StateTransitionRpcMethods.ts](../../../../../../../src/rpc/services/stateTransition/StateTransitionRpcMethods.ts#L1)                                                                                                          | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-STS-3`             | Verdict-to-penalty mapping as stated.                                                                                                                                                                      | Claimed; audit pending | [src/rpc/services/stateTransition/StateTransitionRpcMethods.ts](../../../../../../../src/rpc/services/stateTransition/StateTransitionRpcMethods.ts#L1)                                                                                                          | Engineer audit pending; any divergence named in the evidence remains open. |
