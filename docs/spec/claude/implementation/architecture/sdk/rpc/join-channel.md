...
> flow ([../../protocol/cross-layer-messages.md](../../../../specification/protocol/cross-layer-messages.md) §4) — it
...
outcomes), [../../protocol/cross-layer-messages.md](../../../../specification/protocol/cross-layer-messages.md) §4
...
([../../protocol/cross-layer-messages.md](../../../../specification/protocol/cross-layer-messages.md) §4, REQ-MSG-10).
...
([../../protocol/cross-layer-messages.md](../../../../specification/protocol/cross-layer-messages.md) §4). **Open
...
not consent** ([../../protocol/cross-layer-messages.md](../../../../specification/protocol/cross-layer-messages.md)
§4.2; OQ-10).
...
| -------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `INV-JCS-1.T1` | `INV-JCS-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Responder signs only when signer == participant == authenticated peer.                                                                                   | `INV-JCS-1.T1.P1` — valid case and direct invalid/opposite<br>`INV-JCS-1.T1.P2` — correct/wrong/missing/duplicate/forged identity or signature and membership boundary                                                                                                                                                                                                                                                                             |
| `INV-JCS-2.T1` | `INV-JCS-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Responder signs only a join pinned to its current snapshot/fork with local signer in threshold.                                                          | `INV-JCS-2.T1.P1` — valid case and direct invalid/opposite<br>`INV-JCS-2.T1.P2` — matching/mismatched commitment, predecessor/genesis, stale and foreign fork<br>`INV-JCS-2.T1.P3` — correct/wrong/missing/duplicate/forged identity or signature and membership boundary<br>`INV-JCS-2.T1.P4` — new/existing/removed/slashed participant and concurrent membership change                                                                         |
| `INV-JCS-3.T1` | `INV-JCS-3`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Collector requires each signature to recover to its addressed participant; one failure fails unanimity.                                                  | `INV-JCS-3.T1.P1` — valid case and direct invalid/opposite<br>`INV-JCS-3.T1.P2` — correct/wrong/missing/duplicate/forged identity or signature and membership boundary<br>`INV-JCS-3.T1.P3` — malformed and adversarial input, partial failure, retry and recovery                                                                                                                                                                                 |
| `INV-JCS-4.T1` | `INV-JCS-4`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Collector runs only for the local node's own participant identity.                                                                                       | `INV-JCS-4.T1.P1` — valid case and direct invalid/opposite<br>`INV-JCS-4.T1.P2` — correct/wrong/missing/duplicate/forged identity or signature and membership boundary                                                                                                                                                                                                                                                                             |
| `INV-JCS-5.T1` | `INV-JCS-5`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Service is stateless across calls; decisions from args + live reads.                                                                                     | `INV-JCS-5.T1.P1` — valid case and direct invalid/opposite<br>`INV-JCS-5.T1.P2` — zero/empty/no-op where meaningful, exact boundary, failure/recovery and relevant race                                                                                                                                                                                                                                                                            |
| `REQ-JCS-1.T1` | `REQ-JCS-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | `requestJoinSignature` MUST run the full decode + identity + channel + deadline + fork + snapshot + threshold chain before signing (REQ-RPC-2 instance). | `REQ-JCS-1.T1.P1` — valid case and direct invalid/opposite<br>`REQ-JCS-1.T1.P2` — matching/mismatched commitment, predecessor/genesis, stale and foreign fork<br>`REQ-JCS-1.T1.P3` — correct/wrong/missing/duplicate/forged identity or signature and membership boundary<br>`REQ-JCS-1.T1.P4` — before/at/after deadline and maximum honest skew<br>`REQ-JCS-1.T1.P5` — new/existing/removed/slashed participant and concurrent membership change |
| `REQ-JCS-2.T1` | `REQ-JCS-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Admission MUST be gated by an explicit consent/authorization decision, not auto-sign.                                                                    | `REQ-JCS-2.T1.P1` — valid case and direct invalid/opposite<br>`REQ-JCS-2.T1.P2` — correct/wrong/missing/duplicate/forged identity or signature and membership boundary                                                                                                                                                                                                                                                                             |
| `REQ-JCS-3.T1` | `REQ-JCS-3`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | `requestJoinSignature` failure outcomes MUST conform to a decided failure-outcome policy and be resource-bounded per peer.                               | `REQ-JCS-3.T1.P1` — valid case and direct invalid/opposite<br>`REQ-JCS-3.T1.P2` — correct/wrong/missing/duplicate/forged identity or signature and membership boundary<br>`REQ-JCS-3.T1.P3` — new/existing/removed/slashed participant and concurrent membership change<br>`REQ-JCS-3.T1.P4` — malformed and adversarial input, partial failure, retry and recovery                                                                                |
...
| ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| `INV-JCS-1`             | Responder signs only when signer == participant == authenticated peer.                                                                                   | Claimed; audit pending | [JoinChannelService.signJoinRequest](../../../../../../../src/rpc/services/joinChannel/JoinChannelService.ts#L137)                                                                                                         | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-JCS-2`             | Responder signs only a join pinned to its current snapshot/fork with local signer in threshold.                                                          | Claimed; audit pending | [JoinChannelService.signJoinRequest](../../../../../../../src/rpc/services/joinChannel/JoinChannelService.ts#L137); [JoinChannelFacet](../../../../../../../contracts/V1/StateChannelDiamondProxy/JoinChannelFacet.sol#L8) | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-JCS-3`             | Collector requires each signature to recover to its addressed participant; one failure fails unanimity.                                                  | Claimed; audit pending | [JoinChannelService.collectJoinChannelConfirmation](../../../../../../../src/rpc/services/joinChannel/JoinChannelService.ts#L43)                                                                                           | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-JCS-4`             | Collector runs only for the local node's own participant identity.                                                                                       | Claimed; audit pending | [JoinChannelService.collectJoinChannelConfirmation](../../../../../../../src/rpc/services/joinChannel/JoinChannelService.ts#L43)                                                                                           | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-JCS-5`             | Service is stateless across calls; decisions from args + live reads.                                                                                     | Claimed; audit pending | [JoinChannelService](../../../../../../../src/rpc/services/joinChannel/JoinChannelService.ts#L28)                                                                                                                          | Engineer audit pending; any divergence named in the evidence remains open. |
| `REQ-JCS-1`             | `requestJoinSignature` MUST run the full decode + identity + channel + deadline + fork + snapshot + threshold chain before signing (REQ-RPC-2 instance). | Claimed; audit pending | [JoinChannelService.signJoinRequest](../../../../../../../src/rpc/services/joinChannel/JoinChannelService.ts#L137)                                                                                                         | Engineer audit pending; any divergence named in the evidence remains open. |
...
| `REQ-JCS-3`             | `requestJoinSignature` failure outcomes MUST conform to a decided failure-outcome policy and be resource-bounded per peer.                               | Partial or divergent   | penalty-free error today ([./README.md](./README.md) §8); no rate limit                                                                                                                                                    | Engineer audit pending; any divergence named in the evidence remains open. |
