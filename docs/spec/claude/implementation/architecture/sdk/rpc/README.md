...
- Timeouts are denominated in `timeConfig.agreementTime`, read from the chain
  ([../protocol/time.md](../../../../specification/protocol/time.md)); clock quality per
...
| --- | --- | --- | --- | --- |
| `REQ-RPC-1` | Only deliberately public methods live on `RpcMethods` classes; private helpers and mutable service state are never exposed through them. | Claimed; audit pending | [src/rpc/ARpcMethods.ts](../../../../../../../src/rpc/ARpcMethods.ts#L1), [src/rpc/services](../../../../../../../src/rpc/services) | Engineer audit pending; any divergence named in the evidence remains open. |
| `REQ-RPC-2` | Every endpoint decodes and semantically validates its payload before any state effect; decode failure is a handled protocol failure. | Claimed; audit pending | [src/rpc/services](../../../../../../../src/rpc/services) (per-endpoint) | Engineer audit pending; any divergence named in the evidence remains open. |
| `REQ-RPC-3` | Custom roots extend the boundary only through the service/RpcMethods pattern via manifest + registry. | Claimed; audit pending | [src/rpc/registry.ts](../../../../../../../src/rpc/registry.ts#L2), [src/rpc/resolveCustomRpcManifest.ts](../../../../../../../src/rpc/resolveCustomRpcManifest.ts#L1), [src/P2PManager.ts](../../../../../../../src/P2PManager.ts#L1) | Engineer audit pending; any divergence named in the evidence remains open. |
| `REQ-RPC-4` | Bigints cross the boundary only as canonical Codec encodings; raw `BigInt` throws at the sender. | Claimed; audit pending | [src/rpc/Rpc.ts](../../../../../../../src/rpc/Rpc.ts#L38) (`serializeRpc`), [src/utils/Codec.ts](../../../../../../../src/utils/Codec.ts#L1) | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-RPC-4` | Same mechanism, stated as an invariant of the wire: no raw `BigInt` ever appears in an envelope. | Claimed; audit pending | [src/rpc/Rpc.ts](../../../../../../../src/rpc/Rpc.ts#L38) | Engineer audit pending; any divergence named in the evidence remains open. |
| `REQ-RPC-5` | Caller-scoped admission preconditions are expressed as explicit guards with documented ordering, trusted-transport behavior, and rejection consequence. | Claimed; audit pending | [src/rpc/guards](../../../../../../../src/rpc/guards) | Engineer audit pending; any divergence named in the evidence remains open. |
| `REQ-RPC-6` | Every endpoint is idempotent under re-delivery or replay-rejecting with a defined consequence. | Claimed; audit pending | [src/rpc/services](../../../../../../../src/rpc/services), [src/stateManager/BlockQueueManager.ts](../../../../../../../src/stateManager/BlockQueueManager.ts#L48) | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-RPC-1` | Dispatch order: size cap → envelope → service → guards → method, before any handler runs. | Claimed; audit pending | [src/P2PManager.ts](../../../../../../../src/P2PManager.ts#L1) (`onRpc`), [src/rpc/ARpcService.ts](../../../../../../../src/rpc/ARpcService.ts#L7) (`runRPC`) | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-RPC-2` | Only the addressed peer settles a request; other responders are blacklisted. | Claimed; audit pending | [src/P2PManager.ts](../../../../../../../src/P2PManager.ts#L1) (`handleRpcResponse`) | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-RPC-3` | Guard bypass only for the trusted in-process loopback. | Claimed; audit pending | [src/transport/ATransport.ts](../../../../../../../src/transport/ATransport.ts#L23), [src/transport/LoopbackTransport.ts](../../../../../../../src/transport/LoopbackTransport.ts#L6), [src/rpc/ARpcService.ts](../../../../../../../src/rpc/ARpcService.ts#L7) | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-RPC-5` | RPC handlers never hold the state mutex; mutation goes through the pipeline's entry points. | Claimed; audit pending | [src/rpc](../../../../../../../src/rpc), [src/stateManager/StateManager.ts](../../../../../../../src/stateManager/StateManager.ts#L1) | Engineer audit pending; any divergence named in the evidence remains open. |
