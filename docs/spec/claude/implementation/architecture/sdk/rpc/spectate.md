...
> ([../../protocol/cross-layer-messages.md](../../../../specification/protocol/cross-layer-messages.md) §3) rather than
> restating them.
> **ID prefix:** `SPC` (`INV-SPC-n`, `REQ-SPC-n`).

Related: [./README.md](./README.md) (dispatch, guards, delivery modes, failure outcomes,
one-in-flight-per-peer replay rule), [../../protocol/cross-layer-messages.md](../../../../specification/protocol/cross-layer-messages.md)
...
([../../protocol/cross-layer-messages.md](../../../../specification/protocol/cross-layer-messages.md) §3.1). A
...
[../../protocol/cross-layer-messages.md](../../../../specification/protocol/cross-layer-messages.md) §3.2):
...
REQ-MSG-9 ([../../protocol/cross-layer-messages.md](../../../../specification/protocol/cross-layer-messages.md) §3.2).
...
- A snapshot whose in-channel balances exceed deposits minus withdrawals fails
  ...
  [../../protocol/cross-layer-messages.md](../../../../specification/protocol/cross-layer-messages.md) §6.1 and
...
([../../protocol/cross-layer-messages.md](../../../../specification/protocol/cross-layer-messages.md) §2.3/§6.3, OQ-19):
...
([../../protocol/cross-layer-messages.md](../../../../specification/protocol/cross-layer-messages.md) §3.1). The payload
...
- Resolve the spectate-simulation consumer-side-effect stubbing so the step-12 multicall simulation
  ...
  ([../../protocol/cross-layer-messages.md](../../../../specification/protocol/cross-layer-messages.md) §3.2 TODO).

## Implementation traceability

| Requirement / invariant | Statement                                                                                                                                 | Implementation status  | Implementation evidence                                                                                                                                                                                                                                                            | Gap / divergence                                                           |
| ----------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| `INV-SPC-1`             | Served payload re-verified against on-chain truth + contract logic before any state effect.                                               | Claimed; audit pending | [SpectateService.applySyncResponse](../../../../../../../src/rpc/services/spectate/SpectateService.ts#L96)                                                                                                                                                                         | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-SPC-2`             | Payload validated against the requester's own request, not the peer's echo.                                                               | Claimed; audit pending | [SpectateService.sync / applySyncResponse](../../../../../../../src/rpc/services/spectate/SpectateService.ts#L35)                                                                                                                                                                  | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-SPC-3`             | One in-flight sync per peer, cleaned in `finally`.                                                                                        | Claimed; audit pending | [SpectateService.sync](../../../../../../../src/rpc/services/spectate/SpectateService.ts#L35)                                                                                                                                                                                      | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-SPC-4`             | Fail-closed: any failure aborts with no partial commitment (REQ-MSG-9).                                                                   | Claimed; audit pending | [SpectateService.abort](../../../../../../../src/rpc/services/spectate/SpectateService.ts#L97); [SpectatingValidationStrategy](../../../../../../../src/stateManager/validationStrategy/SpectatingValidationStrategy.ts#L21)                                                       | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-SPC-5`             | Adopted finalized snapshot satisfies the balance invariant (INV-MSG-6) client-side.                                                       | Claimed; audit pending | [SpectateService.applySyncResponse](../../../../../../../src/rpc/services/spectate/SpectateService.ts#L96) (step 11); [DisputeVerificationFacet.verifyBalanceInvariantCheckSnapshot](../../../../../../../contracts/V1/StateChannelDiamondProxy/DisputeVerificationFacet.sol#L464) | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-SPC-6`             | No sync step sends a transaction; verification via local EVM / `staticCall`.                                                              | Claimed; audit pending | [SpectateService](../../../../../../../src/rpc/services/spectate/SpectateService.ts#L34)                                                                                                                                                                                           | Engineer audit pending; any divergence named in the evidence remains open. |
| `REQ-SPC-1`             | The responder MUST return `undefined` (not a substituted proof) for any target it cannot prove exactly, including an above-latest height. | Claimed; audit pending | [SpectateService.generateSyncPayload](../../../../../../../src/rpc/services/spectate/SpectateService.ts#L448)                                                                                                                                                                      | Engineer audit pending; any divergence named in the evidence remains open. |
