...
The documented architecture is intended to implement [the neutral subject](../../specification/architecture/rpc.md). Existing design reports cover the major mechanisms and failure paths.
