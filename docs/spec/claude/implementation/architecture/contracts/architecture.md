...
| -------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `REQ-CON-1.T1` | `REQ-CON-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Every mainnet-deployable contract MUST have deployed bytecode ≤ 24,576 bytes (EIP-170) and initcode ≤ 49,152 bytes (EIP-3860). `Current:` violated by `StateChannelManagerProxy` (30,959), `DisputeFraudProofFacet` (26,436), `DisputeVerificationFacet` (24,783). | `REQ-CON-1.T1.P1` — valid case and direct invalid/opposite<br>`REQ-CON-1.T1.P2` — malformed and adversarial input, partial failure, retry and recovery                                                                                                      |
| `REQ-CON-2.T1` | `REQ-CON-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Build/deployment MUST verify REQ-CON-1 automatically and fail on violation.                                                                                                                                                                                        | `REQ-CON-2.T1.P1` — valid case and direct invalid/opposite<br>`REQ-CON-2.T1.P2` — malformed and adversarial input, partial failure, retry and recovery                                                                                                      |
| `INV-CON-3.T1` | `INV-CON-3`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Proxy and all facets share exactly one storage layout: facets inherit `StateChannelManagerStorage` and declare no state variables of their own.                                                                                                                    | `INV-CON-3.T1.P1` — valid case and direct invalid/opposite<br>`INV-CON-3.T1.P2` — zero/empty/no-op where meaningful, exact boundary, failure/recovery and relevant race                                                                                     |
| `REQ-CON-4.T1` | `REQ-CON-4`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | `onlySelf` functions (`depositAssetsComposable`, `withdrawAssetsComposable`, `executeStateTransition`, `applyJoinChannelToStateMachine`) MUST revert for any external caller; they are reachable only through the proxy's self-CALL.                               | `REQ-CON-4.T1.P1` — valid case and direct invalid/opposite<br>`REQ-CON-4.T1.P2` — zero, exact balance/boundary, one beyond, maximum value and conservation<br>`REQ-CON-4.T1.P3` — new/existing/removed/slashed participant and concurrent membership change |
...
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| `REQ-CON-1`             | Every mainnet-deployable contract MUST have deployed bytecode ≤ 24,576 bytes (EIP-170) and initcode ≤ 49,152 bytes (EIP-3860). `Current:` violated by `StateChannelManagerProxy` (30,959), `DisputeFraudProofFacet` (26,436), `DisputeVerificationFacet` (24,783). | Claimed; audit pending | [contracts/V1/StateChannelDiamondProxy](../../../../../../contracts/V1/StateChannelDiamondProxy) (all deployables)                                                                                                                                                                                                                                                                                                                                                                                       | Engineer audit pending; any divergence named in the evidence remains open. |
...
| `INV-CON-3`             | Proxy and all facets share exactly one storage layout: facets inherit `StateChannelManagerStorage` and declare no state variables of their own.                                                                                                                    | Claimed; audit pending | [StateChannelManagerStorage.sol](../../../../../../contracts/V1/StateChannelDiamondProxy/StateChannelManagerStorage.sol#L3); all facets via [StateChannelCommon.sol](../../../../../../contracts/V1/StateChannelDiamondProxy/StateChannelCommon.sol#L3)                                                                                                                                                                                                                                                  | Engineer audit pending; any divergence named in the evidence remains open. |
| `REQ-CON-4`             | `onlySelf` functions (`depositAssetsComposable`, `withdrawAssetsComposable`, `executeStateTransition`, `applyJoinChannelToStateMachine`) MUST revert for any external caller; they are reachable only through the proxy's self-CALL.                               | Claimed; audit pending | [StateChannelManagerStorage.sol](../../../../../../contracts/V1/StateChannelDiamondProxy/StateChannelManagerStorage.sol#L3) (`onlySelf` modifier); call sites in [StateChannelManagerProxy.sol](../../../../../../contracts/V1/StateChannelDiamondProxy/StateChannelManagerProxy.sol#L3), [JoinChannelFacet.sol](../../../../../../contracts/V1/StateChannelDiamondProxy/JoinChannelFacet.sol#L3), [FraudProofFacet.sol](../../../../../../contracts/V1/StateChannelDiamondProxy/FraudProofFacet.sol#L3) | Engineer audit pending; any divergence named in the evidence remains open. |
