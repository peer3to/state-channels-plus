...
The external interface declaration of the manager surface.

## Key design decisions

1. **Interface = the stable boundary** wrappers must keep satisfying through the refactor.
...
| ------------------------------------------------------------------------------------------------------ | ----------------- |
| [StateChannelManagerInterface.sol](../../../../../../../contracts/V1/StateChannelManagerInterface.sol) |                   |
