...
| ----------------------------------------------------------------- | ---------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="unit-test-manager-proxy-1"></a>`UNIT-TEST-MANAGER-PROXY-1` | Opening and calldata posting | Open with valid/dup/zero ids, unanimous and short signatures, atomic and partial deposits; post calldata within/after the window, as non-author, and twice | Only valid unanimous opens store genesis; posting guards enforce author/no-overwrite/deadline; DEF-1 cases documented | <a id="unit-test-manager-proxy-1.p1"></a>`UNIT-TEST-MANAGER-PROXY-1.P1` — valid open; <a id="unit-test-manager-proxy-1.p2"></a>`UNIT-TEST-MANAGER-PROXY-1.P2` — duplicate/zero channel; <a id="unit-test-manager-proxy-1.p3"></a>`UNIT-TEST-MANAGER-PROXY-1.P3` — short threshold; <a id="unit-test-manager-proxy-1.p4"></a>`UNIT-TEST-MANAGER-PROXY-1.P4` — atomic vs partial deposits; <a id="unit-test-manager-proxy-1.p5"></a>`UNIT-TEST-MANAGER-PROXY-1.P5` — posting guards each; <a id="unit-test-manager-proxy-1.p6"></a>`UNIT-TEST-MANAGER-PROXY-1.P6` — DEF-1 length/zero-address (documents finding) |
| <a id="unit-test-manager-proxy-2"></a>`UNIT-TEST-MANAGER-PROXY-2` | Routing confinement          | Call each wrapper, each onlySelf op directly and via composition, and multicall compositions with a failing leg                                            | Wrappers route to one state; direct internal calls revert; multicall is all-or-nothing                                | <a id="unit-test-manager-proxy-2.p1"></a>`UNIT-TEST-MANAGER-PROXY-2.P1` — wrapper routing per group; <a id="unit-test-manager-proxy-2.p2"></a>`UNIT-TEST-MANAGER-PROXY-2.P2` — onlySelf direct revert; <a id="unit-test-manager-proxy-2.p3"></a>`UNIT-TEST-MANAGER-PROXY-2.P3` — multicall bubbling                                                                                                                                                                                                                                                                                                             |
