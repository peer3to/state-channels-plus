...
| --------------------------------------------------------------------------- | --------------- | ---------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="unit-test-join-channel-facet-1"></a>`UNIT-TEST-JOIN-CHANNEL-FACET-1` | Admission gates | Join/top-up under every gate violation and the valid paths | Only correctly pinned, signed, membership-correct submissions append; each violation reverts with its error | <a id="unit-test-join-channel-facet-1.p1"></a>`UNIT-TEST-JOIN-CHANNEL-FACET-1.P1` — zero-channel-id revert; <a id="unit-test-join-channel-facet-1.p2"></a>`UNIT-TEST-JOIN-CHANNEL-FACET-1.P2` — valid join; <a id="unit-test-join-channel-facet-1.p3"></a>`UNIT-TEST-JOIN-CHANNEL-FACET-1.P3` — valid top-up; <a id="unit-test-join-channel-facet-1.p4"></a>`UNIT-TEST-JOIN-CHANNEL-FACET-1.P4` — fork-pin race; <a id="unit-test-join-channel-facet-1.p5"></a>`UNIT-TEST-JOIN-CHANNEL-FACET-1.P5` — disputed-fork join; <a id="unit-test-join-channel-facet-1.p6"></a>`UNIT-TEST-JOIN-CHANNEL-FACET-1.P6` — wrong-submitter revert; <a id="unit-test-join-channel-facet-1.p7"></a>`UNIT-TEST-JOIN-CHANNEL-FACET-1.P7` — expired-deadline revert; <a id="unit-test-join-channel-facet-1.p8"></a>`UNIT-TEST-JOIN-CHANNEL-FACET-1.P8` — join existing-participant revert; <a id="unit-test-join-channel-facet-1.p9"></a>`UNIT-TEST-JOIN-CHANNEL-FACET-1.P9` — top-up unknown-participant revert; <a id="unit-test-join-channel-facet-1.p10"></a>`UNIT-TEST-JOIN-CHANNEL-FACET-1.P10` — participant-signature revert; <a id="unit-test-join-channel-facet-1.p11"></a>`UNIT-TEST-JOIN-CHANNEL-FACET-1.P11` — threshold-shortfall revert; <a id="unit-test-join-channel-facet-1.p12"></a>`UNIT-TEST-JOIN-CHANNEL-FACET-1.P12` — snapshot-pin race |
