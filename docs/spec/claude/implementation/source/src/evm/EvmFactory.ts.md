...
Constructs the local EVM instance (with custom precompiles) for the mirror deployment.
...
| ----------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| [EvmFactory.ts](../../../../../../../src/evm/EvmFactory.ts) | [`REQ-RUNTIME-4-B0N70Y`](../../../../specification/runtime/execution.md#req-runtime-4-b0n70y) |
