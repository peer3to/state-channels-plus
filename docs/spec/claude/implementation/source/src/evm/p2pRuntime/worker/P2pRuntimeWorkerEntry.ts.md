# P2pRuntimeWorkerEntry.ts — Source Report

> **Source:** [src/evm/p2pRuntime/worker/P2pRuntimeWorkerEntry.ts](../../../../../../../../../src/evm/p2pRuntime/worker/P2pRuntimeWorkerEntry.ts) > **Status:** Authored — engineer verification pending.
...
Worker entry: constructs the host inside the worker and binds the port.
