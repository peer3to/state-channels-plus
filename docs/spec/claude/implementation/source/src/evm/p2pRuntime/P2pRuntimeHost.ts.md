...
1. **The host signs; the client never holds the key** — signing authority stays in one trusted context ([`REQ-ID-3`](../../../../../specification/protocol-model/identity.md#req-id-3)).
...
| --------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [P2pRuntimeHost.ts](../../../../../../../../src/evm/p2pRuntime/P2pRuntimeHost.ts) | [`INV-RUNTIME-1`](../../../../../specification/runtime/execution.md#inv-runtime-1), [`REQ-RUNTIME-2`](../../../../../specification/runtime/execution.md#req-runtime-2), [`REQ-RUNTIME-3`](../../../../../specification/runtime/execution.md#req-runtime-3), [`REQ-ID-3`](../../../../../specification/protocol-model/identity.md#req-id-3) |
...
| ----------------------------------------------------------------------- | ------------- | ------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="unit-test-p2p-runtime-host-1"></a>`UNIT-TEST-P2P-RUNTIME-HOST-1` | Host protocol | Drive the request surface inline and workered incl. failures, disposal mid-flight, and signing requests | Equivalent observable behavior; every request settles once; signing only via specified validated operations | <a id="unit-test-p2p-runtime-host-1.p1"></a>`UNIT-TEST-P2P-RUNTIME-HOST-1.P1` — inline/worker equivalence; <a id="unit-test-p2p-runtime-host-1.p2"></a>`UNIT-TEST-P2P-RUNTIME-HOST-1.P2` — disposal settlement; <a id="unit-test-p2p-runtime-host-1.p3"></a>`UNIT-TEST-P2P-RUNTIME-HOST-1.P3` — signing confinement probes; <a id="unit-test-p2p-runtime-host-1.p4"></a>`UNIT-TEST-P2P-RUNTIME-HOST-1.P4` — event forwarding fidelity |
