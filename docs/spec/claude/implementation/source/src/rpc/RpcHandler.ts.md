...
| ------------------------------------------------------------- | -------------- | ------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="unit-test-rpc-handler-1"></a>`UNIT-TEST-RPC-HANDLER-1` | Delivery verbs | Send via each verb with transport/address/none targets, including empty target lists | Correct transports receive exactly once; loopback dispatches locally; empty lists no-op; requests register correlation | <a id="unit-test-rpc-handler-1.p1"></a>`UNIT-TEST-RPC-HANDLER-1.P1` — broadcast fan-out; <a id="unit-test-rpc-handler-1.p2"></a>`UNIT-TEST-RPC-HANDLER-1.P2` — sendOne by transport; <a id="unit-test-rpc-handler-1.p3"></a>`UNIT-TEST-RPC-HANDLER-1.P3` — sendMultiple transports overload; <a id="unit-test-rpc-handler-1.p4"></a>`UNIT-TEST-RPC-HANDLER-1.P4` — request registers and resolves; <a id="unit-test-rpc-handler-1.p5"></a>`UNIT-TEST-RPC-HANDLER-1.P5` — sendOne by address; <a id="unit-test-rpc-handler-1.p6"></a>`UNIT-TEST-RPC-HANDLER-1.P6` — sendOne loopback; <a id="unit-test-rpc-handler-1.p7"></a>`UNIT-TEST-RPC-HANDLER-1.P7` — sendMultiple addresses overload; <a id="unit-test-rpc-handler-1.p8"></a>`UNIT-TEST-RPC-HANDLER-1.P8` — sendMultiple empty list |
