...
| ------------------------------------------------------- | ------------------------------------- | --------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="unit-test-rpc-wire-1"></a>`UNIT-TEST-RPC-WIRE-1` | Shape validation and bigint rejection | Round-trip valid envelopes/responses; decode malformed variants; serialize a raw BigInt | Valid round trips exact; every malformed variant decodes to `undefined`; raw BigInt throws at serialize | <a id="unit-test-rpc-wire-1.p1"></a>`UNIT-TEST-RPC-WIRE-1.P1` — valid envelope round trip; <a id="unit-test-rpc-wire-1.p2"></a>`UNIT-TEST-RPC-WIRE-1.P2` — malformed shape: missing field; <a id="unit-test-rpc-wire-1.p3"></a>`UNIT-TEST-RPC-WIRE-1.P3` — raw BigInt throws; <a id="unit-test-rpc-wire-1.p4"></a>`UNIT-TEST-RPC-WIRE-1.P4` — boundary-size frame; <a id="unit-test-rpc-wire-1.p5"></a>`UNIT-TEST-RPC-WIRE-1.P5` — valid response round trip; <a id="unit-test-rpc-wire-1.p6"></a>`UNIT-TEST-RPC-WIRE-1.P6` — malformed shape: wrong-typed field; <a id="unit-test-rpc-wire-1.p7"></a>`UNIT-TEST-RPC-WIRE-1.P7` — malformed shape: non-array params |
