...
| ------------------------------------------------------------------------------- | ---------------- | -------------------------------------------------------------- | ---------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="unit-test-webrtc-setup-methods-1"></a>`UNIT-TEST-WEBRTC-SETUP-METHODS-1` | Endpoint routing | Each endpoint with valid/garbage payloads and missing identity | Delegation on valid; silent ignore otherwise; answer emitted as one-way call | <a id="unit-test-webrtc-setup-methods-1.p1"></a>`UNIT-TEST-WEBRTC-SETUP-METHODS-1.P1` — offer→answer round; <a id="unit-test-webrtc-setup-methods-1.p2"></a>`UNIT-TEST-WEBRTC-SETUP-METHODS-1.P2` — garbage per endpoint; <a id="unit-test-webrtc-setup-methods-1.p3"></a>`UNIT-TEST-WEBRTC-SETUP-METHODS-1.P3` — missing identity |
