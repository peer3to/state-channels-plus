...
| --------------------------------------------------------------------------------------- | --------------- | ----------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| <a id="unit-test-is-fork-disputed-service-1"></a>`UNIT-TEST-IS-FORK-DISPUTED-SERVICE-1` | Round semantics | Run rounds normally, duplicate in both directions, across reconnects, with confirming/refusing/silent peers | One round per fork per pair; duplicates violate; records survive churn; refusal/silence excludes; straggler tolerance flips exactly at recording | <a id="unit-test-is-fork-disputed-service-1.p1"></a>`UNIT-TEST-IS-FORK-DISPUTED-SERVICE-1.P1` — normal round bilateral records; <a id="unit-test-is-fork-disputed-service-1.p2"></a>`UNIT-TEST-IS-FORK-DISPUTED-SERVICE-1.P2` — duplicate request/answer violations; <a id="unit-test-is-fork-disputed-service-1.p3"></a>`UNIT-TEST-IS-FORK-DISPUTED-SERVICE-1.P3` — record survives reconnect; <a id="unit-test-is-fork-disputed-service-1.p4"></a>`UNIT-TEST-IS-FORK-DISPUTED-SERVICE-1.P4` — refusal and timeout exclusion; <a id="unit-test-is-fork-disputed-service-1.p5"></a>`UNIT-TEST-IS-FORK-DISPUTED-SERVICE-1.P5` — tolerance boundary before/after recording |
