...
| ------------------------------------------------------------------------------- | -------------------- | --------------------------------------------- | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="unit-test-local-webrtc-factory-1"></a>`UNIT-TEST-LOCAL-WEBRTC-FACTORY-1` | Connection lifecycle | Offer/accept/replace/orphan/close per address | Replacement closes prior; orphans no-op; callbacks fire; close deletes | <a id="unit-test-local-webrtc-factory-1.p1"></a>`UNIT-TEST-LOCAL-WEBRTC-FACTORY-1.P1` — offer then replace; <a id="unit-test-local-webrtc-factory-1.p2"></a>`UNIT-TEST-LOCAL-WEBRTC-FACTORY-1.P2` — accept path; <a id="unit-test-local-webrtc-factory-1.p3"></a>`UNIT-TEST-LOCAL-WEBRTC-FACTORY-1.P3` — orphan answer; <a id="unit-test-local-webrtc-factory-1.p4"></a>`UNIT-TEST-LOCAL-WEBRTC-FACTORY-1.P4` — close cleanup; <a id="unit-test-local-webrtc-factory-1.p5"></a>`UNIT-TEST-LOCAL-WEBRTC-FACTORY-1.P5` — orphan candidate |
