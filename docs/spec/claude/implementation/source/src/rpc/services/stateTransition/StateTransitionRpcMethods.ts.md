...
| [`REQ-IX-1`](../../../../../../specification/interactions.md#req-ix-1)                            | Covered               | **Here:** the transport side — authenticated, envelope-validated, attributed hand-off. **Other files:** full pipeline validation in [BlockQueueManager](../../../stateManager/BlockQueueManager.ts.md)/[ValidationService](../../../stateManager/ValidationService.ts.md). | None (DEF-9 fault partition tracked on this file's REQ-GOSSIP-2 row).  |
