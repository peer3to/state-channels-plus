...
| ------------------------------------------------------------------------------- | -------------------------- | ---------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="unit-test-join-channel-service-1"></a>`UNIT-TEST-JOIN-CHANNEL-SERVICE-1` | Collector unanimity        | Collect with responsive/silent/erroring/wrong-signer/unreachable members and deadline pressure | Only full unanimity assembles; every failure mode fails whole; timeouts respect the deadline floor                      | <a id="unit-test-join-channel-service-1.p1"></a>`UNIT-TEST-JOIN-CHANNEL-SERVICE-1.P1` — unanimous success; <a id="unit-test-join-channel-service-1.p2"></a>`UNIT-TEST-JOIN-CHANNEL-SERVICE-1.P2` — single silent member; <a id="unit-test-join-channel-service-1.p3"></a>`UNIT-TEST-JOIN-CHANNEL-SERVICE-1.P3` — preflight unreachable; <a id="unit-test-join-channel-service-1.p4"></a>`UNIT-TEST-JOIN-CHANNEL-SERVICE-1.P4` — deadline-bounded timeout; <a id="unit-test-join-channel-service-1.p5"></a>`UNIT-TEST-JOIN-CHANNEL-SERVICE-1.P5` — self-collection-only guard; <a id="unit-test-join-channel-service-1.p6"></a>`UNIT-TEST-JOIN-CHANNEL-SERVICE-1.P6` — single erroring member; <a id="unit-test-join-channel-service-1.p7"></a>`UNIT-TEST-JOIN-CHANNEL-SERVICE-1.P7` — single wrong-signer member |
