...
| ----------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| [TimeoutStorage.ts](../../../../../../../src/storage/TimeoutStorage.ts) | [`REQ-TOSTORE-1`](../../../../specification/storage/calldata-and-timeouts.md#req-tostore-1) |
...
- Lowest-height retention independent of arrival order ([`REQ-TOSTORE-1`](../../../../specification/storage/calldata-and-timeouts.md#req-tostore-1)).
...
| ------------------------------------------------------------------------------------------- | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| [`REQ-TOSTORE-1`](../../../../specification/storage/calldata-and-timeouts.md#req-tostore-1) | Covered               | **Here:** higher-height updates ignored ([#L20](../../../../../../../src/storage/TimeoutStorage.ts#L20)). **Other files:** candidate production and precedence checks — [StateManager](../stateManager/StateManager.ts.md) (`tryTimeoutParticipant`). | None.            |
...
| --------------------------------------------------------------------- | ----------------------- | ------------------------------------------------------------ | ------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="unit-test-timeout-storage-1"></a>`UNIT-TEST-TIMEOUT-STORAGE-1` | Lowest-height retention | Store candidates at varied heights per fork in varied orders | Lowest retained for every order; equal height replaces; forks independent | <a id="unit-test-timeout-storage-1.p1"></a>`UNIT-TEST-TIMEOUT-STORAGE-1.P1` — lower replaces higher; <a id="unit-test-timeout-storage-1.p2"></a>`UNIT-TEST-TIMEOUT-STORAGE-1.P2` — higher ignored; <a id="unit-test-timeout-storage-1.p3"></a>`UNIT-TEST-TIMEOUT-STORAGE-1.P3` — order permutations converge; <a id="unit-test-timeout-storage-1.p4"></a>`UNIT-TEST-TIMEOUT-STORAGE-1.P4` — equal-height replacement; <a id="unit-test-timeout-storage-1.p5"></a>`UNIT-TEST-TIMEOUT-STORAGE-1.P5` — per-fork isolation |
