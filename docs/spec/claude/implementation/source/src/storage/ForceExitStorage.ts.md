...
| --------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| [ForceExitStorage.ts](../../../../../../../src/storage/ForceExitStorage.ts) | [`REQ-RMSTORE-2-Y2T1PG`](../../../../specification/storage/progress-markers.md#req-rmstore-2-y2t1pg) |
...
| ----------------------------------------------------------------------------------------- | ---------------- | -------------------------------------------------- | ---------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| <a id="unit-test-force-exit-storage-1-hrt66a"></a>`UNIT-TEST-FORCE-EXIT-STORAGE-1-HRT66A` | Intent lifecycle | Set, read, and clear the flag incl. before any set | Explicit lifecycle; default false; idempotent clears | <a id="unit-test-force-exit-storage-1-hrt66a.p1"></a>`UNIT-TEST-FORCE-EXIT-STORAGE-1-HRT66A.P1` — default false; <a id="unit-test-force-exit-storage-1-hrt66a.p2"></a>`UNIT-TEST-FORCE-EXIT-STORAGE-1-HRT66A.P2` — set/read/clear; <a id="unit-test-force-exit-storage-1-hrt66a.p3"></a>`UNIT-TEST-FORCE-EXIT-STORAGE-1-HRT66A.P3` — repeated set idempotent |
