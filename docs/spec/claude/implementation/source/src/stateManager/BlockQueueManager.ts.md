...
| ----------------------------------------------------------------------------- | ------------------------- | ---------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="unit-test-block-queue-manager-1"></a>`UNIT-TEST-BLOCK-QUEUE-MANAGER-1` | Intake gates and lifetime | Ingest across channel/fork/dup/dead-fork cases; expire entries in each state | Gates apply in order; lifetime fixed under duplicates/restores; expiry branch per state incl. the single probe site | <a id="unit-test-block-queue-manager-1.p1"></a>`UNIT-TEST-BLOCK-QUEUE-MANAGER-1.P1` — gate order; <a id="unit-test-block-queue-manager-1.p2"></a>`UNIT-TEST-BLOCK-QUEUE-MANAGER-1.P2` — lifetime never extends; <a id="unit-test-block-queue-manager-1.p3"></a>`UNIT-TEST-BLOCK-QUEUE-MANAGER-1.P3` — each expiry branch; <a id="unit-test-block-queue-manager-1.p4"></a>`UNIT-TEST-BLOCK-QUEUE-MANAGER-1.P4` — stale-fork silent drop vs unknown-fork probe; <a id="unit-test-block-queue-manager-1.p5"></a>`UNIT-TEST-BLOCK-QUEUE-MANAGER-1.P5` — own-fork recovery coalescing |
