...
| [`REQ-IX-7`](../../../../specification/interactions.md#req-ix-7)                     | Covered               | **Here:** ordered observation with bounded recovery; observed intake re-enters owner validation. **Other files:** [StateChannelEventListener](../StateChannelEventListener.ts.md), [EventHandler](../eventHandlers/EventHandler.ts.md).              | Single-provider observation (trust-model A6); DEF-2 event-set gap tracked at the listener. |
| [`REQ-MIRROR-3`](../../../../specification/enforcement/local-mirror.md#req-mirror-3) | Covered               | **Here:** targeted chain recovery when local records cannot back a decision. **Other files:** chain re-checks at decision sites — [DisputeValidationService](./DisputeValidationService.ts.md), [StateManager](./StateManager.ts.md) timeout checks. | None.                                                                                      |
