...
The chain-time tracker: the node's protocol clock derived from observed block timestamps, serving
`getTimeInSeconds`/`getBlockchainTime` to every window computation.
