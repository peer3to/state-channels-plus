...
Normalization proxy over ethers Result objects (array/object duality) for stable serialization.
...
| --------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| [EthersResultProxy.ts](../../../../../../../src/utils/EthersResultProxy.ts) | [`REQ-RUNTIME-1-RSM6MZ`](../../../../specification/runtime/execution.md#req-runtime-1-rsm6mz) |
