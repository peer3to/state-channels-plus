# address.ts — Source Report

> **Source:** [src/utils/address.ts](../../../../../../../src/utils/address.ts) > **Status:** Authored — engineer verification pending.
...
Address normalization helpers (checksum casing).
