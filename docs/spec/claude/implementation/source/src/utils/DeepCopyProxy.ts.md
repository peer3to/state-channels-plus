...
| --------------------------------------------------------------------- | -------------- | ------------------------------------------------------ | --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="unit-test-deep-copy-proxy-1"></a>`UNIT-TEST-DEEP-COPY-PROXY-1` | Copy semantics | Mutate returned/stored objects through wrapped modules | No aliasing in either direction; nested structures copied | <a id="unit-test-deep-copy-proxy-1.p1"></a>`UNIT-TEST-DEEP-COPY-PROXY-1.P1` — result mutation isolated; <a id="unit-test-deep-copy-proxy-1.p2"></a>`UNIT-TEST-DEEP-COPY-PROXY-1.P2` — input mutation isolated; <a id="unit-test-deep-copy-proxy-1.p3"></a>`UNIT-TEST-DEEP-COPY-PROXY-1.P3` — nested/cyclic handling |
