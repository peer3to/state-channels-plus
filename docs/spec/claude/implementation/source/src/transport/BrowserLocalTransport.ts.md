# BrowserLocalTransport.ts — Source Report

> **Source:** [src/transport/BrowserLocalTransport.ts](../../../../../../../src/transport/BrowserLocalTransport.ts) > **Status:** Authored — engineer verification pending.
...
Browser-side local pairing (message-channel based) mirroring LocalTransport semantics.
...
- [LocalTransport](./LocalTransport.ts.md).
