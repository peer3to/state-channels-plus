...
The documented architecture is intended to implement [the neutral subject](../../specification/protocol/dispute-processing.md). Existing design reports cover the major mechanisms and failure paths.
