...
| --------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `INV-CON-5.T1`  | `INV-CON-5`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | `_setState(getState())` leaves state unchanged; the pair is an exact inverse for all protocol-reachable state.                                                                                                              | <a id="inv-con-5.t1.p1"></a>`INV-CON-5.T1.P1` — valid case<br><a id="inv-con-5.t1.p2"></a>`INV-CON-5.T1.P2` — zero/empty/no-op case where meaningful<br><a id="inv-con-5.t1.p3"></a>`INV-CON-5.T1.P3` — direct invalid/opposite case<br><a id="inv-con-5.t1.p4"></a>`INV-CON-5.T1.P4` — exact boundary<br><a id="inv-con-5.t1.p5"></a>`INV-CON-5.T1.P5` — failure/recovery<br><a id="inv-con-5.t1.p6"></a>`INV-CON-5.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `REQ-CON-6.T1`  | `REQ-CON-6`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Transitions use only the injected context (`_tx.header.*`, own state, calldata args, `gasLimit`); ambient EVM context (`msg.sender`, `block.timestamp`, `msg.data`, …) is prohibited.                                       | <a id="req-con-6.t1.p1"></a>`REQ-CON-6.T1.P1` — valid case<br><a id="req-con-6.t1.p2"></a>`REQ-CON-6.T1.P2` — before deadline<br><a id="req-con-6.t1.p3"></a>`REQ-CON-6.T1.P3` — direct invalid/opposite case<br><a id="req-con-6.t1.p4"></a>`REQ-CON-6.T1.P4` — at deadline<br><a id="req-con-6.t1.p5"></a>`REQ-CON-6.T1.P5` — after deadline<br><a id="req-con-6.t1.p6"></a>`REQ-CON-6.T1.P6` — maximum honest skew                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `REQ-CON-7.T1`  | `REQ-CON-7`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Turn authorization is protocol-enforced (SDK pre-execution leader check); in-contract checks are optional defense in depth. Authorization is block-author-level (one tx per block today makes it look tx-level).            | <a id="req-con-7.t1.p1"></a>`REQ-CON-7.T1.P1` — valid case<br><a id="req-con-7.t1.p2"></a>`REQ-CON-7.T1.P2` — correct identity/signature<br><a id="req-con-7.t1.p3"></a>`REQ-CON-7.T1.P3` — direct invalid/opposite case<br><a id="req-con-7.t1.p4"></a>`REQ-CON-7.T1.P4` — wrong identity/signature<br><a id="req-con-7.t1.p5"></a>`REQ-CON-7.T1.P5` — missing identity/signature<br><a id="req-con-7.t1.p6"></a>`REQ-CON-7.T1.P6` — duplicate identity/signature<br><a id="req-con-7.t1.p7"></a>`REQ-CON-7.T1.P7` — forged identity/signature<br><a id="req-con-7.t1.p8"></a>`REQ-CON-7.T1.P8` — membership boundary                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `REQ-CON-8.T1`  | `REQ-CON-8`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | `subtractBalance` MUST revert on underflow; the balance algebra is deterministic and pure.                                                                                                                                  | <a id="req-con-8.t1.p1"></a>`REQ-CON-8.T1.P1` — valid case<br><a id="req-con-8.t1.p2"></a>`REQ-CON-8.T1.P2` — zero value<br><a id="req-con-8.t1.p3"></a>`REQ-CON-8.T1.P3` — direct invalid/opposite case<br><a id="req-con-8.t1.p4"></a>`REQ-CON-8.T1.P4` — exact balance/boundary<br><a id="req-con-8.t1.p5"></a>`REQ-CON-8.T1.P5` — one beyond the boundary<br><a id="req-con-8.t1.p6"></a>`REQ-CON-8.T1.P6` — maximum value<br><a id="req-con-8.t1.p7"></a>`REQ-CON-8.T1.P7` — value conservation                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `REQ-CON-9.T1`  | `REQ-CON-9`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | State serialization is canonical, lossless, deterministic; mappings only with a complete deterministic key-enumeration scheme; commitment is indirect via `block → stateSnapshotHash → snapshotData.stateMachineStateHash`. | <a id="req-con-9.t1.p1"></a>`REQ-CON-9.T1.P1` — valid case<br><a id="req-con-9.t1.p2"></a>`REQ-CON-9.T1.P2` — matching commitment<br><a id="req-con-9.t1.p3"></a>`REQ-CON-9.T1.P3` — direct invalid/opposite case<br><a id="req-con-9.t1.p4"></a>`REQ-CON-9.T1.P4` — mismatched commitment<br><a id="req-con-9.t1.p5"></a>`REQ-CON-9.T1.P5` — predecessor linkage<br><a id="req-con-9.t1.p6"></a>`REQ-CON-9.T1.P6` — genesis linkage<br><a id="req-con-9.t1.p7"></a>`REQ-CON-9.T1.P7` — stale fork<br><a id="req-con-9.t1.p8"></a>`REQ-CON-9.T1.P8` — foreign fork                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `REQ-CON-10.T1` | `REQ-CON-10`            | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | `_joinChannel` admits a new participant with its initial balance, or tops up an existing participant's balance without changing membership.                                                                                 | <a id="req-con-10.t1.p1"></a>`REQ-CON-10.T1.P1` — valid case<br><a id="req-con-10.t1.p2"></a>`REQ-CON-10.T1.P2` — correct identity/signature<br><a id="req-con-10.t1.p3"></a>`REQ-CON-10.T1.P3` — zero value<br><a id="req-con-10.t1.p4"></a>`REQ-CON-10.T1.P4` — new participant<br><a id="req-con-10.t1.p5"></a>`REQ-CON-10.T1.P5` — direct invalid/opposite case<br><a id="req-con-10.t1.p6"></a>`REQ-CON-10.T1.P6` — wrong identity/signature<br><a id="req-con-10.t1.p7"></a>`REQ-CON-10.T1.P7` — missing identity/signature<br><a id="req-con-10.t1.p8"></a>`REQ-CON-10.T1.P8` — duplicate identity/signature<br><a id="req-con-10.t1.p9"></a>`REQ-CON-10.T1.P9` — forged identity/signature<br><a id="req-con-10.t1.p10"></a>`REQ-CON-10.T1.P10` — membership boundary<br><a id="req-con-10.t1.p11"></a>`REQ-CON-10.T1.P11` — exact balance/boundary<br><a id="req-con-10.t1.p12"></a>`REQ-CON-10.T1.P12` — one beyond the boundary<br><a id="req-con-10.t1.p13"></a>`REQ-CON-10.T1.P13` — maximum value<br><a id="req-con-10.t1.p14"></a>`REQ-CON-10.T1.P14` — value conservation<br><a id="req-con-10.t1.p15"></a>`REQ-CON-10.T1.P15` — existing participant<br><a id="req-con-10.t1.p16"></a>`REQ-CON-10.T1.P16` — removed participant<br><a id="req-con-10.t1.p17"></a>`REQ-CON-10.T1.P17` — slashed participant<br><a id="req-con-10.t1.p18"></a>`REQ-CON-10.T1.P18` — concurrent membership change |
...
| `REQ-CON-8`             | `subtractBalance` MUST revert on underflow; the balance algebra is deterministic and pure.                                                                                                                                  | Covered               | [AStateMachine.sol](../../../../../../../contracts/V1/AStateMachine.sol#L3) (contract comment); [MathStateMachine.sol](../../../../../../../contracts/V1/examples/MathStateMachine/MathStateMachine.sol#L4) (`require(balance1.amount >= balance2.amount)`)                 | None.            |
...
| `REQ-CON-10`            | `_joinChannel` admits a new participant with its initial balance, or tops up an existing participant's balance without changing membership.                                                                                 | Covered               | [AStateMachine.sol](../../../../../../../contracts/V1/AStateMachine.sol#L3) (hook contract comment); [MathStateMachine.sol](../../../../../../../contracts/V1/examples/MathStateMachine/MathStateMachine.sol#L4) (`_joinChannel` both branches)                             | None.            |
