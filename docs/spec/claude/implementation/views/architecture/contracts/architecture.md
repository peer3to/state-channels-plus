...
[`StateChannelManagerInterface`](../../../../../../../contracts/V1/StateChannelManagerInterface.sol#L7) at a
...
- **Explicit interface mirroring.** The proxy implements
  ...
  [`GeneralUtils._delegatecall`](../../../../../../../contracts/V1/StateChannelDiamondProxy/utils/GeneralUtils.sol#L7),
...
- **UtilityFacet is called, not delegatecalled.** Pure/stateless helpers on
  [`UtilityFacet`](../../../../../../../contracts/V1/StateChannelDiamondProxy/UtilityFacet.sol#L7) are reached
...
- **Test-only variant.**
  [`LocalDiamond`](../../../../../../../contracts/V1/StateChannelDiamondProxy/LocalDiamond.sol#L14) extends the
...
- **REQ-CON-2.** The build or deployment pipeline MUST verify REQ-CON-1 automatically and fail on
  ...
  `Current:` **none — gap.** Neither [hardhat.config.ts](../../../../../../../hardhat.config.ts#L1) nor
...
| -------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `REQ-CON-1.T1` | `REQ-CON-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Every mainnet-deployable contract MUST have deployed bytecode ≤ 24,576 bytes (EIP-170) and initcode ≤ 49,152 bytes (EIP-3860). `Current:` violated by `StateChannelManagerProxy` (30,959), `DisputeFraudProofFacet` (26,436), `DisputeVerificationFacet` (24,783). | <a id="req-con-1.t1.p1"></a>`REQ-CON-1.T1.P1` — valid case<br><a id="req-con-1.t1.p2"></a>`REQ-CON-1.T1.P2` — malformed input<br><a id="req-con-1.t1.p3"></a>`REQ-CON-1.T1.P3` — direct invalid/opposite case<br><a id="req-con-1.t1.p4"></a>`REQ-CON-1.T1.P4` — adversarial input<br><a id="req-con-1.t1.p5"></a>`REQ-CON-1.T1.P5` — partial failure<br><a id="req-con-1.t1.p6"></a>`REQ-CON-1.T1.P6` — retry and recovery                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `REQ-CON-2.T1` | `REQ-CON-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Build/deployment MUST verify REQ-CON-1 automatically and fail on violation.                                                                                                                                                                                        | <a id="req-con-2.t1.p1"></a>`REQ-CON-2.T1.P1` — valid case<br><a id="req-con-2.t1.p2"></a>`REQ-CON-2.T1.P2` — malformed input<br><a id="req-con-2.t1.p3"></a>`REQ-CON-2.T1.P3` — direct invalid/opposite case<br><a id="req-con-2.t1.p4"></a>`REQ-CON-2.T1.P4` — adversarial input<br><a id="req-con-2.t1.p5"></a>`REQ-CON-2.T1.P5` — partial failure<br><a id="req-con-2.t1.p6"></a>`REQ-CON-2.T1.P6` — retry and recovery                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `INV-CON-3.T1` | `INV-CON-3`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Proxy and all facets share exactly one storage layout: facets inherit `StateChannelManagerStorage` and declare no state variables of their own.                                                                                                                    | <a id="inv-con-3.t1.p1"></a>`INV-CON-3.T1.P1` — valid case<br><a id="inv-con-3.t1.p2"></a>`INV-CON-3.T1.P2` — zero/empty/no-op case where meaningful<br><a id="inv-con-3.t1.p3"></a>`INV-CON-3.T1.P3` — direct invalid/opposite case<br><a id="inv-con-3.t1.p4"></a>`INV-CON-3.T1.P4` — exact boundary<br><a id="inv-con-3.t1.p5"></a>`INV-CON-3.T1.P5` — failure/recovery<br><a id="inv-con-3.t1.p6"></a>`INV-CON-3.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `REQ-CON-4.T1` | `REQ-CON-4`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | `onlySelf` functions (`depositAssetsComposable`, `withdrawAssetsComposable`, `executeStateTransition`, `applyJoinChannelToStateMachine`) MUST revert for any external caller; they are reachable only through the proxy's self-CALL.                               | <a id="req-con-4.t1.p1"></a>`REQ-CON-4.T1.P1` — valid case<br><a id="req-con-4.t1.p2"></a>`REQ-CON-4.T1.P2` — zero value<br><a id="req-con-4.t1.p3"></a>`REQ-CON-4.T1.P3` — new participant<br><a id="req-con-4.t1.p4"></a>`REQ-CON-4.T1.P4` — direct invalid/opposite case<br><a id="req-con-4.t1.p5"></a>`REQ-CON-4.T1.P5` — exact balance/boundary<br><a id="req-con-4.t1.p6"></a>`REQ-CON-4.T1.P6` — one beyond the boundary<br><a id="req-con-4.t1.p7"></a>`REQ-CON-4.T1.P7` — maximum value<br><a id="req-con-4.t1.p8"></a>`REQ-CON-4.T1.P8` — value conservation<br><a id="req-con-4.t1.p9"></a>`REQ-CON-4.T1.P9` — existing participant<br><a id="req-con-4.t1.p10"></a>`REQ-CON-4.T1.P10` — removed participant<br><a id="req-con-4.t1.p11"></a>`REQ-CON-4.T1.P11` — slashed participant<br><a id="req-con-4.t1.p12"></a>`REQ-CON-4.T1.P12` — concurrent membership change |
...
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| `REQ-CON-1`             | Every mainnet-deployable contract MUST have deployed bytecode ≤ 24,576 bytes (EIP-170) and initcode ≤ 49,152 bytes (EIP-3860). `Current:` violated by `StateChannelManagerProxy` (30,959), `DisputeFraudProofFacet` (26,436), `DisputeVerificationFacet` (24,783). | Covered               | [contracts/V1/StateChannelDiamondProxy](../../../../../../../contracts/V1/StateChannelDiamondProxy) (all deployables)                                                                                                                                                                                                                                                                                                                                                                                                | None.                                                                      |
| `REQ-CON-2`             | Build/deployment MUST verify REQ-CON-1 automatically and fail on violation.                                                                                                                                                                                        | Missing               | none — gap ([hardhat.config.ts](../../../../../../../hardhat.config.ts#L1) sets `allowUnlimitedContractSize: true`; [foundry.toml](../../../../../../../foundry.toml) has no size gate)                                                                                                                                                                                                                                                                                                                              | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-CON-3`             | Proxy and all facets share exactly one storage layout: facets inherit `StateChannelManagerStorage` and declare no state variables of their own.                                                                                                                    | Covered               | [StateChannelManagerStorage.sol](../../../../../../../contracts/V1/StateChannelDiamondProxy/StateChannelManagerStorage.sol#L3); all facets via [StateChannelCommon.sol](../../../../../../../contracts/V1/StateChannelDiamondProxy/StateChannelCommon.sol#L3)                                                                                                                                                                                                                                                        | None.                                                                      |
| `REQ-CON-4`             | `onlySelf` functions (`depositAssetsComposable`, `withdrawAssetsComposable`, `executeStateTransition`, `applyJoinChannelToStateMachine`) MUST revert for any external caller; they are reachable only through the proxy's self-CALL.                               | Covered               | [StateChannelManagerStorage.sol](../../../../../../../contracts/V1/StateChannelDiamondProxy/StateChannelManagerStorage.sol#L3) (`onlySelf` modifier); call sites in [StateChannelManagerProxy.sol](../../../../../../../contracts/V1/StateChannelDiamondProxy/StateChannelManagerProxy.sol#L3), [JoinChannelFacet.sol](../../../../../../../contracts/V1/StateChannelDiamondProxy/JoinChannelFacet.sol#L3), [FraudProofFacet.sol](../../../../../../../contracts/V1/StateChannelDiamondProxy/FraudProofFacet.sol#L3) | None.                                                                      |
