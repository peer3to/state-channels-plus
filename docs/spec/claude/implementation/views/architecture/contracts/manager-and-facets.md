...
| --------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `REQ-CON-11.T1` | `REQ-CON-11`            | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | `open` MUST reject duplicate participants and already-open channels, verify a unanimous threshold signature over `encodedOpenChannel`, and require ≥ 2 successful deposits before storing the genesis snapshot.                          | <a id="req-con-11.t1.p1"></a>`REQ-CON-11.T1.P1` — valid case<br><a id="req-con-11.t1.p2"></a>`REQ-CON-11.T1.P2` — matching commitment<br><a id="req-con-11.t1.p3"></a>`REQ-CON-11.T1.P3` — correct identity/signature<br><a id="req-con-11.t1.p4"></a>`REQ-CON-11.T1.P4` — zero value<br><a id="req-con-11.t1.p5"></a>`REQ-CON-11.T1.P5` — duplicate delivery<br><a id="req-con-11.t1.p6"></a>`REQ-CON-11.T1.P6` — malformed input<br><a id="req-con-11.t1.p7"></a>`REQ-CON-11.T1.P7` — direct invalid/opposite case<br><a id="req-con-11.t1.p8"></a>`REQ-CON-11.T1.P8` — mismatched commitment<br><a id="req-con-11.t1.p9"></a>`REQ-CON-11.T1.P9` — predecessor linkage<br><a id="req-con-11.t1.p10"></a>`REQ-CON-11.T1.P10` — genesis linkage<br><a id="req-con-11.t1.p11"></a>`REQ-CON-11.T1.P11` — stale fork<br><a id="req-con-11.t1.p12"></a>`REQ-CON-11.T1.P12` — foreign fork<br><a id="req-con-11.t1.p13"></a>`REQ-CON-11.T1.P13` — wrong identity/signature<br><a id="req-con-11.t1.p14"></a>`REQ-CON-11.T1.P14` — missing identity/signature<br><a id="req-con-11.t1.p15"></a>`REQ-CON-11.T1.P15` — duplicate identity/signature<br><a id="req-con-11.t1.p16"></a>`REQ-CON-11.T1.P16` — forged identity/signature<br><a id="req-con-11.t1.p17"></a>`REQ-CON-11.T1.P17` — membership boundary<br><a id="req-con-11.t1.p18"></a>`REQ-CON-11.T1.P18` — exact balance/boundary<br><a id="req-con-11.t1.p19"></a>`REQ-CON-11.T1.P19` — one beyond the boundary<br><a id="req-con-11.t1.p20"></a>`REQ-CON-11.T1.P20` — maximum value<br><a id="req-con-11.t1.p21"></a>`REQ-CON-11.T1.P21` — value conservation<br><a id="req-con-11.t1.p22"></a>`REQ-CON-11.T1.P22` — replay delivery<br><a id="req-con-11.t1.p23"></a>`REQ-CON-11.T1.P23` — concurrent delivery<br><a id="req-con-11.t1.p24"></a>`REQ-CON-11.T1.P24` — adversarial input<br><a id="req-con-11.t1.p25"></a>`REQ-CON-11.T1.P25` — partial failure<br><a id="req-con-11.t1.p26"></a>`REQ-CON-11.T1.P26` — retry and recovery                                                                               |
| `INV-CON-12.T1` | `INV-CON-12`            | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Processed withdrawals never exceed resolved deposits for a channel: every outbound message application re-checks `totalWithdrawals ≤ totalDeposits` (`CantWithdrawMoreThanDeposits`).                                                    | <a id="inv-con-12.t1.p1"></a>`INV-CON-12.T1.P1` — valid case<br><a id="inv-con-12.t1.p2"></a>`INV-CON-12.T1.P2` — zero value<br><a id="inv-con-12.t1.p3"></a>`INV-CON-12.T1.P3` — direct invalid/opposite case<br><a id="inv-con-12.t1.p4"></a>`INV-CON-12.T1.P4` — exact balance/boundary<br><a id="inv-con-12.t1.p5"></a>`INV-CON-12.T1.P5` — one beyond the boundary<br><a id="inv-con-12.t1.p6"></a>`INV-CON-12.T1.P6` — maximum value<br><a id="inv-con-12.t1.p7"></a>`INV-CON-12.T1.P7` — value conservation                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `REQ-CON-13.T1` | `REQ-CON-13`            | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Block-calldata commitments are append-only and author-bound: no overwrite, `msg.sender` must be the block's author, and posting must beat `maxTimestamp`.                                                                                | <a id="req-con-13.t1.p1"></a>`REQ-CON-13.T1.P1` — valid case<br><a id="req-con-13.t1.p2"></a>`REQ-CON-13.T1.P2` — matching commitment<br><a id="req-con-13.t1.p3"></a>`REQ-CON-13.T1.P3` — correct identity/signature<br><a id="req-con-13.t1.p4"></a>`REQ-CON-13.T1.P4` — before deadline<br><a id="req-con-13.t1.p5"></a>`REQ-CON-13.T1.P5` — direct invalid/opposite case<br><a id="req-con-13.t1.p6"></a>`REQ-CON-13.T1.P6` — mismatched commitment<br><a id="req-con-13.t1.p7"></a>`REQ-CON-13.T1.P7` — predecessor linkage<br><a id="req-con-13.t1.p8"></a>`REQ-CON-13.T1.P8` — genesis linkage<br><a id="req-con-13.t1.p9"></a>`REQ-CON-13.T1.P9` — stale fork<br><a id="req-con-13.t1.p10"></a>`REQ-CON-13.T1.P10` — foreign fork<br><a id="req-con-13.t1.p11"></a>`REQ-CON-13.T1.P11` — wrong identity/signature<br><a id="req-con-13.t1.p12"></a>`REQ-CON-13.T1.P12` — missing identity/signature<br><a id="req-con-13.t1.p13"></a>`REQ-CON-13.T1.P13` — duplicate identity/signature<br><a id="req-con-13.t1.p14"></a>`REQ-CON-13.T1.P14` — forged identity/signature<br><a id="req-con-13.t1.p15"></a>`REQ-CON-13.T1.P15` — membership boundary<br><a id="req-con-13.t1.p16"></a>`REQ-CON-13.T1.P16` — at deadline<br><a id="req-con-13.t1.p17"></a>`REQ-CON-13.T1.P17` — after deadline<br><a id="req-con-13.t1.p18"></a>`REQ-CON-13.T1.P18` — maximum honest skew                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `REQ-CON-14.T1` | `REQ-CON-14`            | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Dispute uploads are participant-gated and throttled: disputer == `msg.sender`, disputer eligible (snapshot ∪ pending − slashed), one window-opening upload per `evidenceTime` per address, one evidence post per participant per window. | <a id="req-con-14.t1.p1"></a>`REQ-CON-14.T1.P1` — valid case<br><a id="req-con-14.t1.p2"></a>`REQ-CON-14.T1.P2` — matching commitment<br><a id="req-con-14.t1.p3"></a>`REQ-CON-14.T1.P3` — correct identity/signature<br><a id="req-con-14.t1.p4"></a>`REQ-CON-14.T1.P4` — before deadline<br><a id="req-con-14.t1.p5"></a>`REQ-CON-14.T1.P5` — new participant<br><a id="req-con-14.t1.p6"></a>`REQ-CON-14.T1.P6` — malformed input<br><a id="req-con-14.t1.p7"></a>`REQ-CON-14.T1.P7` — direct invalid/opposite case<br><a id="req-con-14.t1.p8"></a>`REQ-CON-14.T1.P8` — mismatched commitment<br><a id="req-con-14.t1.p9"></a>`REQ-CON-14.T1.P9` — predecessor linkage<br><a id="req-con-14.t1.p10"></a>`REQ-CON-14.T1.P10` — genesis linkage<br><a id="req-con-14.t1.p11"></a>`REQ-CON-14.T1.P11` — stale fork<br><a id="req-con-14.t1.p12"></a>`REQ-CON-14.T1.P12` — foreign fork<br><a id="req-con-14.t1.p13"></a>`REQ-CON-14.T1.P13` — wrong identity/signature<br><a id="req-con-14.t1.p14"></a>`REQ-CON-14.T1.P14` — missing identity/signature<br><a id="req-con-14.t1.p15"></a>`REQ-CON-14.T1.P15` — duplicate identity/signature<br><a id="req-con-14.t1.p16"></a>`REQ-CON-14.T1.P16` — forged identity/signature<br><a id="req-con-14.t1.p17"></a>`REQ-CON-14.T1.P17` — membership boundary<br><a id="req-con-14.t1.p18"></a>`REQ-CON-14.T1.P18` — at deadline<br><a id="req-con-14.t1.p19"></a>`REQ-CON-14.T1.P19` — after deadline<br><a id="req-con-14.t1.p20"></a>`REQ-CON-14.T1.P20` — maximum honest skew<br><a id="req-con-14.t1.p21"></a>`REQ-CON-14.T1.P21` — existing participant<br><a id="req-con-14.t1.p22"></a>`REQ-CON-14.T1.P22` — removed participant<br><a id="req-con-14.t1.p23"></a>`REQ-CON-14.T1.P23` — slashed participant<br><a id="req-con-14.t1.p24"></a>`REQ-CON-14.T1.P24` — concurrent membership change<br><a id="req-con-14.t1.p25"></a>`REQ-CON-14.T1.P25` — adversarial input<br><a id="req-con-14.t1.p26"></a>`REQ-CON-14.T1.P26` — partial failure<br><a id="req-con-14.t1.p27"></a>`REQ-CON-14.T1.P27` — retry and recovery |
| `REQ-CON-15.T1` | `REQ-CON-15`            | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | A committed dispute proven fraudulent during the kill period MUST be killed and its disputer slashed; an invalid dispute-fraud-proof submission slashes the submitter instead.                                                           | <a id="req-con-15.t1.p1"></a>`REQ-CON-15.T1.P1` — valid case<br><a id="req-con-15.t1.p2"></a>`REQ-CON-15.T1.P2` — matching commitment<br><a id="req-con-15.t1.p3"></a>`REQ-CON-15.T1.P3` — before deadline<br><a id="req-con-15.t1.p4"></a>`REQ-CON-15.T1.P4` — new participant<br><a id="req-con-15.t1.p5"></a>`REQ-CON-15.T1.P5` — malformed input<br><a id="req-con-15.t1.p6"></a>`REQ-CON-15.T1.P6` — direct invalid/opposite case<br><a id="req-con-15.t1.p7"></a>`REQ-CON-15.T1.P7` — mismatched commitment<br><a id="req-con-15.t1.p8"></a>`REQ-CON-15.T1.P8` — predecessor linkage<br><a id="req-con-15.t1.p9"></a>`REQ-CON-15.T1.P9` — genesis linkage<br><a id="req-con-15.t1.p10"></a>`REQ-CON-15.T1.P10` — stale fork<br><a id="req-con-15.t1.p11"></a>`REQ-CON-15.T1.P11` — foreign fork<br><a id="req-con-15.t1.p12"></a>`REQ-CON-15.T1.P12` — at deadline<br><a id="req-con-15.t1.p13"></a>`REQ-CON-15.T1.P13` — after deadline<br><a id="req-con-15.t1.p14"></a>`REQ-CON-15.T1.P14` — maximum honest skew<br><a id="req-con-15.t1.p15"></a>`REQ-CON-15.T1.P15` — existing participant<br><a id="req-con-15.t1.p16"></a>`REQ-CON-15.T1.P16` — removed participant<br><a id="req-con-15.t1.p17"></a>`REQ-CON-15.T1.P17` — slashed participant<br><a id="req-con-15.t1.p18"></a>`REQ-CON-15.T1.P18` — concurrent membership change<br><a id="req-con-15.t1.p19"></a>`REQ-CON-15.T1.P19` — adversarial input<br><a id="req-con-15.t1.p20"></a>`REQ-CON-15.T1.P20` — partial failure<br><a id="req-con-15.t1.p21"></a>`REQ-CON-15.T1.P21` — retry and recovery                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| ----------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| `REQ-CON-11`            | `open` MUST reject duplicate participants and already-open channels, verify a unanimous threshold signature over `encodedOpenChannel`, and require ≥ 2 successful deposits before storing the genesis snapshot.                          | Covered               | [StateChannelManagerProxy.sol](../../../../../../../contracts/V1/StateChannelDiamondProxy/StateChannelManagerProxy.sol#L3) (`open`)                                                                                                                                                            | None.            |
...
| `REQ-CON-13`            | Block-calldata commitments are append-only and author-bound: no overwrite, `msg.sender` must be the block's author, and posting must beat `maxTimestamp`.                                                                                | Covered               | [StateChannelManagerProxy.sol](../../../../../../../contracts/V1/StateChannelDiamondProxy/StateChannelManagerProxy.sol#L3) (`postBlockCalldata`)                                                                                                                                               | None.            |
