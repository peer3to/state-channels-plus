...
| -------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `INV-SPC-1.T1` | `INV-SPC-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Served payload re-verified against on-chain truth + contract logic before any state effect.                                               | <a id="inv-spc-1.t1.p1"></a>`INV-SPC-1.T1.P1` — valid case<br><a id="inv-spc-1.t1.p2"></a>`INV-SPC-1.T1.P2` — zero/empty/no-op where meaningful<br><a id="inv-spc-1.t1.p3"></a>`INV-SPC-1.T1.P3` — direct invalid/opposite<br><a id="inv-spc-1.t1.p4"></a>`INV-SPC-1.T1.P4` — exact boundary<br><a id="inv-spc-1.t1.p5"></a>`INV-SPC-1.T1.P5` — failure/recovery<br><a id="inv-spc-1.t1.p6"></a>`INV-SPC-1.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `INV-SPC-2.T1` | `INV-SPC-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Payload validated against the requester's own request, not the peer's echo.                                                               | <a id="inv-spc-2.t1.p1"></a>`INV-SPC-2.T1.P1` — valid case<br><a id="inv-spc-2.t1.p2"></a>`INV-SPC-2.T1.P2` — correct identity/signature<br><a id="inv-spc-2.t1.p3"></a>`INV-SPC-2.T1.P3` — direct invalid/opposite<br><a id="inv-spc-2.t1.p4"></a>`INV-SPC-2.T1.P4` — wrong identity/signature<br><a id="inv-spc-2.t1.p5"></a>`INV-SPC-2.T1.P5` — missing identity/signature<br><a id="inv-spc-2.t1.p6"></a>`INV-SPC-2.T1.P6` — duplicate identity/signature<br><a id="inv-spc-2.t1.p7"></a>`INV-SPC-2.T1.P7` — forged identity/signature<br><a id="inv-spc-2.t1.p8"></a>`INV-SPC-2.T1.P8` — membership boundary                                                                                                                                                                                                                                                                                                     |
| `INV-SPC-3.T1` | `INV-SPC-3`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | One in-flight sync per peer, cleaned in `finally`.                                                                                        | <a id="inv-spc-3.t1.p1"></a>`INV-SPC-3.T1.P1` — valid case<br><a id="inv-spc-3.t1.p2"></a>`INV-SPC-3.T1.P2` — correct identity/signature<br><a id="inv-spc-3.t1.p3"></a>`INV-SPC-3.T1.P3` — direct invalid/opposite<br><a id="inv-spc-3.t1.p4"></a>`INV-SPC-3.T1.P4` — wrong identity/signature<br><a id="inv-spc-3.t1.p5"></a>`INV-SPC-3.T1.P5` — missing identity/signature<br><a id="inv-spc-3.t1.p6"></a>`INV-SPC-3.T1.P6` — duplicate identity/signature<br><a id="inv-spc-3.t1.p7"></a>`INV-SPC-3.T1.P7` — forged identity/signature<br><a id="inv-spc-3.t1.p8"></a>`INV-SPC-3.T1.P8` — membership boundary                                                                                                                                                                                                                                                                                                     |
| `INV-SPC-4.T1` | `INV-SPC-4`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Fail-closed: any failure aborts with no partial commitment (REQ-MSG-9).                                                                   | <a id="inv-spc-4.t1.p1"></a>`INV-SPC-4.T1.P1` — valid case<br><a id="inv-spc-4.t1.p2"></a>`INV-SPC-4.T1.P2` — matching commitment<br><a id="inv-spc-4.t1.p3"></a>`INV-SPC-4.T1.P3` — malformed input<br><a id="inv-spc-4.t1.p4"></a>`INV-SPC-4.T1.P4` — direct invalid/opposite<br><a id="inv-spc-4.t1.p5"></a>`INV-SPC-4.T1.P5` — mismatched commitment<br><a id="inv-spc-4.t1.p6"></a>`INV-SPC-4.T1.P6` — predecessor case<br><a id="inv-spc-4.t1.p7"></a>`INV-SPC-4.T1.P7` — genesis case<br><a id="inv-spc-4.t1.p8"></a>`INV-SPC-4.T1.P8` — stale fork<br><a id="inv-spc-4.t1.p9"></a>`INV-SPC-4.T1.P9` — foreign fork<br><a id="inv-spc-4.t1.p10"></a>`INV-SPC-4.T1.P10` — adversarial input<br><a id="inv-spc-4.t1.p11"></a>`INV-SPC-4.T1.P11` — partial failure<br><a id="inv-spc-4.t1.p12"></a>`INV-SPC-4.T1.P12` — retry and recovery                                                                        |
| `INV-SPC-5.T1` | `INV-SPC-5`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Adopted finalized snapshot satisfies the balance invariant (INV-MSG-6) client-side.                                                       | <a id="inv-spc-5.t1.p1"></a>`INV-SPC-5.T1.P1` — valid case<br><a id="inv-spc-5.t1.p2"></a>`INV-SPC-5.T1.P2` — matching commitment<br><a id="inv-spc-5.t1.p3"></a>`INV-SPC-5.T1.P3` — zero value<br><a id="inv-spc-5.t1.p4"></a>`INV-SPC-5.T1.P4` — direct invalid/opposite<br><a id="inv-spc-5.t1.p5"></a>`INV-SPC-5.T1.P5` — mismatched commitment<br><a id="inv-spc-5.t1.p6"></a>`INV-SPC-5.T1.P6` — predecessor case<br><a id="inv-spc-5.t1.p7"></a>`INV-SPC-5.T1.P7` — genesis case<br><a id="inv-spc-5.t1.p8"></a>`INV-SPC-5.T1.P8` — stale fork<br><a id="inv-spc-5.t1.p9"></a>`INV-SPC-5.T1.P9` — foreign fork<br><a id="inv-spc-5.t1.p10"></a>`INV-SPC-5.T1.P10` — exact balance/boundary<br><a id="inv-spc-5.t1.p11"></a>`INV-SPC-5.T1.P11` — one beyond boundary<br><a id="inv-spc-5.t1.p12"></a>`INV-SPC-5.T1.P12` — maximum value<br><a id="inv-spc-5.t1.p13"></a>`INV-SPC-5.T1.P13` — conservation check |
| `INV-SPC-6.T1` | `INV-SPC-6`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | No sync step sends a transaction; verification via local EVM / `staticCall`.                                                              | <a id="inv-spc-6.t1.p1"></a>`INV-SPC-6.T1.P1` — valid case<br><a id="inv-spc-6.t1.p2"></a>`INV-SPC-6.T1.P2` — zero/empty/no-op where meaningful<br><a id="inv-spc-6.t1.p3"></a>`INV-SPC-6.T1.P3` — direct invalid/opposite<br><a id="inv-spc-6.t1.p4"></a>`INV-SPC-6.T1.P4` — exact boundary<br><a id="inv-spc-6.t1.p5"></a>`INV-SPC-6.T1.P5` — failure/recovery<br><a id="inv-spc-6.t1.p6"></a>`INV-SPC-6.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `REQ-SPC-1.T1` | `REQ-SPC-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | The responder MUST return `undefined` (not a substituted proof) for any target it cannot prove exactly, including an above-latest height. | <a id="req-spc-1.t1.p1"></a>`REQ-SPC-1.T1.P1` — valid case<br><a id="req-spc-1.t1.p2"></a>`REQ-SPC-1.T1.P2` — zero/empty/no-op where meaningful<br><a id="req-spc-1.t1.p3"></a>`REQ-SPC-1.T1.P3` — direct invalid/opposite<br><a id="req-spc-1.t1.p4"></a>`REQ-SPC-1.T1.P4` — exact boundary<br><a id="req-spc-1.t1.p5"></a>`REQ-SPC-1.T1.P5` — failure/recovery<br><a id="req-spc-1.t1.p6"></a>`REQ-SPC-1.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `REQ-SPC-2.T1` | `REQ-SPC-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Request-path failures MUST distinguish availability/transport failure from Byzantine evidence before permanent exclusion.                 | <a id="req-spc-2.t1.p1"></a>`REQ-SPC-2.T1.P1` — valid case<br><a id="req-spc-2.t1.p2"></a>`REQ-SPC-2.T1.P2` — malformed input<br><a id="req-spc-2.t1.p3"></a>`REQ-SPC-2.T1.P3` — direct invalid/opposite<br><a id="req-spc-2.t1.p4"></a>`REQ-SPC-2.T1.P4` — adversarial input<br><a id="req-spc-2.t1.p5"></a>`REQ-SPC-2.T1.P5` — partial failure<br><a id="req-spc-2.t1.p6"></a>`REQ-SPC-2.T1.P6` — retry and recovery                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `REQ-SPC-3.T1` | `REQ-SPC-3`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | An honest can't-prove-yet request MUST NOT permanently blacklist the requester.                                                           | <a id="req-spc-3.t1.p1"></a>`REQ-SPC-3.T1.P1` — valid case<br><a id="req-spc-3.t1.p2"></a>`REQ-SPC-3.T1.P2` — zero/empty/no-op where meaningful<br><a id="req-spc-3.t1.p3"></a>`REQ-SPC-3.T1.P3` — direct invalid/opposite<br><a id="req-spc-3.t1.p4"></a>`REQ-SPC-3.T1.P4` — exact boundary<br><a id="req-spc-3.t1.p5"></a>`REQ-SPC-3.T1.P5` — failure/recovery<br><a id="req-spc-3.t1.p6"></a>`REQ-SPC-3.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `REQ-SPC-4.T1` | `REQ-SPC-4`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Proof-serving MUST be resource-bounded per peer.                                                                                          | <a id="req-spc-4.t1.p1"></a>`REQ-SPC-4.T1.P1` — valid case<br><a id="req-spc-4.t1.p2"></a>`REQ-SPC-4.T1.P2` — correct identity/signature<br><a id="req-spc-4.t1.p3"></a>`REQ-SPC-4.T1.P3` — direct invalid/opposite<br><a id="req-spc-4.t1.p4"></a>`REQ-SPC-4.T1.P4` — wrong identity/signature<br><a id="req-spc-4.t1.p5"></a>`REQ-SPC-4.T1.P5` — missing identity/signature<br><a id="req-spc-4.t1.p6"></a>`REQ-SPC-4.T1.P6` — duplicate identity/signature<br><a id="req-spc-4.t1.p7"></a>`REQ-SPC-4.T1.P7` — forged identity/signature<br><a id="req-spc-4.t1.p8"></a>`REQ-SPC-4.T1.P8` — membership boundary                                                                                                                                                                                                                                                                                                     |
