...
| --------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `INV-WRTC-1.T1` | `INV-WRTC-1`            | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Connection key comes from the authenticated transport, never the payload.                              | `INV-WRTC-1.T1.P1` — valid case and direct invalid/opposite<br>`INV-WRTC-1.T1.P2` — zero/empty/no-op where meaningful, exact boundary, failure/recovery and relevant race |
| `INV-WRTC-2.T1` | `INV-WRTC-2`            | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | One-way signaling methods reachable only behind `HandshakeCompletedGuard`.                             | `INV-WRTC-2.T1.P1` — valid case and direct invalid/opposite<br>`INV-WRTC-2.T1.P2` — correct/wrong/missing/duplicate/forged identity or signature and membership boundary  |
| `INV-WRTC-3.T1` | `INV-WRTC-3`            | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Handlers silent-ignore all failures; no throw, no disconnect from the service.                         | `INV-WRTC-3.T1.P1` — valid case and direct invalid/opposite<br>`INV-WRTC-3.T1.P2` — malformed and adversarial input, partial failure, retry and recovery                  |
| `INV-WRTC-4.T1` | `INV-WRTC-4`            | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Single offerer via `localAddress < completedPeerAddress`.                                              | `INV-WRTC-4.T1.P1` — valid case and direct invalid/opposite<br>`INV-WRTC-4.T1.P2` — correct/wrong/missing/duplicate/forged identity or signature and membership boundary  |
| `REQ-WRTC-1.T1` | `REQ-WRTC-1`            | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Signaling payloads are untrusted; SDP/ICE parsing safety is a documented WebRTC-dependency assumption. | `REQ-WRTC-1.T1.P1` — valid case and direct invalid/opposite<br>`REQ-WRTC-1.T1.P2` — correct/wrong/missing/duplicate/forged identity or signature and membership boundary  |
...
| ----------------------- | ------------------------------------------------------------------------------------------------------ | ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| `INV-WRTC-1`            | Connection key comes from the authenticated transport, never the payload.                              | Claimed; audit pending | [WebRTCSetupRpcMethods](../../../../../../../../src/rpc/services/WebRTCSetup/WebRTCSetupRpcMethods.ts#L6) (`senderTransport.peerAddress`), [WebRTCSetupService.normalizePeerAddress/findWebRTCTransport](../../../../../../../../src/rpc/services/WebRTCSetup/WebRTCSetupService.ts#L20) | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-WRTC-2`            | One-way signaling methods reachable only behind `HandshakeCompletedGuard`.                             | Claimed; audit pending | [WebRTCSetupService constructor](../../../../../../../../src/rpc/services/WebRTCSetup/WebRTCSetupService.ts#L1) (`this.guards`), [HandshakeCompletedGuard](../../../../../../../../src/rpc/guards/HandshakeCompletedGuard.ts#L41)                                                        | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-WRTC-3`            | Handlers silent-ignore all failures; no throw, no disconnect from the service.                         | Claimed; audit pending | [WebRTCSetupRpcMethods](../../../../../../../../src/rpc/services/WebRTCSetup/WebRTCSetupRpcMethods.ts#L6) (try/catch → log)                                                                                                                                                              | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-WRTC-4`            | Single offerer via `localAddress < completedPeerAddress`.                                              | Claimed; audit pending | [InitHandshakeService.maybeFinalizeHandshakeOnceFromTransport](../../../../../../../../src/rpc/services/initHandshake/InitHandshakeService.ts#L238)                                                                                                                                      | Engineer audit pending; any divergence named in the evidence remains open. |
| `REQ-WRTC-1`            | Signaling payloads are untrusted; SDP/ICE parsing safety is a documented WebRTC-dependency assumption. | Claimed; audit pending | [WebRTCSetupRpcMethods](../../../../../../../../src/rpc/services/WebRTCSetup/WebRTCSetupRpcMethods.ts#L6) (`JSON.parse` → stack), [connection/](../../../../../../../../src/rpc/services/WebRTCSetup/connection)                                                                         | Engineer audit pending; any divergence named in the evidence remains open. |
