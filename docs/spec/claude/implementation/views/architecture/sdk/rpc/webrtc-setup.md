...
- **Connection churn.** Each `onOfferWebRTC` calls `createConnection`, which `close()`s the peer's
  ...
  ([./README.md](./README.md) §9, [OQ-6](../../../../../specification/open-questions.md)).
...
| --------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `INV-WRTC-1.T1` | `INV-WRTC-1`            | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Connection key comes from the authenticated transport, never the payload.                              | <a id="inv-wrtc-1.t1.p1"></a>`INV-WRTC-1.T1.P1` — valid case<br><a id="inv-wrtc-1.t1.p2"></a>`INV-WRTC-1.T1.P2` — zero/empty/no-op where meaningful<br><a id="inv-wrtc-1.t1.p3"></a>`INV-WRTC-1.T1.P3` — direct invalid/opposite<br><a id="inv-wrtc-1.t1.p4"></a>`INV-WRTC-1.T1.P4` — exact boundary<br><a id="inv-wrtc-1.t1.p5"></a>`INV-WRTC-1.T1.P5` — failure/recovery<br><a id="inv-wrtc-1.t1.p6"></a>`INV-WRTC-1.T1.P6` — relevant race                                                                                                                                                                                     |
| `INV-WRTC-2.T1` | `INV-WRTC-2`            | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | One-way signaling methods reachable only behind `HandshakeCompletedGuard`.                             | <a id="inv-wrtc-2.t1.p1"></a>`INV-WRTC-2.T1.P1` — valid case<br><a id="inv-wrtc-2.t1.p2"></a>`INV-WRTC-2.T1.P2` — correct identity/signature<br><a id="inv-wrtc-2.t1.p3"></a>`INV-WRTC-2.T1.P3` — direct invalid/opposite<br><a id="inv-wrtc-2.t1.p4"></a>`INV-WRTC-2.T1.P4` — wrong identity/signature<br><a id="inv-wrtc-2.t1.p5"></a>`INV-WRTC-2.T1.P5` — missing identity/signature<br><a id="inv-wrtc-2.t1.p6"></a>`INV-WRTC-2.T1.P6` — duplicate identity/signature<br><a id="inv-wrtc-2.t1.p7"></a>`INV-WRTC-2.T1.P7` — forged identity/signature<br><a id="inv-wrtc-2.t1.p8"></a>`INV-WRTC-2.T1.P8` — membership boundary |
| `INV-WRTC-3.T1` | `INV-WRTC-3`            | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Handlers silent-ignore all failures; no throw, no disconnect from the service.                         | <a id="inv-wrtc-3.t1.p1"></a>`INV-WRTC-3.T1.P1` — valid case<br><a id="inv-wrtc-3.t1.p2"></a>`INV-WRTC-3.T1.P2` — malformed input<br><a id="inv-wrtc-3.t1.p3"></a>`INV-WRTC-3.T1.P3` — direct invalid/opposite<br><a id="inv-wrtc-3.t1.p4"></a>`INV-WRTC-3.T1.P4` — adversarial input<br><a id="inv-wrtc-3.t1.p5"></a>`INV-WRTC-3.T1.P5` — partial failure<br><a id="inv-wrtc-3.t1.p6"></a>`INV-WRTC-3.T1.P6` — retry and recovery                                                                                                                                                                                                |
| `INV-WRTC-4.T1` | `INV-WRTC-4`            | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Single offerer via `localAddress < completedPeerAddress`.                                              | <a id="inv-wrtc-4.t1.p1"></a>`INV-WRTC-4.T1.P1` — valid case<br><a id="inv-wrtc-4.t1.p2"></a>`INV-WRTC-4.T1.P2` — correct identity/signature<br><a id="inv-wrtc-4.t1.p3"></a>`INV-WRTC-4.T1.P3` — direct invalid/opposite<br><a id="inv-wrtc-4.t1.p4"></a>`INV-WRTC-4.T1.P4` — wrong identity/signature<br><a id="inv-wrtc-4.t1.p5"></a>`INV-WRTC-4.T1.P5` — missing identity/signature<br><a id="inv-wrtc-4.t1.p6"></a>`INV-WRTC-4.T1.P6` — duplicate identity/signature<br><a id="inv-wrtc-4.t1.p7"></a>`INV-WRTC-4.T1.P7` — forged identity/signature<br><a id="inv-wrtc-4.t1.p8"></a>`INV-WRTC-4.T1.P8` — membership boundary |
| `REQ-WRTC-1.T1` | `REQ-WRTC-1`            | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Signaling payloads are untrusted; SDP/ICE parsing safety is a documented WebRTC-dependency assumption. | <a id="req-wrtc-1.t1.p1"></a>`REQ-WRTC-1.T1.P1` — valid case<br><a id="req-wrtc-1.t1.p2"></a>`REQ-WRTC-1.T1.P2` — correct identity/signature<br><a id="req-wrtc-1.t1.p3"></a>`REQ-WRTC-1.T1.P3` — direct invalid/opposite<br><a id="req-wrtc-1.t1.p4"></a>`REQ-WRTC-1.T1.P4` — wrong identity/signature<br><a id="req-wrtc-1.t1.p5"></a>`REQ-WRTC-1.T1.P5` — missing identity/signature<br><a id="req-wrtc-1.t1.p6"></a>`REQ-WRTC-1.T1.P6` — duplicate identity/signature<br><a id="req-wrtc-1.t1.p7"></a>`REQ-WRTC-1.T1.P7` — forged identity/signature<br><a id="req-wrtc-1.t1.p8"></a>`REQ-WRTC-1.T1.P8` — membership boundary |
...
- Bound signaling frequency (offer/answer/ICE) under the central RPC rate limiter and its prioritization
  scheme ([OQ-6](../../../../../specification/open-questions.md), [./README.md](./README.md) §9); signaling is bulk/best-effort
...
- State the WebRTC-library SDP/ICE parsing trust boundary as an explicit dependency assumption in
  [../../security/trust-model.md](../../../../../specification/security/trust-model.md) (REQ-WRTC-1).
...
| ----------------------- | ------------------------------------------------------------------------------------------------------ | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| `INV-WRTC-1`            | Connection key comes from the authenticated transport, never the payload.                              | Covered               | [WebRTCSetupRpcMethods](../../../../../../../../src/rpc/services/WebRTCSetup/WebRTCSetupRpcMethods.ts#L6) (`senderTransport.peerAddress`), [WebRTCSetupService.normalizePeerAddress/findWebRTCTransport](../../../../../../../../src/rpc/services/WebRTCSetup/WebRTCSetupService.ts#L20) | None.            |
| `INV-WRTC-2`            | One-way signaling methods reachable only behind `HandshakeCompletedGuard`.                             | Covered               | [WebRTCSetupService constructor](../../../../../../../../src/rpc/services/WebRTCSetup/WebRTCSetupService.ts#L1) (`this.guards`), [HandshakeCompletedGuard](../../../../../../../../src/rpc/guards/HandshakeCompletedGuard.ts#L41)                                                        | None.            |
| `INV-WRTC-3`            | Handlers silent-ignore all failures; no throw, no disconnect from the service.                         | Covered               | [WebRTCSetupRpcMethods](../../../../../../../../src/rpc/services/WebRTCSetup/WebRTCSetupRpcMethods.ts#L6) (try/catch → log)                                                                                                                                                              | None.            |
| `INV-WRTC-4`            | Single offerer via `localAddress < completedPeerAddress`.                                              | Covered               | [InitHandshakeService.maybeFinalizeHandshakeOnceFromTransport](../../../../../../../../src/rpc/services/initHandshake/InitHandshakeService.ts#L238)                                                                                                                                      | None.            |
| `REQ-WRTC-1`            | Signaling payloads are untrusted; SDP/ICE parsing safety is a documented WebRTC-dependency assumption. | Covered               | [WebRTCSetupRpcMethods](../../../../../../../../src/rpc/services/WebRTCSetup/WebRTCSetupRpcMethods.ts#L6) (`JSON.parse` → stack), [connection/](../../../../../../../../src/rpc/services/WebRTCSetup/connection)                                                                         | None.            |
