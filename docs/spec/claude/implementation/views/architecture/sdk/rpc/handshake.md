...
(Byzantine peers, transport trust), [../../open-questions.md](../../../../../specification/open-questions.md) (OQ-29, OQ-34,
DEF-8).

Code (paths relative to this file; repo root = `../../../../../`):

- [src/rpc/services/initHandshake/InitHandshakeService.ts](../../../../../../../../src/rpc/services/initHandshake/InitHandshakeService.ts#L2)
- [src/rpc/services/initHandshake/InitHandshakeRpcMethods.ts](../../../../../../../../src/rpc/services/initHandshake/InitHandshakeRpcMethods.ts#L2)
...
`ver` note under [OQ-29](../../../../../specification/open-questions.md)).
...
2. **Time-skew check.** `timeDifference = time - localTime`; `Math.abs(timeDifference) > agreementTime`
   ...
   window (read from chain time config, [../../protocol/time.md](../../../../../specification/protocol-model/time.md)).
...
adjacent to but distinct from [OQ-29](../../../../../specification/open-questions.md) (cross-deployment domain separation)
and the protocol-versioning item in [OQ-34](../../../../../specification/open-questions.md); it should be raised for an
...
([./README.md](./README.md) §9, REQ-RPC-7 / [OQ-6](../../../../../specification/open-questions.md)). A peer can flood
...
flagged generally in [./README.md](./README.md) §8 and [OQ-34](../../../../../specification/open-questions.md) (ban
...
| -------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `INV-HSK-1.T1` | `INV-HSK-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Profile completes only after verify + ack + preferred-transport on the transport (both directions). | <a id="inv-hsk-1.t1.p1"></a>`INV-HSK-1.T1.P1` — valid case<br><a id="inv-hsk-1.t1.p2"></a>`INV-HSK-1.T1.P2` — zero/empty/no-op where meaningful<br><a id="inv-hsk-1.t1.p3"></a>`INV-HSK-1.T1.P3` — direct invalid/opposite<br><a id="inv-hsk-1.t1.p4"></a>`INV-HSK-1.T1.P4` — exact boundary<br><a id="inv-hsk-1.t1.p5"></a>`INV-HSK-1.T1.P5` — failure/recovery<br><a id="inv-hsk-1.t1.p6"></a>`INV-HSK-1.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `INV-HSK-2.T1` | `INV-HSK-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Responder signs the domain-tagged message; no block-signature collision.                            | <a id="inv-hsk-2.t1.p1"></a>`INV-HSK-2.T1.P1` — valid case<br><a id="inv-hsk-2.t1.p2"></a>`INV-HSK-2.T1.P2` — correct identity/signature<br><a id="inv-hsk-2.t1.p3"></a>`INV-HSK-2.T1.P3` — direct invalid/opposite<br><a id="inv-hsk-2.t1.p4"></a>`INV-HSK-2.T1.P4` — wrong identity/signature<br><a id="inv-hsk-2.t1.p5"></a>`INV-HSK-2.T1.P5` — missing identity/signature<br><a id="inv-hsk-2.t1.p6"></a>`INV-HSK-2.T1.P6` — duplicate identity/signature<br><a id="inv-hsk-2.t1.p7"></a>`INV-HSK-2.T1.P7` — forged identity/signature<br><a id="inv-hsk-2.t1.p8"></a>`INV-HSK-2.T1.P8` — membership boundary                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `INV-HSK-3.T1` | `INV-HSK-3`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Non-hex32 challenge / non-finite time rejected before signing.                                      | <a id="inv-hsk-3.t1.p1"></a>`INV-HSK-3.T1.P1` — valid case<br><a id="inv-hsk-3.t1.p2"></a>`INV-HSK-3.T1.P2` — correct identity/signature<br><a id="inv-hsk-3.t1.p3"></a>`INV-HSK-3.T1.P3` — before deadline<br><a id="inv-hsk-3.t1.p4"></a>`INV-HSK-3.T1.P4` — malformed input<br><a id="inv-hsk-3.t1.p5"></a>`INV-HSK-3.T1.P5` — direct invalid/opposite<br><a id="inv-hsk-3.t1.p6"></a>`INV-HSK-3.T1.P6` — wrong identity/signature<br><a id="inv-hsk-3.t1.p7"></a>`INV-HSK-3.T1.P7` — missing identity/signature<br><a id="inv-hsk-3.t1.p8"></a>`INV-HSK-3.T1.P8` — duplicate identity/signature<br><a id="inv-hsk-3.t1.p9"></a>`INV-HSK-3.T1.P9` — forged identity/signature<br><a id="inv-hsk-3.t1.p10"></a>`INV-HSK-3.T1.P10` — membership boundary<br><a id="inv-hsk-3.t1.p11"></a>`INV-HSK-3.T1.P11` — at deadline<br><a id="inv-hsk-3.t1.p12"></a>`INV-HSK-3.T1.P12` — after deadline<br><a id="inv-hsk-3.t1.p13"></a>`INV-HSK-3.T1.P13` — maximum honest skew<br><a id="inv-hsk-3.t1.p14"></a>`INV-HSK-3.T1.P14` — adversarial input<br><a id="inv-hsk-3.t1.p15"></a>`INV-HSK-3.T1.P15` — partial failure<br><a id="inv-hsk-3.t1.p16"></a>`INV-HSK-3.T1.P16` — retry and recovery |
| `INV-HSK-4.T1` | `INV-HSK-4`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Ack `challengeHash` is diagnostic only, never trusted.                                              | <a id="inv-hsk-4.t1.p1"></a>`INV-HSK-4.T1.P1` — valid case<br><a id="inv-hsk-4.t1.p2"></a>`INV-HSK-4.T1.P2` — matching commitment<br><a id="inv-hsk-4.t1.p3"></a>`INV-HSK-4.T1.P3` — direct invalid/opposite<br><a id="inv-hsk-4.t1.p4"></a>`INV-HSK-4.T1.P4` — mismatched commitment<br><a id="inv-hsk-4.t1.p5"></a>`INV-HSK-4.T1.P5` — predecessor case<br><a id="inv-hsk-4.t1.p6"></a>`INV-HSK-4.T1.P6` — genesis case<br><a id="inv-hsk-4.t1.p7"></a>`INV-HSK-4.T1.P7` — stale fork<br><a id="inv-hsk-4.t1.p8"></a>`INV-HSK-4.T1.P8` — foreign fork                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `INV-HSK-5.T1` | `INV-HSK-5`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Request/response accepted only within one `agreementTime` skew window.                              | <a id="inv-hsk-5.t1.p1"></a>`INV-HSK-5.T1.P1` — valid case<br><a id="inv-hsk-5.t1.p2"></a>`INV-HSK-5.T1.P2` — before deadline<br><a id="inv-hsk-5.t1.p3"></a>`INV-HSK-5.T1.P3` — direct invalid/opposite<br><a id="inv-hsk-5.t1.p4"></a>`INV-HSK-5.T1.P4` — at deadline<br><a id="inv-hsk-5.t1.p5"></a>`INV-HSK-5.T1.P5` — after deadline<br><a id="inv-hsk-5.t1.p6"></a>`INV-HSK-5.T1.P6` — maximum honest skew                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `REQ-HSK-1.T1` | `REQ-HSK-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Unguarded service; every endpoint safe against unauthenticated adversarial input.                   | <a id="req-hsk-1.t1.p1"></a>`REQ-HSK-1.T1.P1` — valid case<br><a id="req-hsk-1.t1.p2"></a>`REQ-HSK-1.T1.P2` — zero/empty/no-op where meaningful<br><a id="req-hsk-1.t1.p3"></a>`REQ-HSK-1.T1.P3` — direct invalid/opposite<br><a id="req-hsk-1.t1.p4"></a>`REQ-HSK-1.T1.P4` — exact boundary<br><a id="req-hsk-1.t1.p5"></a>`REQ-HSK-1.T1.P5` — failure/recovery<br><a id="req-hsk-1.t1.p6"></a>`REQ-HSK-1.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `REQ-HSK-2.T1` | `REQ-HSK-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Messages signed for unauthenticated callers are domain-separated.                                   | <a id="req-hsk-2.t1.p1"></a>`REQ-HSK-2.T1.P1` — valid case<br><a id="req-hsk-2.t1.p2"></a>`REQ-HSK-2.T1.P2` — correct identity/signature<br><a id="req-hsk-2.t1.p3"></a>`REQ-HSK-2.T1.P3` — direct invalid/opposite<br><a id="req-hsk-2.t1.p4"></a>`REQ-HSK-2.T1.P4` — wrong identity/signature<br><a id="req-hsk-2.t1.p5"></a>`REQ-HSK-2.T1.P5` — missing identity/signature<br><a id="req-hsk-2.t1.p6"></a>`REQ-HSK-2.T1.P6` — duplicate identity/signature<br><a id="req-hsk-2.t1.p7"></a>`REQ-HSK-2.T1.P7` — forged identity/signature<br><a id="req-hsk-2.t1.p8"></a>`REQ-HSK-2.T1.P8` — membership boundary                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
- Bind peer identity and a channel/session token into the signed handshake message to close the relay/
  reflection MITM (§4.1); coordinate with [OQ-29](../../../../../specification/open-questions.md) domain separation and the
  protocol-versioning decision in [OQ-34](../../../../../specification/open-questions.md) so one signed-domain scheme covers
...
- Persist pre-profile bans by transport-level address so a rejected pre-handshake peer cannot reconnect
  freely ([OQ-34](../../../../../specification/open-questions.md), [./README.md](./README.md) §8).
- Fold the pre-guard signing endpoint under the central RPC rate limiter ([OQ-6](../../../../../specification/open-questions.md),
...
| ----------------------- | --------------------------------------------------------------------------------------------------- | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| `INV-HSK-1`             | Profile completes only after verify + ack + preferred-transport on the transport (both directions). | Covered               | [InitHandshakeService.maybeFinalizeHandshakeOnceFromTransport](../../../../../../../../src/rpc/services/initHandshake/InitHandshakeService.ts#L238)                                                                                                                          | None.            |
| `INV-HSK-2`             | Responder signs the domain-tagged message; no block-signature collision.                            | Covered               | [InitHandshakeService.buildHandshakeChallengeMessage / HANDSHAKE_DOMAIN](../../../../../../../../src/rpc/services/initHandshake/InitHandshakeService.ts#L45)                                                                                                                 | None.            |
| `INV-HSK-3`             | Non-hex32 challenge / non-finite time rejected before signing.                                      | Covered               | [InitHandshakeRpcMethods.onInitHandshakeRequest](../../../../../../../../src/rpc/services/initHandshake/InitHandshakeRpcMethods.ts#L25)                                                                                                                                      | None.            |
| `INV-HSK-4`             | Ack `challengeHash` is diagnostic only, never trusted.                                              | Covered               | [InitHandshakeRpcMethods.onInitHandshakeAck](../../../../../../../../src/rpc/services/initHandshake/InitHandshakeRpcMethods.ts#L114)                                                                                                                                         | None.            |
| `INV-HSK-5`             | Request/response accepted only within one `agreementTime` skew window.                              | Covered               | [InitHandshakeRpcMethods.onInitHandshakeRequest](../../../../../../../../src/rpc/services/initHandshake/InitHandshakeRpcMethods.ts#L25), [InitHandshakeService.handleHandshakeResponse](../../../../../../../../src/rpc/services/initHandshake/InitHandshakeService.ts#L131) | None.            |
| `REQ-HSK-1`             | Unguarded service; every endpoint safe against unauthenticated adversarial input.                   | Covered               | [InitHandshakeService.ts](../../../../../../../../src/rpc/services/initHandshake/InitHandshakeService.ts#L1) (no `this.guards`)                                                                                                                                              | None.            |
| `REQ-HSK-2`             | Messages signed for unauthenticated callers are domain-separated.                                   | Covered               | [InitHandshakeService.HANDSHAKE_DOMAIN](../../../../../../../../src/rpc/services/initHandshake/InitHandshakeService.ts#L1)                                                                                                                                                   | None.            |
