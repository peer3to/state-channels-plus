...
| -------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `INV-HSK-1.T1` | `INV-HSK-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Profile completes only after verify + ack + preferred-transport on the transport (both directions). | `INV-HSK-1.T1.P1` — valid case and direct invalid/opposite<br>`INV-HSK-1.T1.P2` — zero/empty/no-op where meaningful, exact boundary, failure/recovery and relevant race                                                                                                                                                                    |
| `INV-HSK-2.T1` | `INV-HSK-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Responder signs the domain-tagged message; no block-signature collision.                            | `INV-HSK-2.T1.P1` — valid case and direct invalid/opposite<br>`INV-HSK-2.T1.P2` — correct/wrong/missing/duplicate/forged identity or signature and membership boundary                                                                                                                                                                     |
| `INV-HSK-3.T1` | `INV-HSK-3`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Non-hex32 challenge / non-finite time rejected before signing.                                      | `INV-HSK-3.T1.P1` — valid case and direct invalid/opposite<br>`INV-HSK-3.T1.P2` — correct/wrong/missing/duplicate/forged identity or signature and membership boundary<br>`INV-HSK-3.T1.P3` — before/at/after deadline and maximum honest skew<br>`INV-HSK-3.T1.P4` — malformed and adversarial input, partial failure, retry and recovery |
| `INV-HSK-4.T1` | `INV-HSK-4`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Ack `challengeHash` is diagnostic only, never trusted.                                              | `INV-HSK-4.T1.P1` — valid case and direct invalid/opposite<br>`INV-HSK-4.T1.P2` — matching/mismatched commitment, predecessor/genesis, stale and foreign fork                                                                                                                                                                              |
| `INV-HSK-5.T1` | `INV-HSK-5`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Request/response accepted only within one `agreementTime` skew window.                              | `INV-HSK-5.T1.P1` — valid case and direct invalid/opposite<br>`INV-HSK-5.T1.P2` — before/at/after deadline and maximum honest skew                                                                                                                                                                                                         |
| `REQ-HSK-1.T1` | `REQ-HSK-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Unguarded service; every endpoint safe against unauthenticated adversarial input.                   | `REQ-HSK-1.T1.P1` — valid case and direct invalid/opposite<br>`REQ-HSK-1.T1.P2` — zero/empty/no-op where meaningful, exact boundary, failure/recovery and relevant race                                                                                                                                                                    |
| `REQ-HSK-2.T1` | `REQ-HSK-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Messages signed for unauthenticated callers are domain-separated.                                   | `REQ-HSK-2.T1.P1` — valid case and direct invalid/opposite<br>`REQ-HSK-2.T1.P2` — correct/wrong/missing/duplicate/forged identity or signature and membership boundary                                                                                                                                                                     |
...
| ----------------------- | --------------------------------------------------------------------------------------------------- | ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| `INV-HSK-1`             | Profile completes only after verify + ack + preferred-transport on the transport (both directions). | Claimed; audit pending | [InitHandshakeService.maybeFinalizeHandshakeOnceFromTransport](../../../../../../../../src/rpc/services/initHandshake/InitHandshakeService.ts#L238)                                                                                                                          | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-HSK-2`             | Responder signs the domain-tagged message; no block-signature collision.                            | Claimed; audit pending | [InitHandshakeService.buildHandshakeChallengeMessage / HANDSHAKE_DOMAIN](../../../../../../../../src/rpc/services/initHandshake/InitHandshakeService.ts#L45)                                                                                                                 | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-HSK-3`             | Non-hex32 challenge / non-finite time rejected before signing.                                      | Claimed; audit pending | [InitHandshakeRpcMethods.onInitHandshakeRequest](../../../../../../../../src/rpc/services/initHandshake/InitHandshakeRpcMethods.ts#L25)                                                                                                                                      | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-HSK-4`             | Ack `challengeHash` is diagnostic only, never trusted.                                              | Claimed; audit pending | [InitHandshakeRpcMethods.onInitHandshakeAck](../../../../../../../../src/rpc/services/initHandshake/InitHandshakeRpcMethods.ts#L114)                                                                                                                                         | Engineer audit pending; any divergence named in the evidence remains open. |
| `INV-HSK-5`             | Request/response accepted only within one `agreementTime` skew window.                              | Claimed; audit pending | [InitHandshakeRpcMethods.onInitHandshakeRequest](../../../../../../../../src/rpc/services/initHandshake/InitHandshakeRpcMethods.ts#L25), [InitHandshakeService.handleHandshakeResponse](../../../../../../../../src/rpc/services/initHandshake/InitHandshakeService.ts#L131) | Engineer audit pending; any divergence named in the evidence remains open. |
| `REQ-HSK-1`             | Unguarded service; every endpoint safe against unauthenticated adversarial input.                   | Claimed; audit pending | [InitHandshakeService.ts](../../../../../../../../src/rpc/services/initHandshake/InitHandshakeService.ts#L1) (no `this.guards`)                                                                                                                                              | Engineer audit pending; any divergence named in the evidence remains open. |
| `REQ-HSK-2`             | Messages signed for unauthenticated callers are domain-separated.                                   | Claimed; audit pending | [InitHandshakeService.HANDSHAKE_DOMAIN](../../../../../../../../src/rpc/services/initHandshake/InitHandshakeService.ts#L1)                                                                                                                                                   | Engineer audit pending; any divergence named in the evidence remains open. |
