...
- **`amount` is unvalidated.** A non-number stalls (`typeof` checks in `maybeProgress` /
  ...
  (no blacklist — [README.md](./README.md) §6.4). Observed fact: this violates REQ-RPC-2's
  decode-and-validate-before-effect rule; the failure is contained to a disconnect, but it is an
  escaping exception, not a handled protocol failure. (Divergence class: bug against REQ-RPC-2 —
...
No rate limiting exists at the boundary (REQ-RPC-7, [README.md](./README.md) §9), so:
...
neither idempotent nor replay-rejecting in the REQ-RPC-6 sense:
...
**Open question:** the REQ-RPC-6 classification for `openProposal` (make it replay-rejecting via
...
versus deferring entirely to the central rate limiter (OQ-6). (Divergence class: decision
pending.)
...
(OQ-34, [../../open-questions.md](../../../../../specification/open-questions.md)): silent ignore makes out-of-sequence
...
| ID        | Invariant                                                                                                                                                                                          |
| --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| INV-OCN-1 | At most one negotiation is in flight per node; frames from any peer other than the current counterparty never mutate the active round (they are refused busy or silently ignored).                 |
| INV-OCN-2 | The local deposit amount in any proposal the node signs or co-signs is the locally held `myAmount`; no wire value can change the local side of the balances.                                       |
| INV-OCN-3 | The node co-signs an `OpenChannelStruct` only when it matches the locally reconstructed negotiated terms field-for-field and the accompanying signature recovers to the lower-address participant. |
| INV-OCN-4 | Once `channelOpened` latches, every endpoint and timer path is a no-op for this channel.                                                                                                           |
...
| -------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `REQ-OCN-1.T1` | `REQ-OCN-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Every endpoint binds the counterparty to the handshake-verified transport address; parameters never select the peer.                            | <a id="req-ocn-1.t1.p1"></a>`REQ-OCN-1.T1.P1` — valid case<br><a id="req-ocn-1.t1.p2"></a>`REQ-OCN-1.T1.P2` — correct identity/signature<br><a id="req-ocn-1.t1.p3"></a>`REQ-OCN-1.T1.P3` — direct invalid/opposite<br><a id="req-ocn-1.t1.p4"></a>`REQ-OCN-1.T1.P4` — wrong identity/signature<br><a id="req-ocn-1.t1.p5"></a>`REQ-OCN-1.T1.P5` — missing identity/signature<br><a id="req-ocn-1.t1.p6"></a>`REQ-OCN-1.T1.P6` — duplicate identity/signature<br><a id="req-ocn-1.t1.p7"></a>`REQ-OCN-1.T1.P7` — forged identity/signature<br><a id="req-ocn-1.t1.p8"></a>`REQ-OCN-1.T1.P8` — membership boundary                                                                                                                                                                                                                                                                                                                                                               |
| `REQ-OCN-2.T1` | `REQ-OCN-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | The receiver co-signs only the exact negotiated terms; any field deviation or bad lower signature → disconnect + blacklist + reset.             | <a id="req-ocn-2.t1.p1"></a>`REQ-OCN-2.T1.P1` — valid case<br><a id="req-ocn-2.t1.p2"></a>`REQ-OCN-2.T1.P2` — correct identity/signature<br><a id="req-ocn-2.t1.p3"></a>`REQ-OCN-2.T1.P3` — direct invalid/opposite<br><a id="req-ocn-2.t1.p4"></a>`REQ-OCN-2.T1.P4` — wrong identity/signature<br><a id="req-ocn-2.t1.p5"></a>`REQ-OCN-2.T1.P5` — missing identity/signature<br><a id="req-ocn-2.t1.p6"></a>`REQ-OCN-2.T1.P6` — duplicate identity/signature<br><a id="req-ocn-2.t1.p7"></a>`REQ-OCN-2.T1.P7` — forged identity/signature<br><a id="req-ocn-2.t1.p8"></a>`REQ-OCN-2.T1.P8` — membership boundary                                                                                                                                                                                                                                                                                                                                                               |
| `REQ-OCN-3.T1` | `REQ-OCN-3`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Open success is confirmed against the chain, never against a peer message; the deadline check aborts and resets a round the chain did not open. | <a id="req-ocn-3.t1.p1"></a>`REQ-OCN-3.T1.P1` — valid case<br><a id="req-ocn-3.t1.p2"></a>`REQ-OCN-3.T1.P2` — correct identity/signature<br><a id="req-ocn-3.t1.p3"></a>`REQ-OCN-3.T1.P3` — before deadline<br><a id="req-ocn-3.t1.p4"></a>`REQ-OCN-3.T1.P4` — direct invalid/opposite<br><a id="req-ocn-3.t1.p5"></a>`REQ-OCN-3.T1.P5` — wrong identity/signature<br><a id="req-ocn-3.t1.p6"></a>`REQ-OCN-3.T1.P6` — missing identity/signature<br><a id="req-ocn-3.t1.p7"></a>`REQ-OCN-3.T1.P7` — duplicate identity/signature<br><a id="req-ocn-3.t1.p8"></a>`REQ-OCN-3.T1.P8` — forged identity/signature<br><a id="req-ocn-3.t1.p9"></a>`REQ-OCN-3.T1.P9` — membership boundary<br><a id="req-ocn-3.t1.p10"></a>`REQ-OCN-3.T1.P10` — at deadline<br><a id="req-ocn-3.t1.p11"></a>`REQ-OCN-3.T1.P11` — after deadline<br><a id="req-ocn-3.t1.p12"></a>`REQ-OCN-3.T1.P12` — maximum honest skew                                                                              |
| `INV-OCN-1.T1` | `INV-OCN-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | One negotiation slot; non-counterparty frames never mutate the active round.                                                                    | <a id="inv-ocn-1.t1.p1"></a>`INV-OCN-1.T1.P1` — valid case<br><a id="inv-ocn-1.t1.p2"></a>`INV-OCN-1.T1.P2` — zero/empty/no-op where meaningful<br><a id="inv-ocn-1.t1.p3"></a>`INV-OCN-1.T1.P3` — direct invalid/opposite<br><a id="inv-ocn-1.t1.p4"></a>`INV-OCN-1.T1.P4` — exact boundary<br><a id="inv-ocn-1.t1.p5"></a>`INV-OCN-1.T1.P5` — failure/recovery<br><a id="inv-ocn-1.t1.p6"></a>`INV-OCN-1.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `INV-OCN-2.T1` | `INV-OCN-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | The local balance side of any signed proposal is the locally held `myAmount`.                                                                   | <a id="inv-ocn-2.t1.p1"></a>`INV-OCN-2.T1.P1` — valid case<br><a id="inv-ocn-2.t1.p2"></a>`INV-OCN-2.T1.P2` — correct identity/signature<br><a id="inv-ocn-2.t1.p3"></a>`INV-OCN-2.T1.P3` — zero value<br><a id="inv-ocn-2.t1.p4"></a>`INV-OCN-2.T1.P4` — direct invalid/opposite<br><a id="inv-ocn-2.t1.p5"></a>`INV-OCN-2.T1.P5` — wrong identity/signature<br><a id="inv-ocn-2.t1.p6"></a>`INV-OCN-2.T1.P6` — missing identity/signature<br><a id="inv-ocn-2.t1.p7"></a>`INV-OCN-2.T1.P7` — duplicate identity/signature<br><a id="inv-ocn-2.t1.p8"></a>`INV-OCN-2.T1.P8` — forged identity/signature<br><a id="inv-ocn-2.t1.p9"></a>`INV-OCN-2.T1.P9` — membership boundary<br><a id="inv-ocn-2.t1.p10"></a>`INV-OCN-2.T1.P10` — exact balance/boundary<br><a id="inv-ocn-2.t1.p11"></a>`INV-OCN-2.T1.P11` — one beyond boundary<br><a id="inv-ocn-2.t1.p12"></a>`INV-OCN-2.T1.P12` — maximum value<br><a id="inv-ocn-2.t1.p13"></a>`INV-OCN-2.T1.P13` — conservation check |
| `INV-OCN-3.T1` | `INV-OCN-3`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Co-signing requires field-exact term match plus lower-address signature recovery.                                                               | <a id="inv-ocn-3.t1.p1"></a>`INV-OCN-3.T1.P1` — valid case<br><a id="inv-ocn-3.t1.p2"></a>`INV-OCN-3.T1.P2` — correct identity/signature<br><a id="inv-ocn-3.t1.p3"></a>`INV-OCN-3.T1.P3` — direct invalid/opposite<br><a id="inv-ocn-3.t1.p4"></a>`INV-OCN-3.T1.P4` — wrong identity/signature<br><a id="inv-ocn-3.t1.p5"></a>`INV-OCN-3.T1.P5` — missing identity/signature<br><a id="inv-ocn-3.t1.p6"></a>`INV-OCN-3.T1.P6` — duplicate identity/signature<br><a id="inv-ocn-3.t1.p7"></a>`INV-OCN-3.T1.P7` — forged identity/signature<br><a id="inv-ocn-3.t1.p8"></a>`INV-OCN-3.T1.P8` — membership boundary                                                                                                                                                                                                                                                                                                                                                               |
| `INV-OCN-4.T1` | `INV-OCN-4`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | `channelOpened` latches and disables all endpoints and timers for the channel.                                                                  | <a id="inv-ocn-4.t1.p1"></a>`INV-OCN-4.T1.P1` — valid case<br><a id="inv-ocn-4.t1.p2"></a>`INV-OCN-4.T1.P2` — before deadline<br><a id="inv-ocn-4.t1.p3"></a>`INV-OCN-4.T1.P3` — direct invalid/opposite<br><a id="inv-ocn-4.t1.p4"></a>`INV-OCN-4.T1.P4` — at deadline<br><a id="inv-ocn-4.t1.p5"></a>`INV-OCN-4.T1.P5` — after deadline<br><a id="inv-ocn-4.t1.p6"></a>`INV-OCN-4.T1.P6` — maximum honest skew                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
- Replay/idempotence decision for `openProposal` (§5.4) and slot-occupation mitigation (§5.2),
  coordinated with the central rate limiter (OQ-6).
...
| ----------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| `REQ-OCN-1`             | Every endpoint binds the counterparty to the handshake-verified transport address; parameters never select the peer.                            | Covered               | [src/rpc/services/openChannelNegotiation/OpenChannelNegotiationRpcMethods.ts](../../../../../../../../src/rpc/services/openChannelNegotiation/OpenChannelNegotiationRpcMethods.ts#L3)                                                                                                                                                     | None.            |
| `REQ-OCN-2`             | The receiver co-signs only the exact negotiated terms; any field deviation or bad lower signature → disconnect + blacklist + reset.             | Covered               | [src/rpc/services/openChannelNegotiation/OpenChannelNegotiationService.ts](../../../../../../../../src/rpc/services/openChannelNegotiation/OpenChannelNegotiationService.ts#L5) (`openProposal`), [OpenChannelNegotiationHelpers.ts](../../../../../../../../src/rpc/services/openChannelNegotiation/OpenChannelNegotiationHelpers.ts#L1) | None.            |
| `REQ-OCN-3`             | Open success is confirmed against the chain, never against a peer message; the deadline check aborts and resets a round the chain did not open. | Covered               | [src/rpc/services/openChannelNegotiation/OpenChannelNegotiationService.ts](../../../../../../../../src/rpc/services/openChannelNegotiation/OpenChannelNegotiationService.ts#L5) (`maybeProgress`, `scheduleDeadlineCheck`)                                                                                                                | None.            |
| `INV-OCN-1`             | One negotiation slot; non-counterparty frames never mutate the active round.                                                                    | Covered               | [src/rpc/services/openChannelNegotiation/OpenChannelNegotiationRpcMethods.ts](../../../../../../../../src/rpc/services/openChannelNegotiation/OpenChannelNegotiationRpcMethods.ts#L3)                                                                                                                                                     | None.            |
| `INV-OCN-2`             | The local balance side of any signed proposal is the locally held `myAmount`.                                                                   | Covered               | [src/rpc/services/openChannelNegotiation/OpenChannelNegotiationService.ts](../../../../../../../../src/rpc/services/openChannelNegotiation/OpenChannelNegotiationService.ts#L5) (`getParticipantsAndBalances`)                                                                                                                            | None.            |
| `INV-OCN-3`             | Co-signing requires field-exact term match plus lower-address signature recovery.                                                               | Covered               | [src/rpc/services/openChannelNegotiation/OpenChannelNegotiationService.ts](../../../../../../../../src/rpc/services/openChannelNegotiation/OpenChannelNegotiationService.ts#L5), [OpenChannelNegotiationHelpers.ts](../../../../../../../../src/rpc/services/openChannelNegotiation/OpenChannelNegotiationHelpers.ts#L1)                  | None.            |
| `INV-OCN-4`             | `channelOpened` latches and disables all endpoints and timers for the channel.                                                                  | Covered               | [src/rpc/services/openChannelNegotiation/OpenChannelNegotiationService.ts](../../../../../../../../src/rpc/services/openChannelNegotiation/OpenChannelNegotiationService.ts#L5)                                                                                                                                                           | None.            |
