...
2. **Sender attribution** _(RPC layer,
   ...
   disconnect-only ([./README.md](./README.md) §8 open question, [OQ-34](../../../../../specification/open-questions.md)).
...
- **Authentic junk at scale.** Authenticity only binds the author signature to the _declared_
  ...
  [OQ-6](../../../../../specification/open-questions.md)). Until then, memory and task-queue growth during one
...
`P2PManager.onRpc` (engineer direction 2026-08-10, [OQ-6](../../../../../specification/open-questions.md)); required
...
| -------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `REQ-STS-1.T1` | `REQ-STS-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | `onBlockConfirmation` delegates all payload judgment to `ingestBlockConfirmation`, passing the handshake-verified sender address for attribution; the RPC layer performs no payload validation of its own. | <a id="req-sts-1.t1.p1"></a>`REQ-STS-1.T1.P1` — valid case<br><a id="req-sts-1.t1.p2"></a>`REQ-STS-1.T1.P2` — zero/empty/no-op where meaningful<br><a id="req-sts-1.t1.p3"></a>`REQ-STS-1.T1.P3` — direct invalid/opposite<br><a id="req-sts-1.t1.p4"></a>`REQ-STS-1.T1.P4` — exact boundary<br><a id="req-sts-1.t1.p5"></a>`REQ-STS-1.T1.P5` — failure/recovery<br><a id="req-sts-1.t1.p6"></a>`REQ-STS-1.T1.P6` — relevant race                                                                                                                                                                                 |
| `REQ-STS-2.T1` | `REQ-STS-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | A `false` keep-connection verdict disconnects and blacklists the sender by EVM address; `true` has no RPC-layer side effect.                                                                               | <a id="req-sts-2.t1.p1"></a>`REQ-STS-2.T1.P1` — valid case<br><a id="req-sts-2.t1.p2"></a>`REQ-STS-2.T1.P2` — zero/empty/no-op where meaningful<br><a id="req-sts-2.t1.p3"></a>`REQ-STS-2.T1.P3` — direct invalid/opposite<br><a id="req-sts-2.t1.p4"></a>`REQ-STS-2.T1.P4` — exact boundary<br><a id="req-sts-2.t1.p5"></a>`REQ-STS-2.T1.P5` — failure/recovery<br><a id="req-sts-2.t1.p6"></a>`REQ-STS-2.T1.P6` — relevant race                                                                                                                                                                                 |
| `INV-STS-1.T1` | `INV-STS-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Handler holds no mutex and mutates no live state inline.                                                                                                                                                   | <a id="inv-sts-1.t1.p1"></a>`INV-STS-1.T1.P1` — valid case<br><a id="inv-sts-1.t1.p2"></a>`INV-STS-1.T1.P2` — zero/empty/no-op where meaningful<br><a id="inv-sts-1.t1.p3"></a>`INV-STS-1.T1.P3` — direct invalid/opposite<br><a id="inv-sts-1.t1.p4"></a>`INV-STS-1.T1.P4` — exact boundary<br><a id="inv-sts-1.t1.p5"></a>`INV-STS-1.T1.P5` — failure/recovery<br><a id="inv-sts-1.t1.p6"></a>`INV-STS-1.T1.P6` — relevant race                                                                                                                                                                                 |
| `INV-STS-2.T1` | `INV-STS-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Peer-RPC ingest is always source-attributed.                                                                                                                                                               | <a id="inv-sts-2.t1.p1"></a>`INV-STS-2.T1.P1` — valid case<br><a id="inv-sts-2.t1.p2"></a>`INV-STS-2.T1.P2` — correct identity/signature<br><a id="inv-sts-2.t1.p3"></a>`INV-STS-2.T1.P3` — direct invalid/opposite<br><a id="inv-sts-2.t1.p4"></a>`INV-STS-2.T1.P4` — wrong identity/signature<br><a id="inv-sts-2.t1.p5"></a>`INV-STS-2.T1.P5` — missing identity/signature<br><a id="inv-sts-2.t1.p6"></a>`INV-STS-2.T1.P6` — duplicate identity/signature<br><a id="inv-sts-2.t1.p7"></a>`INV-STS-2.T1.P7` — forged identity/signature<br><a id="inv-sts-2.t1.p8"></a>`INV-STS-2.T1.P8` — membership boundary |
| `INV-STS-3.T1` | `INV-STS-3`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Verdict-to-penalty mapping as stated.                                                                                                                                                                      | <a id="inv-sts-3.t1.p1"></a>`INV-STS-3.T1.P1` — valid case<br><a id="inv-sts-3.t1.p2"></a>`INV-STS-3.T1.P2` — static review of named alternatives<br><a id="inv-sts-3.t1.p3"></a>`INV-STS-3.T1.P3` — direct invalid/opposite<br><a id="inv-sts-3.t1.p4"></a>`INV-STS-3.T1.P4` — omitted category<br><a id="inv-sts-3.t1.p5"></a>`INV-STS-3.T1.P5` — changed assumption                                                                                                                                                                                                                                            |
...
| ----------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| `REQ-STS-1`             | `onBlockConfirmation` delegates all payload judgment to `ingestBlockConfirmation`, passing the handshake-verified sender address for attribution; the RPC layer performs no payload validation of its own. | Covered               | [src/rpc/services/stateTransition/StateTransitionRpcMethods.ts](../../../../../../../../src/rpc/services/stateTransition/StateTransitionRpcMethods.ts#L1), [src/stateManager/BlockQueueManager.ts](../../../../../../../../src/stateManager/BlockQueueManager.ts#L48) | None.            |
| `REQ-STS-2`             | A `false` keep-connection verdict disconnects and blacklists the sender by EVM address; `true` has no RPC-layer side effect.                                                                               | Covered               | [src/rpc/services/stateTransition/StateTransitionRpcMethods.ts](../../../../../../../../src/rpc/services/stateTransition/StateTransitionRpcMethods.ts#L1)                                                                                                             | None.            |
| `INV-STS-1`             | Handler holds no mutex and mutates no live state inline.                                                                                                                                                   | Covered               | [src/rpc/services/stateTransition](../../../../../../../../src/rpc/services/stateTransition), pipeline mutex sites in [src/stateManager/StateManager.ts](../../../../../../../../src/stateManager/StateManager.ts#L1)                                                 | None.            |
| `INV-STS-2`             | Peer-RPC ingest is always source-attributed.                                                                                                                                                               | Covered               | [src/rpc/services/stateTransition/StateTransitionRpcMethods.ts](../../../../../../../../src/rpc/services/stateTransition/StateTransitionRpcMethods.ts#L1)                                                                                                             | None.            |
| `INV-STS-3`             | Verdict-to-penalty mapping as stated.                                                                                                                                                                      | Covered               | [src/rpc/services/stateTransition/StateTransitionRpcMethods.ts](../../../../../../../../src/rpc/services/stateTransition/StateTransitionRpcMethods.ts#L1)                                                                                                             | None.            |
