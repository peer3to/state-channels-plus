...
| ID                                                         | Invariant                                                                                                                                                                                                     |
| ---------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`INV-IFD-1-HBJR2P`](is-fork-disputed.md#inv-ifd-1-hbjr2p) | Per direction and per `(peerAddress, forkId)`, at most one acknowledgment is ever recorded; a second incoming request for a recorded pair is a violation with a defined consequence (disconnect + blacklist). |
| [`INV-IFD-2-6N9G29`](is-fork-disputed.md#inv-ifd-2-6n9g29) | A `true` acknowledgment is returned only after the fork was verified disputed against the local mirror or the chain; the record is written before the reply is sent.                                          |
| [`INV-IFD-3-DZ83BB`](is-fork-disputed.md#inv-ifd-3-dz83bb) | The outgoing round runs at most once per fork per process, against the peer set snapshot taken at round start; peers connecting later are neither asked nor punished for that fork.                           |
| [`INV-IFD-4-5J5W3T`](is-fork-disputed.md#inv-ifd-4-5j5w3t) | Acknowledgment state is keyed by EVM address, never by transport, and survives transport replacement.                                                                                                         |
