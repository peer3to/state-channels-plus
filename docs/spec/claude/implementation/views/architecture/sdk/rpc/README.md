...
| --- | --- | --- | --- | --- |
| `REQ-RPC-1.T1` | `REQ-RPC-1` | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Only deliberately public endpoint functions are remotely dispatchable; helpers and mutable service state are unreachable. | <a id="req-rpc-1.t1.p1"></a>`REQ-RPC-1.T1.P1` — Own/prototype/private/helper names<br><a id="req-rpc-1.t1.p2"></a>`REQ-RPC-1.T1.P2` — missing/existing service and method<br><a id="req-rpc-1.t1.p3"></a>`REQ-RPC-1.T1.P3` — crafted method names<br><a id="req-rpc-1.t1.p4"></a>`REQ-RPC-1.T1.P4` — `InitHandshakeService` class<br><a id="req-rpc-1.t1.p5"></a>`REQ-RPC-1.T1.P5` — `WebRTCSetupService` class<br><a id="req-rpc-1.t1.p6"></a>`REQ-RPC-1.T1.P6` — `StateTransitionService` class<br><a id="req-rpc-1.t1.p7"></a>`REQ-RPC-1.T1.P7` — `SpectateService` class<br><a id="req-rpc-1.t1.p8"></a>`REQ-RPC-1.T1.P8` — `IsForkDisputedService` class<br><a id="req-rpc-1.t1.p9"></a>`REQ-RPC-1.T1.P9` — `JoinChannelService` class. |
| `REQ-RPC-2.T1` | `REQ-RPC-2` | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Decode and semantic validation complete before the first state or external effect; malformed input follows the documented protocol-failure path. | <a id="req-rpc-2.t1.p1"></a>`REQ-RPC-2.T1.P1` — Valid value<br><a id="req-rpc-2.t1.p2"></a>`REQ-RPC-2.T1.P2` — wrong type<br><a id="req-rpc-2.t1.p3"></a>`REQ-RPC-2.T1.P3` — truncated data<br><a id="req-rpc-2.t1.p4"></a>`REQ-RPC-2.T1.P4` — boundary values<br><a id="req-rpc-2.t1.p5"></a>`REQ-RPC-2.T1.P5` — adversarial fuzz<br><a id="req-rpc-2.t1.p6"></a>`REQ-RPC-2.T1.P6` — handler side-effect sentinel<br><a id="req-rpc-2.t1.p7"></a>`REQ-RPC-2.T1.P7` — wrong tag<br><a id="req-rpc-2.t1.p8"></a>`REQ-RPC-2.T1.P8` — wrong domain<br><a id="req-rpc-2.t1.p9"></a>`REQ-RPC-2.T1.P9` — trailing data. |
| `REQ-RPC-3.T1` | `REQ-RPC-3` | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | A custom root is reachable only when manifest resolution and registry construction install its service/RpcMethods pair. | <a id="req-rpc-3.t1.p1"></a>`REQ-RPC-3.T1.P1` — Absent root<br><a id="req-rpc-3.t1.p2"></a>`REQ-RPC-3.T1.P2` — malformed manifest<br><a id="req-rpc-3.t1.p3"></a>`REQ-RPC-3.T1.P3` — inline runtime<br><a id="req-rpc-3.t1.p4"></a>`REQ-RPC-3.T1.P4` — production root<br><a id="req-rpc-3.t1.p5"></a>`REQ-RPC-3.T1.P5` — present root<br><a id="req-rpc-3.t1.p6"></a>`REQ-RPC-3.T1.P6` — duplicate root<br><a id="req-rpc-3.t1.p7"></a>`REQ-RPC-3.T1.P7` — worker runtime<br><a id="req-rpc-3.t1.p8"></a>`REQ-RPC-3.T1.P8` — test-harness root. |
| `REQ-RPC-4.T1` | `REQ-RPC-4` | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Canonically encoded bigint-bearing values round-trip; a raw `BigInt` fails serialization at the sender. | <a id="req-rpc-4.t1.p1"></a>`REQ-RPC-4.T1.P1` — Zero bigint<br><a id="req-rpc-4.t1.p2"></a>`REQ-RPC-4.T1.P2` — nested structs<br><a id="req-rpc-4.t1.p3"></a>`REQ-RPC-4.T1.P3` — Codec string<br><a id="req-rpc-4.t1.p4"></a>`REQ-RPC-4.T1.P4` — raw bigint<br><a id="req-rpc-4.t1.p5"></a>`REQ-RPC-4.T1.P5` — worker port<br><a id="req-rpc-4.t1.p6"></a>`REQ-RPC-4.T1.P6` — max bigint<br><a id="req-rpc-4.t1.p7"></a>`REQ-RPC-4.T1.P7` — safe-limit+1 bigint<br><a id="req-rpc-4.t1.p8"></a>`REQ-RPC-4.T1.P8` — nested arrays<br><a id="req-rpc-4.t1.p9"></a>`REQ-RPC-4.T1.P9` — network port. |
| `INV-RPC-4.T1` | `INV-RPC-4` | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | No successfully serialized RPC envelope contains a raw bigint or corrupted byte representation. | <a id="inv-rpc-4.t1.p1"></a>`INV-RPC-4.T1.P1` — Request envelope<br><a id="inv-rpc-4.t1.p2"></a>`INV-RPC-4.T1.P2` — nested arrays<br><a id="inv-rpc-4.t1.p3"></a>`INV-RPC-4.T1.P3` — `Uint8Array`<br><a id="inv-rpc-4.t1.p4"></a>`INV-RPC-4.T1.P4` — join `encodedSignedJoinChannel` endpoint<br><a id="inv-rpc-4.t1.p5"></a>`INV-RPC-4.T1.P5` — response envelope<br><a id="inv-rpc-4.t1.p6"></a>`INV-RPC-4.T1.P6` — error envelope<br><a id="inv-rpc-4.t1.p7"></a>`INV-RPC-4.T1.P7` — nested objects<br><a id="inv-rpc-4.t1.p8"></a>`INV-RPC-4.T1.P8` — spectate `encodedSyncPayload` endpoint. |
| `REQ-RPC-5.T1` | `REQ-RPC-5` | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Guards run in documented order for untrusted transports; only the loopback bypasses them; rejection has the specified consequence. | <a id="req-rpc-5.t1.p1"></a>`REQ-RPC-5.T1.P1` — `HandshakeCompletedGuard` pass<br><a id="req-rpc-5.t1.p2"></a>`REQ-RPC-5.T1.P2` — ordering interactions<br><a id="req-rpc-5.t1.p3"></a>`REQ-RPC-5.T1.P3` — pre-handshake<br><a id="req-rpc-5.t1.p4"></a>`REQ-RPC-5.T1.P4` — loopback bypass<br><a id="req-rpc-5.t1.p5"></a>`REQ-RPC-5.T1.P5` — retry queue<br><a id="req-rpc-5.t1.p6"></a>`REQ-RPC-5.T1.P6` — `HandshakeCompletedGuard` fail<br><a id="req-rpc-5.t1.p7"></a>`REQ-RPC-5.T1.P7` — post-handshake<br><a id="req-rpc-5.t1.p8"></a>`REQ-RPC-5.T1.P8` — Holepunch transport<br><a id="req-rpc-5.t1.p9"></a>`REQ-RPC-5.T1.P9` — WebRTC transport<br><a id="req-rpc-5.t1.p10"></a>`REQ-RPC-5.T1.P10` — local transport. |
| `REQ-RPC-6.T1` | `REQ-RPC-6` | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Redelivery either converges to the same result without duplicate effects or is rejected with the documented consequence. | <a id="req-rpc-6.t1.p1"></a>`REQ-RPC-6.T1.P1` — Duplicate of in-flight request<br><a id="req-rpc-6.t1.p2"></a>`REQ-RPC-6.T1.P2` — late response<br><a id="req-rpc-6.t1.p3"></a>`REQ-RPC-6.T1.P3` — retry after transport loss<br><a id="req-rpc-6.t1.p4"></a>`REQ-RPC-6.T1.P4` — reordered concurrent requests<br><a id="req-rpc-6.t1.p5"></a>`REQ-RPC-6.T1.P5` — `onBlockConfirmation` endpoint<br><a id="req-rpc-6.t1.p6"></a>`REQ-RPC-6.T1.P6` — duplicate of completed request<br><a id="req-rpc-6.t1.p7"></a>`REQ-RPC-6.T1.P7` — `onInitHandshakeAck` endpoint<br><a id="req-rpc-6.t1.p8"></a>`REQ-RPC-6.T1.P8` — `onDisputeAcknowledgmentRequest` endpoint<br><a id="req-rpc-6.t1.p9"></a>`REQ-RPC-6.T1.P9` — spectate sync endpoint. |
| `INV-RPC-1.T1` | `INV-RPC-1` | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Frame-size, envelope, service, guard, and method checks occur in that order and no failed stage reaches the next stage or handler. | <a id="inv-rpc-1.t1.p1"></a>`INV-RPC-1.T1.P1` — Frame-size stage failure<br><a id="inv-rpc-1.t1.p2"></a>`INV-RPC-1.T1.P2` — malformed frame<br><a id="inv-rpc-1.t1.p3"></a>`INV-RPC-1.T1.P3` — absent service<br><a id="inv-rpc-1.t1.p4"></a>`INV-RPC-1.T1.P4` — guard rejection<br><a id="inv-rpc-1.t1.p5"></a>`INV-RPC-1.T1.P5` — envelope stage failure<br><a id="inv-rpc-1.t1.p6"></a>`INV-RPC-1.T1.P6` — service stage failure<br><a id="inv-rpc-1.t1.p7"></a>`INV-RPC-1.T1.P7` — guard stage failure<br><a id="inv-rpc-1.t1.p8"></a>`INV-RPC-1.T1.P8` — method stage failure<br><a id="inv-rpc-1.t1.p9"></a>`INV-RPC-1.T1.P9` — at-cap frame boundary<br><a id="inv-rpc-1.t1.p10"></a>`INV-RPC-1.T1.P10` — oversized frame<br><a id="inv-rpc-1.t1.p11"></a>`INV-RPC-1.T1.P11` — absent method<br><a id="inv-rpc-1.t1.p12"></a>`INV-RPC-1.T1.P12` — guard bypass (trusted). |
| `INV-RPC-2.T1` | `INV-RPC-2` | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Only the handshake-identified addressed peer settles a request; any other responder cannot settle it and is disconnected/blacklisted. | <a id="inv-rpc-2.t1.p1"></a>`INV-RPC-2.T1.P1` — Correct peer<br><a id="inv-rpc-2.t1.p2"></a>`INV-RPC-2.T1.P2` — transport replacement for same identity<br><a id="inv-rpc-2.t1.p3"></a>`INV-RPC-2.T1.P3` — concurrent response<br><a id="inv-rpc-2.t1.p4"></a>`INV-RPC-2.T1.P4` — requestId collision<br><a id="inv-rpc-2.t1.p5"></a>`INV-RPC-2.T1.P5` — wrong peer<br><a id="inv-rpc-2.t1.p6"></a>`INV-RPC-2.T1.P6` — late response<br><a id="inv-rpc-2.t1.p7"></a>`INV-RPC-2.T1.P7` — duplicate response. |
| `INV-RPC-3.T1` | `INV-RPC-3` | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Guard bypass occurs only for the in-process loopback; no network transport can claim trusted status. | <a id="inv-rpc-3.t1.p1"></a>`INV-RPC-3.T1.P1` — Loopback transport<br><a id="inv-rpc-3.t1.p2"></a>`INV-RPC-3.T1.P2` — forged trust metadata<br><a id="inv-rpc-3.t1.p3"></a>`INV-RPC-3.T1.P3` — transport upgrade/replacement<br><a id="inv-rpc-3.t1.p4"></a>`INV-RPC-3.T1.P4` — pre-handshake request<br><a id="inv-rpc-3.t1.p5"></a>`INV-RPC-3.T1.P5` — Holepunch transport<br><a id="inv-rpc-3.t1.p6"></a>`INV-RPC-3.T1.P6` — WebRTC transport<br><a id="inv-rpc-3.t1.p7"></a>`INV-RPC-3.T1.P7` — local transport. |
| `INV-RPC-5.T1` | `INV-RPC-5` | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | RPC dispatch never owns the state mutex; state mutation enters only through the pipeline's mutex-acquiring public boundary. | <a id="inv-rpc-5.t1.p1"></a>`INV-RPC-5.T1.P1` — Read-only endpoint<br><a id="inv-rpc-5.t1.p2"></a>`INV-RPC-5.T1.P2` — concurrent intake<br><a id="inv-rpc-5.t1.p3"></a>`INV-RPC-5.T1.P3` — handler error<br><a id="inv-rpc-5.t1.p4"></a>`INV-RPC-5.T1.P4` — retry<br><a id="inv-rpc-5.t1.p5"></a>`INV-RPC-5.T1.P5` — inline runtime<br><a id="inv-rpc-5.t1.p6"></a>`INV-RPC-5.T1.P6` — mutating endpoint<br><a id="inv-rpc-5.t1.p7"></a>`INV-RPC-5.T1.P7` — worker runtime. |
| `REQ-RPC-7.T1` | `REQ-RPC-7` | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | The central limiter bounds aggregate peer-driven RPC work without starving required control traffic. | <a id="req-rpc-7.t1.p1"></a>`REQ-RPC-7.T1.P1` — Per-peer saturation<br><a id="req-rpc-7.t1.p2"></a>`REQ-RPC-7.T1.P2` — cheap endpoint<br><a id="req-rpc-7.t1.p3"></a>`REQ-RPC-7.T1.P3` — reconnect<br><a id="req-rpc-7.t1.p4"></a>`REQ-RPC-7.T1.P4` — burst load<br><a id="req-rpc-7.t1.p5"></a>`REQ-RPC-7.T1.P5` — recovery after refill<br><a id="req-rpc-7.t1.p6"></a>`REQ-RPC-7.T1.P6` — global saturation<br><a id="req-rpc-7.t1.p7"></a>`REQ-RPC-7.T1.P7` — expensive endpoint<br><a id="req-rpc-7.t1.p8"></a>`REQ-RPC-7.T1.P8` — identity rotation<br><a id="req-rpc-7.t1.p9"></a>`REQ-RPC-7.T1.P9` — sustained load. |
## Future Work
