...
| -------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `REQ-SDK-3.T1` | `REQ-SDK-3`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Handshake signatures are domain-tagged and cannot collide with block signatures.                                  | <a id="req-sdk-3.t1.p1"></a>`REQ-SDK-3.T1.P1` — valid case<br><a id="req-sdk-3.t1.p2"></a>`REQ-SDK-3.T1.P2` — correct identity/signature<br><a id="req-sdk-3.t1.p3"></a>`REQ-SDK-3.T1.P3` — direct invalid/opposite case<br><a id="req-sdk-3.t1.p4"></a>`REQ-SDK-3.T1.P4` — wrong identity/signature<br><a id="req-sdk-3.t1.p5"></a>`REQ-SDK-3.T1.P5` — missing identity/signature<br><a id="req-sdk-3.t1.p6"></a>`REQ-SDK-3.T1.P6` — duplicate identity/signature<br><a id="req-sdk-3.t1.p7"></a>`REQ-SDK-3.T1.P7` — forged identity/signature<br><a id="req-sdk-3.t1.p8"></a>`REQ-SDK-3.T1.P8` — membership boundary |
| `REQ-SDK-4.T1` | `REQ-SDK-4`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Only the addressed peer may settle an RPC request; oversized/undecodable frames disconnect.                       | <a id="req-sdk-4.t1.p1"></a>`REQ-SDK-4.T1.P1` — valid case<br><a id="req-sdk-4.t1.p2"></a>`REQ-SDK-4.T1.P2` — correct identity/signature<br><a id="req-sdk-4.t1.p3"></a>`REQ-SDK-4.T1.P3` — direct invalid/opposite case<br><a id="req-sdk-4.t1.p4"></a>`REQ-SDK-4.T1.P4` — wrong identity/signature<br><a id="req-sdk-4.t1.p5"></a>`REQ-SDK-4.T1.P5` — missing identity/signature<br><a id="req-sdk-4.t1.p6"></a>`REQ-SDK-4.T1.P6` — duplicate identity/signature<br><a id="req-sdk-4.t1.p7"></a>`REQ-SDK-4.T1.P7` — forged identity/signature<br><a id="req-sdk-4.t1.p8"></a>`REQ-SDK-4.T1.P8` — membership boundary |
| `INV-SDK-4.T1` | `INV-SDK-4`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | `BlockStorage` never overwrites a stored block with a conflicting body; `justPersist` never advances live height. | <a id="inv-sdk-4.t1.p1"></a>`INV-SDK-4.T1.P1` — valid case<br><a id="inv-sdk-4.t1.p2"></a>`INV-SDK-4.T1.P2` — zero/empty/no-op case where meaningful<br><a id="inv-sdk-4.t1.p3"></a>`INV-SDK-4.T1.P3` — direct invalid/opposite case<br><a id="inv-sdk-4.t1.p4"></a>`INV-SDK-4.T1.P4` — exact boundary<br><a id="inv-sdk-4.t1.p5"></a>`INV-SDK-4.T1.P5` — failure/recovery<br><a id="inv-sdk-4.t1.p6"></a>`INV-SDK-4.T1.P6` — relevant race                                                                                                                                                                            |
| `INV-SDK-5.T1` | `INV-SDK-5`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | The event pipeline's processed-block watermark never advances past an incomplete or failed log.                   | <a id="inv-sdk-5.t1.p1"></a>`INV-SDK-5.T1.P1` — valid case<br><a id="inv-sdk-5.t1.p2"></a>`INV-SDK-5.T1.P2` — malformed input<br><a id="inv-sdk-5.t1.p3"></a>`INV-SDK-5.T1.P3` — direct invalid/opposite case<br><a id="inv-sdk-5.t1.p4"></a>`INV-SDK-5.T1.P4` — adversarial input<br><a id="inv-sdk-5.t1.p5"></a>`INV-SDK-5.T1.P5` — partial failure<br><a id="inv-sdk-5.t1.p6"></a>`INV-SDK-5.T1.P6` — retry and recovery                                                                                                                                                                                            |
| `INV-SDK-6.T1` | `INV-SDK-6`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Blacklisting is peer-identity-keyed and survives transport replacement.                                           | <a id="inv-sdk-6.t1.p1"></a>`INV-SDK-6.T1.P1` — valid case<br><a id="inv-sdk-6.t1.p2"></a>`INV-SDK-6.T1.P2` — correct identity/signature<br><a id="inv-sdk-6.t1.p3"></a>`INV-SDK-6.T1.P3` — direct invalid/opposite case<br><a id="inv-sdk-6.t1.p4"></a>`INV-SDK-6.T1.P4` — wrong identity/signature<br><a id="inv-sdk-6.t1.p5"></a>`INV-SDK-6.T1.P5` — missing identity/signature<br><a id="inv-sdk-6.t1.p6"></a>`INV-SDK-6.T1.P6` — duplicate identity/signature<br><a id="inv-sdk-6.t1.p7"></a>`INV-SDK-6.T1.P7` — forged identity/signature<br><a id="inv-sdk-6.t1.p8"></a>`INV-SDK-6.T1.P8` — membership boundary |
...
| ----------------------- | ----------------------------------------------------------------------------------------------------------------- | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| `REQ-SDK-3`             | Handshake signatures are domain-tagged and cannot collide with block signatures.                                  | Covered               | [src/rpc/services/initHandshake/InitHandshakeService.ts](../../../../../../../src/rpc/services/initHandshake/InitHandshakeService.ts#L2) (`HANDSHAKE_DOMAIN`) | None.            |
| `REQ-SDK-4`             | Only the addressed peer may settle an RPC request; oversized/undecodable frames disconnect.                       | Covered               | [src/P2PManager.ts](../../../../../../../src/P2PManager.ts#L1) (`handleRpcResponse`, `onRpc`)                                                                 | None.            |
| `INV-SDK-4`             | `BlockStorage` never overwrites a stored block with a conflicting body; `justPersist` never advances live height. | Covered               | [src/storage/BlockStorage.ts](../../../../../../../src/storage/BlockStorage.ts#L1)                                                                            | None.            |
| `INV-SDK-5`             | The event pipeline's processed-block watermark never advances past an incomplete or failed log.                   | Covered               | [src/stateManager/EventSyncService.ts](../../../../../../../src/stateManager/EventSyncService.ts#L1) (`publishCompletedBlocks`)                               | None.            |
| `INV-SDK-6`             | Blacklisting is peer-identity-keyed and survives transport replacement.                                           | Covered               | [src/ProfileManager.ts](../../../../../../../src/ProfileManager.ts#L1), [src/P2PManager.ts](../../../../../../../src/P2PManager.ts#L1)                        | None.            |
