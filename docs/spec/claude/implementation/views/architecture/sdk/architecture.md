...
| -------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `REQ-SDK-1.T1` | `REQ-SDK-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | The runtime owns its signer; `p2pSetup` accepts only `signerSecret` (random when omitted), never an injected `Signer`.         | <a id="req-sdk-1.t1.p1"></a>`REQ-SDK-1.T1.P1` — valid case<br><a id="req-sdk-1.t1.p2"></a>`REQ-SDK-1.T1.P2` — correct identity/signature<br><a id="req-sdk-1.t1.p3"></a>`REQ-SDK-1.T1.P3` — before deadline<br><a id="req-sdk-1.t1.p4"></a>`REQ-SDK-1.T1.P4` — direct invalid/opposite case<br><a id="req-sdk-1.t1.p5"></a>`REQ-SDK-1.T1.P5` — wrong identity/signature<br><a id="req-sdk-1.t1.p6"></a>`REQ-SDK-1.T1.P6` — missing identity/signature<br><a id="req-sdk-1.t1.p7"></a>`REQ-SDK-1.T1.P7` — duplicate identity/signature<br><a id="req-sdk-1.t1.p8"></a>`REQ-SDK-1.T1.P8` — forged identity/signature<br><a id="req-sdk-1.t1.p9"></a>`REQ-SDK-1.T1.P9` — membership boundary<br><a id="req-sdk-1.t1.p10"></a>`REQ-SDK-1.T1.P10` — at deadline<br><a id="req-sdk-1.t1.p11"></a>`REQ-SDK-1.T1.P11` — after deadline<br><a id="req-sdk-1.t1.p12"></a>`REQ-SDK-1.T1.P12` — maximum honest skew |
| `REQ-SDK-2.T1` | `REQ-SDK-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | The SDK requires at least one available honest RPC endpoint; current implementation uses exactly one WebSocket `PROVIDER_URL`. | <a id="req-sdk-2.t1.p1"></a>`REQ-SDK-2.T1.P1` — valid case<br><a id="req-sdk-2.t1.p2"></a>`REQ-SDK-2.T1.P2` — zero/empty/no-op case where meaningful<br><a id="req-sdk-2.t1.p3"></a>`REQ-SDK-2.T1.P3` — direct invalid/opposite case<br><a id="req-sdk-2.t1.p4"></a>`REQ-SDK-2.T1.P4` — exact boundary<br><a id="req-sdk-2.t1.p5"></a>`REQ-SDK-2.T1.P5` — failure/recovery<br><a id="req-sdk-2.t1.p6"></a>`REQ-SDK-2.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `INV-SDK-1.T1` | `INV-SDK-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | All app↔runtime interaction crosses the runtime port; `getStateManager()` throws.                                             | <a id="inv-sdk-1.t1.p1"></a>`INV-SDK-1.T1.P1` — valid case<br><a id="inv-sdk-1.t1.p2"></a>`INV-SDK-1.T1.P2` — before deadline<br><a id="inv-sdk-1.t1.p3"></a>`INV-SDK-1.T1.P3` — direct invalid/opposite case<br><a id="inv-sdk-1.t1.p4"></a>`INV-SDK-1.T1.P4` — at deadline<br><a id="inv-sdk-1.t1.p5"></a>`INV-SDK-1.T1.P5` — after deadline<br><a id="inv-sdk-1.t1.p6"></a>`INV-SDK-1.T1.P6` — maximum honest skew                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `INV-SDK-2.T1` | `INV-SDK-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | On-chain sends draw nonces from the host-owned nonce manager.                                                                  | <a id="inv-sdk-2.t1.p1"></a>`INV-SDK-2.T1.P1` — valid case<br><a id="inv-sdk-2.t1.p2"></a>`INV-SDK-2.T1.P2` — zero/empty/no-op case where meaningful<br><a id="inv-sdk-2.t1.p3"></a>`INV-SDK-2.T1.P3` — direct invalid/opposite case<br><a id="inv-sdk-2.t1.p4"></a>`INV-SDK-2.T1.P4` — exact boundary<br><a id="inv-sdk-2.t1.p5"></a>`INV-SDK-2.T1.P5` — failure/recovery<br><a id="inv-sdk-2.t1.p6"></a>`INV-SDK-2.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `INV-SDK-3.T1` | `INV-SDK-3`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Dispute execution uses a dedicated state-machine instance, never the live one.                                                 | <a id="inv-sdk-3.t1.p1"></a>`INV-SDK-3.T1.P1` — valid case<br><a id="inv-sdk-3.t1.p2"></a>`INV-SDK-3.T1.P2` — malformed input<br><a id="inv-sdk-3.t1.p3"></a>`INV-SDK-3.T1.P3` — direct invalid/opposite case<br><a id="inv-sdk-3.t1.p4"></a>`INV-SDK-3.T1.P4` — adversarial input<br><a id="inv-sdk-3.t1.p5"></a>`INV-SDK-3.T1.P5` — partial failure<br><a id="inv-sdk-3.t1.p6"></a>`INV-SDK-3.T1.P6` — retry and recovery                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------ | --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| `REQ-SDK-1`             | The runtime owns its signer; `p2pSetup` accepts only `signerSecret` (random when omitted), never an injected `Signer`.         | Covered               | [src/evm/EvmDiamondStateMachine.ts](../../../../../../../src/evm/EvmDiamondStateMachine.ts#L1), [src/evm/p2pRuntime/RuntimeChainContext.ts](../../../../../../../src/evm/p2pRuntime/RuntimeChainContext.ts#L1) | None.            |
| `REQ-SDK-2`             | The SDK requires at least one available honest RPC endpoint; current implementation uses exactly one WebSocket `PROVIDER_URL`. | Covered               | [src/evm/p2pRuntime/RuntimeChainContext.ts](../../../../../../../src/evm/p2pRuntime/RuntimeChainContext.ts#L1), [src/utils/config.ts](../../../../../../../src/utils/config.ts#L1)                             | None.            |
| `INV-SDK-1`             | All app↔runtime interaction crosses the runtime port; `getStateManager()` throws.                                             | Covered               | [src/evm/P2pInstance.ts](../../../../../../../src/evm/P2pInstance.ts#L1)                                                                                                                                       | None.            |
| `INV-SDK-2`             | On-chain sends draw nonces from the host-owned nonce manager.                                                                  | Covered               | [src/evm/p2pRuntime/P2pRuntimeHost.ts](../../../../../../../src/evm/p2pRuntime/P2pRuntimeHost.ts#L5), [src/evm/signer/HostNonceManager.ts](../../../../../../../src/evm/signer/HostNonceManager.ts#L16)        | None.            |
| `INV-SDK-3`             | Dispute execution uses a dedicated state-machine instance, never the live one.                                                 | Covered               | [src/evm/EvmDiamondStateMachine.ts](../../../../../../../src/evm/EvmDiamondStateMachine.ts#L1) (`createStandaloneFromLocalStateMachineWithExecutor`, `p2pSetup` double deploy)                                 | None.            |
