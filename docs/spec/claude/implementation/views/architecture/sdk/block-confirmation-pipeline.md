...
[../security/trust-model.md](../../../../specification/security/trust-model.md), [OQ-6](../../../../specification/open-questions.md)); no
...
before production — tracked in [OQ-6](../../../../specification/open-questions.md).
...
| -------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `INV-BCP-1.T1` | `INV-BCP-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Validation/execution serialized under the StateManager mutex.                                                                                                                                                                                                                                                  | <a id="inv-bcp-1.t1.p1"></a>`INV-BCP-1.T1.P1` — valid case<br><a id="inv-bcp-1.t1.p2"></a>`INV-BCP-1.T1.P2` — zero/empty/no-op case where meaningful<br><a id="inv-bcp-1.t1.p3"></a>`INV-BCP-1.T1.P3` — direct invalid/opposite case<br><a id="inv-bcp-1.t1.p4"></a>`INV-BCP-1.T1.P4` — exact boundary<br><a id="inv-bcp-1.t1.p5"></a>`INV-BCP-1.T1.P5` — failure/recovery<br><a id="inv-bcp-1.t1.p6"></a>`INV-BCP-1.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `INV-BCP-2.T1` | `INV-BCP-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Failed validation restores the VM to its pre-transition state.                                                                                                                                                                                                                                                 | <a id="inv-bcp-2.t1.p1"></a>`INV-BCP-2.T1.P1` — valid case<br><a id="inv-bcp-2.t1.p2"></a>`INV-BCP-2.T1.P2` — malformed input<br><a id="inv-bcp-2.t1.p3"></a>`INV-BCP-2.T1.P3` — direct invalid/opposite case<br><a id="inv-bcp-2.t1.p4"></a>`INV-BCP-2.T1.P4` — adversarial input<br><a id="inv-bcp-2.t1.p5"></a>`INV-BCP-2.T1.P5` — partial failure<br><a id="inv-bcp-2.t1.p6"></a>`INV-BCP-2.T1.P6` — retry and recovery                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `INV-BCP-3.T1` | `INV-BCP-3`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | In-order execution; future blocks parked.                                                                                                                                                                                                                                                                      | <a id="inv-bcp-3.t1.p1"></a>`INV-BCP-3.T1.P1` — valid case<br><a id="inv-bcp-3.t1.p2"></a>`INV-BCP-3.T1.P2` — duplicate delivery<br><a id="inv-bcp-3.t1.p3"></a>`INV-BCP-3.T1.P3` — direct invalid/opposite case<br><a id="inv-bcp-3.t1.p4"></a>`INV-BCP-3.T1.P4` — replay delivery<br><a id="inv-bcp-3.t1.p5"></a>`INV-BCP-3.T1.P5` — concurrent delivery                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `INV-BCP-4.T1` | `INV-BCP-4`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Monotone, attributed, capped signature/source merging; fixed entry lifetime.                                                                                                                                                                                                                                   | <a id="inv-bcp-4.t1.p1"></a>`INV-BCP-4.T1.P1` — valid case<br><a id="inv-bcp-4.t1.p2"></a>`INV-BCP-4.T1.P2` — correct identity/signature<br><a id="inv-bcp-4.t1.p3"></a>`INV-BCP-4.T1.P3` — before deadline<br><a id="inv-bcp-4.t1.p4"></a>`INV-BCP-4.T1.P4` — duplicate delivery<br><a id="inv-bcp-4.t1.p5"></a>`INV-BCP-4.T1.P5` — direct invalid/opposite case<br><a id="inv-bcp-4.t1.p6"></a>`INV-BCP-4.T1.P6` — wrong identity/signature<br><a id="inv-bcp-4.t1.p7"></a>`INV-BCP-4.T1.P7` — missing identity/signature<br><a id="inv-bcp-4.t1.p8"></a>`INV-BCP-4.T1.P8` — duplicate identity/signature<br><a id="inv-bcp-4.t1.p9"></a>`INV-BCP-4.T1.P9` — forged identity/signature<br><a id="inv-bcp-4.t1.p10"></a>`INV-BCP-4.T1.P10` — membership boundary<br><a id="inv-bcp-4.t1.p11"></a>`INV-BCP-4.T1.P11` — at deadline<br><a id="inv-bcp-4.t1.p12"></a>`INV-BCP-4.T1.P12` — after deadline<br><a id="inv-bcp-4.t1.p13"></a>`INV-BCP-4.T1.P13` — maximum honest skew<br><a id="inv-bcp-4.t1.p14"></a>`INV-BCP-4.T1.P14` — replay delivery<br><a id="inv-bcp-4.t1.p15"></a>`INV-BCP-4.T1.P15` — concurrent delivery |
| `INV-BCP-5.T1` | `INV-BCP-5`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Persist before gossip.                                                                                                                                                                                                                                                                                         | <a id="inv-bcp-5.t1.p1"></a>`INV-BCP-5.T1.P1` — valid case<br><a id="inv-bcp-5.t1.p2"></a>`INV-BCP-5.T1.P2` — zero/empty/no-op case where meaningful<br><a id="inv-bcp-5.t1.p3"></a>`INV-BCP-5.T1.P3` — direct invalid/opposite case<br><a id="inv-bcp-5.t1.p4"></a>`INV-BCP-5.T1.P4` — exact boundary<br><a id="inv-bcp-5.t1.p5"></a>`INV-BCP-5.T1.P5` — failure/recovery<br><a id="inv-bcp-5.t1.p6"></a>`INV-BCP-5.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `INV-BCP-6.T1` | `INV-BCP-6`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Every live `DISPUTE` outcome stores a fraud proof before disputing.                                                                                                                                                                                                                                            | <a id="inv-bcp-6.t1.p1"></a>`INV-BCP-6.T1.P1` — valid case<br><a id="inv-bcp-6.t1.p2"></a>`INV-BCP-6.T1.P2` — malformed input<br><a id="inv-bcp-6.t1.p3"></a>`INV-BCP-6.T1.P3` — direct invalid/opposite case<br><a id="inv-bcp-6.t1.p4"></a>`INV-BCP-6.T1.P4` — adversarial input<br><a id="inv-bcp-6.t1.p5"></a>`INV-BCP-6.T1.P5` — partial failure<br><a id="inv-bcp-6.t1.p6"></a>`INV-BCP-6.T1.P6` — retry and recovery                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `INV-BCP-7.T1` | `INV-BCP-7`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Subjective lateness never produces a proof or slash.                                                                                                                                                                                                                                                           | <a id="inv-bcp-7.t1.p1"></a>`INV-BCP-7.T1.P1` — valid case<br><a id="inv-bcp-7.t1.p2"></a>`INV-BCP-7.T1.P2` — new participant<br><a id="inv-bcp-7.t1.p3"></a>`INV-BCP-7.T1.P3` — direct invalid/opposite case<br><a id="inv-bcp-7.t1.p4"></a>`INV-BCP-7.T1.P4` — existing participant<br><a id="inv-bcp-7.t1.p5"></a>`INV-BCP-7.T1.P5` — removed participant<br><a id="inv-bcp-7.t1.p6"></a>`INV-BCP-7.T1.P6` — slashed participant<br><a id="inv-bcp-7.t1.p7"></a>`INV-BCP-7.T1.P7` — concurrent membership change                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `REQ-BCP-1.T1` | `REQ-BCP-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Both input paths (peer RPC and chain calldata) converge on one ingest with source attribution / on-chain timestamp respectively.                                                                                                                                                                               | <a id="req-bcp-1.t1.p1"></a>`REQ-BCP-1.T1.P1` — valid case<br><a id="req-bcp-1.t1.p2"></a>`REQ-BCP-1.T1.P2` — correct identity/signature<br><a id="req-bcp-1.t1.p3"></a>`REQ-BCP-1.T1.P3` — before deadline<br><a id="req-bcp-1.t1.p4"></a>`REQ-BCP-1.T1.P4` — direct invalid/opposite case<br><a id="req-bcp-1.t1.p5"></a>`REQ-BCP-1.T1.P5` — wrong identity/signature<br><a id="req-bcp-1.t1.p6"></a>`REQ-BCP-1.T1.P6` — missing identity/signature<br><a id="req-bcp-1.t1.p7"></a>`REQ-BCP-1.T1.P7` — duplicate identity/signature<br><a id="req-bcp-1.t1.p8"></a>`REQ-BCP-1.T1.P8` — forged identity/signature<br><a id="req-bcp-1.t1.p9"></a>`REQ-BCP-1.T1.P9` — membership boundary<br><a id="req-bcp-1.t1.p10"></a>`REQ-BCP-1.T1.P10` — at deadline<br><a id="req-bcp-1.t1.p11"></a>`REQ-BCP-1.T1.P11` — after deadline<br><a id="req-bcp-1.t1.p12"></a>`REQ-BCP-1.T1.P12` — maximum honest skew                                                                                                                                                                                                                       |
| `REQ-BCP-2.T1` | `REQ-BCP-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Objective timestamp rule is evaluated by the canonical Solidity predicate over the exact proof struct.                                                                                                                                                                                                         | <a id="req-bcp-2.t1.p1"></a>`REQ-BCP-2.T1.P1` — valid case<br><a id="req-bcp-2.t1.p2"></a>`REQ-BCP-2.T1.P2` — before deadline<br><a id="req-bcp-2.t1.p3"></a>`REQ-BCP-2.T1.P3` — static review of a named alternative<br><a id="req-bcp-2.t1.p4"></a>`REQ-BCP-2.T1.P4` — direct invalid/opposite case<br><a id="req-bcp-2.t1.p5"></a>`REQ-BCP-2.T1.P5` — at deadline<br><a id="req-bcp-2.t1.p6"></a>`REQ-BCP-2.T1.P6` — after deadline<br><a id="req-bcp-2.t1.p7"></a>`REQ-BCP-2.T1.P7` — maximum honest skew<br><a id="req-bcp-2.t1.p8"></a>`REQ-BCP-2.T1.P8` — static review of an omitted category<br><a id="req-bcp-2.t1.p9"></a>`REQ-BCP-2.T1.P9` — static review of a changed assumption                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `REQ-BCP-3.T1` | `REQ-BCP-3`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Non-state-mutating intake and merge (older/future/duplicate blocks, late signatures) never require the state-transition mutex; merge rules are deterministic, idempotent, and resource-capped per entry.                                                                                                       | <a id="req-bcp-3.t1.p1"></a>`REQ-BCP-3.T1.P1` — valid case<br><a id="req-bcp-3.t1.p2"></a>`REQ-BCP-3.T1.P2` — correct identity/signature<br><a id="req-bcp-3.t1.p3"></a>`REQ-BCP-3.T1.P3` — duplicate delivery<br><a id="req-bcp-3.t1.p4"></a>`REQ-BCP-3.T1.P4` — direct invalid/opposite case<br><a id="req-bcp-3.t1.p5"></a>`REQ-BCP-3.T1.P5` — wrong identity/signature<br><a id="req-bcp-3.t1.p6"></a>`REQ-BCP-3.T1.P6` — missing identity/signature<br><a id="req-bcp-3.t1.p7"></a>`REQ-BCP-3.T1.P7` — duplicate identity/signature<br><a id="req-bcp-3.t1.p8"></a>`REQ-BCP-3.T1.P8` — forged identity/signature<br><a id="req-bcp-3.t1.p9"></a>`REQ-BCP-3.T1.P9` — membership boundary<br><a id="req-bcp-3.t1.p10"></a>`REQ-BCP-3.T1.P10` — replay delivery<br><a id="req-bcp-3.t1.p11"></a>`REQ-BCP-3.T1.P11` — concurrent delivery                                                                                                                                                                                                                                                                                    |
| `REQ-BCP-4.T1` | `REQ-BCP-4`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | State application is total-order by `(forkId, height)` — at most one block in execution; same-coordinate competing bodies coexist in the queue, the first validated body wins locally (decided 2026-08-10), and the conflict is surfaced via validation/fraud-proof/drop paths, never hidden by arrival order. | <a id="req-bcp-4.t1.p1"></a>`REQ-BCP-4.T1.P1` — valid case<br><a id="req-bcp-4.t1.p2"></a>`REQ-BCP-4.T1.P2` — matching commitment<br><a id="req-bcp-4.t1.p3"></a>`REQ-BCP-4.T1.P3` — duplicate delivery<br><a id="req-bcp-4.t1.p4"></a>`REQ-BCP-4.T1.P4` — malformed input<br><a id="req-bcp-4.t1.p5"></a>`REQ-BCP-4.T1.P5` — direct invalid/opposite case<br><a id="req-bcp-4.t1.p6"></a>`REQ-BCP-4.T1.P6` — mismatched commitment<br><a id="req-bcp-4.t1.p7"></a>`REQ-BCP-4.T1.P7` — predecessor linkage<br><a id="req-bcp-4.t1.p8"></a>`REQ-BCP-4.T1.P8` — genesis linkage<br><a id="req-bcp-4.t1.p9"></a>`REQ-BCP-4.T1.P9` — stale fork<br><a id="req-bcp-4.t1.p10"></a>`REQ-BCP-4.T1.P10` — foreign fork<br><a id="req-bcp-4.t1.p11"></a>`REQ-BCP-4.T1.P11` — replay delivery<br><a id="req-bcp-4.t1.p12"></a>`REQ-BCP-4.T1.P12` — concurrent delivery<br><a id="req-bcp-4.t1.p13"></a>`REQ-BCP-4.T1.P13` — adversarial input<br><a id="req-bcp-4.t1.p14"></a>`REQ-BCP-4.T1.P14` — partial failure<br><a id="req-bcp-4.t1.p15"></a>`REQ-BCP-4.T1.P15` — retry and recovery                                               |
...
| ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| `INV-BCP-1`             | Validation/execution serialized under the StateManager mutex.                                                                                                                                                                                                                                                  | Covered               | [src/stateManager/StateManager.ts](../../../../../../../src/stateManager/StateManager.ts#L1) (`onBlockConfirmation`, `playTransaction`, `withMutex`)                                                                                                                                    | None.            |
| `INV-BCP-2`             | Failed validation restores the VM to its pre-transition state.                                                                                                                                                                                                                                                 | Covered               | `onBlockConfirmation` finally-block + `restoreStateAfterFailedValidation`                                                                                                                                                                                                               | None.            |
| `INV-BCP-3`             | In-order execution; future blocks parked.                                                                                                                                                                                                                                                                      | Covered               | [src/stateManager/BlockQueueManager.ts](../../../../../../../src/stateManager/BlockQueueManager.ts#L48) (`tryDequeuePriority`), [src/stateManager/ValidationService.ts](../../../../../../../src/stateManager/ValidationService.ts#L15) gate #6                                         | None.            |
| `INV-BCP-4`             | Monotone, attributed, capped signature/source merging; fixed entry lifetime.                                                                                                                                                                                                                                   | Covered               | [src/storage/QueueStorage.ts](../../../../../../../src/storage/QueueStorage.ts#L1), [BlockQueueManager.scheduleQueueTimeout](../../../../../../../src/stateManager/BlockQueueManager.ts#L153)                                                                                           | None.            |
| `INV-BCP-5`             | Persist before gossip.                                                                                                                                                                                                                                                                                         | Covered               | `success()` step order, `tryMergeStoredBlockConfirmation`                                                                                                                                                                                                                               | None.            |
...
| `INV-BCP-7`             | Subjective lateness never produces a proof or slash.                                                                                                                                                                                                                                                           | Covered               | [src/stateManager/ValidationService.ts](../../../../../../../src/stateManager/ValidationService.ts#L15) (`NOT_ENOUGH_TIME` path)                                                                                                                                                        | None.            |
...
| `REQ-BCP-2`             | Objective timestamp rule is evaluated by the canonical Solidity predicate over the exact proof struct.                                                                                                                                                                                                         | Covered               | [src/stateManager/ValidationService.ts](../../../../../../../src/stateManager/ValidationService.ts#L15) (`hasInvalidTimestamp.staticCall`)                                                                                                                                              | None.            |
| `REQ-BCP-3`             | Non-state-mutating intake and merge (older/future/duplicate blocks, late signatures) never require the state-transition mutex; merge rules are deterministic, idempotent, and resource-capped per entry.                                                                                                       | Covered               | [BlockQueueManager](../../../../../../../src/stateManager/BlockQueueManager.ts#L31) (scheduled tasks), [QueueStorage](../../../../../../../src/storage/QueueStorage.ts#L26), [StateManager.tryMergeStoredBlockConfirmation](../../../../../../../src/stateManager/StateManager.ts#L769) | None.            |
