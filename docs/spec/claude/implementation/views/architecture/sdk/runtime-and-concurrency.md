...
| ---------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- |
| [src/evm/browser/evmJumpdestCache.ts](../../../../../../../src/evm/browser/evmJumpdestCache.ts#L1)                     | `REQ-RUN-1`, `REQ-RUN-4`                                              |
| [src/evm/ConsolePrecompile.ts](../../../../../../../src/evm/ConsolePrecompile.ts#L1)                                   | `REQ-RUN-1`                                                           |
| [src/evm/EvmFactory.ts](../../../../../../../src/evm/EvmFactory.ts#L1)                                                 | `REQ-RUN-1`, `REQ-RUN-3`, `REQ-RUN-4`                                 |
| [src/evm/index.ts](../../../../../../../src/evm/index.ts#L1)                                                           | Not applicable — export barrel only                                   |
| [src/evm/node/evmJumpdestCache.ts](../../../../../../../src/evm/node/evmJumpdestCache.ts#L1)                           | `REQ-RUN-1`, `REQ-RUN-4`                                              |
| [src/evm/node/workerCpuProfiler.ts](../../../../../../../src/evm/node/workerCpuProfiler.ts#L1)                         | Not applicable — optional diagnostics only                            |
| [src/evm/signer/ClientChainSigner.ts](../../../../../../../src/evm/signer/ClientChainSigner.ts#L1)                     | `REQ-RUN-3`, `INV-RUN-4`                                              |
| [src/evm/signer/DeploymentBridgeSigner.ts](../../../../../../../src/evm/signer/DeploymentBridgeSigner.ts#L1)           | `REQ-RUN-3`, `INV-RUN-4`                                              |
| [src/evm/signer/LocalContractExecutorSigner.ts](../../../../../../../src/evm/signer/LocalContractExecutorSigner.ts#L1) | `REQ-RUN-3`, `INV-RUN-4`                                              |
...
- **Supported-device envelope: a mid-range phone (REQ-RUN-14).** _Decided
  ...
  [../security/trust-model.md](../../../../specification/security/trust-model.md) REQ-TRUST-5) on a
...
| --------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `REQ-RUN-1.T1`  | `REQ-RUN-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Communication is serialized messages over paired ports; the protocol and observable behavior are identical inline or worker, so callers keep no separate implementations and a component can move to a worker without changing its contract.                                                                                                | <a id="req-run-1.t1.p1"></a>`REQ-RUN-1.T1.P1` — valid case<br><a id="req-run-1.t1.p2"></a>`REQ-RUN-1.T1.P2` — zero/empty/no-op case where meaningful<br><a id="req-run-1.t1.p3"></a>`REQ-RUN-1.T1.P3` — direct invalid/opposite case<br><a id="req-run-1.t1.p4"></a>`REQ-RUN-1.T1.P4` — exact boundary<br><a id="req-run-1.t1.p5"></a>`REQ-RUN-1.T1.P5` — failure/recovery<br><a id="req-run-1.t1.p6"></a>`REQ-RUN-1.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `REQ-RUN-2.T1`  | `REQ-RUN-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | No shared mutable memory between main thread, host, and executor; all inter-context interaction is a serialized message.                                                                                                                                                                                                                    | <a id="req-run-2.t1.p1"></a>`REQ-RUN-2.T1.P1` — valid case<br><a id="req-run-2.t1.p2"></a>`REQ-RUN-2.T1.P2` — zero/empty/no-op case where meaningful<br><a id="req-run-2.t1.p3"></a>`REQ-RUN-2.T1.P3` — direct invalid/opposite case<br><a id="req-run-2.t1.p4"></a>`REQ-RUN-2.T1.P4` — exact boundary<br><a id="req-run-2.t1.p5"></a>`REQ-RUN-2.T1.P5` — failure/recovery<br><a id="req-run-2.t1.p6"></a>`REQ-RUN-2.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `REQ-RUN-3.T1`  | `REQ-RUN-3`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Internal state is owned by the receiving component; the app cannot reach node state, the host cannot reach EVM state, except by a request.                                                                                                                                                                                                  | <a id="req-run-3.t1.p1"></a>`REQ-RUN-3.T1.P1` — valid case<br><a id="req-run-3.t1.p2"></a>`REQ-RUN-3.T1.P2` — zero/empty/no-op case where meaningful<br><a id="req-run-3.t1.p3"></a>`REQ-RUN-3.T1.P3` — direct invalid/opposite case<br><a id="req-run-3.t1.p4"></a>`REQ-RUN-3.T1.P4` — exact boundary<br><a id="req-run-3.t1.p5"></a>`REQ-RUN-3.T1.P5` — failure/recovery<br><a id="req-run-3.t1.p6"></a>`REQ-RUN-3.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `REQ-RUN-4.T1`  | `REQ-RUN-4`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Ownership, ordering, lifecycle, error, disposal, and serialization rules for a cross-boundary message are explicit before a component moves to a worker.                                                                                                                                                                                    | <a id="req-run-4.t1.p1"></a>`REQ-RUN-4.T1.P1` — valid case<br><a id="req-run-4.t1.p2"></a>`REQ-RUN-4.T1.P2` — duplicate delivery<br><a id="req-run-4.t1.p3"></a>`REQ-RUN-4.T1.P3` — direct invalid/opposite case<br><a id="req-run-4.t1.p4"></a>`REQ-RUN-4.T1.P4` — replay delivery<br><a id="req-run-4.t1.p5"></a>`REQ-RUN-4.T1.P5` — concurrent delivery                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `REQ-RUN-5.T1`  | `REQ-RUN-5`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Every client→host request carries a client-local `requestId`; a single handler per port correlates the one matching response; only the paired context can settle it.                                                                                                                                                                        | <a id="req-run-5.t1.p1"></a>`REQ-RUN-5.T1.P1` — valid case<br><a id="req-run-5.t1.p2"></a>`REQ-RUN-5.T1.P2` — zero/empty/no-op case where meaningful<br><a id="req-run-5.t1.p3"></a>`REQ-RUN-5.T1.P3` — direct invalid/opposite case<br><a id="req-run-5.t1.p4"></a>`REQ-RUN-5.T1.P4` — exact boundary<br><a id="req-run-5.t1.p5"></a>`REQ-RUN-5.T1.P5` — failure/recovery<br><a id="req-run-5.t1.p6"></a>`REQ-RUN-5.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `REQ-RUN-6.T1`  | `REQ-RUN-6`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Cross-boundary values obey structured-clone limits: bigints as quantity/Codec strings, manifests not class instances, only ports transferred; `customData`/`kzg` rejected; non-serializable bus args drop.                                                                                                                                  | <a id="req-run-6.t1.p1"></a>`REQ-RUN-6.T1.P1` — valid case<br><a id="req-run-6.t1.p2"></a>`REQ-RUN-6.T1.P2` — zero value<br><a id="req-run-6.t1.p3"></a>`REQ-RUN-6.T1.P3` — malformed input<br><a id="req-run-6.t1.p4"></a>`REQ-RUN-6.T1.P4` — direct invalid/opposite case<br><a id="req-run-6.t1.p5"></a>`REQ-RUN-6.T1.P5` — exact balance/boundary<br><a id="req-run-6.t1.p6"></a>`REQ-RUN-6.T1.P6` — one beyond the boundary<br><a id="req-run-6.t1.p7"></a>`REQ-RUN-6.T1.P7` — maximum value<br><a id="req-run-6.t1.p8"></a>`REQ-RUN-6.T1.P8` — value conservation<br><a id="req-run-6.t1.p9"></a>`REQ-RUN-6.T1.P9` — adversarial input<br><a id="req-run-6.t1.p10"></a>`REQ-RUN-6.T1.P10` — partial failure<br><a id="req-run-6.t1.p11"></a>`REQ-RUN-6.T1.P11` — retry and recovery                                                                                                                                                                                                                                         |
| `REQ-RUN-7.T1`  | `REQ-RUN-7`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Worker isolation is a client performance strategy (not server scaling), applied incrementally where measurement justifies it; each boundary should be measurement-justified.                                                                                                                                                                | <a id="req-run-7.t1.p1"></a>`REQ-RUN-7.T1.P1` — valid case<br><a id="req-run-7.t1.p2"></a>`REQ-RUN-7.T1.P2` — duplicate delivery<br><a id="req-run-7.t1.p3"></a>`REQ-RUN-7.T1.P3` — direct invalid/opposite case<br><a id="req-run-7.t1.p4"></a>`REQ-RUN-7.T1.P4` — replay delivery<br><a id="req-run-7.t1.p5"></a>`REQ-RUN-7.T1.P5` — concurrent delivery                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `INV-RUN-1.T1`  | `INV-RUN-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Ports parallelize across contexts; the host mutex serializes live-state mutation, preserved across the executor worker because executor calls are awaited under the mutex.                                                                                                                                                                  | <a id="inv-run-1.t1.p1"></a>`INV-RUN-1.T1.P1` — valid case<br><a id="inv-run-1.t1.p2"></a>`INV-RUN-1.T1.P2` — zero/empty/no-op case where meaningful<br><a id="inv-run-1.t1.p3"></a>`INV-RUN-1.T1.P3` — direct invalid/opposite case<br><a id="inv-run-1.t1.p4"></a>`INV-RUN-1.T1.P4` — exact boundary<br><a id="inv-run-1.t1.p5"></a>`INV-RUN-1.T1.P5` — failure/recovery<br><a id="inv-run-1.t1.p6"></a>`INV-RUN-1.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `INV-RUN-2.T1`  | `INV-RUN-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | 1:1 port pair; one transfer owner; one handler per port; correlation trusts the paired writer.                                                                                                                                                                                                                                              | <a id="inv-run-2.t1.p1"></a>`INV-RUN-2.T1.P1` — valid case<br><a id="inv-run-2.t1.p2"></a>`INV-RUN-2.T1.P2` — zero/empty/no-op case where meaningful<br><a id="inv-run-2.t1.p3"></a>`INV-RUN-2.T1.P3` — direct invalid/opposite case<br><a id="inv-run-2.t1.p4"></a>`INV-RUN-2.T1.P4` — exact boundary<br><a id="inv-run-2.t1.p5"></a>`INV-RUN-2.T1.P5` — failure/recovery<br><a id="inv-run-2.t1.p6"></a>`INV-RUN-2.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `INV-RUN-3.T1`  | `INV-RUN-3`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Host construction failure posts `hostError` + closes the port (client `ready` rejects, pending reject); dead client port self-disposes the host.                                                                                                                                                                                            | <a id="inv-run-3.t1.p1"></a>`INV-RUN-3.T1.P1` — valid case<br><a id="inv-run-3.t1.p2"></a>`INV-RUN-3.T1.P2` — malformed input<br><a id="inv-run-3.t1.p3"></a>`INV-RUN-3.T1.P3` — direct invalid/opposite case<br><a id="inv-run-3.t1.p4"></a>`INV-RUN-3.T1.P4` — adversarial input<br><a id="inv-run-3.t1.p5"></a>`INV-RUN-3.T1.P5` — partial failure<br><a id="inv-run-3.t1.p6"></a>`INV-RUN-3.T1.P6` — retry and recovery                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `INV-RUN-4.T1`  | `INV-RUN-4`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | The signing key and nonce never cross a boundary; only the host signs; the client holds proxy signers.                                                                                                                                                                                                                                      | <a id="inv-run-4.t1.p1"></a>`INV-RUN-4.T1.P1` — valid case<br><a id="inv-run-4.t1.p2"></a>`INV-RUN-4.T1.P2` — correct identity/signature<br><a id="inv-run-4.t1.p3"></a>`INV-RUN-4.T1.P3` — direct invalid/opposite case<br><a id="inv-run-4.t1.p4"></a>`INV-RUN-4.T1.P4` — wrong identity/signature<br><a id="inv-run-4.t1.p5"></a>`INV-RUN-4.T1.P5` — missing identity/signature<br><a id="inv-run-4.t1.p6"></a>`INV-RUN-4.T1.P6` — duplicate identity/signature<br><a id="inv-run-4.t1.p7"></a>`INV-RUN-4.T1.P7` — forged identity/signature<br><a id="inv-run-4.t1.p8"></a>`INV-RUN-4.T1.P8` — membership boundary                                                                                                                                                                                                                                                                                                                                                                                                            |
| `REQ-RUN-8.T1`  | `REQ-RUN-8`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Harness control is a custom-RPC root over the same serialized surfaces; a controller drives a peer only through `hostRpc` (loopback to that peer's host, or a typed relay to a peer address), never by in-process reference.                                                                                                                | <a id="req-run-8.t1.p1"></a>`REQ-RUN-8.T1.P1` — valid case<br><a id="req-run-8.t1.p2"></a>`REQ-RUN-8.T1.P2` — correct identity/signature<br><a id="req-run-8.t1.p3"></a>`REQ-RUN-8.T1.P3` — direct invalid/opposite case<br><a id="req-run-8.t1.p4"></a>`REQ-RUN-8.T1.P4` — wrong identity/signature<br><a id="req-run-8.t1.p5"></a>`REQ-RUN-8.T1.P5` — missing identity/signature<br><a id="req-run-8.t1.p6"></a>`REQ-RUN-8.T1.P6` — duplicate identity/signature<br><a id="req-run-8.t1.p7"></a>`REQ-RUN-8.T1.P7` — forged identity/signature<br><a id="req-run-8.t1.p8"></a>`REQ-RUN-8.T1.P8` — membership boundary                                                                                                                                                                                                                                                                                                                                                                                                            |
| `REQ-RUN-9.T1`  | `REQ-RUN-9`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Every harness-control operation returns structured-clone-serializable projections; bigint-bearing structs cross `Codec.encode`d and are decoded in the host endpoint.                                                                                                                                                                       | <a id="req-run-9.t1.p1"></a>`REQ-RUN-9.T1.P1` — valid case<br><a id="req-run-9.t1.p2"></a>`REQ-RUN-9.T1.P2` — zero/empty/no-op case where meaningful<br><a id="req-run-9.t1.p3"></a>`REQ-RUN-9.T1.P3` — direct invalid/opposite case<br><a id="req-run-9.t1.p4"></a>`REQ-RUN-9.T1.P4` — exact boundary<br><a id="req-run-9.t1.p5"></a>`REQ-RUN-9.T1.P5` — failure/recovery<br><a id="req-run-9.t1.p6"></a>`REQ-RUN-9.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `REQ-RUN-10.T1` | `REQ-RUN-10`            | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | The harness-control root is not reachable by a network peer and is not present in a production artifact.                                                                                                                                                                                                                                    | <a id="req-run-10.t1.p1"></a>`REQ-RUN-10.T1.P1` — valid case<br><a id="req-run-10.t1.p2"></a>`REQ-RUN-10.T1.P2` — correct identity/signature<br><a id="req-run-10.t1.p3"></a>`REQ-RUN-10.T1.P3` — direct invalid/opposite case<br><a id="req-run-10.t1.p4"></a>`REQ-RUN-10.T1.P4` — wrong identity/signature<br><a id="req-run-10.t1.p5"></a>`REQ-RUN-10.T1.P5` — missing identity/signature<br><a id="req-run-10.t1.p6"></a>`REQ-RUN-10.T1.P6` — duplicate identity/signature<br><a id="req-run-10.t1.p7"></a>`REQ-RUN-10.T1.P7` — forged identity/signature<br><a id="req-run-10.t1.p8"></a>`REQ-RUN-10.T1.P8` — membership boundary                                                                                                                                                                                                                                                                                                                                                                                            |
| `REQ-RUN-11.T1` | `REQ-RUN-11`            | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Concurrently executing peers and test processes are isolated: per-peer host realm and service state, disjoint account partitions per process, per-test channel id, per-slot chain/discovery/cache.                                                                                                                                          | <a id="req-run-11.t1.p1"></a>`REQ-RUN-11.T1.P1` — valid case<br><a id="req-run-11.t1.p2"></a>`REQ-RUN-11.T1.P2` — correct identity/signature<br><a id="req-run-11.t1.p3"></a>`REQ-RUN-11.T1.P3` — new participant<br><a id="req-run-11.t1.p4"></a>`REQ-RUN-11.T1.P4` — direct invalid/opposite case<br><a id="req-run-11.t1.p5"></a>`REQ-RUN-11.T1.P5` — wrong identity/signature<br><a id="req-run-11.t1.p6"></a>`REQ-RUN-11.T1.P6` — missing identity/signature<br><a id="req-run-11.t1.p7"></a>`REQ-RUN-11.T1.P7` — duplicate identity/signature<br><a id="req-run-11.t1.p8"></a>`REQ-RUN-11.T1.P8` — forged identity/signature<br><a id="req-run-11.t1.p9"></a>`REQ-RUN-11.T1.P9` — membership boundary<br><a id="req-run-11.t1.p10"></a>`REQ-RUN-11.T1.P10` — existing participant<br><a id="req-run-11.t1.p11"></a>`REQ-RUN-11.T1.P11` — removed participant<br><a id="req-run-11.t1.p12"></a>`REQ-RUN-11.T1.P12` — slashed participant<br><a id="req-run-11.t1.p13"></a>`REQ-RUN-11.T1.P13` — concurrent membership change |
| `REQ-RUN-12.T1` | `REQ-RUN-12`            | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | The inline-vs-worker equivalence criterion states which observations must be identical across `RUN_SDK_IN_THREAD × VM_DEDICATED_THREAD`, and the matrix test is that criterion's oracle.                                                                                                                                                    | <a id="req-run-12.t1.p1"></a>`REQ-RUN-12.T1.P1` — valid case<br><a id="req-run-12.t1.p2"></a>`REQ-RUN-12.T1.P2` — zero/empty/no-op case where meaningful<br><a id="req-run-12.t1.p3"></a>`REQ-RUN-12.T1.P3` — direct invalid/opposite case<br><a id="req-run-12.t1.p4"></a>`REQ-RUN-12.T1.P4` — exact boundary<br><a id="req-run-12.t1.p5"></a>`REQ-RUN-12.T1.P5` — failure/recovery<br><a id="req-run-12.t1.p6"></a>`REQ-RUN-12.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `REQ-RUN-13.T1` | `REQ-RUN-13`            | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Both worker boundaries (runtime host, EVM executor) are the intended defaults, uniformly — no per-environment profile branching; today's off-by-default state is a maturity gap. Engineer decision 2026-08-10 (§6.1).                                                                                                                       | <a id="req-run-13.t1.p1"></a>`REQ-RUN-13.T1.P1` — valid case<br><a id="req-run-13.t1.p2"></a>`REQ-RUN-13.T1.P2` — before deadline<br><a id="req-run-13.t1.p3"></a>`REQ-RUN-13.T1.P3` — direct invalid/opposite case<br><a id="req-run-13.t1.p4"></a>`REQ-RUN-13.T1.P4` — at deadline<br><a id="req-run-13.t1.p5"></a>`REQ-RUN-13.T1.P5` — after deadline<br><a id="req-run-13.t1.p6"></a>`REQ-RUN-13.T1.P6` — maximum honest skew                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `REQ-RUN-14.T1` | `REQ-RUN-14`            | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | A ~6-participant channel must run within a mid-range mobile browser envelope (~4 GB device RAM, few-hundred-MB usable heap, mobile CPU). The envelope is a hard implementation budget: three contexts must be made to fit it. The 1024 MB worker cap is CI containment and is too high for this floor. Engineer decision 2026-08-10 (§6.1). | <a id="req-run-14.t1.p1"></a>`REQ-RUN-14.T1.P1` — valid case<br><a id="req-run-14.t1.p2"></a>`REQ-RUN-14.T1.P2` — correct identity/signature<br><a id="req-run-14.t1.p3"></a>`REQ-RUN-14.T1.P3` — direct invalid/opposite case<br><a id="req-run-14.t1.p4"></a>`REQ-RUN-14.T1.P4` — wrong identity/signature<br><a id="req-run-14.t1.p5"></a>`REQ-RUN-14.T1.P5` — missing identity/signature<br><a id="req-run-14.t1.p6"></a>`REQ-RUN-14.T1.P6` — duplicate identity/signature<br><a id="req-run-14.t1.p7"></a>`REQ-RUN-14.T1.P7` — forged identity/signature<br><a id="req-run-14.t1.p8"></a>`REQ-RUN-14.T1.P8` — membership boundary                                                                                                                                                                                                                                                                                                                                                                                            |
| `REQ-RUN-15.T1` | `REQ-RUN-15`            | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Inline and worker mode are equivalent when observable protocol behavior matches: blocks/signatures/state roots, on-chain actions, emitted events and payloads, and error identity. Timing and internal interleaving are out of scope.                                                                                                       | <a id="req-run-15.t1.p1"></a>`REQ-RUN-15.T1.P1` — valid case<br><a id="req-run-15.t1.p2"></a>`REQ-RUN-15.T1.P2` — correct identity/signature<br><a id="req-run-15.t1.p3"></a>`REQ-RUN-15.T1.P3` — direct invalid/opposite case<br><a id="req-run-15.t1.p4"></a>`REQ-RUN-15.T1.P4` — wrong identity/signature<br><a id="req-run-15.t1.p5"></a>`REQ-RUN-15.T1.P5` — missing identity/signature<br><a id="req-run-15.t1.p6"></a>`REQ-RUN-15.T1.P6` — duplicate identity/signature<br><a id="req-run-15.t1.p7"></a>`REQ-RUN-15.T1.P7` — forged identity/signature<br><a id="req-run-15.t1.p8"></a>`REQ-RUN-15.T1.P8` — membership boundary                                                                                                                                                                                                                                                                                                                                                                                            |
| `INV-RUN-5.T1`  | `INV-RUN-5`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | A harness-control operation executes in the host realm on live objects and returns only serializable projections; no live `Block`, transport, profile, or `StateManager` reference crosses the port.                                                                                                                                        | <a id="inv-run-5.t1.p1"></a>`INV-RUN-5.T1.P1` — valid case<br><a id="inv-run-5.t1.p2"></a>`INV-RUN-5.T1.P2` — zero/empty/no-op case where meaningful<br><a id="inv-run-5.t1.p3"></a>`INV-RUN-5.T1.P3` — direct invalid/opposite case<br><a id="inv-run-5.t1.p4"></a>`INV-RUN-5.T1.P4` — exact boundary<br><a id="inv-run-5.t1.p5"></a>`INV-RUN-5.T1.P5` — failure/recovery<br><a id="inv-run-5.t1.p6"></a>`INV-RUN-5.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `INV-RUN-6.T1`  | `INV-RUN-6`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Harness stub state (installed doubles, saved originals, registered peer keys) is scoped to one peer's host service instance, so co-located inline hosts do not leak faults between peers.                                                                                                                                                   | <a id="inv-run-6.t1.p1"></a>`INV-RUN-6.T1.P1` — valid case<br><a id="inv-run-6.t1.p2"></a>`INV-RUN-6.T1.P2` — correct identity/signature<br><a id="inv-run-6.t1.p3"></a>`INV-RUN-6.T1.P3` — direct invalid/opposite case<br><a id="inv-run-6.t1.p4"></a>`INV-RUN-6.T1.P4` — wrong identity/signature<br><a id="inv-run-6.t1.p5"></a>`INV-RUN-6.T1.P5` — missing identity/signature<br><a id="inv-run-6.t1.p6"></a>`INV-RUN-6.T1.P6` — duplicate identity/signature<br><a id="inv-run-6.t1.p7"></a>`INV-RUN-6.T1.P7` — forged identity/signature<br><a id="inv-run-6.t1.p8"></a>`INV-RUN-6.T1.P8` — membership boundary                                                                                                                                                                                                                                                                                                                                                                                                            |
