...
`unsafeSetGenesisState` (INV-DVP-5), with valid
...
2. **Slash set.** `LocalDiamond.getOnChainSlashedParticipants ∩ participants`;
   ...
   (separation of fraud-proof enforcement from reduction, INV-DVP-6).
...
[`DisputeValidationService.validateDispute`](../../../../../../../src/stateManager/DisputeValidationService.ts#L49)
...
- **INV-DVP-6** — Fraud-proof enforcement is separate from reduction: proofs
  ...
  the dispute consumes the set, it does not re-execute proofs (INV-DVP-6).
...
| -------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `INV-DVP-1.T1` | `INV-DVP-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Per-fork dispute idempotence with rollback on failed upload.                                                | <a id="inv-dvp-1.t1.p1"></a>`INV-DVP-1.T1.P1` — valid case<br><a id="inv-dvp-1.t1.p2"></a>`INV-DVP-1.T1.P2` — matching commitment<br><a id="inv-dvp-1.t1.p3"></a>`INV-DVP-1.T1.P3` — duplicate delivery<br><a id="inv-dvp-1.t1.p4"></a>`INV-DVP-1.T1.P4` — malformed input<br><a id="inv-dvp-1.t1.p5"></a>`INV-DVP-1.T1.P5` — direct invalid/opposite case<br><a id="inv-dvp-1.t1.p6"></a>`INV-DVP-1.T1.P6` — mismatched commitment<br><a id="inv-dvp-1.t1.p7"></a>`INV-DVP-1.T1.P7` — predecessor linkage<br><a id="inv-dvp-1.t1.p8"></a>`INV-DVP-1.T1.P8` — genesis linkage<br><a id="inv-dvp-1.t1.p9"></a>`INV-DVP-1.T1.P9` — stale fork<br><a id="inv-dvp-1.t1.p10"></a>`INV-DVP-1.T1.P10` — foreign fork<br><a id="inv-dvp-1.t1.p11"></a>`INV-DVP-1.T1.P11` — replay delivery<br><a id="inv-dvp-1.t1.p12"></a>`INV-DVP-1.T1.P12` — concurrent delivery<br><a id="inv-dvp-1.t1.p13"></a>`INV-DVP-1.T1.P13` — adversarial input<br><a id="inv-dvp-1.t1.p14"></a>`INV-DVP-1.T1.P14` — partial failure<br><a id="inv-dvp-1.t1.p15"></a>`INV-DVP-1.T1.P15` — retry and recovery |
| `INV-DVP-2.T1` | `INV-DVP-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Kill decisions are grounded in canonical Solidity predicates; self-slashing proofs are preflighted.         | <a id="inv-dvp-2.t1.p1"></a>`INV-DVP-2.T1.P1` — valid case<br><a id="inv-dvp-2.t1.p2"></a>`INV-DVP-2.T1.P2` — new participant<br><a id="inv-dvp-2.t1.p3"></a>`INV-DVP-2.T1.P3` — direct invalid/opposite case<br><a id="inv-dvp-2.t1.p4"></a>`INV-DVP-2.T1.P4` — existing participant<br><a id="inv-dvp-2.t1.p5"></a>`INV-DVP-2.T1.P5` — removed participant<br><a id="inv-dvp-2.t1.p6"></a>`INV-DVP-2.T1.P6` — slashed participant<br><a id="inv-dvp-2.t1.p7"></a>`INV-DVP-2.T1.P7` — concurrent membership change                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `INV-DVP-3.T1` | `INV-DVP-3`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Invalid audit ⇔ exactly one stored dispute fraud proof.                                                     | <a id="inv-dvp-3.t1.p1"></a>`INV-DVP-3.T1.P1` — valid case<br><a id="inv-dvp-3.t1.p2"></a>`INV-DVP-3.T1.P2` — malformed input<br><a id="inv-dvp-3.t1.p3"></a>`INV-DVP-3.T1.P3` — direct invalid/opposite case<br><a id="inv-dvp-3.t1.p4"></a>`INV-DVP-3.T1.P4` — adversarial input<br><a id="inv-dvp-3.t1.p5"></a>`INV-DVP-3.T1.P5` — partial failure<br><a id="inv-dvp-3.t1.p6"></a>`INV-DVP-3.T1.P6` — retry and recovery                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `INV-DVP-4.T1` | `INV-DVP-4`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Deterministic, order-independent reduction; races classified as convergence.                                | <a id="inv-dvp-4.t1.p1"></a>`INV-DVP-4.T1.P1` — valid case<br><a id="inv-dvp-4.t1.p2"></a>`INV-DVP-4.T1.P2` — duplicate delivery<br><a id="inv-dvp-4.t1.p3"></a>`INV-DVP-4.T1.P3` — direct invalid/opposite case<br><a id="inv-dvp-4.t1.p4"></a>`INV-DVP-4.T1.P4` — replay delivery<br><a id="inv-dvp-4.t1.p5"></a>`INV-DVP-4.T1.P5` — concurrent delivery                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `INV-DVP-5.T1` | `INV-DVP-5`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Every dispute path installs a successor fork via `unsafeSetGenesisState`.                                   | <a id="inv-dvp-5.t1.p1"></a>`INV-DVP-5.T1.P1` — valid case<br><a id="inv-dvp-5.t1.p2"></a>`INV-DVP-5.T1.P2` — matching commitment<br><a id="inv-dvp-5.t1.p3"></a>`INV-DVP-5.T1.P3` — malformed input<br><a id="inv-dvp-5.t1.p4"></a>`INV-DVP-5.T1.P4` — direct invalid/opposite case<br><a id="inv-dvp-5.t1.p5"></a>`INV-DVP-5.T1.P5` — mismatched commitment<br><a id="inv-dvp-5.t1.p6"></a>`INV-DVP-5.T1.P6` — predecessor linkage<br><a id="inv-dvp-5.t1.p7"></a>`INV-DVP-5.T1.P7` — genesis linkage<br><a id="inv-dvp-5.t1.p8"></a>`INV-DVP-5.T1.P8` — stale fork<br><a id="inv-dvp-5.t1.p9"></a>`INV-DVP-5.T1.P9` — foreign fork<br><a id="inv-dvp-5.t1.p10"></a>`INV-DVP-5.T1.P10` — adversarial input<br><a id="inv-dvp-5.t1.p11"></a>`INV-DVP-5.T1.P11` — partial failure<br><a id="inv-dvp-5.t1.p12"></a>`INV-DVP-5.T1.P12` — retry and recovery                                                                                                                                                                                                                       |
| `INV-DVP-6.T1` | `INV-DVP-6`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Fraud proofs slash before/independently of the dispute that consumes the slash set.                         | <a id="inv-dvp-6.t1.p1"></a>`INV-DVP-6.T1.P1` — valid case<br><a id="inv-dvp-6.t1.p2"></a>`INV-DVP-6.T1.P2` — new participant<br><a id="inv-dvp-6.t1.p3"></a>`INV-DVP-6.T1.P3` — malformed input<br><a id="inv-dvp-6.t1.p4"></a>`INV-DVP-6.T1.P4` — direct invalid/opposite case<br><a id="inv-dvp-6.t1.p5"></a>`INV-DVP-6.T1.P5` — existing participant<br><a id="inv-dvp-6.t1.p6"></a>`INV-DVP-6.T1.P6` — removed participant<br><a id="inv-dvp-6.t1.p7"></a>`INV-DVP-6.T1.P7` — slashed participant<br><a id="inv-dvp-6.t1.p8"></a>`INV-DVP-6.T1.P8` — concurrent membership change<br><a id="inv-dvp-6.t1.p9"></a>`INV-DVP-6.T1.P9` — adversarial input<br><a id="inv-dvp-6.t1.p10"></a>`INV-DVP-6.T1.P10` — partial failure<br><a id="inv-dvp-6.t1.p11"></a>`INV-DVP-6.T1.P11` — retry and recovery                                                                                                                                                                                                                                                                        |
| `REQ-DVP-1.T1` | `REQ-DVP-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Timeout submission respects precedence/race guards (existing window age, calldata grants, forced timeouts). | <a id="req-dvp-1.t1.p1"></a>`REQ-DVP-1.T1.P1` — valid case<br><a id="req-dvp-1.t1.p2"></a>`REQ-DVP-1.T1.P2` — before deadline<br><a id="req-dvp-1.t1.p3"></a>`REQ-DVP-1.T1.P3` — direct invalid/opposite case<br><a id="req-dvp-1.t1.p4"></a>`REQ-DVP-1.T1.P4` — at deadline<br><a id="req-dvp-1.t1.p5"></a>`REQ-DVP-1.T1.P5` — after deadline<br><a id="req-dvp-1.t1.p6"></a>`REQ-DVP-1.T1.P6` — maximum honest skew                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `REQ-DVP-2.T1` | `REQ-DVP-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | The reducer reads the dispute window through event-synchronized storage (never a window it cannot back).    | <a id="req-dvp-2.t1.p1"></a>`REQ-DVP-2.T1.P1` — valid case<br><a id="req-dvp-2.t1.p2"></a>`REQ-DVP-2.T1.P2` — before deadline<br><a id="req-dvp-2.t1.p3"></a>`REQ-DVP-2.T1.P3` — malformed input<br><a id="req-dvp-2.t1.p4"></a>`REQ-DVP-2.T1.P4` — direct invalid/opposite case<br><a id="req-dvp-2.t1.p5"></a>`REQ-DVP-2.T1.P5` — at deadline<br><a id="req-dvp-2.t1.p6"></a>`REQ-DVP-2.T1.P6` — after deadline<br><a id="req-dvp-2.t1.p7"></a>`REQ-DVP-2.T1.P7` — maximum honest skew<br><a id="req-dvp-2.t1.p8"></a>`REQ-DVP-2.T1.P8` — adversarial input<br><a id="req-dvp-2.t1.p9"></a>`REQ-DVP-2.T1.P9` — partial failure<br><a id="req-dvp-2.t1.p10"></a>`REQ-DVP-2.T1.P10` — retry and recovery                                                                                                                                                                                                                                                                                                                                                                        |
| `REQ-DVP-3.T1` | `REQ-DVP-3`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | An incorrect committed reduction is challenged within the challenge period.                                 | <a id="req-dvp-3.t1.p1"></a>`REQ-DVP-3.T1.P1` — valid case<br><a id="req-dvp-3.t1.p2"></a>`REQ-DVP-3.T1.P2` — matching commitment<br><a id="req-dvp-3.t1.p3"></a>`REQ-DVP-3.T1.P3` — before deadline<br><a id="req-dvp-3.t1.p4"></a>`REQ-DVP-3.T1.P4` — direct invalid/opposite case<br><a id="req-dvp-3.t1.p5"></a>`REQ-DVP-3.T1.P5` — mismatched commitment<br><a id="req-dvp-3.t1.p6"></a>`REQ-DVP-3.T1.P6` — predecessor linkage<br><a id="req-dvp-3.t1.p7"></a>`REQ-DVP-3.T1.P7` — genesis linkage<br><a id="req-dvp-3.t1.p8"></a>`REQ-DVP-3.T1.P8` — stale fork<br><a id="req-dvp-3.t1.p9"></a>`REQ-DVP-3.T1.P9` — foreign fork<br><a id="req-dvp-3.t1.p10"></a>`REQ-DVP-3.T1.P10` — at deadline<br><a id="req-dvp-3.t1.p11"></a>`REQ-DVP-3.T1.P11` — after deadline<br><a id="req-dvp-3.t1.p12"></a>`REQ-DVP-3.T1.P12` — maximum honest skew                                                                                                                                                                                                                             |
...
| ----------------------- | ----------------------------------------------------------------------------------------------------------- | --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| `INV-DVP-1`             | Per-fork dispute idempotence with rollback on failed upload.                                                | Covered               | [src/disputeManager/DisputeManager.ts](../../../../../../../src/disputeManager/DisputeManager.ts#L1) (`dispute`)                                                                                                                                               | None.            |
| `INV-DVP-2`             | Kill decisions are grounded in canonical Solidity predicates; self-slashing proofs are preflighted.         | Covered               | [src/stateManager/DisputeValidationService.ts](../../../../../../../src/stateManager/DisputeValidationService.ts#L33) (staticCalls, `validateTimeoutCalldataPostedProof`)                                                                                      | None.            |
| `INV-DVP-3`             | Invalid audit ⇔ exactly one stored dispute fraud proof.                                                     | Covered               | `validateDispute` + `hasStoredDisputeFraudProof` throw paths                                                                                                                                                                                                   | None.            |
| `INV-DVP-4`             | Deterministic, order-independent reduction; races classified as convergence.                                | Covered               | [src/stateManager/reduction](../../../../../../../src/stateManager/reduction) (`classifyReductionRace`, `compute`)                                                                                                                                             | None.            |
| `INV-DVP-5`             | Every dispute path installs a successor fork via `unsafeSetGenesisState`.                                   | Covered               | [src/stateManager/reduction/ReductionManager.ts](../../../../../../../src/stateManager/reduction/ReductionManager.ts#L52) (`completeWithGenesis`), [src/eventHandlers/EventHandler.ts](../../../../../../../src/eventHandlers/EventHandler.ts#L1) (final path) | None.            |
| `INV-DVP-6`             | Fraud proofs slash before/independently of the dispute that consumes the slash set.                         | Covered               | `constructDispute` multicall ordering; `killDispute`                                                                                                                                                                                                           | None.            |
| `REQ-DVP-1`             | Timeout submission respects precedence/race guards (existing window age, calldata grants, forced timeouts). | Covered               | [src/stateManager/StateManager.ts](../../../../../../../src/stateManager/StateManager.ts#L1) (`tryTimeoutParticipant`)                                                                                                                                         | None.            |
| `REQ-DVP-2`             | The reducer reads the dispute window through event-synchronized storage (never a window it cannot back).    | Covered               | [src/stateManager/EventSyncService.ts](../../../../../../../src/stateManager/EventSyncService.ts#L1) (`loadSynchronizedWindowCommitments`, `ensureDisputesProcessed`)                                                                                          | None.            |
| `REQ-DVP-3`             | An incorrect committed reduction is challenged within the challenge period.                                 | Covered               | [src/eventHandlers/EventHandler.ts](../../../../../../../src/eventHandlers/EventHandler.ts#L1) (`validateDisputeReductionAndChallenge`)                                                                                                                        | None.            |
