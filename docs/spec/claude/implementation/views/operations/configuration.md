...
| -------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `REQ-CFG-1.T1` | `REQ-CFG-1`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Read the resulting public `config` after `createConfig`; every field equals the highest-precedence valid source.                                                   | <a id="req-cfg-1.t1.p1"></a>`REQ-CFG-1.T1.P1` — default only<br><a id="req-cfg-1.t1.p2"></a>`REQ-CFG-1.T1.P2` — file over default<br><a id="req-cfg-1.t1.p3"></a>`REQ-CFG-1.T1.P3` — environment over file<br><a id="req-cfg-1.t1.p4"></a>`REQ-CFG-1.T1.P4` — explicit override over environment<br><a id="req-cfg-1.t1.p5"></a>`REQ-CFG-1.T1.P5` — unrelated keys unchanged                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `REQ-CFG-2.T1` | `REQ-CFG-2`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Boolean, number, array, and string values have the documented runtime types; malformed values leave the previous value intact.                                     | <a id="req-cfg-2.t1.p1"></a>`REQ-CFG-2.T1.P1` — boolean `true` spelling<br><a id="req-cfg-2.t1.p2"></a>`REQ-CFG-2.T1.P2` — finite number<br><a id="req-cfg-2.t1.p3"></a>`REQ-CFG-2.T1.P3` — JSON array<br><a id="req-cfg-2.t1.p4"></a>`REQ-CFG-2.T1.P4` — malformed JSON<br><a id="req-cfg-2.t1.p5"></a>`REQ-CFG-2.T1.P5` — empty value<br><a id="req-cfg-2.t1.p6"></a>`REQ-CFG-2.T1.P6` — boolean `1` spelling<br><a id="req-cfg-2.t1.p7"></a>`REQ-CFG-2.T1.P7` — boolean `yes` spelling<br><a id="req-cfg-2.t1.p8"></a>`REQ-CFG-2.T1.P8` — boolean `y` spelling<br><a id="req-cfg-2.t1.p9"></a>`REQ-CFG-2.T1.P9` — boolean `on` spelling<br><a id="req-cfg-2.t1.p10"></a>`REQ-CFG-2.T1.P10` — boolean `false` spelling<br><a id="req-cfg-2.t1.p11"></a>`REQ-CFG-2.T1.P11` — boolean `0` spelling<br><a id="req-cfg-2.t1.p12"></a>`REQ-CFG-2.T1.P12` — boolean `no` spelling<br><a id="req-cfg-2.t1.p13"></a>`REQ-CFG-2.T1.P13` — boolean `n` spelling<br><a id="req-cfg-2.t1.p14"></a>`REQ-CFG-2.T1.P14` — boolean `off` spelling<br><a id="req-cfg-2.t1.p15"></a>`REQ-CFG-2.T1.P15` — mixed-case boolean spelling<br><a id="req-cfg-2.t1.p16"></a>`REQ-CFG-2.T1.P16` — whitespace-padded boolean spelling<br><a id="req-cfg-2.t1.p17"></a>`REQ-CFG-2.T1.P17` — non-finite number<br><a id="req-cfg-2.t1.p18"></a>`REQ-CFG-2.T1.P18` — comma-separated array<br><a id="req-cfg-2.t1.p19"></a>`REQ-CFG-2.T1.P19` — space-separated array<br><a id="req-cfg-2.t1.p20"></a>`REQ-CFG-2.T1.P20` — unknown value |
| `REQ-CFG-3.T1` | `REQ-CFG-3`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Identical environment-like input affects the Node result only; browser configuration remains file/override based.                                                  | <a id="req-cfg-3.t1.p1"></a>`REQ-CFG-3.T1.P1` — Node<br><a id="req-cfg-3.t1.p2"></a>`REQ-CFG-3.T1.P2` — browser<br><a id="req-cfg-3.t1.p3"></a>`REQ-CFG-3.T1.P3` — worker-host startup<br><a id="req-cfg-3.t1.p4"></a>`REQ-CFG-3.T1.P4` — explicit override in Node<br><a id="req-cfg-3.t1.p5"></a>`REQ-CFG-3.T1.P5` — explicit override in the browser                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `REQ-CFG-4.T1` | `REQ-CFG-4`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Components in one initialized runtime observe the same resolved values; later ambient environment mutation does not silently produce per-component configurations. | <a id="req-cfg-4.t1.p1"></a>`REQ-CFG-4.T1.P1` — main-thread runtime<br><a id="req-cfg-4.t1.p2"></a>`REQ-CFG-4.T1.P2` — dedicated runtime thread<br><a id="req-cfg-4.t1.p3"></a>`REQ-CFG-4.T1.P3` — repeated component reads<br><a id="req-cfg-4.t1.p4"></a>`REQ-CFG-4.T1.P4` — fresh runtime initialization                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `REQ-CFG-5.T1` | `REQ-CFG-5`             | Exercise the real public component or contract boundary, including rejection and failure paths without partial effects. | Defaults contain no credential; environment/explicit values reach the intended configuration field without appearing in repository configuration.                  | <a id="req-cfg-5.t1.p1"></a>`REQ-CFG-5.T1.P1` — crash-log token<br><a id="req-cfg-5.t1.p2"></a>`REQ-CFG-5.T1.P2` — credential-bearing provider URL<br><a id="req-cfg-5.t1.p3"></a>`REQ-CFG-5.T1.P3` — absent secret<br><a id="req-cfg-5.t1.p4"></a>`REQ-CFG-5.T1.P4` — explicit override                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| ----------------------------------------------------------------- | -------------------------------------------------------------- | ------------------------------------- | ---------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="integration-test-config-1"></a>`INTEGRATION-TEST-CONFIG-1` | `INV-CONFIG-1`, `REQ-CONFIG-1`, `REQ-CONFIG-2`, `REQ-CONFIG-3` | All configuration specification tests | Start the complete participant with each effective configuration and conflicting source combination. | Startup uses one typed compatible configuration or fails before protocol work without exposing secrets. | <a id="integration-test-config-1.p1"></a>`INTEGRATION-TEST-CONFIG-1.P1` — valid sources/precedence; <a id="integration-test-config-1.p2"></a>`INTEGRATION-TEST-CONFIG-1.P2` — invalid values; <a id="integration-test-config-1.p3"></a>`INTEGRATION-TEST-CONFIG-1.P3` — secret-free failure diagnostics; <a id="integration-test-config-1.p4"></a>`INTEGRATION-TEST-CONFIG-1.P4` — mismatched values; <a id="integration-test-config-1.p5"></a>`INTEGRATION-TEST-CONFIG-1.P5` — boundary values; <a id="integration-test-config-1.p6"></a>`INTEGRATION-TEST-CONFIG-1.P6` — restart after failed startup. |
