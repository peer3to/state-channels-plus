...
[../security/trust-model.md](../security/trust-model.md), [OQ-6](../open-questions.md)); no
...
| --------- | -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| INV-BCP-1 | Design pending | Validation/execution serialized under the StateManager mutex.                                                                                                                                                                                                                                                  | [src/stateManager/StateManager.ts](../../../../src/stateManager/StateManager.ts) (`onBlockConfirmation`, `playTransaction`, `withMutex`)                                                                                                             | [test/e2e/E2E-StateTransition.test.ts](../../../../test/e2e/E2E-StateTransition.test.ts)                                                                                                                       |
| INV-BCP-2 | Design pending | Failed validation restores the VM to its pre-transition state.                                                                                                                                                                                                                                                 | `onBlockConfirmation` finally-block + `restoreStateAfterFailedValidation`                                                                                                                                                                            | [test/e2e/E2E-FraudProofsBlockConfirmation.test.ts](../../../../test/e2e/E2E-FraudProofsBlockConfirmation.test.ts) (continued progress after rejected blocks)                                                  |
| INV-BCP-3 | Design pending | In-order execution; future blocks parked.                                                                                                                                                                                                                                                                      | [src/stateManager/BlockQueueManager.ts](../../../../src/stateManager/BlockQueueManager.ts) (`tryDequeuePriority`), [src/stateManager/ValidationService.ts](../../../../src/stateManager/ValidationService.ts) gate #6                                | [test/e2e/E2E-BlockQueueManager.test.ts](../../../../test/e2e/E2E-BlockQueueManager.test.ts)                                                                                                                   |
| INV-BCP-4 | Design pending | Monotone, attributed, capped signature/source merging; fixed entry lifetime.                                                                                                                                                                                                                                   | [src/storage/QueueStorage.ts](../../../../src/storage/QueueStorage.ts), [BlockQueueManager.scheduleQueueTimeout](../../../../src/stateManager/BlockQueueManager.ts)                                                                                  | [test/storage/QueueStorage.test.ts](../../../../test/storage/QueueStorage.test.ts), [test/e2e/E2E-ByzantineErrorAttribution.test.ts](../../../../test/e2e/E2E-ByzantineErrorAttribution.test.ts)               |
| INV-BCP-5 | Design pending | Persist before gossip.                                                                                                                                                                                                                                                                                         | `success()` step order, `tryMergeStoredBlockConfirmation`                                                                                                                                                                                            | [test/e2e/E2E-StateTransition.test.ts](../../../../test/e2e/E2E-StateTransition.test.ts) (echo dedup)                                                                                                          |
| INV-BCP-6 | Design pending | Every live `DISPUTE` outcome stores a fraud proof before disputing.                                                                                                                                                                                                                                            | [src/stateManager/validationStrategy/BlockValidationStrategy.ts](../../../../src/stateManager/validationStrategy/BlockValidationStrategy.ts), [src/stateManager/utils/FraudProofService.ts](../../../../src/stateManager/utils/FraudProofService.ts) | [test/e2e/E2E-FraudProofsBlockConfirmation.test.ts](../../../../test/e2e/E2E-FraudProofsBlockConfirmation.test.ts)                                                                                             |
| INV-BCP-7 | Design pending | Subjective lateness never produces a proof or slash.                                                                                                                                                                                                                                                           | [src/stateManager/ValidationService.ts](../../../../src/stateManager/ValidationService.ts) (`NOT_ENOUGH_TIME` path)                                                                                                                                  | [test/e2e/E2E-Timeouts.test.ts](../../../../test/e2e/E2E-Timeouts.test.ts)                                                                                                                                     |
| REQ-BCP-1 | Design pending | Both input paths (peer RPC and chain calldata) converge on one ingest with source attribution / on-chain timestamp respectively.                                                                                                                                                                               | [src/rpc/services/stateTransition](../../../../src/rpc/services/stateTransition), [src/eventHandlers/EventHandler.ts](../../../../src/eventHandlers/EventHandler.ts) (`onBlockCalldataPosted`)                                                       | [test/e2e/E2E-StateTransition.test.ts](../../../../test/e2e/E2E-StateTransition.test.ts), [test/e2e/E2E-Timeouts.test.ts](../../../../test/e2e/E2E-Timeouts.test.ts) (calldata recovery)                       |
| REQ-BCP-2 | Design pending | Objective timestamp rule is evaluated by the canonical Solidity predicate over the exact proof struct.                                                                                                                                                                                                         | [src/stateManager/ValidationService.ts](../../../../src/stateManager/ValidationService.ts) (`hasInvalidTimestamp.staticCall`)                                                                                                                        | [test/e2e/E2E-FirstBlockTimestampGrace.test.ts](../../../../test/e2e/E2E-FirstBlockTimestampGrace.test.ts)                                                                                                     |
| REQ-BCP-3 | Design pending | Non-state-mutating intake and merge (older/future/duplicate blocks, late signatures) never require the state-transition mutex; merge rules are deterministic, idempotent, and resource-capped per entry.                                                                                                       | [BlockQueueManager](../../../../src/stateManager/BlockQueueManager.ts) (scheduled tasks), [QueueStorage](../../../../src/storage/QueueStorage.ts), [StateManager.tryMergeStoredBlockConfirmation](../../../../src/stateManager/StateManager.ts)      | concurrency exercised by [test/e2e/E2E-StateTransition.test.ts](../../../../test/e2e/E2E-StateTransition.test.ts) and parallel-runner suites; dedicated mutex-freedom/merge-idempotence unit tests: none — gap |
