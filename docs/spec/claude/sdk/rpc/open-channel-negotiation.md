...
> ([`OpenChannelNegotiationService.ts`](../../../../../src/rpc/services/openChannelNegotiation/OpenChannelNegotiationService.ts),
> [`OpenChannelNegotiationRpcMethods.ts`](../../../../../src/rpc/services/openChannelNegotiation/OpenChannelNegotiationRpcMethods.ts),
> [`OpenChannelNegotiationHelpers.ts`](../../../../../src/rpc/services/openChannelNegotiation/OpenChannelNegotiationHelpers.ts)):
...
([`src/rpc/services/index.ts`](../../../../../src/rpc/services/index.ts), together with its
RpcMethods class, the `OpenChannelNegotiationCustomRpc`/`OpenChannelNegotiationP2PManager` types,
and the helpers), but [`MainRpcService`](../../../../../src/rpc/MainRpcService.ts) does not
...
(OQ-34, [../../open-questions.md](../../open-questions.md)): silent ignore makes out-of-sequence
...
- Constants ([`OpenChannelNegotiationHelpers.ts`](../../../../../src/rpc/services/openChannelNegotiation/OpenChannelNegotiationHelpers.ts)):
...
| --------- | -------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| REQ-OCN-1 | Design pending | Every endpoint binds the counterparty to the handshake-verified transport address; parameters never select the peer.                            | [src/rpc/services/openChannelNegotiation/OpenChannelNegotiationRpcMethods.ts](../../../../../src/rpc/services/openChannelNegotiation/OpenChannelNegotiationRpcMethods.ts)                                                                                                                                         | none — gap                                                                                                                                                                               |
| REQ-OCN-2 | Design pending | The receiver co-signs only the exact negotiated terms; any field deviation or bad lower signature → disconnect + blacklist + reset.             | [src/rpc/services/openChannelNegotiation/OpenChannelNegotiationService.ts](../../../../../src/rpc/services/openChannelNegotiation/OpenChannelNegotiationService.ts) (`openProposal`), [OpenChannelNegotiationHelpers.ts](../../../../../src/rpc/services/openChannelNegotiation/OpenChannelNegotiationHelpers.ts) | [test/rpc/openChannelNegotiation/OpenChannelProposal.test.ts](../../../../../test/rpc/openChannelNegotiation/OpenChannelProposal.test.ts) (comparison only; service path untested — gap) |
| REQ-OCN-3 | Design pending | Open success is confirmed against the chain, never against a peer message; the deadline check aborts and resets a round the chain did not open. | [src/rpc/services/openChannelNegotiation/OpenChannelNegotiationService.ts](../../../../../src/rpc/services/openChannelNegotiation/OpenChannelNegotiationService.ts) (`maybeProgress`, `scheduleDeadlineCheck`)                                                                                                    | none — gap                                                                                                                                                                               |
| INV-OCN-1 | Design pending | One negotiation slot; non-counterparty frames never mutate the active round.                                                                    | [src/rpc/services/openChannelNegotiation/OpenChannelNegotiationRpcMethods.ts](../../../../../src/rpc/services/openChannelNegotiation/OpenChannelNegotiationRpcMethods.ts)                                                                                                                                         | none — gap                                                                                                                                                                               |
| INV-OCN-2 | Design pending | The local balance side of any signed proposal is the locally held `myAmount`.                                                                   | [src/rpc/services/openChannelNegotiation/OpenChannelNegotiationService.ts](../../../../../src/rpc/services/openChannelNegotiation/OpenChannelNegotiationService.ts) (`getParticipantsAndBalances`)                                                                                                                | none — gap                                                                                                                                                                               |
| INV-OCN-3 | Design pending | Co-signing requires field-exact term match plus lower-address signature recovery.                                                               | [src/rpc/services/openChannelNegotiation/OpenChannelNegotiationService.ts](../../../../../src/rpc/services/openChannelNegotiation/OpenChannelNegotiationService.ts), [OpenChannelNegotiationHelpers.ts](../../../../../src/rpc/services/openChannelNegotiation/OpenChannelNegotiationHelpers.ts)                  | [test/rpc/openChannelNegotiation/OpenChannelProposal.test.ts](../../../../../test/rpc/openChannelNegotiation/OpenChannelProposal.test.ts) (comparison half); none — gap (recovery half)  |
| INV-OCN-4 | Design pending | `channelOpened` latches and disables all endpoints and timers for the channel.                                                                  | [src/rpc/services/openChannelNegotiation/OpenChannelNegotiationService.ts](../../../../../src/rpc/services/openChannelNegotiation/OpenChannelNegotiationService.ts)                                                                                                                                               | none — gap                                                                                                                                                                               |
