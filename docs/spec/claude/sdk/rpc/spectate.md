...
> ([../../protocol/cross-layer-messages.md](../../protocol/cross-layer-messages.md) §3) rather than
> restating them.
> **ID prefix:** `SPC` (`INV-SPC-n`, `REQ-SPC-n`).

Related: [./README.md](./README.md) (dispatch, guards, delivery modes, failure outcomes,
one-in-flight-per-peer replay rule), [../../protocol/cross-layer-messages.md](../../protocol/cross-layer-messages.md)
§3 (spectate-before-join, the enumerated abort conditions REQ-MSG-9), §6 (the channel-balance
invariant INV-MSG-6), [../../open-questions.md](../../open-questions.md) (OQ-6, OQ-10, OQ-19, DEF-5).
...
([../../protocol/cross-layer-messages.md](../../protocol/cross-layer-messages.md) §3.1). A
...
- **Responder side (`onSpectateRequest` → `generateSyncPayload`).** The one **public RPC endpoint**
  ([`SpectateRpcMethods`](../../../../../src/rpc/services/spectate/SpectateRpcMethods.ts)). Generates
...
([`InitHandshakeService`](../../../../../src/rpc/services/initHandshake/InitHandshakeService.ts),
...
([`BlockQueueManager`](../../../../../src/stateManager/BlockQueueManager.ts)), which pins the
...
([`SpectateRpcMethods`](../../../../../src/rpc/services/spectate/SpectateRpcMethods.ts) +
[`SpectateService.generateSyncPayload`](../../../../../src/rpc/services/spectate/SpectateService.ts)):
...
2. **Generate proof.** `generateSyncPayload(channelId, forkId?, blockHeight?)`:
    ...
    - Assemble the `SyncPayload` ([`src/types/spectate.ts`](../../../../../src/types/spectate.ts)).
...
[../../protocol/cross-layer-messages.md](../../protocol/cross-layer-messages.md) §3.2):
...
[`SpectateService.abort`](../../../../../src/rpc/services/spectate/SpectateService.ts): if the node
...
REQ-MSG-9 ([../../protocol/cross-layer-messages.md](../../protocol/cross-layer-messages.md) §3.2).
...
- A snapshot whose in-channel balances exceed deposits minus withdrawals fails
  ...
  [../../protocol/cross-layer-messages.md](../../protocol/cross-layer-messages.md) §6.1 and
  [../../open-questions.md](../../open-questions.md) OQ-19: even a _unanimous_ colluding participant
...
([../../protocol/cross-layer-messages.md](../../protocol/cross-layer-messages.md) §2.3/§6.3, OQ-19):
...
pending; related to DEF-5, [../../open-questions.md](../../open-questions.md).)
...
canonical known defect ([../../open-questions.md](../../open-questions.md) DEF-5 / OQ-10 addendum):
...
([../../protocol/cross-layer-messages.md](../../protocol/cross-layer-messages.md) §3.1). The payload
...
- Resolve the spectate-simulation consumer-side-effect stubbing so the step-12 multicall simulation
  ...
  ([../../protocol/cross-layer-messages.md](../../protocol/cross-layer-messages.md) §3.2 TODO).

## 9. Traceability

| ID        | State          | Statement                                                                                                                                 | Implementation                                                                                                                                                                                                                                                | Verification evidence                                                                                                                                                                                                                                 |
| --------- | -------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| INV-SPC-1 | Design pending | Served payload re-verified against on-chain truth + contract logic before any state effect.                                               | [SpectateService.applySyncResponse](../../../../../src/rpc/services/spectate/SpectateService.ts)                                                                                                                                                              | [E2E-Spectate.test.ts](../../../../../test/e2e/E2E-Spectate.test.ts), [E2E-SpectateStaleProofGuard.test.ts](../../../../../test/e2e/E2E-SpectateStaleProofGuard.test.ts), [SpectateService.test.ts](../../../../../test/unit/SpectateService.test.ts) |
| INV-SPC-2 | Design pending | Payload validated against the requester's own request, not the peer's echo.                                                               | [SpectateService.sync / applySyncResponse](../../../../../src/rpc/services/spectate/SpectateService.ts)                                                                                                                                                       | none — gap (implicit; no direct assertion)                                                                                                                                                                                                            |
| INV-SPC-3 | Design pending | One in-flight sync per peer, cleaned in `finally`.                                                                                        | [SpectateService.sync](../../../../../src/rpc/services/spectate/SpectateService.ts)                                                                                                                                                                           | none — gap                                                                                                                                                                                                                                            |
| INV-SPC-4 | Design pending | Fail-closed: any failure aborts with no partial commitment (REQ-MSG-9).                                                                   | [SpectateService.abort](../../../../../src/rpc/services/spectate/SpectateService.ts); [SpectatingValidationStrategy](../../../../../src/stateManager/validationStrategy/SpectatingValidationStrategy.ts)                                                      | [E2E-SpectatingAbortDoS.test.ts](../../../../../test/e2e/E2E-SpectatingAbortDoS.test.ts), [E2E-Spectate.test.ts](../../../../../test/e2e/E2E-Spectate.test.ts)                                                                                        |
| INV-SPC-5 | Design pending | Adopted finalized snapshot satisfies the balance invariant (INV-MSG-6) client-side.                                                       | [SpectateService.applySyncResponse](../../../../../src/rpc/services/spectate/SpectateService.ts) (step 11); [DisputeVerificationFacet.verifyBalanceInvariantCheckSnapshot](../../../../../contracts/V1/StateChannelDiamondProxy/DisputeVerificationFacet.sol) | [E2E-Spectate.test.ts](../../../../../test/e2e/E2E-Spectate.test.ts)                                                                                                                                                                                  |
| INV-SPC-6 | Design pending | No sync step sends a transaction; verification via local EVM / `staticCall`.                                                              | [SpectateService](../../../../../src/rpc/services/spectate/SpectateService.ts)                                                                                                                                                                                | [E2E-Spectate.test.ts](../../../../../test/e2e/E2E-Spectate.test.ts)                                                                                                                                                                                  |
| REQ-SPC-1 | Design pending | The responder MUST return `undefined` (not a substituted proof) for any target it cannot prove exactly, including an above-latest height. | [SpectateService.generateSyncPayload](../../../../../src/rpc/services/spectate/SpectateService.ts)                                                                                                                                                            | [SpectateService.test.ts](../../../../../test/unit/SpectateService.test.ts)                                                                                                                                                                           |
| REQ-SPC-2 | Design pending | Request-path failures MUST distinguish availability/transport failure from Byzantine evidence before permanent exclusion.                 | none — DEF-5 (over-broad blacklist)                                                                                                                                                                                                                           | none — gap ([DEF-5](../../open-questions.md))                                                                                                                                                                                                         |
| REQ-SPC-3 | Design pending | An honest can't-prove-yet request MUST NOT permanently blacklist the requester.                                                           | none — current code blacklists (§4.2)                                                                                                                                                                                                                         | none — gap (decision pending)                                                                                                                                                                                                                         |
| REQ-SPC-4 | Design pending | Proof-serving MUST be resource-bounded per peer.                                                                                          | none — one-in-flight only; no rate limit                                                                                                                                                                                                                      | none — gap ([OQ-6](../../open-questions.md))                                                                                                                                                                                                          |
