...
| --------- | ----------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| INV-SPC-1 | Served payload re-verified against on-chain truth + contract logic before any state effect.                                               | [SpectateService.applySyncResponse](../../../../../src/rpc/services/spectate/SpectateService.ts)                                                                                                                                                              | [E2E-Spectate.test.ts](../../../../../test/e2e/E2E-Spectate.test.ts), [E2E-SpectateStaleProofGuard.test.ts](../../../../../test/e2e/E2E-SpectateStaleProofGuard.test.ts), [SpectateService.test.ts](../../../../../test/unit/SpectateService.test.ts) |
| INV-SPC-2 | Payload validated against the requester's own request, not the peer's echo.                                                               | [SpectateService.sync / applySyncResponse](../../../../../src/rpc/services/spectate/SpectateService.ts)                                                                                                                                                       | none — gap (implicit; no direct assertion)                                                                                                                                                                                                            |
| INV-SPC-3 | One in-flight sync per peer, cleaned in `finally`.                                                                                        | [SpectateService.sync](../../../../../src/rpc/services/spectate/SpectateService.ts)                                                                                                                                                                           | none — gap                                                                                                                                                                                                                                            |
| INV-SPC-4 | Fail-closed: any failure aborts with no partial commitment (REQ-MSG-9).                                                                   | [SpectateService.abort](../../../../../src/rpc/services/spectate/SpectateService.ts); [SpectatingValidationStrategy](../../../../../src/stateManager/validationStrategy/SpectatingValidationStrategy.ts)                                                      | [E2E-SpectatingAbortDoS.test.ts](../../../../../test/e2e/E2E-SpectatingAbortDoS.test.ts), [E2E-Spectate.test.ts](../../../../../test/e2e/E2E-Spectate.test.ts)                                                                                        |
| INV-SPC-5 | Adopted finalized snapshot satisfies the balance invariant (INV-MSG-6) client-side.                                                       | [SpectateService.applySyncResponse](../../../../../src/rpc/services/spectate/SpectateService.ts) (step 11); [DisputeVerificationFacet.verifyBalanceInvariantCheckSnapshot](../../../../../contracts/V1/StateChannelDiamondProxy/DisputeVerificationFacet.sol) | [E2E-Spectate.test.ts](../../../../../test/e2e/E2E-Spectate.test.ts)                                                                                                                                                                                  |
| INV-SPC-6 | No sync step sends a transaction; verification via local EVM / `staticCall`.                                                              | [SpectateService](../../../../../src/rpc/services/spectate/SpectateService.ts)                                                                                                                                                                                | [E2E-Spectate.test.ts](../../../../../test/e2e/E2E-Spectate.test.ts)                                                                                                                                                                                  |
| REQ-SPC-1 | The responder MUST return `undefined` (not a substituted proof) for any target it cannot prove exactly, including an above-latest height. | [SpectateService.generateSyncPayload](../../../../../src/rpc/services/spectate/SpectateService.ts)                                                                                                                                                            | [SpectateService.test.ts](../../../../../test/unit/SpectateService.test.ts)                                                                                                                                                                           |
| REQ-SPC-2 | Request-path failures MUST distinguish availability/transport failure from Byzantine evidence before permanent exclusion.                 | none — DEF-5 (over-broad blacklist)                                                                                                                                                                                                                           | none — gap ([DEF-5](../../open-questions.md))                                                                                                                                                                                                         |
| REQ-SPC-3 | An honest can't-prove-yet request MUST NOT permanently blacklist the requester.                                                           | none — current code blacklists (§4.2)                                                                                                                                                                                                                         | none — gap (decision pending)                                                                                                                                                                                                                         |
| REQ-SPC-4 | Proof-serving MUST be resource-bounded per peer.                                                                                          | none — one-in-flight only; no rate limit                                                                                                                                                                                                                      | none — gap ([OQ-6](../../open-questions.md))                                                                                                                                                                                                          |
