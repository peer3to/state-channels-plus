...
| --- | --- | --- | --- |
| REQ-RPC-1 | Only deliberately public methods live on `RpcMethods` classes; private helpers and mutable service state are never exposed through them. | [src/rpc/ARpcMethods.ts](../../../../../src/rpc/ARpcMethods.ts), [src/rpc/services](../../../../../src/rpc/services) | none — gap (structural convention; no lint/test enforces it) |
...
| REQ-RPC-3 | Custom roots extend the boundary only through the service/RpcMethods pattern via manifest + registry. | [src/rpc/registry.ts](../../../../../src/rpc/registry.ts), [src/rpc/resolveCustomRpcManifest.ts](../../../../../src/rpc/resolveCustomRpcManifest.ts), [src/P2PManager.ts](../../../../../src/P2PManager.ts) | [test/e2e/E2E-CustomRpcRequestResponse.test.ts](../../../../../test/e2e/E2E-CustomRpcRequestResponse.test.ts) |
| REQ-RPC-4 | Bigints cross the boundary only as canonical Codec encodings; raw `BigInt` throws at the sender. | [src/rpc/Rpc.ts](../../../../../src/rpc/Rpc.ts) (`serializeRpc`), [src/utils/Codec.ts](../../../../../src/utils/Codec.ts) | [test/rpc/Rpc.test.ts](../../../../../test/rpc/Rpc.test.ts) |
| INV-RPC-4 | Same mechanism, stated as an invariant of the wire: no raw `BigInt` ever appears in an envelope. | [src/rpc/Rpc.ts](../../../../../src/rpc/Rpc.ts) | [test/rpc/Rpc.test.ts](../../../../../test/rpc/Rpc.test.ts) |
| REQ-RPC-5 | Caller-scoped admission preconditions are expressed as explicit guards with documented ordering, trusted-transport behavior, and rejection consequence. | [src/rpc/guards](../../../../../src/rpc/guards) | [test/e2e/E2E-InitHandshake.test.ts](../../../../../test/e2e/E2E-InitHandshake.test.ts); none — gap (no per-service guard-bypass matrix) |
...
| INV-RPC-1 | Dispatch order: size cap → envelope → service → guards → method, before any handler runs. | [src/P2PManager.ts](../../../../../src/P2PManager.ts) (`onRpc`), [src/rpc/ARpcService.ts](../../../../../src/rpc/ARpcService.ts) (`runRPC`) | [test/rpc/Rpc.test.ts](../../../../../test/rpc/Rpc.test.ts) |
| INV-RPC-2 | Only the addressed peer settles a request; other responders are blacklisted. | [src/P2PManager.ts](../../../../../src/P2PManager.ts) (`handleRpcResponse`) | [test/rpc/Rpc.test.ts](../../../../../test/rpc/Rpc.test.ts), [test/e2e/E2E-CustomRpcRequestResponse.test.ts](../../../../../test/e2e/E2E-CustomRpcRequestResponse.test.ts) |
| INV-RPC-3 | Guard bypass only for the trusted in-process loopback. | [src/transport/ATransport.ts](../../../../../src/transport/ATransport.ts), [src/transport/LoopbackTransport.ts](../../../../../src/transport/LoopbackTransport.ts), [src/rpc/ARpcService.ts](../../../../../src/rpc/ARpcService.ts) | none — gap (no test asserts network transports cannot claim trust) |
| INV-RPC-5 | RPC handlers never hold the state mutex; mutation goes through the pipeline's entry points. | [src/rpc](../../../../../src/rpc), [src/stateManager/StateManager.ts](../../../../../src/stateManager/StateManager.ts) | [block-confirmation-pipeline.md](../block-confirmation-pipeline.md) §12 evidence (REQ-BCP-3/4) |
| REQ-RPC-7 | A single central RPC-level rate limiter (shared across services, possibly per-peer) bounds peer-driven resource use. | none — not implemented ([OQ-6](../../open-questions.md)) | none — gap |
