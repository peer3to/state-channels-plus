...
| --------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| REQ-IFD-1 | On a relevant `DisputeCommitted` event, the node requests acknowledgment from every connected peer exactly once per fork, with a `2 × agreementTime` reply window.                        | [src/eventHandlers/EventHandler.ts](../../../../../src/eventHandlers/EventHandler.ts) (`handleDisputeCommitted`), [src/rpc/services/isForkDisputedService/IsForkDisputedService.ts](../../../../../src/rpc/services/isForkDisputedService/IsForkDisputedService.ts) | [test/e2e/E2E-IsForkDisputed.test.ts](../../../../../test/e2e/E2E-IsForkDisputed.test.ts)                                            |
| REQ-IFD-2 | A responder acknowledges only a fork verified disputed (local mirror, then chain); a false claim, duplicate request, or missing sender identity disconnects and blacklists the requester. | [src/rpc/services/isForkDisputedService/IsForkDisputedRpcMethods.ts](../../../../../src/rpc/services/isForkDisputedService/IsForkDisputedRpcMethods.ts)                                                                                                             | [test/e2e/E2E-IsForkDisputed.test.ts](../../../../../test/e2e/E2E-IsForkDisputed.test.ts)                                            |
...
| INV-IFD-1 | One recorded ack per direction per `(peer, fork)`; replays are violations.                                                                                                                | [src/rpc/services/isForkDisputedService](../../../../../src/rpc/services/isForkDisputedService)                                                                                                                                                                     | [test/e2e/E2E-IsForkDisputed.test.ts](../../../../../test/e2e/E2E-IsForkDisputed.test.ts)                                            |
| INV-IFD-2 | Verify-then-record-then-reply ordering on the responder.                                                                                                                                  | [src/rpc/services/isForkDisputedService/IsForkDisputedRpcMethods.ts](../../../../../src/rpc/services/isForkDisputedService/IsForkDisputedRpcMethods.ts)                                                                                                             | [test/e2e/E2E-IsForkDisputed.test.ts](../../../../../test/e2e/E2E-IsForkDisputed.test.ts)                                            |
| INV-IFD-3 | One outgoing round per fork; snapshot peer set.                                                                                                                                           | [src/rpc/services/isForkDisputedService/IsForkDisputedService.ts](../../../../../src/rpc/services/isForkDisputedService/IsForkDisputedService.ts)                                                                                                                   | [test/e2e/E2E-IsForkDisputed.test.ts](../../../../../test/e2e/E2E-IsForkDisputed.test.ts) (duplicate-round case)                     |
| INV-IFD-4 | Address-keyed ack state survives transport churn.                                                                                                                                         | [src/rpc/services/isForkDisputedService/IsForkDisputedService.ts](../../../../../src/rpc/services/isForkDisputedService/IsForkDisputedService.ts)                                                                                                                   | none — gap (no upgrade-crossing test)                                                                                                |
