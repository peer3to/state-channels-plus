...
> On-chain dispute-window semantics: [../../protocol/disputes.md](../../protocol/disputes.md) §4.
...
Trigger: [`EventHandler.handleDisputeCommitted`](../../../../../src/eventHandlers/EventHandler.ts).
Evidence consumer:
[`BlockValidationStrategy.blockForkIsDisputed`](../../../../../src/stateManager/validationStrategy/BlockValidationStrategy.ts).

## 1. Purpose & position in the protocol

When a dispute is committed on-chain against fork `F`
([../../protocol/disputes.md](../../protocol/disputes.md) §4.1), every honest node observing the
...
([`handleDisputeCommitted`](../../../../../src/eventHandlers/EventHandler.ts)); late non-final
...
| `peerAcknowledgementsByAddress: Map<address, Set<ForkId>>` | Forks **each peer acknowledged to me** (requester side).  | `peerAcknowledgesDisputedFork` on a `true` reply | [`BlockValidationStrategy.blockForkIsDisputed`](../../../../../src/stateManager/validationStrategy/BlockValidationStrategy.ts) — the Byzantine-build check |
...
fraud-proof evidence ([../../protocol/fraud-proofs.md](../../protocol/fraud-proofs.md)).
...
"provable" overstates. (Observed: [`IsForkDisputedRpcMethods`](../../../../../src/rpc/services/isForkDisputedService/IsForkDisputedRpcMethods.ts)
...
([../../protocol/disputes.md](../../protocol/disputes.md) §4.1 upload rules).
...
[OQ-34](../../open-questions.md) (failure-outcome policy consistency); classified there as
...
- **Chain-read amplification.** Every request naming a not-yet-acknowledged `(peer, fork)` pair
  ...
  limiter ([OQ-6](../../open-questions.md), [./README.md](./README.md) §9) is the intended fix;
...
[./README.md](./README.md) §6.7). Responder side: duplicate request → disconnect + blacklist
...
([./README.md](./README.md) §6.5). Evidence:
...
- **Can an adversary _cause_ honest peers to withhold?** Not directly — the response requires
  ...
  ([../../open-questions.md](../../open-questions.md)); classified decision pending under the
...
- **Can an adversary _time_ the round to hit a known-offline victim?** Partially. Round timing
  ...
  [../../protocol/disputes.md](../../protocol/disputes.md) §4.1). An adversarial participant
...
- Timeout denominated in `agreementTime` ([../../protocol/time.md](../../protocol/time.md));
...
- The round trigger depends on dispute-event delivery and ordering
  ([OQ-25](../../open-questions.md), [OQ-30](../../open-questions.md)); a node that never
...
- Rate/burst metering under the central limiter ([OQ-6](../../open-questions.md)), including a
...
| --------- | -------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| REQ-IFD-1 | Design pending | On a relevant `DisputeCommitted` event, the node requests acknowledgment from every connected peer exactly once per fork, with a `2 × agreementTime` reply window.                        | [src/eventHandlers/EventHandler.ts](../../../../../src/eventHandlers/EventHandler.ts) (`handleDisputeCommitted`), [src/rpc/services/isForkDisputedService/IsForkDisputedService.ts](../../../../../src/rpc/services/isForkDisputedService/IsForkDisputedService.ts) | [test/e2e/E2E-IsForkDisputed.test.ts](../../../../../test/e2e/E2E-IsForkDisputed.test.ts)                                            |
| REQ-IFD-2 | Design pending | A responder acknowledges only a fork verified disputed (local mirror, then chain); a false claim, duplicate request, or missing sender identity disconnects and blacklists the requester. | [src/rpc/services/isForkDisputedService/IsForkDisputedRpcMethods.ts](../../../../../src/rpc/services/isForkDisputedService/IsForkDisputedRpcMethods.ts)                                                                                                             | [test/e2e/E2E-IsForkDisputed.test.ts](../../../../../test/e2e/E2E-IsForkDisputed.test.ts)                                            |
| REQ-IFD-3 | Design pending | A peer that rejects, errors, replies `false`, or exceeds the window is disconnected and blacklisted by the requester.                                                                     | [src/rpc/services/isForkDisputedService/IsForkDisputedService.ts](../../../../../src/rpc/services/isForkDisputedService/IsForkDisputedService.ts) (`requestDisputeAcknowledgment`)                                                                                  | [test/e2e/E2E-IsForkDisputed.test.ts](../../../../../test/e2e/E2E-IsForkDisputed.test.ts) (timeout case)                             |
| REQ-IFD-4 | Design pending | Recorded peer acknowledgments gate the dead-fork punishment: acknowledged suppliers of disputed-fork blocks are cut; unacknowledged suppliers retain straggler tolerance.                 | [src/stateManager/validationStrategy/BlockValidationStrategy.ts](../../../../../src/stateManager/validationStrategy/BlockValidationStrategy.ts) (`blockForkIsDisputed`)                                                                                             | [test/e2e/E2E-IsForkDisputed.test.ts](../../../../../test/e2e/E2E-IsForkDisputed.test.ts) ("building on acknowledged disputed fork") |
| INV-IFD-1 | Design pending | One recorded ack per direction per `(peer, fork)`; replays are violations.                                                                                                                | [src/rpc/services/isForkDisputedService](../../../../../src/rpc/services/isForkDisputedService)                                                                                                                                                                     | [test/e2e/E2E-IsForkDisputed.test.ts](../../../../../test/e2e/E2E-IsForkDisputed.test.ts)                                            |
| INV-IFD-2 | Design pending | Verify-then-record-then-reply ordering on the responder.                                                                                                                                  | [src/rpc/services/isForkDisputedService/IsForkDisputedRpcMethods.ts](../../../../../src/rpc/services/isForkDisputedService/IsForkDisputedRpcMethods.ts)                                                                                                             | [test/e2e/E2E-IsForkDisputed.test.ts](../../../../../test/e2e/E2E-IsForkDisputed.test.ts)                                            |
| INV-IFD-3 | Design pending | One outgoing round per fork; snapshot peer set.                                                                                                                                           | [src/rpc/services/isForkDisputedService/IsForkDisputedService.ts](../../../../../src/rpc/services/isForkDisputedService/IsForkDisputedService.ts)                                                                                                                   | [test/e2e/E2E-IsForkDisputed.test.ts](../../../../../test/e2e/E2E-IsForkDisputed.test.ts) (duplicate-round case)                     |
| INV-IFD-4 | Design pending | Address-keyed ack state survives transport churn.                                                                                                                                         | [src/rpc/services/isForkDisputedService/IsForkDisputedService.ts](../../../../../src/rpc/services/isForkDisputedService/IsForkDisputedService.ts)                                                                                                                   | none — gap (no upgrade-crossing test)                                                                                                |
