...
| ---------- | ------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| INV-WRTC-1 | Connection key comes from the authenticated transport, never the payload.                              | [WebRTCSetupRpcMethods](../../../../../src/rpc/services/WebRTCSetup/WebRTCSetupRpcMethods.ts) (`senderTransport.peerAddress`), [WebRTCSetupService.normalizePeerAddress/findWebRTCTransport](../../../../../src/rpc/services/WebRTCSetup/WebRTCSetupService.ts) | none — gap (no payload-address-spoof test)                                                                                                                                    |
| INV-WRTC-2 | One-way signaling methods reachable only behind `HandshakeCompletedGuard`.                             | [WebRTCSetupService constructor](../../../../../src/rpc/services/WebRTCSetup/WebRTCSetupService.ts) (`this.guards`), [HandshakeCompletedGuard](../../../../../src/rpc/guards/HandshakeCompletedGuard.ts)                                                        | [test/e2e/E2E-InitHandshake.test.ts](../../../../../test/e2e/E2E-InitHandshake.test.ts) (upgrade runs post-handshake); none — gap (no pre-handshake signaling-rejection test) |
| INV-WRTC-3 | Handlers silent-ignore all failures; no throw, no disconnect from the service.                         | [WebRTCSetupRpcMethods](../../../../../src/rpc/services/WebRTCSetup/WebRTCSetupRpcMethods.ts) (try/catch → log)                                                                                                                                                 | none — gap (no malformed-payload silent-ignore test)                                                                                                                          |
| INV-WRTC-4 | Single offerer via `localAddress < completedPeerAddress`.                                              | [InitHandshakeService.maybeFinalizeHandshakeOnceFromTransport](../../../../../src/rpc/services/initHandshake/InitHandshakeService.ts)                                                                                                                           | [test/e2e/E2E-InitHandshake.test.ts](../../../../../test/e2e/E2E-InitHandshake.test.ts) (WebRTC upgrade)                                                                      |
| REQ-WRTC-1 | Signaling payloads are untrusted; SDP/ICE parsing safety is a documented WebRTC-dependency assumption. | [WebRTCSetupRpcMethods](../../../../../src/rpc/services/WebRTCSetup/WebRTCSetupRpcMethods.ts) (`JSON.parse` → stack), [connection/](../../../../../src/rpc/services/WebRTCSetup/connection/)                                                                    | none — gap (no adversarial SDP/ICE suite; dependency assumption not yet in trust-model)                                                                                       |
