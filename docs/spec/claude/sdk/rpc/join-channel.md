...
| --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| INV-JCS-1 | Responder signs only when signer == participant == authenticated peer.                                                                                   | [JoinChannelService.signJoinRequest](../../../../../src/rpc/services/joinChannel/JoinChannelService.ts)                                                                                                | [JoinChannelSignatureRequest.test.ts](../../../../../test/rpc/joinChannel/JoinChannelSignatureRequest.test.ts)                                   |
...
| INV-JCS-4 | Collector runs only for the local node's own participant identity.                                                                                       | [JoinChannelService.collectJoinChannelConfirmation](../../../../../src/rpc/services/joinChannel/JoinChannelService.ts)                                                                                 | none — gap (implied by tests; no direct assertion)                                                                                               |
| INV-JCS-5 | Service is stateless across calls; decisions from args + live reads.                                                                                     | [JoinChannelService](../../../../../src/rpc/services/joinChannel/JoinChannelService.ts)                                                                                                                | none — gap (structural)                                                                                                                          |
...
| REQ-JCS-2 | Admission MUST be gated by an explicit consent/authorization decision, not auto-sign.                                                                    | none — not implemented (code TODO; [OQ-10](../../open-questions.md))                                                                                                                                   | none — gap                                                                                                                                       |
| REQ-JCS-3 | `requestJoinSignature` failure outcomes MUST conform to a decided failure-outcome policy and be resource-bounded per peer.                               | penalty-free error today ([./README.md](./README.md) §8); no rate limit                                                                                                                                | none — gap ([OQ-34](../../open-questions.md), [OQ-6](../../open-questions.md))                                                                   |
