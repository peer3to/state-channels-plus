...
> flow ([../../protocol/cross-layer-messages.md](../../protocol/cross-layer-messages.md) §4) — it
...
outcomes), [../../protocol/cross-layer-messages.md](../../protocol/cross-layer-messages.md) §4
(join/admission as an inbound-stream consumer; REQ-MSG-10/11), §3 (spectate-before-join),
[../../open-questions.md](../../open-questions.md) (OQ-10, OQ-19, OQ-34, DEF-6).
...
([../../protocol/cross-layer-messages.md](../../protocol/cross-layer-messages.md) §4, REQ-MSG-10).
...
- **Responder side (`requestJoinSignature` → `signJoinRequest`).** The one **public RPC endpoint**
  ([`JoinChannelRpcMethods`](../../../../../src/rpc/services/joinChannel/JoinChannelRpcMethods.ts)).
...
live in [`StateManager`](../../../../../src/stateManager/StateManager.ts) and the contracts, not
here.
...
- **Writes:** none to service or state-manager storage. The only side effect is producing
  ...
  [`ForceJoinStorage`](../../../../../src/storage/ForceJoinStorage.ts) — not this service.
...
([../../protocol/cross-layer-messages.md](../../protocol/cross-layer-messages.md) §4). **Open
...
[`StateManager.getOnChainParticipantUnion`](../../../../../src/stateManager/StateManager.ts) vs.
...
([`LocalP2pSigner`](../../../../../src/evm/signer/LocalP2pSigner.ts) /
[`ClientP2pSigner`](../../../../../src/evm/signer/ClientP2pSigner.ts) → `hostRpc`, §3 of
[./README.md](./README.md)). Ordered stages
([`JoinChannelService`](../../../../../src/rpc/services/joinChannel/JoinChannelService.ts)):
...
not consent** ([../../protocol/cross-layer-messages.md](../../protocol/cross-layer-messages.md)
§4.2; OQ-10).
...
- **Cross-deployment / cross-chain replay.** The signed message carries no domain separation
  ([../../open-questions.md](../../open-questions.md) OQ-29). A join signature is in principle
...
([`StateManager`](../../../../../src/stateManager/StateManager.ts), lines ~512-528; SDK TODO:
...
- **Named gaps (`none — gap`):**
    ...
    - No adversarial-fuzz test of `requestJoinSignature` payloads at the envelope boundary (shared
      gap with REQ-RPC-2 in [./README.md](./README.md) §12).
...
| --------- | -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| INV-JCS-1 | Design pending | Responder signs only when signer == participant == authenticated peer.                                                                                   | [JoinChannelService.signJoinRequest](../../../../../src/rpc/services/joinChannel/JoinChannelService.ts)                                                                                                | [JoinChannelSignatureRequest.test.ts](../../../../../test/rpc/joinChannel/JoinChannelSignatureRequest.test.ts)                                   |
| INV-JCS-2 | Design pending | Responder signs only a join pinned to its current snapshot/fork with local signer in threshold.                                                          | [JoinChannelService.signJoinRequest](../../../../../src/rpc/services/joinChannel/JoinChannelService.ts); [JoinChannelFacet](../../../../../contracts/V1/StateChannelDiamondProxy/JoinChannelFacet.sol) | [E2E-JoinChannelRaceConditions.test.ts](../../../../../test/e2e/E2E-JoinChannelRaceConditions.test.ts)                                           |
| INV-JCS-3 | Design pending | Collector requires each signature to recover to its addressed participant; one failure fails unanimity.                                                  | [JoinChannelService.collectJoinChannelConfirmation](../../../../../src/rpc/services/joinChannel/JoinChannelService.ts)                                                                                 | [JoinChannelSignatureRequest.test.ts](../../../../../test/rpc/joinChannel/JoinChannelSignatureRequest.test.ts)                                   |
| INV-JCS-4 | Design pending | Collector runs only for the local node's own participant identity.                                                                                       | [JoinChannelService.collectJoinChannelConfirmation](../../../../../src/rpc/services/joinChannel/JoinChannelService.ts)                                                                                 | none — gap (implied by tests; no direct assertion)                                                                                               |
| INV-JCS-5 | Design pending | Service is stateless across calls; decisions from args + live reads.                                                                                     | [JoinChannelService](../../../../../src/rpc/services/joinChannel/JoinChannelService.ts)                                                                                                                | none — gap (structural)                                                                                                                          |
| REQ-JCS-1 | Design pending | `requestJoinSignature` MUST run the full decode + identity + channel + deadline + fork + snapshot + threshold chain before signing (REQ-RPC-2 instance). | [JoinChannelService.signJoinRequest](../../../../../src/rpc/services/joinChannel/JoinChannelService.ts)                                                                                                | [JoinChannelSignatureRequest.test.ts](../../../../../test/rpc/joinChannel/JoinChannelSignatureRequest.test.ts); none — gap (no adversarial fuzz) |
| REQ-JCS-2 | Design pending | Admission MUST be gated by an explicit consent/authorization decision, not auto-sign.                                                                    | none — not implemented (code TODO; [OQ-10](../../open-questions.md))                                                                                                                                   | none — gap                                                                                                                                       |
| REQ-JCS-3 | Design pending | `requestJoinSignature` failure outcomes MUST conform to a decided failure-outcome policy and be resource-bounded per peer.                               | penalty-free error today ([./README.md](./README.md) §8); no rate limit                                                                                                                                | none — gap ([OQ-34](../../open-questions.md), [OQ-6](../../open-questions.md))                                                                   |
