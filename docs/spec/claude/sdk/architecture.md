...
- Redundant multi-provider chain observation with cross-checking, and a defined
  degradation mode when providers disagree (review §8; see
  [../security/trust-model.md](../security/trust-model.md)).
...
| REQ-SDK-2 | The SDK requires at least one available honest RPC endpoint; current implementation uses exactly one WebSocket `PROVIDER_URL`. | [src/evm/p2pRuntime/RuntimeChainContext.ts](../../../../src/evm/p2pRuntime/RuntimeChainContext.ts), [src/utils/config.ts](../../../../src/utils/config.ts)                             | none — gap (no partitioned/dishonest-RPC test)                                                                                                                                  |
| INV-SDK-1 | All app↔runtime interaction crosses the runtime port; `getStateManager()` throws.                                             | [src/evm/P2pInstance.ts](../../../../src/evm/P2pInstance.ts)                                                                                                                           | [test/e2e/E2E-RuntimeTransportModes.test.ts](../../../../test/e2e/E2E-RuntimeTransportModes.test.ts)                                                                            |
| INV-SDK-2 | On-chain sends draw nonces from the host-owned nonce manager.                                                                  | [src/evm/p2pRuntime/P2pRuntimeHost.ts](../../../../src/evm/p2pRuntime/P2pRuntimeHost.ts), [src/evm/signer/HostNonceManager.ts](../../../../src/evm/signer/HostNonceManager.ts)         | concurrency e2e suites (dispute/reduction races) exercise it indirectly; none — gap (no dedicated nonce-race test)                                                              |
| INV-SDK-3 | Dispute execution uses a dedicated state-machine instance, never the live one.                                                 | [src/evm/EvmDiamondStateMachine.ts](../../../../src/evm/EvmDiamondStateMachine.ts) (`createStandaloneFromLocalStateMachineWithExecutor`, `p2pSetup` double deploy)                     | [test/e2e/disputeValidation](../../../../test/e2e/disputeValidation) suites replay disputes while live execution continues                                                      |
