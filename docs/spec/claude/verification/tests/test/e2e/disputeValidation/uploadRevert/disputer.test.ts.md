...
per-gate disputer-not-sender revert and the `REQ-DIS-2` wrong-identity split.
...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [`E2E: dispute validation / uploadRevert / disputer > dispute.input.disputer = ZeroAddress → dispute upload fails → ErrorDisputerNotMsgSender`](../../../../../../../../../test/e2e/disputeValidation/uploadRevert/disputer.test.ts#L17) (line 17) | [`UNIT-TEST-DISPUTE-MANAGER-FACET-1.P8`](../../../../../../implementation/source/contracts/V1/StateChannelDiamondProxy/DisputeManagerFacet.sol.md#unit-test-dispute-manager-facet-1.p8)<br>[`REQ-DIS-2.T1.P6`](../../../../../../specification/disputes/disputes.md#req-dis-2.t1.p6) |
