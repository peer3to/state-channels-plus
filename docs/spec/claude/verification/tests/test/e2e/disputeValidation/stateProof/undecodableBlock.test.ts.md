...
abstention split (`UNIT-TEST-DISPUTE-VALIDATION-SERVICE-1.P2`) is the out-of-scope branch,
and `REQ-DISPUTE-PIPE-2` permutations still bundle whole corruption families, so nothing
else is assigned.
