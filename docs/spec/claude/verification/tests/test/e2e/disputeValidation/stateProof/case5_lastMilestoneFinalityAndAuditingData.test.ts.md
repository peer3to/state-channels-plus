...
`DisputeLastMilestoneNotFinalAndNoAuditingData` predicate permutation and the `REQ-SP-1`
direct-violation split (a non-final milestone rejected as anchor); the
`REQ-DISPUTE-PIPE-2.T1.P4` "incomplete evidence" family remains broader than this single
