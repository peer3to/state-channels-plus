...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| [`E2E: p2pSetup runtime modes > <dynamic: `connects and round-trips contract calls in ${modeLabel}/${vmLabel} mode`>`](../../../../../../../test/e2e/E2E-RuntimeTransportModes.test.ts#L141) (line 141) | [`UNIT-TEST-P2P-RUNTIME-HOST-1.P1`](../../../../implementation/source/src/evm/p2pRuntime/P2pRuntimeHost.ts.md#unit-test-p2p-runtime-host-1.p1) |
