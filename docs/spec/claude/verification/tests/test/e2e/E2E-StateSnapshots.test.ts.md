...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`E2E: State Snapshots > should post updated state snapshot on-chain after 3 transitions`](../../../../../../../test/e2e/E2E-StateSnapshots.test.ts#L24) (line 24)                                                                                                                                | [`REQ-ENFSNAP-1.T1.P1`](../../../../specification/enforcement/snapshot-adoption.md#req-enfsnap-1-t1-p1), [`REQ-LIF-1.T1.P1`](../../../../specification/settlement/lifecycle.md#req-lif-1.t1.p1), [`INV-MSG-4.T1.P1`](../../../../specification/settlement/cross-layer-messages.md#inv-msg-4.t1.p1), [`INV-MSG-6.T1.P1`](../../../../specification/settlement/cross-layer-messages.md#inv-msg-6.t1.p1) |
| [`E2E: State Snapshots > should remove malicious participant after fork and then post updated state snapshot on the reduced fork - 2 independent snapshot updates`](../../../../../../../test/e2e/E2E-StateSnapshots.test.ts#L48) (line 48)                                                       | [`REQ-LIF-2.T1.P1`](../../../../specification/settlement/lifecycle.md#req-lif-2.t1.p1)                                                                                                                                                                                                                                                                                                                |
...
| [`E2E: State Snapshots > should handle snapshot update at blockHeight = 0 (first snapshot) - edge case since genesis is also height 0`](../../../../../../../test/e2e/E2E-StateSnapshots.test.ts#L329) (line 329)                                                                                 | [`REQ-LIF-1.T1.P7`](../../../../specification/settlement/lifecycle.md#req-lif-1.t1.p7)                                                                                                                                                                                                                                                                                                                |
