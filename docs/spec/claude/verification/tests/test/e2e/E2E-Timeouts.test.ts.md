...
suites, and the timeout-scheduling permutations (due-time boundaries, predecessor-post
reschedules, forced vs normal splits, per-fork retention) are defined against
`StateManager`/`TimeoutStorage`, whose dedicated unit suites are their natural home — no
permutation is fully covered by a single test here, so none are assigned.
...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| [`E2E: Timeouts > Basic Timeout Scenarios > should handle timeout when next peer to write does not author a block`](../../../../../../../test/e2e/E2E-Timeouts.test.ts#L14) (line 14)                                   | —      |
| [`E2E: Timeouts > Basic Timeout Scenarios > should demonstrate timeout creates disputes`](../../../../../../../test/e2e/E2E-Timeouts.test.ts#L25) (line 25)                                                             | —      |
...
| [`E2E: Timeouts > Forced Timeout (Junk Calldata) > should create forced timeout when peer posts junk calldata that is rejected`](../../../../../../../test/e2e/E2E-Timeouts.test.ts#L64) (line 64)                      | —      |
