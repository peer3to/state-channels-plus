...
`test/rpc/initHandshake/InitHandshakeChallenge.test.ts`. Remaining unassigned permutations are
exact-boundary scenarios (at-deadline, maximum honest skew, window edges) and malformed shapes
that no test here drives.
...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`E2E: Init Handshake > Handshake Completion > should complete handshake successfully and create peer profile`](../../../../../../../test/e2e/E2E-InitHandshake.test.ts#L16) (line 16)                   | [`UNIT-TEST-INIT-HANDSHAKE-SERVICE-1.P1`](../../../../implementation/source/src/rpc/services/initHandshake/InitHandshakeService.ts.md#unit-test-init-handshake-service-1.p1), [`INV-HSK-1.T1.P1`](../../../../implementation/views/architecture/sdk/rpc/handshake.md#inv-hsk-1.t1.p1), [`INV-HSK-5.T1.P1`](../../../../implementation/views/architecture/sdk/rpc/handshake.md#inv-hsk-5.t1.p1), [`REQ-HSK-1.T1.P1`](../../../../implementation/views/architecture/sdk/rpc/handshake.md#req-hsk-1.t1.p1) |
...
| [`E2E: Init Handshake > Time Validation > should disconnect peer when handshake request time difference exceeds agreementTime`](../../../../../../../test/e2e/E2E-InitHandshake.test.ts#L112) (line 112) | [`INV-HSK-5.T1.P3`](../../../../implementation/views/architecture/sdk/rpc/handshake.md#inv-hsk-5.t1.p3)                                                                                                                                                                                                                                                                                                                                                                                                 |
| [`E2E: Init Handshake > Time Validation > should disconnect peer that doesn't respond within agreementTime`](../../../../../../../test/e2e/E2E-InitHandshake.test.ts#L132) (line 132)                    | [`INV-HSK-5.T1.P5`](../../../../implementation/views/architecture/sdk/rpc/handshake.md#inv-hsk-5.t1.p5), [`REQ-HSK-1.T1.P5`](../../../../implementation/views/architecture/sdk/rpc/handshake.md#req-hsk-1.t1.p5)                                                                                                                                                                                                                                                                                        |
...
| [`E2E: Init Handshake > Time Validation > should disconnect peer answering with an undecodable (junk) signature`](../../../../../../../test/e2e/E2E-InitHandshake.test.ts#L177) (line 177)               | [`REQ-HSK-1.T1.P3`](../../../../implementation/views/architecture/sdk/rpc/handshake.md#req-hsk-1.t1.p3)                                                                                                                                                                                                                                                                                                                                                                                                 |
