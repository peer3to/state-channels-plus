...
| [`EventBus (worker + main thread) > surfaces a clone error to the hook producer after local delivery, and the main thread never sees the event`](../../../../../../../test/stateManager/EventBus.test.ts#L475) (line 475)             | [`REQ-RUN-6.T1.P3`](../../../../implementation/views/architecture/sdk/runtime-and-concurrency.md#req-run-6.t1.p3) |
