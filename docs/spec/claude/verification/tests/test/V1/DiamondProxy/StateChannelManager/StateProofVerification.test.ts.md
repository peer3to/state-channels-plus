...
bundle is now split: the valid-decode half (`UNIT-TEST-UTILITY-FACET-1.P4`) is still never
exercised here, but the invalid-decode half (`UNIT-TEST-UTILITY-FACET-1.P7`) is exactly what the
