...
whole-participant startup (`INTEGRATION-TEST-CONFIG-1`). The pool now defines one permutation
...
| -------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [`config env parsing > applies peer3.config.ts as baseConfig`](../../../../../../../test/utils/Config.test.ts#L42) (line 42)                       | [`REQ-CFG-1.T1.P2`](../../../../implementation/views/operations/configuration.md#req-cfg-1.t1.p2)                                                                                                      |
| [`config env parsing > parses HOLEPUNCH_RELAYER_URLS from env JSON array`](../../../../../../../test/utils/Config.test.ts#L48) (line 48)           | [`REQ-CFG-1.T1.P3`](../../../../implementation/views/operations/configuration.md#req-cfg-1.t1.p3), [`REQ-CFG-2.T1.P3`](../../../../implementation/views/operations/configuration.md#req-cfg-2.t1.p3)   |
| [`config env parsing > parses HOLEPUNCH_RELAYER_URLS from env comma-separated list`](../../../../../../../test/utils/Config.test.ts#L59) (line 59) | [`REQ-CFG-3.T1.P1`](../../../../implementation/views/operations/configuration.md#req-cfg-3.t1.p1), [`REQ-CFG-2.T1.P18`](../../../../implementation/views/operations/configuration.md#req-cfg-2.t1.p18) |
| [`config env parsing > manual overrides win over env for HOLEPUNCH_RELAYER_URLS`](../../../../../../../test/utils/Config.test.ts#L70) (line 70)    | [`REQ-CFG-1.T1.P4`](../../../../implementation/views/operations/configuration.md#req-cfg-1.t1.p4)                                                                                                      |
