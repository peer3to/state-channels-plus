...
| [`WorkerBridgeWebRTCConnectionFactory > rejects in-flight requests when the shared bridge is disposed`](../../../../../../../test/utils/WebRTCWorkerBridgeConnectionFactory.test.ts#L154) (line 154) | [`UNIT-TEST-WORKER-BRIDGE-FACTORY-1.P4`](../../../../implementation/source/src/rpc/services/WebRTCSetup/connection/WorkerBridgeWebRTCConnectionFactory.ts.md#unit-test-worker-bridge-factory-1.p4) |
