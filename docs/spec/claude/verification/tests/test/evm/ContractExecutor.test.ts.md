...
| [`ContractExecutor > should serialize many detached canonical increments and simulations without corrupting state`](../../../../../../../test/evm/ContractExecutor.test.ts#L382) (line 382) | [`REQ-RUNTIME-2.T1.P1`](../../../../specification/runtime/execution.md#req-runtime-2-t1-p1) |
