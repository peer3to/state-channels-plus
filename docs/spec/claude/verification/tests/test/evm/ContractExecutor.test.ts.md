...
of scope (owned by `test/evm/WorkerContractExecutor.test.ts`). After atomization, the
ordered-domain serialization scenario of the runtime ownership requirement is a single-test
permutation and is assigned to the mixed-workload serialization case; the executor's other
mutex cases remain finer-grained than any pool ID.
...
| [`ContractExecutor > should serialize many detached canonical increments and simulations without corrupting state`](../../../../../../../test/evm/ContractExecutor.test.ts#L382) (line 382) | [`REQ-RUNTIME-2-KBXKTG.T1.P1`](../../../../specification/runtime/execution.md#req-runtime-2-kbxktg.t1.p1) |
