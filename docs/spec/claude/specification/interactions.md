...
| Snapshot adoption and outbound processing | Settlement → Enforcement                             | [`REQ-IX-6-A4Y7KB`](settlement/README.md#req-ix-6-a4y7kb) |
| Chain observation                         | Enforcement → Runtime → all systems                  | [`REQ-IX-7-A004VZ`](runtime/README.md#req-ix-7-a004vz)    |
| Execution equivalence                     | Runtime → all systems                                | [`REQ-IX-8-FY54AV`](interactions.md#req-ix-8-fy54av)      |
| Storage fidelity                          | All systems ↔ Storage                               | [`REQ-IX-9-AV56NR`](storage/README.md#req-ix-9-av56nr)    |
...
**[`REQ-IX-6-A4Y7KB`](settlement/README.md#req-ix-6-a4y7kb) — Snapshot adoption and outbound processing.** Settlement advances the on-chain snapshot
...
**[`REQ-IX-7-A004VZ`](runtime/README.md#req-ix-7-a004vz) — Chain observation.** Runtime observes enforcement's events and calldata through RPC
...
**[`REQ-IX-9-AV56NR`](storage/README.md#req-ix-9-av56nr) — Storage fidelity.** Every system persists and reads its local protocol knowledge
