...
| -------------- | ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `REQ-LIF-1.T1` | `REQ-LIF-1`               | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Best-case complete lifecycle needs at least two base-layer txs: open/deposit and settlement via a snapshot update that processes the outbound stream. | <a id="req-lif-1.t1.p1"></a>`REQ-LIF-1.T1.P1` — valid case<br><a id="req-lif-1.t1.p4"></a>`REQ-LIF-1.T1.P4` — direct invalid/opposite case<br><a id="req-lif-1.t1.p2"></a>`REQ-LIF-1.T1.P2` — matching commitment<br><a id="req-lif-1.t1.p5"></a>`REQ-LIF-1.T1.P5` — mismatched commitment<br><a id="req-lif-1.t1.p6"></a>`REQ-LIF-1.T1.P6` — predecessor snapshot<br><a id="req-lif-1.t1.p7"></a>`REQ-LIF-1.T1.P7` — genesis snapshot<br><a id="req-lif-1.t1.p8"></a>`REQ-LIF-1.T1.P8` — stale fork<br><a id="req-lif-1.t1.p9"></a>`REQ-LIF-1.T1.P9` — foreign fork<br><a id="req-lif-1.t1.p3"></a>`REQ-LIF-1.T1.P3` — zero balance<br><a id="req-lif-1.t1.p10"></a>`REQ-LIF-1.T1.P10` — exact balance boundary<br><a id="req-lif-1.t1.p11"></a>`REQ-LIF-1.T1.P11` — one beyond boundary<br><a id="req-lif-1.t1.p12"></a>`REQ-LIF-1.T1.P12` — maximum value<br><a id="req-lif-1.t1.p13"></a>`REQ-LIF-1.T1.P13` — conservation check                                                                                                                                                                                                           |
| `REQ-LIF-2.T1` | `REQ-LIF-2`               | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Only two paths yield a snapshot-updating state: same-fork finality proof, or dispute reduction after the challenge window.                            | <a id="req-lif-2.t1.p1"></a>`REQ-LIF-2.T1.P1` — valid case<br><a id="req-lif-2.t1.p5"></a>`REQ-LIF-2.T1.P5` — direct invalid/opposite case<br><a id="req-lif-2.t1.p2"></a>`REQ-LIF-2.T1.P2` — matching commitment<br><a id="req-lif-2.t1.p6"></a>`REQ-LIF-2.T1.P6` — mismatched commitment<br><a id="req-lif-2.t1.p7"></a>`REQ-LIF-2.T1.P7` — predecessor snapshot<br><a id="req-lif-2.t1.p8"></a>`REQ-LIF-2.T1.P8` — genesis snapshot<br><a id="req-lif-2.t1.p9"></a>`REQ-LIF-2.T1.P9` — stale fork<br><a id="req-lif-2.t1.p10"></a>`REQ-LIF-2.T1.P10` — foreign fork<br><a id="req-lif-2.t1.p3"></a>`REQ-LIF-2.T1.P3` — before deadline<br><a id="req-lif-2.t1.p11"></a>`REQ-LIF-2.T1.P11` — at deadline<br><a id="req-lif-2.t1.p12"></a>`REQ-LIF-2.T1.P12` — after deadline<br><a id="req-lif-2.t1.p13"></a>`REQ-LIF-2.T1.P13` — maximum honest skew<br><a id="req-lif-2.t1.p4"></a>`REQ-LIF-2.T1.P4` — malformed input<br><a id="req-lif-2.t1.p14"></a>`REQ-LIF-2.T1.P14` — adversarial input<br><a id="req-lif-2.t1.p15"></a>`REQ-LIF-2.T1.P15` — partial failure<br><a id="req-lif-2.t1.p16"></a>`REQ-LIF-2.T1.P16` — retry and recovery |
| `REQ-LIF-3.T1` | `REQ-LIF-3`               | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | A normal transition may produce an outbound exit message; producing it needs no finality — finality is needed only at on-chain snapshot submission.   | <a id="req-lif-3.t1.p1"></a>`REQ-LIF-3.T1.P1` — valid case<br><a id="req-lif-3.t1.p3"></a>`REQ-LIF-3.T1.P3` — direct invalid/opposite case<br><a id="req-lif-3.t1.p2"></a>`REQ-LIF-3.T1.P2` — matching commitment<br><a id="req-lif-3.t1.p4"></a>`REQ-LIF-3.T1.P4` — mismatched commitment<br><a id="req-lif-3.t1.p5"></a>`REQ-LIF-3.T1.P5` — predecessor snapshot<br><a id="req-lif-3.t1.p6"></a>`REQ-LIF-3.T1.P6` — genesis snapshot<br><a id="req-lif-3.t1.p7"></a>`REQ-LIF-3.T1.P7` — stale fork<br><a id="req-lif-3.t1.p8"></a>`REQ-LIF-3.T1.P8` — foreign fork                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `REQ-LIF-4.T1` | `REQ-LIF-4`               | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Every initiated dispute produces a canonical successor fork; execution resumes from it.                                                               | <a id="req-lif-4.t1.p1"></a>`REQ-LIF-4.T1.P1` — valid case<br><a id="req-lif-4.t1.p4"></a>`REQ-LIF-4.T1.P4` — direct invalid/opposite case<br><a id="req-lif-4.t1.p2"></a>`REQ-LIF-4.T1.P2` — matching commitment<br><a id="req-lif-4.t1.p5"></a>`REQ-LIF-4.T1.P5` — mismatched commitment<br><a id="req-lif-4.t1.p6"></a>`REQ-LIF-4.T1.P6` — predecessor snapshot<br><a id="req-lif-4.t1.p7"></a>`REQ-LIF-4.T1.P7` — genesis snapshot<br><a id="req-lif-4.t1.p8"></a>`REQ-LIF-4.T1.P8` — stale fork<br><a id="req-lif-4.t1.p9"></a>`REQ-LIF-4.T1.P9` — foreign fork<br><a id="req-lif-4.t1.p3"></a>`REQ-LIF-4.T1.P3` — malformed input<br><a id="req-lif-4.t1.p10"></a>`REQ-LIF-4.T1.P10` — adversarial input<br><a id="req-lif-4.t1.p11"></a>`REQ-LIF-4.T1.P11` — partial failure<br><a id="req-lif-4.t1.p12"></a>`REQ-LIF-4.T1.P12` — retry and recovery                                                                                                                                                                                                                                                                                    |
| `INV-LIF-5.T1` | `INV-LIF-5`               | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Settlement conserves value: processed withdrawals never exceed deposits.                                                                              | <a id="inv-lif-5.t1.p1"></a>`INV-LIF-5.T1.P1` — valid case<br><a id="inv-lif-5.t1.p3"></a>`INV-LIF-5.T1.P3` — direct invalid/opposite case<br><a id="inv-lif-5.t1.p2"></a>`INV-LIF-5.T1.P2` — zero balance<br><a id="inv-lif-5.t1.p4"></a>`INV-LIF-5.T1.P4` — exact balance boundary<br><a id="inv-lif-5.t1.p5"></a>`INV-LIF-5.T1.P5` — one beyond boundary<br><a id="inv-lif-5.t1.p6"></a>`INV-LIF-5.T1.P6` — maximum value<br><a id="inv-lif-5.t1.p7"></a>`INV-LIF-5.T1.P7` — conservation check                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `REQ-LIF-6.T1` | `REQ-LIF-6`               | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Four deployment-configured windows (`p2pTime`, `agreementTime`, `chainFallbackTime`, `evidenceTime`) bound the phases as specified in §8.             | <a id="req-lif-6.t1.p1"></a>`REQ-LIF-6.T1.P1` — valid case<br><a id="req-lif-6.t1.p3"></a>`REQ-LIF-6.T1.P3` — direct invalid/opposite case<br><a id="req-lif-6.t1.p2"></a>`REQ-LIF-6.T1.P2` — before deadline<br><a id="req-lif-6.t1.p4"></a>`REQ-LIF-6.T1.P4` — at deadline<br><a id="req-lif-6.t1.p5"></a>`REQ-LIF-6.T1.P5` — after deadline<br><a id="req-lif-6.t1.p6"></a>`REQ-LIF-6.T1.P6` — maximum honest skew                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
