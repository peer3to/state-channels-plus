...
| ------------------------------------------- | ------------------------- | --------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="inv-enffp-1-t1"></a>`INV-ENFFP-1.T1` | `INV-ENFFP-1`             | Apply valid proofs, repeat them, target already-slashed participants, and attempt any removal path.             | Append-only set with correct timestamps; repeats and already-slashed targets skip; no removal exists.                              | <a id="inv-enffp-1-t1-p1"></a>`INV-ENFFP-1.T1.P1` — double-sign proof appends once; <a id="inv-enffp-1-t1-p2"></a>`INV-ENFFP-1.T1.P2` — repeated proof skips; <a id="inv-enffp-1-t1-p3"></a>`INV-ENFFP-1.T1.P3` — timestamps reflect chain time; <a id="inv-enffp-1-t1-p4"></a>`INV-ENFFP-1.T1.P4` — no removal path; <a id="inv-enffp-1-t1-p5"></a>`INV-ENFFP-1.T1.P5` — invalid-transition proof appends once; <a id="inv-enffp-1-t1-p6"></a>`INV-ENFFP-1.T1.P6` — wrong-genesis proof appends once; <a id="inv-enffp-1-t1-p7"></a>`INV-ENFFP-1.T1.P7` — invalid-timestamp proof appends once; <a id="inv-enffp-1-t1-p8"></a>`INV-ENFFP-1.T1.P8` — forged-inbound proof appends once; <a id="inv-enffp-1-t1-p9"></a>`INV-ENFFP-1.T1.P9` — dispute-content proof appends once; <a id="inv-enffp-1-t1-p10"></a>`INV-ENFFP-1.T1.P10` — timeout proof appends once; <a id="inv-enffp-1-t1-p11"></a>`INV-ENFFP-1.T1.P11` — already-slashed target skips. |
...
| <a id="req-enffp-2-t1"></a>`REQ-ENFFP-2.T1` | `REQ-ENFFP-2`             | Dispatch every defined block and dispute proof type, plus unknown types, against open and expired kill periods. | Every defined type reaches its check; unknown types reject with no slash; kill-period gating holds for dispute proofs.             | <a id="req-enffp-2-t1-p1"></a>`REQ-ENFFP-2.T1.P1` — double-sign type dispatches; <a id="req-enffp-2-t1-p2"></a>`REQ-ENFFP-2.T1.P2` — unknown type safe-rejects; <a id="req-enffp-2-t1-p3"></a>`REQ-ENFFP-2.T1.P3` — expired kill period rejects; <a id="req-enffp-2-t1-p4"></a>`REQ-ENFFP-2.T1.P4` — invalid-transition type dispatches; <a id="req-enffp-2-t1-p5"></a>`REQ-ENFFP-2.T1.P5` — wrong-genesis type dispatches; <a id="req-enffp-2-t1-p6"></a>`REQ-ENFFP-2.T1.P6` — invalid-timestamp type dispatches; <a id="req-enffp-2-t1-p7"></a>`REQ-ENFFP-2.T1.P7` — forged-inbound type dispatches; <a id="req-enffp-2-t1-p8"></a>`REQ-ENFFP-2.T1.P8` — dispute-content type dispatches; <a id="req-enffp-2-t1-p9"></a>`REQ-ENFFP-2.T1.P9` — timeout type dispatches; <a id="req-enffp-2-t1-p10"></a>`REQ-ENFFP-2.T1.P10` — killed dispute skipped.                                                                                                |
