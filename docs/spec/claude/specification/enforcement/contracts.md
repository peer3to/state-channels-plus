...
| ----------------------------------------------------------- | ------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| <a id="inv-contract-arch-1-t1"></a>`INV-CONTRACT-ARCH-1.T1` | `INV-CONTRACT-ARCH-1`     | Execute state-changing operations through every owning module and inspect the resulting manager state.                                        | All paths observe one state and preserve unrelated fields.                                                                                                   | <a id="inv-contract-arch-1-t1-p1"></a>`INV-CONTRACT-ARCH-1.T1.P1` — admission-and-funds module; <a id="inv-contract-arch-1-t1-p2"></a>`INV-CONTRACT-ARCH-1.T1.P2` — success path; <a id="inv-contract-arch-1-t1-p3"></a>`INV-CONTRACT-ARCH-1.T1.P3` — sequential calls; <a id="inv-contract-arch-1-t1-p4"></a>`INV-CONTRACT-ARCH-1.T1.P4` — incompatible layout; <a id="inv-contract-arch-1-t1-p5"></a>`INV-CONTRACT-ARCH-1.T1.P5` — snapshot-adoption module; <a id="inv-contract-arch-1-t1-p6"></a>`INV-CONTRACT-ARCH-1.T1.P6` — dispute-window module; <a id="inv-contract-arch-1-t1-p7"></a>`INV-CONTRACT-ARCH-1.T1.P7` — fraud-slashing module; <a id="inv-contract-arch-1-t1-p8"></a>`INV-CONTRACT-ARCH-1.T1.P8` — execution/consumer composition path; <a id="inv-contract-arch-1-t1-p9"></a>`INV-CONTRACT-ARCH-1.T1.P9` — block-calldata publication; <a id="inv-contract-arch-1-t1-p10"></a>`INV-CONTRACT-ARCH-1.T1.P10` — revert path; <a id="inv-contract-arch-1-t1-p11"></a>`INV-CONTRACT-ARCH-1.T1.P11` — interleaved calls; <a id="inv-contract-arch-1-t1-p12"></a>`INV-CONTRACT-ARCH-1.T1.P12` — incompatible module. |
| <a id="req-contract-arch-1-t1"></a>`REQ-CONTRACT-ARCH-1.T1` | `REQ-CONTRACT-ARCH-1`     | Invoke every public operation through the stable manager boundary.                                                                            | Routing preserves the specified input, output, event, revert, and atomicity contract.                                                                        | <a id="req-contract-arch-1-t1-p1"></a>`REQ-CONTRACT-ARCH-1.T1.P1` — lifecycle; <a id="req-contract-arch-1-t1-p2"></a>`REQ-CONTRACT-ARCH-1.T1.P2` — messages; <a id="req-contract-arch-1-t1-p3"></a>`REQ-CONTRACT-ARCH-1.T1.P3` — disputes; <a id="req-contract-arch-1-t1-p4"></a>`REQ-CONTRACT-ARCH-1.T1.P4` — views; <a id="req-contract-arch-1-t1-p5"></a>`REQ-CONTRACT-ARCH-1.T1.P5` — proofs; <a id="req-contract-arch-1-t1-p6"></a>`REQ-CONTRACT-ARCH-1.T1.P6` — fraud; <a id="req-contract-arch-1-t1-p7"></a>`REQ-CONTRACT-ARCH-1.T1.P7` — failure path.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| <a id="req-contract-arch-2-t1"></a>`REQ-CONTRACT-ARCH-2.T1` | `REQ-CONTRACT-ARCH-2`     | Present the same valid and invalid artifact through every path that consumes it.                                                              | Every path gives the same classification and forbidden effects remain absent.                                                                                | <a id="req-contract-arch-2-t1-p1"></a>`REQ-CONTRACT-ARCH-2.T1.P1` — signatures; <a id="req-contract-arch-2-t1-p2"></a>`REQ-CONTRACT-ARCH-2.T1.P2` — channel/fork; <a id="req-contract-arch-2-t1-p3"></a>`REQ-CONTRACT-ARCH-2.T1.P3` — timing; <a id="req-contract-arch-2-t1-p4"></a>`REQ-CONTRACT-ARCH-2.T1.P4` — commitments; <a id="req-contract-arch-2-t1-p5"></a>`REQ-CONTRACT-ARCH-2.T1.P5` — replay.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| <a id="req-contract-arch-4-t1"></a>`REQ-CONTRACT-ARCH-4.T1` | `REQ-CONTRACT-ARCH-4`     | Deploy complete, incomplete, duplicate, oversized, and incompatible compositions; attempt replacement after channel creation.                 | Only complete compatible deployments succeed; existing channels retain their semantics.                                                                      | <a id="req-contract-arch-4-t1-p1"></a>`REQ-CONTRACT-ARCH-4.T1.P1` — complete; <a id="req-contract-arch-4-t1-p2"></a>`REQ-CONTRACT-ARCH-4.T1.P2` — missing selector; <a id="req-contract-arch-4-t1-p3"></a>`REQ-CONTRACT-ARCH-4.T1.P3` — size boundary; <a id="req-contract-arch-4-t1-p4"></a>`REQ-CONTRACT-ARCH-4.T1.P4` — incompatible replacement; <a id="req-contract-arch-4-t1-p5"></a>`REQ-CONTRACT-ARCH-4.T1.P5` — duplicate selector; <a id="req-contract-arch-4-t1-p6"></a>`REQ-CONTRACT-ARCH-4.T1.P6` — gas boundary.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
