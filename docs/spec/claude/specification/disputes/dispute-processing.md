...
| --------------------------------------------------------- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| <a id="inv-dispute-pipe-1-t1"></a>`INV-DISPUTE-PIPE-1.T1` | `INV-DISPUTE-PIPE-1`      | Give independent auditors identical valid and invalid disputes in different delivery orders.                                                                                    | Classification, offenders, survivor set, and successor commitments are identical.                                                                         | <a id="inv-dispute-pipe-1-t1-p1"></a>`INV-DISPUTE-PIPE-1.T1.P1` — valid dispute; <a id="inv-dispute-pipe-1-t1-p2"></a>`INV-DISPUTE-PIPE-1.T1.P2` — calldata posted; <a id="inv-dispute-pipe-1-t1-p3"></a>`INV-DISPUTE-PIPE-1.T1.P3` — delivery order; <a id="inv-dispute-pipe-1-t1-p4"></a>`INV-DISPUTE-PIPE-1.T1.P4` — restart; <a id="inv-dispute-pipe-1-t1-p5"></a>`INV-DISPUTE-PIPE-1.T1.P5` — invalid dispute; <a id="inv-dispute-pipe-1-t1-p6"></a>`INV-DISPUTE-PIPE-1.T1.P6` — no calldata posted.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| <a id="req-dispute-pipe-1-t1"></a>`REQ-DISPUTE-PIPE-1.T1` | `REQ-DISPUTE-PIPE-1`      | Submit correct and substituted manager/channel/fork/dispute identities through local and chain intake.                                                                          | Only exactly bound evidence enters audit; rejection leaves no partial dispute state.                                                                      | <a id="req-dispute-pipe-1-t1-p1"></a>`REQ-DISPUTE-PIPE-1.T1.P1` — local intake; <a id="req-dispute-pipe-1-t1-p2"></a>`REQ-DISPUTE-PIPE-1.T1.P2` — wrong manager; <a id="req-dispute-pipe-1-t1-p3"></a>`REQ-DISPUTE-PIPE-1.T1.P3` — duplicate intake; <a id="req-dispute-pipe-1-t1-p4"></a>`REQ-DISPUTE-PIPE-1.T1.P4` — chain intake; <a id="req-dispute-pipe-1-t1-p5"></a>`REQ-DISPUTE-PIPE-1.T1.P5` — wrong channel; <a id="req-dispute-pipe-1-t1-p6"></a>`REQ-DISPUTE-PIPE-1.T1.P6` — wrong fork; <a id="req-dispute-pipe-1-t1-p7"></a>`REQ-DISPUTE-PIPE-1.T1.P7` — wrong dispute instance; <a id="req-dispute-pipe-1-t1-p8"></a>`REQ-DISPUTE-PIPE-1.T1.P8` — concurrent intake.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| <a id="req-dispute-pipe-2-t1"></a>`REQ-DISPUTE-PIPE-2.T1` | `REQ-DISPUTE-PIPE-2`      | Corrupt or omit each audit layer independently and in representative combinations.                                                                                              | The first relevant invalid predicate is classified consistently and no later step legitimizes it.                                                         | <a id="req-dispute-pipe-2-t1-p1"></a>`REQ-DISPUTE-PIPE-2.T1.P1` — corrupted signatures; <a id="req-dispute-pipe-2-t1-p2"></a>`REQ-DISPUTE-PIPE-2.T1.P2` — broken linkage; <a id="req-dispute-pipe-2-t1-p3"></a>`REQ-DISPUTE-PIPE-2.T1.P3` — replay deviation; <a id="req-dispute-pipe-2-t1-p4"></a>`REQ-DISPUTE-PIPE-2.T1.P4` — incomplete evidence; <a id="req-dispute-pipe-2-t1-p5"></a>`REQ-DISPUTE-PIPE-2.T1.P5` — broken authorization; <a id="req-dispute-pipe-2-t1-p6"></a>`REQ-DISPUTE-PIPE-2.T1.P6` — broken final/unfinalized boundaries; <a id="req-dispute-pipe-2-t1-p7"></a>`REQ-DISPUTE-PIPE-2.T1.P7` — corrupted messages; <a id="req-dispute-pipe-2-t1-p8"></a>`REQ-DISPUTE-PIPE-2.T1.P8` — invalid time.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| <a id="req-dispute-pipe-3-t1"></a>`REQ-DISPUTE-PIPE-3.T1` | `REQ-DISPUTE-PIPE-3`      | Vary fraudulent, unavailable, honest, removed, and already-slashed participants and evidence order.                                                                             | The same survivor set, balances, messages, and successor fork result.                                                                                     | <a id="req-dispute-pipe-3-t1-p1"></a>`REQ-DISPUTE-PIPE-3.T1.P1` — fraudulent participant; <a id="req-dispute-pipe-3-t1-p2"></a>`REQ-DISPUTE-PIPE-3.T1.P2` — one offender; <a id="req-dispute-pipe-3-t1-p3"></a>`REQ-DISPUTE-PIPE-3.T1.P3` — order permutations; <a id="req-dispute-pipe-3-t1-p4"></a>`REQ-DISPUTE-PIPE-3.T1.P4` — empty survivor set; <a id="req-dispute-pipe-3-t1-p5"></a>`REQ-DISPUTE-PIPE-3.T1.P5` — unavailable participant; <a id="req-dispute-pipe-3-t1-p6"></a>`REQ-DISPUTE-PIPE-3.T1.P6` — honest participant; <a id="req-dispute-pipe-3-t1-p7"></a>`REQ-DISPUTE-PIPE-3.T1.P7` — removed participant; <a id="req-dispute-pipe-3-t1-p8"></a>`REQ-DISPUTE-PIPE-3.T1.P8` — already-slashed participant; <a id="req-dispute-pipe-3-t1-p9"></a>`REQ-DISPUTE-PIPE-3.T1.P9` — many offenders; <a id="req-dispute-pipe-3-t1-p10"></a>`REQ-DISPUTE-PIPE-3.T1.P10` — minimum survivor set.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| <a id="req-dispute-pipe-4-t1"></a>`REQ-DISPUTE-PIPE-4.T1` | `REQ-DISPUTE-PIPE-4`      | Fail and retry at persistence, chain submission, adoption, queue reset, and resumption boundaries.                                                                              | No split-brain fork or duplicate action occurs; recovery converges or remains safely retryable.                                                           | <a id="req-dispute-pipe-4-t1-p1"></a>`REQ-DISPUTE-PIPE-4.T1.P1` — persistence failure; <a id="req-dispute-pipe-4-t1-p2"></a>`REQ-DISPUTE-PIPE-4.T1.P2` — duplicate action; <a id="req-dispute-pipe-4-t1-p3"></a>`REQ-DISPUTE-PIPE-4.T1.P3` — restart; <a id="req-dispute-pipe-4-t1-p4"></a>`REQ-DISPUTE-PIPE-4.T1.P4` — concurrent observers; <a id="req-dispute-pipe-4-t1-p5"></a>`REQ-DISPUTE-PIPE-4.T1.P5` — chain-submission failure; <a id="req-dispute-pipe-4-t1-p6"></a>`REQ-DISPUTE-PIPE-4.T1.P6` — adoption failure; <a id="req-dispute-pipe-4-t1-p7"></a>`REQ-DISPUTE-PIPE-4.T1.P7` — queue-reset failure; <a id="req-dispute-pipe-4-t1-p8"></a>`REQ-DISPUTE-PIPE-4.T1.P8` — resumption failure; <a id="req-dispute-pipe-4-t1-p9"></a>`REQ-DISPUTE-PIPE-4.T1.P9` — retry after failure.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| <a id="req-dispute-pipe-5-t1"></a>`REQ-DISPUTE-PIPE-5.T1` | `REQ-DISPUTE-PIPE-5`      | Audit disputes where local and canonical predicate results are forced to agree and to diverge; audit unanchorable disputes; drive kill attempts with and without stored proofs. | Verdicts follow the canonical logic; invalid ⇔ exactly one stored proof; self-slashing types are preflighted; unanchorable disputes are skipped as valid. | <a id="req-dispute-pipe-5-t1-p1"></a>`REQ-DISPUTE-PIPE-5.T1.P1` — mirrored `DisputeNotLatestState` agrees with the chain; <a id="req-dispute-pipe-5-t1-p2"></a>`REQ-DISPUTE-PIPE-5.T1.P2` — invalid verdict stores exactly one proof; <a id="req-dispute-pipe-5-t1-p3"></a>`REQ-DISPUTE-PIPE-5.T1.P3` — preflight blocks a self-slashing submission; <a id="req-dispute-pipe-5-t1-p4"></a>`REQ-DISPUTE-PIPE-5.T1.P4` — unanchorable dispute skipped as valid, later judged by an anchored peer; <a id="req-dispute-pipe-5-t1-p5"></a>`REQ-DISPUTE-PIPE-5.T1.P5` — mirrored `DisputeInvalidOutputState` agrees with the chain; <a id="req-dispute-pipe-5-t1-p6"></a>`REQ-DISPUTE-PIPE-5.T1.P6` — mirrored `DisputeInvalidStateProof` agrees with the chain; <a id="req-dispute-pipe-5-t1-p7"></a>`REQ-DISPUTE-PIPE-5.T1.P7` — mirrored `DisputeInvalidBalanceInvariant` agrees with the chain; <a id="req-dispute-pipe-5-t1-p8"></a>`REQ-DISPUTE-PIPE-5.T1.P8` — mirrored `DisputeOnChainSlashesNotSubset` agrees with the chain; <a id="req-dispute-pipe-5-t1-p9"></a>`REQ-DISPUTE-PIPE-5.T1.P9` — mirrored `TimeoutThreshold` agrees with the chain; <a id="req-dispute-pipe-5-t1-p10"></a>`REQ-DISPUTE-PIPE-5.T1.P10` — mirrored `TimeoutCalldataPosted` agrees with the chain; <a id="req-dispute-pipe-5-t1-p11"></a>`REQ-DISPUTE-PIPE-5.T1.P11` — mirrored `TimeoutNotLinkedToLatestState` agrees with the chain; <a id="req-dispute-pipe-5-t1-p12"></a>`REQ-DISPUTE-PIPE-5.T1.P12` — mirrored `TimeoutParticipantNotNext` agrees with the chain; <a id="req-dispute-pipe-5-t1-p13"></a>`REQ-DISPUTE-PIPE-5.T1.P13` — mirrored `TimeoutTooEarly` agrees with the chain; <a id="req-dispute-pipe-5-t1-p14"></a>`REQ-DISPUTE-PIPE-5.T1.P14` — mirrored `DisputeInvalidBlockInStateProofApplyFraudProof` agrees with the chain; <a id="req-dispute-pipe-5-t1-p15"></a>`REQ-DISPUTE-PIPE-5.T1.P15` — mirrored `DisputeLastMilestoneNotFinalAndNoAuditingData` agrees with the chain; <a id="req-dispute-pipe-5-t1-p16"></a>`REQ-DISPUTE-PIPE-5.T1.P16` — mirrored `InvalidDisputeReason` agrees with the chain; <a id="req-dispute-pipe-5-t1-p17"></a>`REQ-DISPUTE-PIPE-5.T1.P17` — mirrored `DisputeStateProofHeaderMismatch` agrees with the chain; <a id="req-dispute-pipe-5-t1-p18"></a>`REQ-DISPUTE-PIPE-5.T1.P18` — mirrored `DisputeInboundHashNotInChain` agrees with the chain; <a id="req-dispute-pipe-5-t1-p19"></a>`REQ-DISPUTE-PIPE-5.T1.P19` — mirrored `DisputeInvalidBlockStructure` agrees with the chain; <a id="req-dispute-pipe-5-t1-p20"></a>`REQ-DISPUTE-PIPE-5.T1.P20` — mirrored `DisputeBlockAuthorNotParticipant` agrees with the chain. |
