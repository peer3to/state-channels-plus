...
| <a id="req-dstore-2-t1"></a>`REQ-DSTORE-2.T1` | `REQ-DSTORE-2`            | Set and read both flags across forks.                                                        | Flags are per fork and independent; unset reads not-disputed.                         | <a id="req-dstore-2-t1-p1"></a>`REQ-DSTORE-2.T1.P1` — set/read disputed flag; <a id="req-dstore-2-t1-p2"></a>`REQ-DSTORE-2.T1.P2` — per-fork isolation; <a id="req-dstore-2-t1-p3"></a>`REQ-DSTORE-2.T1.P3` — unset default; <a id="req-dstore-2-t1-p4"></a>`REQ-DSTORE-2.T1.P4` — set/read own-dispute flag.                                                                                                                                                                                                                                                   |
| <a id="req-dstore-3-t1"></a>`REQ-DSTORE-3.T1` | `REQ-DSTORE-3`            | Store proofs, re-store variants under the same key, and query the participant index.         | First write wins; index matches stored set exactly; per-dispute proof unique.         | <a id="req-dstore-3-t1-p1"></a>`REQ-DSTORE-3.T1.P1` — fraud proof store/read by content hash; <a id="req-dstore-3-t1-p2"></a>`REQ-DSTORE-3.T1.P2` — fraud proof re-store no-op; <a id="req-dstore-3-t1-p3"></a>`REQ-DSTORE-3.T1.P3` — participant index consistency; <a id="req-dstore-3-t1-p4"></a>`REQ-DSTORE-3.T1.P4` — one dispute fraud proof per dispute; <a id="req-dstore-3-t1-p5"></a>`REQ-DSTORE-3.T1.P5` — dispute fraud proof store/read by content hash; <a id="req-dstore-3-t1-p6"></a>`REQ-DSTORE-3.T1.P6` — dispute fraud proof re-store no-op. |
