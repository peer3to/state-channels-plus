...
| <a id="req-stor-2-t1"></a>`REQ-STOR-2.T1` | `REQ-STOR-2`              | Inject crashes at every durable-write boundary of block commit, dispute action, and stream progress.      | State is all-or-nothing at each boundary; events never describe uncommitted state; retries are idempotent.                 | <a id="req-stor-2-t1-p1"></a>`REQ-STOR-2.T1.P1` — crash before block commit; <a id="req-stor-2-t1-p2"></a>`REQ-STOR-2.T1.P2` — torn multi-store operation; <a id="req-stor-2-t1-p3"></a>`REQ-STOR-2.T1.P3` — retry block commit after pre-commit crash; <a id="req-stor-2-t1-p4"></a>`REQ-STOR-2.T1.P4` — crash inside block commit; <a id="req-stor-2-t1-p5"></a>`REQ-STOR-2.T1.P5` — crash after block commit; <a id="req-stor-2-t1-p6"></a>`REQ-STOR-2.T1.P6` — crash before dispute-action commit; <a id="req-stor-2-t1-p7"></a>`REQ-STOR-2.T1.P7` — crash inside dispute-action commit; <a id="req-stor-2-t1-p8"></a>`REQ-STOR-2.T1.P8` — crash after dispute-action commit; <a id="req-stor-2-t1-p9"></a>`REQ-STOR-2.T1.P9` — crash before stream-progress commit; <a id="req-stor-2-t1-p10"></a>`REQ-STOR-2.T1.P10` — crash inside stream-progress commit; <a id="req-stor-2-t1-p11"></a>`REQ-STOR-2.T1.P11` — crash after stream-progress commit; <a id="req-stor-2-t1-p12"></a>`REQ-STOR-2.T1.P12` — retry block commit after mid-commit crash; <a id="req-stor-2-t1-p13"></a>`REQ-STOR-2.T1.P13` — retry block commit after post-commit crash; <a id="req-stor-2-t1-p14"></a>`REQ-STOR-2.T1.P14` — retry dispute action after pre-commit crash; <a id="req-stor-2-t1-p15"></a>`REQ-STOR-2.T1.P15` — retry dispute action after mid-commit crash; <a id="req-stor-2-t1-p16"></a>`REQ-STOR-2.T1.P16` — retry dispute action after post-commit crash; <a id="req-stor-2-t1-p17"></a>`REQ-STOR-2.T1.P17` — retry stream-progress write after pre-commit crash; <a id="req-stor-2-t1-p18"></a>`REQ-STOR-2.T1.P18` — retry stream-progress write after mid-commit crash; <a id="req-stor-2-t1-p19"></a>`REQ-STOR-2.T1.P19` — retry stream-progress write after post-commit crash. |
