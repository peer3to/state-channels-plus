...
| --------------------------------------------------- | ------------------------- | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="inv-snapstore-1-t1"></a>`INV-SNAPSTORE-1.T1` | `INV-SNAPSTORE-1`         | Store and read snapshots and states by hash, including repeated stores.                                             | Exact round trips; repeated stores idempotent; absent keys return nothing.                         | <a id="inv-snapstore-1-t1-p1"></a>`INV-SNAPSTORE-1.T1.P1` — round trip both stores; <a id="inv-snapstore-1-t1-p2"></a>`INV-SNAPSTORE-1.T1.P2` — repeated store; <a id="inv-snapstore-1-t1-p3"></a>`INV-SNAPSTORE-1.T1.P3` — absent key.                                                                                                               |
