...
| --------------- | ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `REQ-TIME-1.T1` | `REQ-TIME-1`              | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Chain time is authoritative; wall clocks are not a source of truth                                                        | `REQ-TIME-1.T1.P1` — valid case and direct invalid/opposite<br>`REQ-TIME-1.T1.P2` — correct/wrong/missing/duplicate/forged identity or signature and membership boundary<br>`REQ-TIME-1.T1.P3` — before/at/after deadline and maximum honest skew                                                                                               |
| `REQ-TIME-2.T1` | `REQ-TIME-2`              | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Honest participants keep estimated chain time within the skew bound (estimated from recent block timestamps)              | `REQ-TIME-2.T1.P1` — valid case and direct invalid/opposite<br>`REQ-TIME-2.T1.P2` — correct/wrong/missing/duplicate/forged identity or signature and membership boundary<br>`REQ-TIME-2.T1.P3` — before/at/after deadline and maximum honest skew                                                                                               |
| `REQ-TIME-3.T1` | `REQ-TIME-3`              | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Window values and skew bound are explicit configuration trade-offs; windows dominate honest skew                          | `REQ-TIME-3.T1.P1` — valid case and direct invalid/opposite<br>`REQ-TIME-3.T1.P2` — before/at/after deadline and maximum honest skew<br>`REQ-TIME-3.T1.P3` — zero, exact balance/boundary, one beyond, maximum value and conservation<br>`REQ-TIME-3.T1.P4` — static review of every named alternative, omitted category and changed assumption |
| `REQ-TIME-4.T1` | `REQ-TIME-4`              | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Timeouts/fraud proofs/slashing use only objectively validated timestamps; subjective assessments gate local behavior only | `REQ-TIME-4.T1.P1` — valid case and direct invalid/opposite<br>`REQ-TIME-4.T1.P2` — before/at/after deadline and maximum honest skew<br>`REQ-TIME-4.T1.P3` — new/existing/removed/slashed participant and concurrent membership change<br>`REQ-TIME-4.T1.P4` — malformed and adversarial input, partial failure, retry and recovery             |
