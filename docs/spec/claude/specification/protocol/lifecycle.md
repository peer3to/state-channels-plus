...
| -------------- | ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `REQ-LIF-1.T1` | `REQ-LIF-1`               | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Best-case complete lifecycle needs at least two base-layer txs: open/deposit and settlement via a snapshot update that processes the outbound stream. | `REQ-LIF-1.T1.P1` — valid case and direct invalid/opposite<br>`REQ-LIF-1.T1.P2` — matching/mismatched commitment, predecessor/genesis, stale and foreign fork<br>`REQ-LIF-1.T1.P3` — zero, exact balance/boundary, one beyond, maximum value and conservation                                                                     |
| `REQ-LIF-2.T1` | `REQ-LIF-2`               | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Only two paths yield a snapshot-updating state: same-fork finality proof, or dispute reduction after the challenge window.                            | `REQ-LIF-2.T1.P1` — valid case and direct invalid/opposite<br>`REQ-LIF-2.T1.P2` — matching/mismatched commitment, predecessor/genesis, stale and foreign fork<br>`REQ-LIF-2.T1.P3` — before/at/after deadline and maximum honest skew<br>`REQ-LIF-2.T1.P4` — malformed and adversarial input, partial failure, retry and recovery |
| `REQ-LIF-3.T1` | `REQ-LIF-3`               | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | A normal transition may produce an outbound exit message; producing it needs no finality — finality is needed only at on-chain snapshot submission.   | `REQ-LIF-3.T1.P1` — valid case and direct invalid/opposite<br>`REQ-LIF-3.T1.P2` — matching/mismatched commitment, predecessor/genesis, stale and foreign fork                                                                                                                                                                     |
| `REQ-LIF-4.T1` | `REQ-LIF-4`               | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Every initiated dispute produces a canonical successor fork; execution resumes from it.                                                               | `REQ-LIF-4.T1.P1` — valid case and direct invalid/opposite<br>`REQ-LIF-4.T1.P2` — matching/mismatched commitment, predecessor/genesis, stale and foreign fork<br>`REQ-LIF-4.T1.P3` — malformed and adversarial input, partial failure, retry and recovery                                                                         |
| `INV-LIF-5.T1` | `INV-LIF-5`               | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Settlement conserves value: processed withdrawals never exceed deposits.                                                                              | `INV-LIF-5.T1.P1` — valid case and direct invalid/opposite<br>`INV-LIF-5.T1.P2` — zero, exact balance/boundary, one beyond, maximum value and conservation                                                                                                                                                                        |
| `REQ-LIF-6.T1` | `REQ-LIF-6`               | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Four deployment-configured windows (`p2pTime`, `agreementTime`, `chainFallbackTime`, `evidenceTime`) bound the phases as specified in §8.             | `REQ-LIF-6.T1.P1` — valid case and direct invalid/opposite<br>`REQ-LIF-6.T1.P2` — before/at/after deadline and maximum honest skew                                                                                                                                                                                                |
