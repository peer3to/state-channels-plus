...
| ---------------- | ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `INV-TRUST-1.T1` | `INV-TRUST-1`             | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Safety-relevant disagreements resolvable on-chain from objective inputs alone.                                                                                             | <a id="inv-trust-1.t1.p1"></a>`INV-TRUST-1.T1.P1` — valid case<br><a id="inv-trust-1.t1.p3"></a>`INV-TRUST-1.T1.P3` — direct invalid/opposite case<br><a id="inv-trust-1.t1.p2"></a>`INV-TRUST-1.T1.P2` — zero/empty/no-op case<br><a id="inv-trust-1.t1.p4"></a>`INV-TRUST-1.T1.P4` — exact boundary<br><a id="inv-trust-1.t1.p5"></a>`INV-TRUST-1.T1.P5` — failure and recovery<br><a id="inv-trust-1.t1.p6"></a>`INV-TRUST-1.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `REQ-TRUST-1.T1` | `REQ-TRUST-1`             | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Enforcement uses only objective on-chain claims; subjective input never slashable.                                                                                         | <a id="req-trust-1.t1.p1"></a>`REQ-TRUST-1.T1.P1` — valid case<br><a id="req-trust-1.t1.p3"></a>`REQ-TRUST-1.T1.P3` — direct invalid/opposite case<br><a id="req-trust-1.t1.p2"></a>`REQ-TRUST-1.T1.P2` — new participant<br><a id="req-trust-1.t1.p4"></a>`REQ-TRUST-1.T1.P4` — existing participant<br><a id="req-trust-1.t1.p5"></a>`REQ-TRUST-1.T1.P5` — removed participant<br><a id="req-trust-1.t1.p6"></a>`REQ-TRUST-1.T1.P6` — slashed participant<br><a id="req-trust-1.t1.p7"></a>`REQ-TRUST-1.T1.P7` — concurrent membership change                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `REQ-TRUST-2.T1` | `REQ-TRUST-2`             | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | At least one available, honest RPC connection required; redundancy helps availability but does not remove the assumption.                                                  | <a id="req-trust-2.t1.p1"></a>`REQ-TRUST-2.T1.P1` — valid case<br><a id="req-trust-2.t1.p3"></a>`REQ-TRUST-2.T1.P3` — direct invalid/opposite case<br><a id="req-trust-2.t1.p2"></a>`REQ-TRUST-2.T1.P2` — new participant<br><a id="req-trust-2.t1.p4"></a>`REQ-TRUST-2.T1.P4` — existing participant<br><a id="req-trust-2.t1.p5"></a>`REQ-TRUST-2.T1.P5` — removed participant<br><a id="req-trust-2.t1.p6"></a>`REQ-TRUST-2.T1.P6` — slashed participant<br><a id="req-trust-2.t1.p7"></a>`REQ-TRUST-2.T1.P7` — concurrent membership change                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `REQ-TRUST-3.T1` | `REQ-TRUST-3`             | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | At least one non-Byzantine participant per partition; all-Byzantine partitions have no safety.                                                                             | <a id="req-trust-3.t1.p1"></a>`REQ-TRUST-3.T1.P1` — valid case<br><a id="req-trust-3.t1.p4"></a>`REQ-TRUST-3.T1.P4` — direct invalid/opposite case<br><a id="req-trust-3.t1.p2"></a>`REQ-TRUST-3.T1.P2` — correct identity/signature<br><a id="req-trust-3.t1.p5"></a>`REQ-TRUST-3.T1.P5` — wrong identity/signature<br><a id="req-trust-3.t1.p6"></a>`REQ-TRUST-3.T1.P6` — missing identity/signature<br><a id="req-trust-3.t1.p7"></a>`REQ-TRUST-3.T1.P7` — duplicate identity/signature<br><a id="req-trust-3.t1.p8"></a>`REQ-TRUST-3.T1.P8` — forged identity/signature<br><a id="req-trust-3.t1.p9"></a>`REQ-TRUST-3.T1.P9` — membership boundary<br><a id="req-trust-3.t1.p3"></a>`REQ-TRUST-3.T1.P3` — malformed input<br><a id="req-trust-3.t1.p10"></a>`REQ-TRUST-3.T1.P10` — adversarial input<br><a id="req-trust-3.t1.p11"></a>`REQ-TRUST-3.T1.P11` — partial failure<br><a id="req-trust-3.t1.p12"></a>`REQ-TRUST-3.T1.P12` — retry and recovery                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `REQ-TRUST-4.T1` | `REQ-TRUST-4`             | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Watchtower/delegate required for offline honest participants, with stated data, privacy, availability, authorization, timeout, and failure assumptions.                    | <a id="req-trust-4.t1.p1"></a>`REQ-TRUST-4.T1.P1` — valid case<br><a id="req-trust-4.t1.p6"></a>`REQ-TRUST-4.T1.P6` — direct invalid/opposite case<br><a id="req-trust-4.t1.p2"></a>`REQ-TRUST-4.T1.P2` — correct identity/signature<br><a id="req-trust-4.t1.p7"></a>`REQ-TRUST-4.T1.P7` — wrong identity/signature<br><a id="req-trust-4.t1.p8"></a>`REQ-TRUST-4.T1.P8` — missing identity/signature<br><a id="req-trust-4.t1.p9"></a>`REQ-TRUST-4.T1.P9` — duplicate identity/signature<br><a id="req-trust-4.t1.p10"></a>`REQ-TRUST-4.T1.P10` — forged identity/signature<br><a id="req-trust-4.t1.p11"></a>`REQ-TRUST-4.T1.P11` — membership boundary<br><a id="req-trust-4.t1.p3"></a>`REQ-TRUST-4.T1.P3` — before deadline<br><a id="req-trust-4.t1.p12"></a>`REQ-TRUST-4.T1.P12` — at deadline<br><a id="req-trust-4.t1.p13"></a>`REQ-TRUST-4.T1.P13` — after deadline<br><a id="req-trust-4.t1.p14"></a>`REQ-TRUST-4.T1.P14` — maximum honest skew<br><a id="req-trust-4.t1.p4"></a>`REQ-TRUST-4.T1.P4` — malformed input<br><a id="req-trust-4.t1.p15"></a>`REQ-TRUST-4.T1.P15` — adversarial input<br><a id="req-trust-4.t1.p16"></a>`REQ-TRUST-4.T1.P16` — partial failure<br><a id="req-trust-4.t1.p17"></a>`REQ-TRUST-4.T1.P17` — retry and recovery<br><a id="req-trust-4.t1.p5"></a>`REQ-TRUST-4.T1.P5` — static review of named alternatives<br><a id="req-trust-4.t1.p18"></a>`REQ-TRUST-4.T1.P18` — omitted category<br><a id="req-trust-4.t1.p19"></a>`REQ-TRUST-4.T1.P19` — changed assumption |
| `REQ-TRUST-5.T1` | `REQ-TRUST-5`             | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Full-mesh topology; target is many small partitions (≤ ~10, commonly 6).                                                                                                   | <a id="req-trust-5.t1.p1"></a>`REQ-TRUST-5.T1.P1` — valid case<br><a id="req-trust-5.t1.p3"></a>`REQ-TRUST-5.T1.P3` — direct invalid/opposite case<br><a id="req-trust-5.t1.p2"></a>`REQ-TRUST-5.T1.P2` — zero/empty/no-op case<br><a id="req-trust-5.t1.p4"></a>`REQ-TRUST-5.T1.P4` — exact boundary<br><a id="req-trust-5.t1.p5"></a>`REQ-TRUST-5.T1.P5` — failure and recovery<br><a id="req-trust-5.t1.p6"></a>`REQ-TRUST-5.T1.P6` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `REQ-TRUST-6.T1` | `REQ-TRUST-6`             | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Temporary assumption A9: peer authentication assumes no on-path adversary; identity-dependent guarantees are conditional until the handshake binds identities and session. | <a id="req-trust-6.t1.p1"></a>`REQ-TRUST-6.T1.P1` — valid case<br><a id="req-trust-6.t1.p3"></a>`REQ-TRUST-6.T1.P3` — direct invalid/opposite case<br><a id="req-trust-6.t1.p2"></a>`REQ-TRUST-6.T1.P2` — correct identity/signature<br><a id="req-trust-6.t1.p4"></a>`REQ-TRUST-6.T1.P4` — wrong identity/signature<br><a id="req-trust-6.t1.p5"></a>`REQ-TRUST-6.T1.P5` — missing identity/signature<br><a id="req-trust-6.t1.p6"></a>`REQ-TRUST-6.T1.P6` — duplicate identity/signature<br><a id="req-trust-6.t1.p7"></a>`REQ-TRUST-6.T1.P7` — forged identity/signature<br><a id="req-trust-6.t1.p8"></a>`REQ-TRUST-6.T1.P8` — membership boundary                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
