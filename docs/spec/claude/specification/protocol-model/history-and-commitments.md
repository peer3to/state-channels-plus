...
| --------------- | ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `INV-HIST-1.T1` | `INV-HIST-1`              | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Block commits to the state snapshot hash; serialized state committed indirectly via `SnapshotData.stateMachineStateHash` | <a id="inv-hist-1.t1.p1"></a>`INV-HIST-1.T1.P1` — valid case<br><a id="inv-hist-1.t1.p2"></a>`INV-HIST-1.T1.P2` — matching commitment<br><a id="inv-hist-1.t1.p3"></a>`INV-HIST-1.T1.P3` — direct invalid/opposite case<br><a id="inv-hist-1.t1.p4"></a>`INV-HIST-1.T1.P4` — mismatched commitment<br><a id="inv-hist-1.t1.p5"></a>`INV-HIST-1.T1.P5` — predecessor link<br><a id="inv-hist-1.t1.p6"></a>`INV-HIST-1.T1.P6` — genesis link<br><a id="inv-hist-1.t1.p7"></a>`INV-HIST-1.T1.P7` — stale fork<br><a id="inv-hist-1.t1.p8"></a>`INV-HIST-1.T1.P8` — foreign fork |
| `INV-HIST-2.T1` | `INV-HIST-2`              | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Hash-linking: height>0 links to previous block hash; height 0 links to genesis snapshot hash                             | <a id="inv-hist-2.t1.p1"></a>`INV-HIST-2.T1.P1` — valid case<br><a id="inv-hist-2.t1.p2"></a>`INV-HIST-2.T1.P2` — matching commitment<br><a id="inv-hist-2.t1.p3"></a>`INV-HIST-2.T1.P3` — direct invalid/opposite case<br><a id="inv-hist-2.t1.p4"></a>`INV-HIST-2.T1.P4` — mismatched commitment<br><a id="inv-hist-2.t1.p5"></a>`INV-HIST-2.T1.P5` — predecessor link<br><a id="inv-hist-2.t1.p6"></a>`INV-HIST-2.T1.P6` — genesis link<br><a id="inv-hist-2.t1.p7"></a>`INV-HIST-2.T1.P7` — stale fork<br><a id="inv-hist-2.t1.p8"></a>`INV-HIST-2.T1.P8` — foreign fork |
| `INV-HIST-3.T1` | `INV-HIST-3`              | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Snapshots commit to inbound and outbound message-stream tips (hash + height)                                             | <a id="inv-hist-3.t1.p1"></a>`INV-HIST-3.T1.P1` — valid case<br><a id="inv-hist-3.t1.p2"></a>`INV-HIST-3.T1.P2` — matching commitment<br><a id="inv-hist-3.t1.p3"></a>`INV-HIST-3.T1.P3` — direct invalid/opposite case<br><a id="inv-hist-3.t1.p4"></a>`INV-HIST-3.T1.P4` — mismatched commitment<br><a id="inv-hist-3.t1.p5"></a>`INV-HIST-3.T1.P5` — predecessor link<br><a id="inv-hist-3.t1.p6"></a>`INV-HIST-3.T1.P6` — genesis link<br><a id="inv-hist-3.t1.p7"></a>`INV-HIST-3.T1.P7` — stale fork<br><a id="inv-hist-3.t1.p8"></a>`INV-HIST-3.T1.P8` — foreign fork |
| `INV-HIST-4.T1` | `INV-HIST-4`              | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | `forkId = keccak256(abi.encode(genesis SnapshotData))`; `originForkId` chains fork ancestry                              | <a id="inv-hist-4.t1.p1"></a>`INV-HIST-4.T1.P1` — valid case<br><a id="inv-hist-4.t1.p2"></a>`INV-HIST-4.T1.P2` — matching commitment<br><a id="inv-hist-4.t1.p3"></a>`INV-HIST-4.T1.P3` — direct invalid/opposite case<br><a id="inv-hist-4.t1.p4"></a>`INV-HIST-4.T1.P4` — mismatched commitment<br><a id="inv-hist-4.t1.p5"></a>`INV-HIST-4.T1.P5` — predecessor link<br><a id="inv-hist-4.t1.p6"></a>`INV-HIST-4.T1.P6` — genesis link<br><a id="inv-hist-4.t1.p7"></a>`INV-HIST-4.T1.P7` — stale fork<br><a id="inv-hist-4.t1.p8"></a>`INV-HIST-4.T1.P8` — foreign fork |
