...
| -------------- | ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `REQ-FIN-1.T1` | `REQ-FIN-1`               | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Participants build on the latest valid state immediately; explicit threshold finality is never a precondition for producing the next block. | <a id="req-fin-1.t1.p1"></a>`REQ-FIN-1.T1.P1` — valid case<br><a id="req-fin-1.t1.p2"></a>`REQ-FIN-1.T1.P2` — correct identity and signature<br><a id="req-fin-1.t1.p3"></a>`REQ-FIN-1.T1.P3` — direct invalid/opposite case<br><a id="req-fin-1.t1.p4"></a>`REQ-FIN-1.T1.P4` — wrong-identity signature<br><a id="req-fin-1.t1.p5"></a>`REQ-FIN-1.T1.P5` — missing signature<br><a id="req-fin-1.t1.p6"></a>`REQ-FIN-1.T1.P6` — duplicate signature<br><a id="req-fin-1.t1.p7"></a>`REQ-FIN-1.T1.P7` — forged signature<br><a id="req-fin-1.t1.p8"></a>`REQ-FIN-1.T1.P8` — membership-boundary signer                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `INV-FIN-2.T1` | `INV-FIN-2`               | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Signing is a non-equivocating vote; provable equivocation is slashable.                                                                     | <a id="inv-fin-2.t1.p1"></a>`INV-FIN-2.T1.P1` — valid case<br><a id="inv-fin-2.t1.p2"></a>`INV-FIN-2.T1.P2` — correct identity and signature<br><a id="inv-fin-2.t1.p3"></a>`INV-FIN-2.T1.P3` — new participant<br><a id="inv-fin-2.t1.p4"></a>`INV-FIN-2.T1.P4` — direct invalid/opposite case<br><a id="inv-fin-2.t1.p5"></a>`INV-FIN-2.T1.P5` — wrong-identity signature<br><a id="inv-fin-2.t1.p6"></a>`INV-FIN-2.T1.P6` — missing signature<br><a id="inv-fin-2.t1.p7"></a>`INV-FIN-2.T1.P7` — duplicate signature<br><a id="inv-fin-2.t1.p8"></a>`INV-FIN-2.T1.P8` — forged signature<br><a id="inv-fin-2.t1.p9"></a>`INV-FIN-2.T1.P9` — membership-boundary signer<br><a id="inv-fin-2.t1.p10"></a>`INV-FIN-2.T1.P10` — existing participant<br><a id="inv-fin-2.t1.p11"></a>`INV-FIN-2.T1.P11` — removed participant<br><a id="inv-fin-2.t1.p12"></a>`INV-FIN-2.T1.P12` — slashed participant<br><a id="inv-fin-2.t1.p13"></a>`INV-FIN-2.T1.P13` — concurrent membership change                                                                                                                                                                                                                                                                                          |
| `REQ-FIN-3.T1` | `REQ-FIN-3`               | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Signatures accumulate across hash-linked ancestry (virtual voting).                                                                         | <a id="req-fin-3.t1.p1"></a>`REQ-FIN-3.T1.P1` — valid case<br><a id="req-fin-3.t1.p2"></a>`REQ-FIN-3.T1.P2` — matching commitment<br><a id="req-fin-3.t1.p3"></a>`REQ-FIN-3.T1.P3` — correct identity and signature<br><a id="req-fin-3.t1.p4"></a>`REQ-FIN-3.T1.P4` — direct invalid/opposite case<br><a id="req-fin-3.t1.p5"></a>`REQ-FIN-3.T1.P5` — mismatched commitment<br><a id="req-fin-3.t1.p6"></a>`REQ-FIN-3.T1.P6` — predecessor link<br><a id="req-fin-3.t1.p7"></a>`REQ-FIN-3.T1.P7` — genesis link<br><a id="req-fin-3.t1.p8"></a>`REQ-FIN-3.T1.P8` — stale fork<br><a id="req-fin-3.t1.p9"></a>`REQ-FIN-3.T1.P9` — foreign fork<br><a id="req-fin-3.t1.p10"></a>`REQ-FIN-3.T1.P10` — wrong-identity signature<br><a id="req-fin-3.t1.p11"></a>`REQ-FIN-3.T1.P11` — missing signature<br><a id="req-fin-3.t1.p12"></a>`REQ-FIN-3.T1.P12` — duplicate signature<br><a id="req-fin-3.t1.p13"></a>`REQ-FIN-3.T1.P13` — forged signature<br><a id="req-fin-3.t1.p14"></a>`REQ-FIN-3.T1.P14` — membership-boundary signer                                                                                                                                                                                                                                               |
| `REQ-FIN-4.T1` | `REQ-FIN-4`               | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | N consecutive blocks authored by the complete participant set finalize the sequence's first block.                                          | <a id="req-fin-4.t1.p1"></a>`REQ-FIN-4.T1.P1` — valid case<br><a id="req-fin-4.t1.p2"></a>`REQ-FIN-4.T1.P2` — correct identity and signature<br><a id="req-fin-4.t1.p3"></a>`REQ-FIN-4.T1.P3` — direct invalid/opposite case<br><a id="req-fin-4.t1.p4"></a>`REQ-FIN-4.T1.P4` — wrong-identity signature<br><a id="req-fin-4.t1.p5"></a>`REQ-FIN-4.T1.P5` — missing signature<br><a id="req-fin-4.t1.p6"></a>`REQ-FIN-4.T1.P6` — duplicate signature<br><a id="req-fin-4.t1.p7"></a>`REQ-FIN-4.T1.P7` — forged signature<br><a id="req-fin-4.t1.p8"></a>`REQ-FIN-4.T1.P8` — membership-boundary signer                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `REQ-FIN-5.T1` | `REQ-FIN-5`               | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Deterministic block-level authoring via `getNextToWrite`; a missed slot is timeout-disputable.                                              | <a id="req-fin-5.t1.p1"></a>`REQ-FIN-5.T1.P1` — valid case<br><a id="req-fin-5.t1.p2"></a>`REQ-FIN-5.T1.P2` — correct identity and signature<br><a id="req-fin-5.t1.p3"></a>`REQ-FIN-5.T1.P3` — before deadline<br><a id="req-fin-5.t1.p4"></a>`REQ-FIN-5.T1.P4` — direct invalid/opposite case<br><a id="req-fin-5.t1.p5"></a>`REQ-FIN-5.T1.P5` — wrong-identity signature<br><a id="req-fin-5.t1.p6"></a>`REQ-FIN-5.T1.P6` — missing signature<br><a id="req-fin-5.t1.p7"></a>`REQ-FIN-5.T1.P7` — duplicate signature<br><a id="req-fin-5.t1.p8"></a>`REQ-FIN-5.T1.P8` — forged signature<br><a id="req-fin-5.t1.p9"></a>`REQ-FIN-5.T1.P9` — membership-boundary signer<br><a id="req-fin-5.t1.p10"></a>`REQ-FIN-5.T1.P10` — at deadline<br><a id="req-fin-5.t1.p11"></a>`REQ-FIN-5.T1.P11` — after deadline<br><a id="req-fin-5.t1.p12"></a>`REQ-FIN-5.T1.P12` — maximum honest skew                                                                                                                                                                                                                                                                                                                                                                                          |
| `REQ-FIN-6.T1` | `REQ-FIN-6`               | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Recommended leader-election policy is round-robin as a function of channel state.                                                           | <a id="req-fin-6.t1.p1"></a>`REQ-FIN-6.T1.P1` — valid case<br><a id="req-fin-6.t1.p2"></a>`REQ-FIN-6.T1.P2` — zero case where meaningful<br><a id="req-fin-6.t1.p3"></a>`REQ-FIN-6.T1.P3` — direct invalid/opposite case<br><a id="req-fin-6.t1.p4"></a>`REQ-FIN-6.T1.P4` — empty case where meaningful<br><a id="req-fin-6.t1.p5"></a>`REQ-FIN-6.T1.P5` — no-op case where meaningful<br><a id="req-fin-6.t1.p6"></a>`REQ-FIN-6.T1.P6` — exact boundary<br><a id="req-fin-6.t1.p7"></a>`REQ-FIN-6.T1.P7` — failure and recovery<br><a id="req-fin-6.t1.p8"></a>`REQ-FIN-6.T1.P8` — relevant race                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `REQ-FIN-7.T1` | `REQ-FIN-7`               | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | The finality threshold is unanimous over the relevant union participant set (minus on-chain-slashed, for disputes).                         | <a id="req-fin-7.t1.p1"></a>`REQ-FIN-7.T1.P1` — valid case<br><a id="req-fin-7.t1.p2"></a>`REQ-FIN-7.T1.P2` — correct identity and signature<br><a id="req-fin-7.t1.p3"></a>`REQ-FIN-7.T1.P3` — new participant<br><a id="req-fin-7.t1.p4"></a>`REQ-FIN-7.T1.P4` — malformed input<br><a id="req-fin-7.t1.p5"></a>`REQ-FIN-7.T1.P5` — direct invalid/opposite case<br><a id="req-fin-7.t1.p6"></a>`REQ-FIN-7.T1.P6` — wrong-identity signature<br><a id="req-fin-7.t1.p7"></a>`REQ-FIN-7.T1.P7` — missing signature<br><a id="req-fin-7.t1.p8"></a>`REQ-FIN-7.T1.P8` — duplicate signature<br><a id="req-fin-7.t1.p9"></a>`REQ-FIN-7.T1.P9` — forged signature<br><a id="req-fin-7.t1.p10"></a>`REQ-FIN-7.T1.P10` — membership-boundary signer<br><a id="req-fin-7.t1.p11"></a>`REQ-FIN-7.T1.P11` — existing participant<br><a id="req-fin-7.t1.p12"></a>`REQ-FIN-7.T1.P12` — removed participant<br><a id="req-fin-7.t1.p13"></a>`REQ-FIN-7.T1.P13` — slashed participant<br><a id="req-fin-7.t1.p14"></a>`REQ-FIN-7.T1.P14` — concurrent membership change<br><a id="req-fin-7.t1.p15"></a>`REQ-FIN-7.T1.P15` — adversarial input<br><a id="req-fin-7.t1.p16"></a>`REQ-FIN-7.T1.P16` — partial failure<br><a id="req-fin-7.t1.p17"></a>`REQ-FIN-7.T1.P17` — retry and recovery |
| `INV-FIN-8.T1` | `INV-FIN-8`               | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Valid non-final transitions are carried into the canonical successor fork, not reverted (longest valid proved history wins).                | <a id="inv-fin-8.t1.p1"></a>`INV-FIN-8.T1.P1` — valid case<br><a id="inv-fin-8.t1.p2"></a>`INV-FIN-8.T1.P2` — matching commitment<br><a id="inv-fin-8.t1.p3"></a>`INV-FIN-8.T1.P3` — direct invalid/opposite case<br><a id="inv-fin-8.t1.p4"></a>`INV-FIN-8.T1.P4` — mismatched commitment<br><a id="inv-fin-8.t1.p5"></a>`INV-FIN-8.T1.P5` — predecessor link<br><a id="inv-fin-8.t1.p6"></a>`INV-FIN-8.T1.P6` — genesis link<br><a id="inv-fin-8.t1.p7"></a>`INV-FIN-8.T1.P7` — stale fork<br><a id="inv-fin-8.t1.p8"></a>`INV-FIN-8.T1.P8` — foreign fork                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
