...
| `SignedBlock`       | `encodedBlock`, `signature`                                                | A block signed by its author. Signing is a non-equivocating commitment ([../protocol/finality.md](./finality.md)).                                                                                                                               |
| `BlockConfirmation` | `signedBlock`, `signatures[]`                                              | A block plus collected participant signatures; the building unit of milestones ([../protocol/state-proofs.md](../disputes/state-proofs.md)).                                                                                                     |
...
| `Timeout`             | `participant`, `blockHeight`, `minTimeStamp`, `isForced`, and optional `previousBlockProducer`, `previousBlockProducerPostedCalldata`, `participantSignatureOnPreviousBlock`                                                                    | A claim to remove an unavailable participant at a block height, invalid before `minTimeStamp`. `isForced` skips on-chain race-condition checks when the target committed to a block not linked to the latest state but deviation cannot be proven directly. The optional fields carry evidence about the previous block producer used by the timeout dispute fraud proofs. Precedence and ordering rules: [../protocol/disputes.md](../disputes/disputes.md).                    |
...
| --------------- | ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `INV-DATA-1.T1` | `INV-DATA-1`              | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Equal logical values encode to identical canonical bytes and decode to equal fields in every conforming implementation.               | <a id="inv-data-1.t1.p1"></a>`INV-DATA-1.T1.P1` — Transaction and block structs (§1)<br><a id="inv-data-1.t1.p2"></a>`INV-DATA-1.T1.P2` — empty arrays<br><a id="inv-data-1.t1.p3"></a>`INV-DATA-1.T1.P3` — `DisputeInput.timeout` present<br><a id="inv-data-1.t1.p4"></a>`INV-DATA-1.T1.P4` — nested bytes<br><a id="inv-data-1.t1.p5"></a>`INV-DATA-1.T1.P5` — contract runtime↔off-chain runtime vectors<br><a id="inv-data-1.t1.p6"></a>`INV-DATA-1.T1.P6` — cross-layer message structs (§2)<br><a id="inv-data-1.t1.p7"></a>`INV-DATA-1.T1.P7` — channel setup and membership structs (§3)<br><a id="inv-data-1.t1.p8"></a>`INV-DATA-1.T1.P8` — exit structs (§4)<br><a id="inv-data-1.t1.p9"></a>`INV-DATA-1.T1.P9` — `Balance` (§5)<br><a id="inv-data-1.t1.p10"></a>`INV-DATA-1.T1.P10` — snapshot structs (§6)<br><a id="inv-data-1.t1.p11"></a>`INV-DATA-1.T1.P11` — dispute structs (§7.1)<br><a id="inv-data-1.t1.p12"></a>`INV-DATA-1.T1.P12` — window, reduction, and storage structs (§7.2)<br><a id="inv-data-1.t1.p13"></a>`INV-DATA-1.T1.P13` — state-proof structs (§7.3)<br><a id="inv-data-1.t1.p14"></a>`INV-DATA-1.T1.P14` — fraud-proof structs and enums (§7.4)<br><a id="inv-data-1.t1.p15"></a>`INV-DATA-1.T1.P15` — single-element arrays<br><a id="inv-data-1.t1.p16"></a>`INV-DATA-1.T1.P16` — multiple-element arrays<br><a id="inv-data-1.t1.p17"></a>`INV-DATA-1.T1.P17` — `DisputeInput.timeout` absent<br><a id="inv-data-1.t1.p18"></a>`INV-DATA-1.T1.P18` — `DisputeInput.selfRemoval` present<br><a id="inv-data-1.t1.p19"></a>`INV-DATA-1.T1.P19` — `DisputeInput.selfRemoval` absent<br><a id="inv-data-1.t1.p20"></a>`INV-DATA-1.T1.P20` — `Timeout` optional evidence fields present<br><a id="inv-data-1.t1.p21"></a>`INV-DATA-1.T1.P21` — `Timeout` optional evidence fields absent. |
| `REQ-DATA-1.T1` | `REQ-DATA-1`              | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Malformed, truncated, trailing, out-of-range, wrong-tag, or otherwise non-canonical values are rejected deterministically.            | <a id="req-data-1.t1.p1"></a>`REQ-DATA-1.T1.P1` — One mutation per field<br><a id="req-data-1.t1.p2"></a>`REQ-DATA-1.T1.P2` — minimum lengths<br><a id="req-data-1.t1.p3"></a>`REQ-DATA-1.T1.P3` — unknown enum tags<br><a id="req-data-1.t1.p4"></a>`REQ-DATA-1.T1.P4` — one mutation per container boundary<br><a id="req-data-1.t1.p5"></a>`REQ-DATA-1.T1.P5` — maximum lengths<br><a id="req-data-1.t1.p6"></a>`REQ-DATA-1.T1.P6` — one-beyond lengths<br><a id="req-data-1.t1.p7"></a>`REQ-DATA-1.T1.P7` — minimum integers<br><a id="req-data-1.t1.p8"></a>`REQ-DATA-1.T1.P8` — maximum integers<br><a id="req-data-1.t1.p9"></a>`REQ-DATA-1.T1.P9` — one-beyond integers.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `REQ-DATA-2.T1` | `REQ-DATA-2`              | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Field order and ordered collections are preserved; set-like collections use their specified canonical order and duplicate policy.     | <a id="req-data-2.t1.p1"></a>`REQ-DATA-2.T1.P1` — Original arrays<br><a id="req-data-2.t1.p2"></a>`REQ-DATA-2.T1.P2` — duplicate members<br><a id="req-data-2.t1.p3"></a>`REQ-DATA-2.T1.P3` — equal sets in different insertion orders<br><a id="req-data-2.t1.p4"></a>`REQ-DATA-2.T1.P4` — missing fields<br><a id="req-data-2.t1.p5"></a>`REQ-DATA-2.T1.P5` — reversed arrays<br><a id="req-data-2.t1.p6"></a>`REQ-DATA-2.T1.P6` — permuted arrays<br><a id="req-data-2.t1.p7"></a>`REQ-DATA-2.T1.P7` — extra fields.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `REQ-DATA-3.T1` | `REQ-DATA-3`              | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | A correctly encoded value cannot be replayed where its required channel, fork, participant, height, or signature domain differs.      | <a id="req-data-3.t1.p1"></a>`REQ-DATA-3.T1.P1` — Same channel and fork<br><a id="req-data-3.t1.p2"></a>`REQ-DATA-3.T1.P2` — stale height<br><a id="req-data-3.t1.p3"></a>`REQ-DATA-3.T1.P3` — correct participant<br><a id="req-data-3.t1.p4"></a>`REQ-DATA-3.T1.P4` — correct signature domain<br><a id="req-data-3.t1.p5"></a>`REQ-DATA-3.T1.P5` — wrong channel<br><a id="req-data-3.t1.p6"></a>`REQ-DATA-3.T1.P6` — wrong fork<br><a id="req-data-3.t1.p7"></a>`REQ-DATA-3.T1.P7` — current height<br><a id="req-data-3.t1.p8"></a>`REQ-DATA-3.T1.P8` — wrong participant<br><a id="req-data-3.t1.p9"></a>`REQ-DATA-3.T1.P9` — wrong signature domain.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `REQ-DATA-4.T1` | `REQ-DATA-4`              | Use the applicable black-box method in the verification strategy above; exercise the behavior through public inputs without implementation internals. | Integer and byte values cross ABI, off-chain runtime, worker, and RPC boundaries without truncation, coercion, or byte-shape changes. | <a id="req-data-4.t1.p1"></a>`REQ-DATA-4.T1.P1` — Zero integers<br><a id="req-data-4.t1.p2"></a>`REQ-DATA-4.T1.P2` — values above JavaScript safe integer<br><a id="req-data-4.t1.p3"></a>`REQ-DATA-4.T1.P3` — empty bytes<br><a id="req-data-4.t1.p4"></a>`REQ-DATA-4.T1.P4` — `Uint8Array` representation<br><a id="req-data-4.t1.p5"></a>`REQ-DATA-4.T1.P5` — structured-clone boundary<br><a id="req-data-4.t1.p6"></a>`REQ-DATA-4.T1.P6` — maximum integers<br><a id="req-data-4.t1.p7"></a>`REQ-DATA-4.T1.P7` — large bytes<br><a id="req-data-4.t1.p8"></a>`REQ-DATA-4.T1.P8` — hex representation<br><a id="req-data-4.t1.p9"></a>`REQ-DATA-4.T1.P9` — JSON boundary.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
