...
| -------------------------------------------------------- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="inv-sm-1.t1"></a>[`INV-SM-1.T1`](#inv-sm-1.t1)    | [`INV-SM-1`](#inv-sm-1)   | Restore the same serialized pre-state in independent local runners and the on-chain replay path, then submit the identical transition and gas limit.                                                         | Success/revert classification, resulting state bytes, and ordered outbound messages are identical in every runtime.                                  | <a id="inv-sm-1.t1.p1"></a>[`INV-SM-1.T1.P1`](#inv-sm-1.t1.p1) — Every public transition<br><a id="inv-sm-1.t1.p2"></a>[`INV-SM-1.T1.P2`](#inv-sm-1.t1.p2) — successful transition<br><a id="inv-sm-1.t1.p3"></a>[`INV-SM-1.T1.P3`](#inv-sm-1.t1.p3) — empty state<br><a id="inv-sm-1.t1.p4"></a>[`INV-SM-1.T1.P4`](#inv-sm-1.t1.p4) — no outbound message<br><a id="inv-sm-1.t1.p5"></a>[`INV-SM-1.T1.P5`](#inv-sm-1.t1.p5) — repeated execution<br><a id="inv-sm-1.t1.p6"></a>[`INV-SM-1.T1.P6`](#inv-sm-1.t1.p6) — reverting transition<br><a id="inv-sm-1.t1.p7"></a>[`INV-SM-1.T1.P7`](#inv-sm-1.t1.p7) — minimum state<br><a id="inv-sm-1.t1.p8"></a>[`INV-SM-1.T1.P8`](#inv-sm-1.t1.p8) — typical state<br><a id="inv-sm-1.t1.p9"></a>[`INV-SM-1.T1.P9`](#inv-sm-1.t1.p9) — maximum supported state<br><a id="inv-sm-1.t1.p10"></a>[`INV-SM-1.T1.P10`](#inv-sm-1.t1.p10) — one outbound message<br><a id="inv-sm-1.t1.p11"></a>[`INV-SM-1.T1.P11`](#inv-sm-1.t1.p11) — many outbound messages.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| <a id="req-sm-1.t1"></a>[`REQ-SM-1.T1`](#req-sm-1.t1)    | [`REQ-SM-1`](#req-sm-1)   | Hold the injected header fixed while varying ambient sender, timestamp, block data, chain ID, balance, and gas context; then vary only the header.                                                           | Ambient changes cannot affect the result; changing the injected participant or timestamp affects only behavior that explicitly uses it.              | <a id="req-sm-1.t1.p1"></a>[`REQ-SM-1.T1.P1`](#req-sm-1.t1.p1) — `msg.sender` varied<br><a id="req-sm-1.t1.p2"></a>[`REQ-SM-1.T1.P2`](#req-sm-1.t1.p2) — valid participant<br><a id="req-sm-1.t1.p3"></a>[`REQ-SM-1.T1.P3`](#req-sm-1.t1.p3) — timestamps before each application boundary<br><a id="req-sm-1.t1.p4"></a>[`REQ-SM-1.T1.P4`](#req-sm-1.t1.p4) — `tx.origin` varied<br><a id="req-sm-1.t1.p5"></a>[`REQ-SM-1.T1.P5`](#req-sm-1.t1.p5) — `block.timestamp` varied<br><a id="req-sm-1.t1.p6"></a>[`REQ-SM-1.T1.P6`](#req-sm-1.t1.p6) — `block.number` varied<br><a id="req-sm-1.t1.p7"></a>[`REQ-SM-1.T1.P7`](#req-sm-1.t1.p7) — `blockhash` varied<br><a id="req-sm-1.t1.p8"></a>[`REQ-SM-1.T1.P8`](#req-sm-1.t1.p8) — `block.prevrandao` varied<br><a id="req-sm-1.t1.p9"></a>[`REQ-SM-1.T1.P9`](#req-sm-1.t1.p9) — `block.coinbase` varied<br><a id="req-sm-1.t1.p10"></a>[`REQ-SM-1.T1.P10`](#req-sm-1.t1.p10) — `block.basefee` varied<br><a id="req-sm-1.t1.p11"></a>[`REQ-SM-1.T1.P11`](#req-sm-1.t1.p11) — `block.chainid` varied<br><a id="req-sm-1.t1.p12"></a>[`REQ-SM-1.T1.P12`](#req-sm-1.t1.p12) — wrapper-level `msg.data` varied<br><a id="req-sm-1.t1.p13"></a>[`REQ-SM-1.T1.P13`](#req-sm-1.t1.p13) — `msg.value` varied<br><a id="req-sm-1.t1.p14"></a>[`REQ-SM-1.T1.P14`](#req-sm-1.t1.p14) — `address(this).balance` varied<br><a id="req-sm-1.t1.p15"></a>[`REQ-SM-1.T1.P15`](#req-sm-1.t1.p15) — external contract state varied<br><a id="req-sm-1.t1.p16"></a>[`REQ-SM-1.T1.P16`](#req-sm-1.t1.p16) — precompile-dependent randomness varied<br><a id="req-sm-1.t1.p17"></a>[`REQ-SM-1.T1.P17`](#req-sm-1.t1.p17) — `gasleft()` varied<br><a id="req-sm-1.t1.p18"></a>[`REQ-SM-1.T1.P18`](#req-sm-1.t1.p18) — representative combination of prohibited values<br><a id="req-sm-1.t1.p19"></a>[`REQ-SM-1.T1.P19`](#req-sm-1.t1.p19) — wrong participant<br><a id="req-sm-1.t1.p20"></a>[`REQ-SM-1.T1.P20`](#req-sm-1.t1.p20) — timestamps at each application boundary<br><a id="req-sm-1.t1.p21"></a>[`REQ-SM-1.T1.P21`](#req-sm-1.t1.p21) — timestamps after each application boundary. |
| <a id="inv-sm-2.t1"></a>[`INV-SM-2.T1`](#inv-sm-2.t1)    | [`INV-SM-2`](#inv-sm-2)   | Serialize state, restore those bytes into a fresh instance, serialize again, and execute the same next transition on original and restored instances.                                                        | Bytes and logical state round-trip exactly, and both instances produce the same next result.                                                         | <a id="inv-sm-2.t1.p1"></a>[`INV-SM-2.T1.P1`](#inv-sm-2.t1.p1) — Empty state<br><a id="inv-sm-2.t1.p2"></a>[`INV-SM-2.T1.P2`](#inv-sm-2.t1.p2) — every collection shape<br><a id="inv-sm-2.t1.p3"></a>[`INV-SM-2.T1.P3`](#inv-sm-2.t1.p3) — repeated round trips<br><a id="inv-sm-2.t1.p4"></a>[`INV-SM-2.T1.P4`](#inv-sm-2.t1.p4) — malformed bytes reject without partial mutation<br><a id="inv-sm-2.t1.p5"></a>[`INV-SM-2.T1.P5`](#inv-sm-2.t1.p5) — minimum state<br><a id="inv-sm-2.t1.p6"></a>[`INV-SM-2.T1.P6`](#inv-sm-2.t1.p6) — typical state<br><a id="inv-sm-2.t1.p7"></a>[`INV-SM-2.T1.P7`](#inv-sm-2.t1.p7) — maximum state.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| <a id="req-sm-2.t1"></a>[`REQ-SM-2.T1`](#req-sm-2.t1)    | [`REQ-SM-2`](#req-sm-2)   | Construct logically equal states through different valid operation orders and compare their encodings and hashes.                                                                                            | Equal logical states produce identical canonical bytes; every transition-readable field survives encode/decode.                                      | <a id="req-sm-2.t1.p1"></a>[`REQ-SM-2.T1.P1`](#req-sm-2.t1.p1) — Reordered construction<br><a id="req-sm-2.t1.p2"></a>[`REQ-SM-2.T1.P2`](#req-sm-2.t1.p2) — zero/default fields<br><a id="req-sm-2.t1.p3"></a>[`REQ-SM-2.T1.P3`](#req-sm-2.t1.p3) — every collection ordering<br><a id="req-sm-2.t1.p4"></a>[`REQ-SM-2.T1.P4`](#req-sm-2.t1.p4) — minimum values<br><a id="req-sm-2.t1.p5"></a>[`REQ-SM-2.T1.P5`](#req-sm-2.t1.p5) — omitted encoding rejects<br><a id="req-sm-2.t1.p6"></a>[`REQ-SM-2.T1.P6`](#req-sm-2.t1.p6) — reordered insertion<br><a id="req-sm-2.t1.p7"></a>[`REQ-SM-2.T1.P7`](#req-sm-2.t1.p7) — maximum values<br><a id="req-sm-2.t1.p8"></a>[`REQ-SM-2.T1.P8`](#req-sm-2.t1.p8) — duplicate encoding rejects<br><a id="req-sm-2.t1.p9"></a>[`REQ-SM-2.T1.P9`](#req-sm-2.t1.p9) — malformed encoding rejects.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| <a id="req-sm-3.t1"></a>[`REQ-SM-3.T1`](#req-sm-3.t1)    | [`REQ-SM-3`](#req-sm-3)   | Populate every mapping-backed state shape, serialize and restore it, then enumerate and compare all keys and values.                                                                                         | Enumeration is complete, uniquely ordered, deterministic, and restores the exact mapping.                                                            | <a id="req-sm-3.t1.p1"></a>[`REQ-SM-3.T1.P1`](#req-sm-3.t1.p1) — Empty mapping<br><a id="req-sm-3.t1.p2"></a>[`REQ-SM-3.T1.P2`](#req-sm-3.t1.p2) — different insertion orders<br><a id="req-sm-3.t1.p3"></a>[`REQ-SM-3.T1.P3`](#req-sm-3.t1.p3) — duplicate keys<br><a id="req-sm-3.t1.p4"></a>[`REQ-SM-3.T1.P4`](#req-sm-3.t1.p4) — minimum key and value<br><a id="req-sm-3.t1.p5"></a>[`REQ-SM-3.T1.P5`](#req-sm-3.t1.p5) — missing enumeration entry<br><a id="req-sm-3.t1.p6"></a>[`REQ-SM-3.T1.P6`](#req-sm-3.t1.p6) — one key<br><a id="req-sm-3.t1.p7"></a>[`REQ-SM-3.T1.P7`](#req-sm-3.t1.p7) — many keys<br><a id="req-sm-3.t1.p8"></a>[`REQ-SM-3.T1.P8`](#req-sm-3.t1.p8) — removed keys<br><a id="req-sm-3.t1.p9"></a>[`REQ-SM-3.T1.P9`](#req-sm-3.t1.p9) — maximum key and value<br><a id="req-sm-3.t1.p10"></a>[`REQ-SM-3.T1.P10`](#req-sm-3.t1.p10) — stale enumeration entry.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| <a id="req-sm-4.t1"></a>[`REQ-SM-4.T1`](#req-sm-4.t1)    | [`REQ-SM-4`](#req-sm-4)   | Open a channel with one encoding, then attempt to replay its history with changed field order, encoding, or state-machine logic.                                                                             | The original encoding remains stable for that channel; incompatible changes cannot silently reinterpret existing state.                              | <a id="req-sm-4.t1.p1"></a>[`REQ-SM-4.T1.P1`](#req-sm-4.t1.p1) — Unchanged implementation<br><a id="req-sm-4.t1.p2"></a>[`REQ-SM-4.T1.P2`](#req-sm-4.t1.p2) — field reorder<br><a id="req-sm-4.t1.p3"></a>[`REQ-SM-4.T1.P3`](#req-sm-4.t1.p3) — logic-only change<br><a id="req-sm-4.t1.p4"></a>[`REQ-SM-4.T1.P4`](#req-sm-4.t1.p4) — old channel<br><a id="req-sm-4.t1.p5"></a>[`REQ-SM-4.T1.P5`](#req-sm-4.t1.p5) — field add<br><a id="req-sm-4.t1.p6"></a>[`REQ-SM-4.T1.P6`](#req-sm-4.t1.p6) — field remove<br><a id="req-sm-4.t1.p7"></a>[`REQ-SM-4.T1.P7`](#req-sm-4.t1.p7) — field type change<br><a id="req-sm-4.t1.p8"></a>[`REQ-SM-4.T1.P8`](#req-sm-4.t1.p8) — newly opened channel.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| <a id="req-bal-1.t1"></a>[`REQ-BAL-1.T1`](#req-bal-1.t1) | [`REQ-BAL-1`](#req-bal-1) | Subtract through the public balance boundary and observe the returned balance or deterministic rejection.                                                                                                    | Amounts up to the held value subtract exactly; any uncovered fungible or custom value rejects without mutation.                                      | <a id="req-bal-1.t1.p1"></a>[`REQ-BAL-1.T1.P1`](#req-bal-1.t1.p1) — Zero from zero<br><a id="req-bal-1.t1.p2"></a>[`REQ-BAL-1.T1.P2`](#req-bal-1.t1.p2) — less than held value<br><a id="req-bal-1.t1.p3"></a>[`REQ-BAL-1.T1.P3`](#req-bal-1.t1.p3) — maximum value<br><a id="req-bal-1.t1.p4"></a>[`REQ-BAL-1.T1.P4`](#req-bal-1.t1.p4) — missing custom asset<br><a id="req-bal-1.t1.p5"></a>[`REQ-BAL-1.T1.P5`](#req-bal-1.t1.p5) — repeated failure and retry<br><a id="req-bal-1.t1.p6"></a>[`REQ-BAL-1.T1.P6`](#req-bal-1.t1.p6) — zero from nonzero<br><a id="req-bal-1.t1.p7"></a>[`REQ-BAL-1.T1.P7`](#req-bal-1.t1.p7) — equal to held value<br><a id="req-bal-1.t1.p8"></a>[`REQ-BAL-1.T1.P8`](#req-bal-1.t1.p8) — one over held value<br><a id="req-bal-1.t1.p9"></a>[`REQ-BAL-1.T1.P9`](#req-bal-1.t1.p9) — duplicate custom asset.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| <a id="req-bal-2.t1"></a>[`REQ-BAL-2.T1`](#req-bal-2.t1) | [`REQ-BAL-2`](#req-bal-2) | Run each balance operation repeatedly with identical encoded inputs in independent instances and replay contexts.                                                                                            | Each operation returns or reverts identically and has no hidden state or ambient-context dependency.                                                 | <a id="req-bal-2.t1.p1"></a>[`REQ-BAL-2.T1.P1`](#req-bal-2.t1.p1) — `addBalance`<br><a id="req-bal-2.t1.p2"></a>[`REQ-BAL-2.T1.P2`](#req-bal-2.t1.p2) — zero values<br><a id="req-bal-2.t1.p3"></a>[`REQ-BAL-2.T1.P3`](#req-bal-2.t1.p3) — canonical custom data<br><a id="req-bal-2.t1.p4"></a>[`REQ-BAL-2.T1.P4`](#req-bal-2.t1.p4) — success<br><a id="req-bal-2.t1.p5"></a>[`REQ-BAL-2.T1.P5`](#req-bal-2.t1.p5) — changed ambient context<br><a id="req-bal-2.t1.p6"></a>[`REQ-BAL-2.T1.P6`](#req-bal-2.t1.p6) — `subtractBalance`<br><a id="req-bal-2.t1.p7"></a>[`REQ-BAL-2.T1.P7`](#req-bal-2.t1.p7) — `areBalancesEqual`<br><a id="req-bal-2.t1.p8"></a>[`REQ-BAL-2.T1.P8`](#req-bal-2.t1.p8) — `isBalanceLesserThan`<br><a id="req-bal-2.t1.p9"></a>[`REQ-BAL-2.T1.P9`](#req-bal-2.t1.p9) — `getTotalStateBalance`<br><a id="req-bal-2.t1.p10"></a>[`REQ-BAL-2.T1.P10`](#req-bal-2.t1.p10) — `getZeroBalance`<br><a id="req-bal-2.t1.p11"></a>[`REQ-BAL-2.T1.P11`](#req-bal-2.t1.p11) — minimum values<br><a id="req-bal-2.t1.p12"></a>[`REQ-BAL-2.T1.P12`](#req-bal-2.t1.p12) — typical values<br><a id="req-bal-2.t1.p13"></a>[`REQ-BAL-2.T1.P13`](#req-bal-2.t1.p13) — maximum values<br><a id="req-bal-2.t1.p14"></a>[`REQ-BAL-2.T1.P14`](#req-bal-2.t1.p14) — rejection.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| <a id="req-sm-5.t1"></a>[`REQ-SM-5.T1`](#req-sm-5.t1)    | [`REQ-SM-5`](#req-sm-5)   | Query the next writer from each reachable state, then attempt to author the next block as every participant and a non-participant.                                                                           | Exactly the returned address is authorized to author the next block.                                                                                 | <a id="req-sm-5.t1.p1"></a>[`REQ-SM-5.T1.P1`](#req-sm-5.t1.p1) — Every participant position<br><a id="req-sm-5.t1.p2"></a>[`REQ-SM-5.T1.P2`](#req-sm-5.t1.p2) — one participant<br><a id="req-sm-5.t1.p3"></a>[`REQ-SM-5.T1.P3`](#req-sm-5.t1.p3) — membership before join<br><a id="req-sm-5.t1.p4"></a>[`REQ-SM-5.T1.P4`](#req-sm-5.t1.p4) — correct author<br><a id="req-sm-5.t1.p5"></a>[`REQ-SM-5.T1.P5`](#req-sm-5.t1.p5) — many participants<br><a id="req-sm-5.t1.p6"></a>[`REQ-SM-5.T1.P6`](#req-sm-5.t1.p6) — membership after join<br><a id="req-sm-5.t1.p7"></a>[`REQ-SM-5.T1.P7`](#req-sm-5.t1.p7) — membership before removal<br><a id="req-sm-5.t1.p8"></a>[`REQ-SM-5.T1.P8`](#req-sm-5.t1.p8) — membership after removal<br><a id="req-sm-5.t1.p9"></a>[`REQ-SM-5.T1.P9`](#req-sm-5.t1.p9) — wrong author<br><a id="req-sm-5.t1.p10"></a>[`REQ-SM-5.T1.P10`](#req-sm-5.t1.p10) — missing author<br><a id="req-sm-5.t1.p11"></a>[`REQ-SM-5.T1.P11`](#req-sm-5.t1.p11) — duplicate author<br><a id="req-sm-5.t1.p12"></a>[`REQ-SM-5.T1.P12`](#req-sm-5.t1.p12) — non-member author.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| <a id="req-sm-6.t1"></a>[`REQ-SM-6.T1`](#req-sm-6.t1)    | [`REQ-SM-6`](#req-sm-6)   | Submit correct- and wrong-author blocks through local validation and the on-chain dispute replay path using a state machine with no in-contract guard.                                                       | Correct blocks proceed; wrong-author blocks are rejected before execution in every required protocol path.                                           | <a id="req-sm-6.t1.p1"></a>[`REQ-SM-6.T1.P1`](#req-sm-6.t1.p1) — Live receipt<br><a id="req-sm-6.t1.p2"></a>[`REQ-SM-6.T1.P2`](#req-sm-6.t1.p2) — every participant position<br><a id="req-sm-6.t1.p3"></a>[`REQ-SM-6.T1.P3`](#req-sm-6.t1.p3) — forged signatures<br><a id="req-sm-6.t1.p4"></a>[`REQ-SM-6.T1.P4`](#req-sm-6.t1.p4) — stored-block merge<br><a id="req-sm-6.t1.p5"></a>[`REQ-SM-6.T1.P5`](#req-sm-6.t1.p5) — spectating<br><a id="req-sm-6.t1.p6"></a>[`REQ-SM-6.T1.P6`](#req-sm-6.t1.p6) — calldata dispute<br><a id="req-sm-6.t1.p7"></a>[`REQ-SM-6.T1.P7`](#req-sm-6.t1.p7) — non-calldata dispute<br><a id="req-sm-6.t1.p8"></a>[`REQ-SM-6.T1.P8`](#req-sm-6.t1.p8) — duplicate signatures.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| <a id="req-sm-7.t1"></a>[`REQ-SM-7.T1`](#req-sm-7.t1)    | [`REQ-SM-7`](#req-sm-7)   | Deliver a join through the public inbound-message path for a new participant and again for the same participant.                                                                                             | First delivery adds membership and value once; subsequent valid delivery tops up value without duplicating membership.                               | <a id="req-sm-7.t1.p1"></a>[`REQ-SM-7.T1.P1`](#req-sm-7.t1.p1) — New participant<br><a id="req-sm-7.t1.p2"></a>[`REQ-SM-7.T1.P2`](#req-sm-7.t1.p2) — zero balance<br><a id="req-sm-7.t1.p3"></a>[`REQ-SM-7.T1.P3`](#req-sm-7.t1.p3) — duplicate delivery<br><a id="req-sm-7.t1.p4"></a>[`REQ-SM-7.T1.P4`](#req-sm-7.t1.p4) — hook rejection without partial state<br><a id="req-sm-7.t1.p5"></a>[`REQ-SM-7.T1.P5`](#req-sm-7.t1.p5) — existing participant<br><a id="req-sm-7.t1.p6"></a>[`REQ-SM-7.T1.P6`](#req-sm-7.t1.p6) — removed participant<br><a id="req-sm-7.t1.p7"></a>[`REQ-SM-7.T1.P7`](#req-sm-7.t1.p7) — slashed participant<br><a id="req-sm-7.t1.p8"></a>[`REQ-SM-7.T1.P8`](#req-sm-7.t1.p8) — nonzero balance<br><a id="req-sm-7.t1.p9"></a>[`REQ-SM-7.T1.P9`](#req-sm-7.t1.p9) — reordered delivery<br><a id="req-sm-7.t1.p10"></a>[`REQ-SM-7.T1.P10`](#req-sm-7.t1.p10) — concurrent delivery<br><a id="req-sm-7.t1.p11"></a>[`REQ-SM-7.T1.P11`](#req-sm-7.t1.p11) — retried delivery.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| <a id="req-sm-8.t1"></a>[`REQ-SM-8.T1`](#req-sm-8.t1)    | [`REQ-SM-8`](#req-sm-8)   | Execute successful and failing soft-removal and slashing paths for equivalent participant states, then inspect state and outbound messages.                                                                  | Successful paths emit the same canonical exit shape; only penalty balance differs; failures leave no partial state or message.                       | <a id="req-sm-8.t1.p1"></a>[`REQ-SM-8.T1.P1`](#req-sm-8.t1.p1) — Zero balance<br><a id="req-sm-8.t1.p2"></a>[`REQ-SM-8.T1.P2`](#req-sm-8.t1.p2) — existing participant<br><a id="req-sm-8.t1.p3"></a>[`REQ-SM-8.T1.P3`](#req-sm-8.t1.p3) — hook success<br><a id="req-sm-8.t1.p4"></a>[`REQ-SM-8.T1.P4`](#req-sm-8.t1.p4) — duplicate invocation<br><a id="req-sm-8.t1.p5"></a>[`REQ-SM-8.T1.P5`](#req-sm-8.t1.p5) — concurrent membership change<br><a id="req-sm-8.t1.p6"></a>[`REQ-SM-8.T1.P6`](#req-sm-8.t1.p6) — outbound processing success<br><a id="req-sm-8.t1.p7"></a>[`REQ-SM-8.T1.P7`](#req-sm-8.t1.p7) — nonzero balance<br><a id="req-sm-8.t1.p8"></a>[`REQ-SM-8.T1.P8`](#req-sm-8.t1.p8) — maximum balance<br><a id="req-sm-8.t1.p9"></a>[`REQ-SM-8.T1.P9`](#req-sm-8.t1.p9) — removed participant<br><a id="req-sm-8.t1.p10"></a>[`REQ-SM-8.T1.P10`](#req-sm-8.t1.p10) — slashed participant<br><a id="req-sm-8.t1.p11"></a>[`REQ-SM-8.T1.P11`](#req-sm-8.t1.p11) — non-member participant<br><a id="req-sm-8.t1.p12"></a>[`REQ-SM-8.T1.P12`](#req-sm-8.t1.p12) — hook failure<br><a id="req-sm-8.t1.p13"></a>[`REQ-SM-8.T1.P13`](#req-sm-8.t1.p13) — retried invocation<br><a id="req-sm-8.t1.p14"></a>[`REQ-SM-8.T1.P14`](#req-sm-8.t1.p14) — outbound processing failure.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| <a id="req-sm-9.t1"></a>[`REQ-SM-9.T1`](#req-sm-9.t1)    | [`REQ-SM-9`](#req-sm-9)   | Exercise every interface capability through the public protocol boundary, snapshot state and outbound messages before and after, and repeat equivalent operations in every applicable execution environment. | Every required capability is reachable and has the specified canonical result; read-only and rejected operations leave state and messages unchanged. | <a id="req-sm-9.t1.p1"></a>[`REQ-SM-9.T1.P1`](#req-sm-9.t1.p1) — apply-transition capability<br><a id="req-sm-9.t1.p2"></a>[`REQ-SM-9.T1.P2`](#req-sm-9.t1.p2) — valid input<br><a id="req-sm-9.t1.p3"></a>[`REQ-SM-9.T1.P3`](#req-sm-9.t1.p3) — local execution<br><a id="req-sm-9.t1.p4"></a>[`REQ-SM-9.T1.P4`](#req-sm-9.t1.p4) — read-only non-mutation<br><a id="req-sm-9.t1.p5"></a>[`REQ-SM-9.T1.P5`](#req-sm-9.t1.p5) — rejection without partial state or outbound messages<br><a id="req-sm-9.t1.p6"></a>[`REQ-SM-9.T1.P6`](#req-sm-9.t1.p6) — read-only-query capability<br><a id="req-sm-9.t1.p7"></a>[`REQ-SM-9.T1.P7`](#req-sm-9.t1.p7) — serialize-state capability<br><a id="req-sm-9.t1.p8"></a>[`REQ-SM-9.T1.P8`](#req-sm-9.t1.p8) — restore-state capability<br><a id="req-sm-9.t1.p9"></a>[`REQ-SM-9.T1.P9`](#req-sm-9.t1.p9) — enumerate-participants capability<br><a id="req-sm-9.t1.p10"></a>[`REQ-SM-9.T1.P10`](#req-sm-9.t1.p10) — select-next-author capability<br><a id="req-sm-9.t1.p11"></a>[`REQ-SM-9.T1.P11`](#req-sm-9.t1.p11) — balance-evaluation capability<br><a id="req-sm-9.t1.p12"></a>[`REQ-SM-9.T1.P12`](#req-sm-9.t1.p12) — inbound-message capability<br><a id="req-sm-9.t1.p13"></a>[`REQ-SM-9.T1.P13`](#req-sm-9.t1.p13) — membership-lifecycle capability<br><a id="req-sm-9.t1.p14"></a>[`REQ-SM-9.T1.P14`](#req-sm-9.t1.p14) — boundary input<br><a id="req-sm-9.t1.p15"></a>[`REQ-SM-9.T1.P15`](#req-sm-9.t1.p15) — malformed input<br><a id="req-sm-9.t1.p16"></a>[`REQ-SM-9.T1.P16`](#req-sm-9.t1.p16) — unsupported input<br><a id="req-sm-9.t1.p17"></a>[`REQ-SM-9.T1.P17`](#req-sm-9.t1.p17) — on-chain execution.                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
