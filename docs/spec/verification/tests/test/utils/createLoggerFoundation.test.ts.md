...
| [`createLoggerFoundation > uses the default store size for zero configuration`](../../../../../../test/utils/createLoggerFoundation.test.ts#L50) (line 50)         | [`UNIT-TEST-CREATE-LOGGER-FOUNDATION-32-1NHGFC.P4`](../../../../implementation/source/src/utils/logging/createLoggerFoundation.ts.md#unit-test-create-logger-foundation-32-1nhgfc.p4) |
