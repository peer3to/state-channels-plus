...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`Unit: ReductionExecutor > getSyncedForkDisputes > committed dispute missing locally → recovers via event replay, then reduces`](../../../../../../test/unit/ReductionExecutor.test.ts#L326) (line 326)                                                                 | [`UNIT-TEST-REDUCTION-EXECUTOR-1-DGAD37.P2`](../../../../implementation/source/src/stateManager/reduction/ReductionExecutor.ts.md#unit-test-reduction-executor-1-dgad37.p2)                                                                                                                          |
...
| [`Unit: ReductionExecutor > reduce data unavailable > someone else's reduction while the run is unavailable → not challenged, no throw`](../../../../../../test/unit/ReductionExecutor.test.ts#L101) (line 101)                                                          | —                                                                                                                                                                                                                                                                                                    |
| [`Unit: ReductionExecutor > dispute window unavailable > unreadable dispute window → the attempt defers instead of aborting`](../../../../../../test/unit/ReductionExecutor.test.ts#L187) (line 187)                                                                     | —                                                                                                                                                                                                                                                                                                    |
| [`Unit: ReductionExecutor > dispute window unavailable > a re-dispatched dispute log that fails again → failed attempt, not a fatal`](../../../../../../test/unit/ReductionExecutor.test.ts#L249) (line 249)                                                             | —                                                                                                                                                                                                                                                                                                    |
| [`Unit: ReductionExecutor > dispute window unavailable > unreadable dispute window → the reduction is not challenged`](../../../../../../test/unit/ReductionExecutor.test.ts#L288) (line 288)                                                                            | —                                                                                                                                                                                                                                                                                                    |
| [`Unit: ReductionExecutor > reduced fork already in its kill period > the simulation meets the reduced fork's open window → the reduce lands alone, the chain snapshot waits, no host errors`](../../../../../../test/unit/ReductionExecutor.test.ts#L436) (line 436)    | [`UNIT-TEST-REDUCTION-EXECUTOR-1-DGAD37.P16`](../../../../implementation/source/src/stateManager/reduction/ReductionExecutor.ts.md#unit-test-reduction-executor-1-dgad37.p16), [`REQ-ENFSNAP-4-ESP98F.T1.P8`](../../../../specification/enforcement/snapshot-adoption.md#req-enfsnap-4-esp98f.t1.p8) |
| [`Unit: ReductionExecutor > reduced fork already in its kill period > the send meets the reduced fork's open window → the reduce is resubmitted alone, the chain snapshot waits, no host errors`](../../../../../../test/unit/ReductionExecutor.test.ts#L441) (line 441) | [`UNIT-TEST-REDUCTION-EXECUTOR-1-DGAD37.P15`](../../../../implementation/source/src/stateManager/reduction/ReductionExecutor.ts.md#unit-test-reduction-executor-1-dgad37.p15)                                                                                                                        |
