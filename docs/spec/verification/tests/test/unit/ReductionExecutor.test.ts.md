...
| [`Unit: ReductionExecutor > reduced fork already in its kill period > the simulation meets the reduced fork's open window → the reduce lands alone, the chain snapshot waits, no host errors`](../../../../../../test/unit/ReductionExecutor.test.ts#L436) (line 436)    | [`UNIT-TEST-REDUCTION-EXECUTOR-1-DGAD37.P14`](../../../../implementation/source/src/stateManager/reduction/ReductionExecutor.ts.md#unit-test-reduction-executor-1-dgad37.p14), [`REQ-ENFSNAP-4-ESP98F.T1.P8`](../../../../specification/enforcement/snapshot-adoption.md#req-enfsnap-4-esp98f.t1.p8) |
