...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`open-channel registry events > reconstructs the opened set from ChannelOpened events and matches the paged registry`](../../../../../../test/unit/OpenChannelRegistryEvents.test.ts#L12) (line 12) | [`UNIT-TEST-OPEN-CHANNEL-REGISTRY-1-KFDPM7.P9`](../../../../implementation/source/contracts/V1/StateChannelDiamondProxy/StateChannelCommon.sol.md#unit-test-open-channel-registry-1-kfdpm7) |
