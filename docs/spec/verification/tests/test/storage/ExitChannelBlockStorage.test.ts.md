...
| [`MessageBlockStorage - outbound behavior > latest block helpers > returns the most recent block`](../../../../../../test/storage/ExitChannelBlockStorage.test.ts#L80) (line 80)                                           | [`UNIT-TEST-MESSAGE-BLOCK-STORAGE-1-EHBRD1.P1`](../../../../implementation/source/src/storage/MessageBlockStorage.ts.md#unit-test-message-block-storage-1-ehbrd1) |
