...
| [`chain signer serialization > round-trips a normalized transaction request`](../../../../../../test/evm/chainSignerSerialization.test.ts#L19) (line 19)                                        | [`REQ-RUN-6-MTBT2H.T1.P1`](../../../../implementation/views/architecture/sdk/runtime-and-concurrency.md#req-run-6-mtbt2h) |
...
| [`chain signer serialization > rejects fields that cannot cross the runtime port`](../../../../../../test/evm/chainSignerSerialization.test.ts#L78) (line 78)                                   | [`REQ-RUN-6-MTBT2H.T1.P4`](../../../../implementation/views/architecture/sdk/runtime-and-concurrency.md#req-run-6-mtbt2h) |
