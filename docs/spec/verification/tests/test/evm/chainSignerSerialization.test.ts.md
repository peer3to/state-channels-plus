...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| [`chain signer serialization > round-trips a normalized transaction request`](../../../../../../test/evm/chainSignerSerialization.test.ts#L12) (line 12)               | [`REQ-RUN-6-MTBT2H.T1.P1`](../../../../implementation/views/architecture/sdk/runtime-and-concurrency.md#req-run-6-mtbt2h.t1.p1) |
| [`chain signer serialization > reconstructs a native provider-backed transaction response`](../../../../../../test/evm/chainSignerSerialization.test.ts#L46) (line 46) | —                                                                                                                               |
| [`chain signer serialization > allows explicit client-side replacement detection`](../../../../../../test/evm/chainSignerSerialization.test.ts#L67) (line 67)          | —                                                                                                                               |
| [`chain signer serialization > rejects fields that cannot cross the runtime port`](../../../../../../test/evm/chainSignerSerialization.test.ts#L115) (line 115)        | [`REQ-RUN-6-MTBT2H.T1.P4`](../../../../implementation/views/architecture/sdk/runtime-and-concurrency.md#req-run-6-mtbt2h.t1.p4) |
