...
| [`E2E: Participant Lifecycle > Join path > preserves a landed pending join when the same confirmation is retried`](../../../../../../test/e2e/E2E-ParticipantLifecycle.test.ts#L161) (line 161)                               | [`REQ-ENFADM-2-K6K9SP.T1.P4`](../../../../specification/enforcement/admission-and-funds.md#req-enfadm-2-k6k9sp.t1.p4), [`UNIT-TEST-JOIN-CHANNEL-FACET-1-VBJY1A.P17`](../../../../implementation/source/contracts/V1/StateChannelDiamondProxy/JoinChannelFacet.sol.md#unit-test-join-channel-facet-1-vbjy1a.p17) |
