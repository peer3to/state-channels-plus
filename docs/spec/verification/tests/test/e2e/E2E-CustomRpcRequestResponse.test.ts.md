...
Both manager-address connections use `connectStateChannelManager`, so this same worker/runtime
boundary also proves the canonical merged binding remains usable during a complete two-peer setup.
