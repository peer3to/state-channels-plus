...
per-gate disputer-not-sender revert and the [`REQ-DIS-2-PKVZ7E` (Upload is limited to eligible disputers)](../../../../../../specification/disputes/disputes.md#req-dis-2-pkvz7e) wrong-identity split.
...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`E2E: dispute validation / uploadRevert / disputer > dispute.input.disputer = ZeroAddress → dispute upload fails → ErrorDisputerNotMsgSender`](../../../../../../../../test/e2e/disputeValidation/uploadRevert/disputer.test.ts#L7) (line 7) | [`UNIT-TEST-DISPUTE-MANAGER-FACET-1-B4KKY2.P8`](../../../../../../implementation/source/contracts/V1/StateChannelDiamondProxy/DisputeManagerFacet.sol.md#unit-test-dispute-manager-facet-1-b4kky2)<br>[`REQ-DIS-2-PKVZ7E.T1.P6`](../../../../../../specification/disputes/disputes.md#req-dis-2-pkvz7e.t1.p6) |
