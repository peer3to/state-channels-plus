...
Five direct literal cases drive the reuse of one runtime across channels end to end on the `MathTestSession`
...
The five cases separate what could otherwise hide behind a single happy path. The first reaches a second
...
has not finished), that no genesis snapshot was persisted for the old fork, and that the responder is not
blacklisted; only then does it release the drain and let the leave return. Disconnection is not read separately:
the sync's rejection path disconnects and blacklists together, and the reset itself drops every peer. A
generation advanced after the drain, or a stale branch that rejects its responder, turns it red. The fifth
proves that an explicit shutdown of a reused runtime is still
...
| [`E2E: Channel reuse > a sync resuming mid-reset sees the channel already left and does not penalise its responder`](../../../../../../test/e2e/E2E-ChannelReuse.test.ts#L116) (line 116)          | [`UNIT-TEST-SPECTATE-SERVICE-1-SJBYCT.P27`](../../../../implementation/source/src/rpc/network/services/spectate/SpectateService.ts.md#unit-test-spectate-service-1-sjbyct.p27), [`UNIT-TEST-STATE-MANAGER-RESET-1-9QG1AG.P7`](../../../../implementation/source/src/stateManager/StateManager.ts.md#unit-test-state-manager-reset-1-9qg1ag.p7)                                                                                                                                                                                                                                                          |
| [`E2E: Channel reuse > explicit disposal still shuts down a runtime that was reused`](../../../../../../test/e2e/E2E-ChannelReuse.test.ts#L171) (line 171)                                         | [`REQ-LIF-10-QR8NQ9.T1.P16`](../../../../specification/settlement/lifecycle.md#req-lif-10-qr8nq9.t1.p16)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
