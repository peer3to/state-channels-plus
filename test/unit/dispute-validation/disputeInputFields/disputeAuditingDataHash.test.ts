...
describe("dispute-validation / disputeInputFields / disputeAuditingDataHash", function () {
    it(
        "no calldata: dispute.input.disputeAuditingDataHash tampered → dispute commits, no DisputeInvalidStateProof or other audit-data fraud proof",
        covers(
            {
                disputeAuditingDataHash: "tampered-no-calldata"
            },
            async function () {
