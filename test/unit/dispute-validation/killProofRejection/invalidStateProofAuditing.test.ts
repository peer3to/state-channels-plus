...
describe("dispute-validation / killProofRejection / invalidStateProofAuditing", function () {
    it(
        ...
        covers(
            {
                ...
                disputeAuditingDataHash: "proof-mismatch",
            ...
            async function () {
                ...
                junkAuditing.latestFinalizedStateStateMachineState =
                    hexString(128);
