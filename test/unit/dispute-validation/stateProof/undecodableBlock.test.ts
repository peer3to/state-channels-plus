...
describe("dispute-validation / stateProof / undecodableBlock", function () {
    it(
        "stateProof.milestones[-1].blockConfirmations[-1].signedBlock.encodedBlock = junk → DisputeInvalidStateProof",
        covers(
            {
                stateProof: "undecodable-block",
