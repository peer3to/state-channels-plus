...
describe("E2E: Timeouts", function () {
    describe("Basic Timeout Scenarios", function () {
        scenario(
            ...
            {
                target: [
                    "Timeout.participant:next-writer",
                    "Timeout.isForced:false"
                ],
                proof: "TimeoutThreshold",
    ...
    describe("Network Disconnection Timeouts", function () {
        scenario(
            ...
            {
                target: "Timeout.previousBlockProducerPostedCalldata:true",
                proof: "TimeoutCalldataPosted"
            },
            async function () {
                const h = TestSession.getHarness();
